  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_L2_PF_STORE_ONLY = _RANDOM[/*Zero width*/ 1'b0][0];
        reg_L1D_PF_ENABLE_STRIDE = _RANDOM[/*Zero width*/ 1'b0][1];
        reg_L1D_PF_ACTIVE_STRIDE = _RANDOM[/*Zero width*/ 1'b0][7:2];
        reg_L1D_PF_ACTIVE_THRESHOLD = _RANDOM[/*Zero width*/ 1'b0][11:8];
        reg_L1D_PF_ENABLE_PHT = _RANDOM[/*Zero width*/ 1'b0][12];
        reg_L1D_PF_ENABLE_AGT = _RANDOM[/*Zero width*/ 1'b0][13];
        reg_L1D_PF_TRAIN_ON_HIT = _RANDOM[/*Zero width*/ 1'b0][14];
        reg_L1D_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][15];
        reg_L2_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][16];
        reg_L1I_PF_ENABLE = _RANDOM[/*Zero width*/ 1'b0][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_L2_PF_STORE_ONLY = 1'h0;
        reg_L1D_PF_ENABLE_STRIDE = 1'h1;
