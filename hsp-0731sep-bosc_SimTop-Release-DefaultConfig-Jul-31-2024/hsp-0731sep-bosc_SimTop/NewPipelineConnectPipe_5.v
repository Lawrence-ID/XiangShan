...
module NewPipelineConnectPipe_5(
  ...
  input         io_in_bits_common_vlWen,
  input         io_in_bits_common_fpu_typeTagOut,
  input         io_in_bits_common_fpu_wflags,
  input  [1:0]  io_in_bits_common_fpu_typ,
  input  [2:0]  io_in_bits_common_fpu_rm,
  input         io_in_bits_common_preDecode_valid,
  input         io_in_bits_common_preDecode_isRVC,
  input  [1:0]  io_in_bits_common_preDecode_brType,
  input         io_in_bits_common_preDecode_isCall,
  input         io_in_bits_common_preDecode_isRet,
  input         io_in_bits_common_ftqIdx_flag,
  input  [5:0]  io_in_bits_common_ftqIdx_value,
  input  [3:0]  io_in_bits_common_ftqOffset,
  input         io_in_bits_common_predictInfo_taken,
  ...
  output        io_out_bits_common_vlWen,
  output        io_out_bits_common_fpu_typeTagOut,
  output        io_out_bits_common_fpu_wflags,
  output [1:0]  io_out_bits_common_fpu_typ,
  output [2:0]  io_out_bits_common_fpu_rm,
  output        io_out_bits_common_preDecode_valid,
  output        io_out_bits_common_preDecode_isRVC,
  output [1:0]  io_out_bits_common_preDecode_brType,
  output        io_out_bits_common_preDecode_isCall,
  output        io_out_bits_common_preDecode_isRet,
  output        io_out_bits_common_ftqIdx_flag,
  output [5:0]  io_out_bits_common_ftqIdx_value,
  output [3:0]  io_out_bits_common_ftqOffset,
  output        io_out_bits_common_predictInfo_taken,
  ...
  reg         data_common_vlWen;
  reg         data_common_fpu_typeTagOut;
  reg         data_common_fpu_wflags;
  reg  [1:0]  data_common_fpu_typ;
  reg  [2:0]  data_common_fpu_rm;
  reg         data_common_preDecode_valid;
  reg         data_common_preDecode_isRVC;
  reg  [1:0]  data_common_preDecode_brType;
  reg         data_common_preDecode_isCall;
  reg         data_common_preDecode_isRet;
  reg         data_common_ftqIdx_flag;
  reg  [5:0]  data_common_ftqIdx_value;
  reg  [3:0]  data_common_ftqOffset;
  reg         data_common_predictInfo_taken;
  ...
  always @(posedge clock) begin
    if (_data_T) begin
      ...
      data_common_vlWen <= io_in_bits_common_vlWen;
      data_common_fpu_typeTagOut <= io_in_bits_common_fpu_typeTagOut;
      data_common_fpu_wflags <= io_in_bits_common_fpu_wflags;
      data_common_fpu_typ <= io_in_bits_common_fpu_typ;
      data_common_fpu_rm <= io_in_bits_common_fpu_rm;
      data_common_preDecode_valid <= io_in_bits_common_preDecode_valid;
      data_common_preDecode_isRVC <= io_in_bits_common_preDecode_isRVC;
      data_common_preDecode_brType <= io_in_bits_common_preDecode_brType;
      data_common_preDecode_isCall <= io_in_bits_common_preDecode_isCall;
      data_common_preDecode_isRet <= io_in_bits_common_preDecode_isRet;
      ...
      data_common_predictInfo_taken <= io_in_bits_common_predictInfo_taken;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_common_fpWen = _RANDOM[4'h8][6];
        data_common_vecWen = _RANDOM[4'h8][7];
        data_common_v0Wen = _RANDOM[4'h8][8];
        data_common_vlWen = _RANDOM[4'h8][9];
        data_common_fpu_typeTagOut = _RANDOM[4'h8][12];
        data_common_fpu_wflags = _RANDOM[4'h8][14];
        data_common_fpu_typ = _RANDOM[4'h8][22:21];
        data_common_fpu_rm = _RANDOM[4'h8][28:26];
        data_common_preDecode_valid = _RANDOM[4'hA][4];
        data_common_preDecode_isRVC = _RANDOM[4'hA][5];
        data_common_preDecode_brType = _RANDOM[4'hA][7:6];
        data_common_preDecode_isCall = _RANDOM[4'hA][8];
        data_common_preDecode_isRet = _RANDOM[4'hA][9];
        data_common_ftqIdx_flag = _RANDOM[4'hA][10];
        data_common_ftqIdx_value = _RANDOM[4'hA][16:11];
        data_common_ftqOffset = _RANDOM[4'hA][20:17];
        data_common_predictInfo_taken = _RANDOM[4'hB][28];
        data_common_dataSources_0_value = {_RANDOM[4'hB][31:29], _RANDOM[4'hC][0]};
        data_common_dataSources_1_value = _RANDOM[4'hC][4:1];
        data_common_l1ExuOH_0_0 = _RANDOM[4'hC][5];
        data_common_l1ExuOH_0_2 = _RANDOM[4'hC][7];
        data_common_l1ExuOH_0_4 = _RANDOM[4'hC][9];
        data_common_l1ExuOH_0_6 = _RANDOM[4'hC][11];
        data_common_l1ExuOH_0_21 = _RANDOM[4'hC][26];
        data_common_l1ExuOH_0_22 = _RANDOM[4'hC][27];
        data_common_l1ExuOH_0_23 = _RANDOM[4'hC][28];
        data_common_l1ExuOH_1_0 = _RANDOM[4'hD][1];
        data_common_l1ExuOH_1_2 = _RANDOM[4'hD][3];
        data_common_l1ExuOH_1_4 = _RANDOM[4'hD][5];
        data_common_l1ExuOH_1_6 = _RANDOM[4'hD][7];
        data_common_l1ExuOH_1_21 = _RANDOM[4'hD][22];
        data_common_l1ExuOH_1_22 = _RANDOM[4'hD][23];
        data_common_l1ExuOH_1_23 = _RANDOM[4'hD][24];
        data_common_loadDependency_0 = _RANDOM[4'hE][4:3];
        data_common_loadDependency_1 = _RANDOM[4'hE][6:5];
        data_common_loadDependency_2 = _RANDOM[4'hE][8:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_common_vlWen = data_common_vlWen;
  assign io_out_bits_common_fpu_typeTagOut = data_common_fpu_typeTagOut;
  assign io_out_bits_common_fpu_wflags = data_common_fpu_wflags;
  assign io_out_bits_common_fpu_typ = data_common_fpu_typ;
  assign io_out_bits_common_fpu_rm = data_common_fpu_rm;
  assign io_out_bits_common_preDecode_valid = data_common_preDecode_valid;
  assign io_out_bits_common_preDecode_isRVC = data_common_preDecode_isRVC;
  assign io_out_bits_common_preDecode_brType = data_common_preDecode_brType;
  assign io_out_bits_common_preDecode_isCall = data_common_preDecode_isCall;
  assign io_out_bits_common_preDecode_isRet = data_common_preDecode_isRet;
  ...
  assign io_out_bits_common_predictInfo_taken = data_common_predictInfo_taken;
