...
module VBestOffsetPrefetch(
  ...
  wire [38:0] _scoreTable_io_test_req_bits_addr;
  ...
  wire [38:0] _delayQueue_io_out_bits;
  wire        _s0_fire_T = _scoreTable_io_req_ready & io_train_valid;
  reg         s1_req_valid;
  reg         s1_needT;
  reg  [6:0]  s1_source;
  reg  [38:0] s1_newFullAddr;
  reg  [32:0] s1_reqVaddr;
  always @(posedge clock or posedge reset) begin
    if (reset)
      s1_req_valid <= 1'h0;
    else
      s1_req_valid <= _s0_fire_T;
  ...
  always @(posedge clock) begin
    if (_s0_fire_T) begin
      ...
      s1_newFullAddr <=
        39'({io_train_bits_vaddr, 6'h0}
            + {{23{_scoreTable_io_prefetchOffset[9]}},
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_newFullAddr = {_RANDOM[2'h0][31:9], _RANDOM[2'h1][15:0]};
        s1_reqVaddr = {_RANDOM[2'h1][31:16], _RANDOM[2'h2][16:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_req_valid = 1'h0;
    end // initial
