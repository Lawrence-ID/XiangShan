  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_imm = _RANDOM[6'h3][17:6];
        entryReg_payload_fuOpType = {_RANDOM[6'h9][31:30], _RANDOM[6'hA][6:0]};
        entryReg_payload_rfWen = _RANDOM[6'hA][7];
        entryReg_payload_selImm = _RANDOM[6'hA][20:17];
        entryReg_payload_pdest = _RANDOM[6'h15][26:19];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h29][5];
        entryReg_payload_sqIdx_value = _RANDOM[6'h29][11:6];
        enqDelayValidReg_last_REG = _RANDOM[6'h29][19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
