...
module ExeUnit_7(
  ...
  output [40:0] io_out_bits_redirect_bits_cfiUpdate_pc,
  output [40:0] io_out_bits_redirect_bits_cfiUpdate_target,
  ...
  input  [38:0] io_csrio_exception_bits_pc,
  ...
  wire [38:0] _csr_io_csrio_exception_delay_io_out_bits_pc;
  ...
  wire [40:0] _csr_io_csrio_exception_delay_io_out_bits_gpaddr;
  ...
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_0;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_1;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_2;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_3;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_0;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_1;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_2;
  wire        _csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_3;
  ...
  wire [31:0] _in1ToN_io_out_0_bits_imm;
  ...
  wire [31:0] _in1ToN_io_out_1_bits_imm;
  ...
  wire [38:0] _in1ToN_io_out_1_bits_pc;
  ...
  wire        _csr_io_out_bits_ctrl_preDecode_valid;
  wire        _csr_io_out_bits_ctrl_preDecode_isRVC;
  wire [1:0]  _csr_io_out_bits_ctrl_preDecode_brType;
  wire        _csr_io_out_bits_ctrl_preDecode_isCall;
  wire        _csr_io_out_bits_ctrl_preDecode_isRet;
  ...
  wire        _GEN = io_out_ready & (|_io_out_valid_T);
  wire [8:0]  _flushItself_T_6 = {io_flush_bits_robIdx_flag, io_flush_bits_robIdx_value};
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      uncer_en_reg_2 <= _robIdx_T | ~_GEN & uncer_en_reg_2;
      busy <=
        ~(_robIdx_T & io_flush_valid
          & (io_flush_bits_level
             & {io_in_bits_robIdx_flag, io_in_bits_robIdx_value} == _flushItself_T_6
             | io_in_bits_robIdx_flag ^ io_flush_bits_robIdx_flag
             ^ io_in_bits_robIdx_value > io_flush_bits_robIdx_value) | busy
          & io_flush_valid
          & (io_flush_bits_level & {robIdx_flag, robIdx_value} == _flushItself_T_6
             | robIdx_flag ^ io_flush_bits_robIdx_flag
             ^ robIdx_value > io_flush_bits_robIdx_value) | _GEN) & (_robIdx_T | busy);
    end
  ...
  CSR csr (
    ...
    .io_in_bits_data_src_0
      (_in1ToN_io_out_0_bits_src_0),
    .io_in_bits_data_imm
      ({32'h0, _in1ToN_io_out_0_bits_imm}),
    .io_out_valid
      (_csr_io_out_valid),
    ...
    .io_out_bits_ctrl_preDecode_valid
      (_csr_io_out_bits_ctrl_preDecode_valid),
    .io_out_bits_ctrl_preDecode_isRVC
      (_csr_io_out_bits_ctrl_preDecode_isRVC),
    .io_out_bits_ctrl_preDecode_brType
      (_csr_io_out_bits_ctrl_preDecode_brType),
    .io_out_bits_ctrl_preDecode_isCall
      (_csr_io_out_bits_ctrl_preDecode_isCall),
    .io_out_bits_ctrl_preDecode_isRet
      (_csr_io_out_bits_ctrl_preDecode_isRet),
    ...
    .io_csrio_exception_bits_trigger_frontendCanFire_0
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_0),
    .io_csrio_exception_bits_trigger_frontendCanFire_1
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_1),
    .io_csrio_exception_bits_trigger_frontendCanFire_2
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_2),
    .io_csrio_exception_bits_trigger_frontendCanFire_3
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_3),
    .io_csrio_exception_bits_trigger_backendCanFire_0
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_0),
    .io_csrio_exception_bits_trigger_backendCanFire_1
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_1),
    .io_csrio_exception_bits_trigger_backendCanFire_2
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_2),
    .io_csrio_exception_bits_trigger_backendCanFire_3
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_3),
    .io_csrio_trapTarget
      (io_csrio_trapTarget),
    .io_csrio_interrupt
      (io_csrio_interrupt),
  ...
  Fence Fence (
    ...
    .io_in_bits_data_imm              ({32'h0, _in1ToN_io_out_1_bits_imm}),
    .io_in_bits_data_pc               (_in1ToN_io_out_1_bits_pc),
  ...
  Dispatcher_7 in1ToN (
    ...
    .io_out_0_bits_preDecode_valid  (_in1ToN_io_out_0_bits_preDecode_valid),
    .io_out_0_bits_preDecode_isRVC  (_in1ToN_io_out_0_bits_preDecode_isRVC),
    .io_out_0_bits_preDecode_brType (_in1ToN_io_out_0_bits_preDecode_brType),
    .io_out_0_bits_preDecode_isCall (_in1ToN_io_out_0_bits_preDecode_isCall),
    .io_out_0_bits_preDecode_isRet  (_in1ToN_io_out_0_bits_preDecode_isRet),
  ...
  DelayN_232 csr_io_csrio_exception_delay (
    .clock                                 (clock),
    ...
    .io_in_bits_trigger_frontendCanFire_0
      (io_csrio_exception_bits_trigger_frontendCanFire_0),
    .io_in_bits_trigger_frontendCanFire_1
      (io_csrio_exception_bits_trigger_frontendCanFire_1),
    .io_in_bits_trigger_frontendCanFire_2
      (io_csrio_exception_bits_trigger_frontendCanFire_2),
    .io_in_bits_trigger_frontendCanFire_3
      (io_csrio_exception_bits_trigger_frontendCanFire_3),
    .io_in_bits_trigger_backendCanFire_0
      (io_csrio_exception_bits_trigger_backendCanFire_0),
    .io_in_bits_trigger_backendCanFire_1
      (io_csrio_exception_bits_trigger_backendCanFire_1),
    .io_in_bits_trigger_backendCanFire_2
      (io_csrio_exception_bits_trigger_backendCanFire_2),
    .io_in_bits_trigger_backendCanFire_3
      (io_csrio_exception_bits_trigger_backendCanFire_3),
    ...
    .io_out_bits_isHls
      (_csr_io_csrio_exception_delay_io_out_bits_isHls),
    .io_out_bits_trigger_frontendCanFire_0
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_0),
    .io_out_bits_trigger_frontendCanFire_1
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_1),
    .io_out_bits_trigger_frontendCanFire_2
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_2),
    .io_out_bits_trigger_frontendCanFire_3
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_frontendCanFire_3),
    .io_out_bits_trigger_backendCanFire_0
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_0),
    .io_out_bits_trigger_backendCanFire_1
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_1),
    .io_out_bits_trigger_backendCanFire_2
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_2),
    .io_out_bits_trigger_backendCanFire_3
      (_csr_io_csrio_exception_delay_io_out_bits_trigger_backendCanFire_3)
  );
  ...
  assign io_out_bits_predecodeInfo_valid =
    _csr_io_out_valid & _csr_io_out_bits_ctrl_preDecode_valid;
  assign io_out_bits_predecodeInfo_isRVC =
    _csr_io_out_valid & _csr_io_out_bits_ctrl_preDecode_isRVC;
  assign io_out_bits_predecodeInfo_brType =
    _csr_io_out_valid ? _csr_io_out_bits_ctrl_preDecode_brType : 2'h0;
  assign io_out_bits_predecodeInfo_isCall =
    _csr_io_out_valid & _csr_io_out_bits_ctrl_preDecode_isCall;
  assign io_out_bits_predecodeInfo_isRet =
    _csr_io_out_valid & _csr_io_out_bits_ctrl_preDecode_isRet;
endmodule
