...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_56(
  input          clock,
  input          reset,
  output         io_in_ready,
  input          io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_exceptionVec_4 = _RANDOM[6'h2][24];
        data_uop_exceptionVec_5 = _RANDOM[6'h2][25];
        data_uop_exceptionVec_6 = _RANDOM[6'h2][26];
        data_uop_exceptionVec_7 = _RANDOM[6'h2][27];
        data_uop_exceptionVec_13 = _RANDOM[6'h3][1];
        data_uop_exceptionVec_15 = _RANDOM[6'h3][3];
        data_uop_exceptionVec_21 = _RANDOM[6'h3][9];
        data_uop_exceptionVec_23 = _RANDOM[6'h3][11];
        ...
        data_uop_vpu_vma = _RANDOM[6'h8][24];
        data_uop_vpu_vta = _RANDOM[6'h8][25];
        data_uop_vpu_vsew = _RANDOM[6'h8][27:26];
        data_uop_vpu_vm = _RANDOM[6'h9][7];
        ...
        data_uop_vpu_vmask =
          {_RANDOM[6'hA][31:4],
           ...
           _RANDOM[6'hD],
           _RANDOM[6'hE][3:0]};
        data_uop_vpu_vl = _RANDOM[6'hE][11:4];
        data_uop_vpu_veew = _RANDOM[6'hE][16:15];
        data_uop_pdest = _RANDOM[6'h12][9:2];
        data_uop_robIdx_flag = _RANDOM[6'h12][10];
        data_uop_robIdx_value = _RANDOM[6'h12][18:11];
        data_uop_replayInst = _RANDOM[6'h25][28];
        data_data =
          {_RANDOM[6'h26][31:2],
           _RANDOM[6'h27],
           _RANDOM[6'h28],
           _RANDOM[6'h29],
           _RANDOM[6'h2A][1:0]};
        data_vdIdxInField = _RANDOM[6'h2E][7:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
