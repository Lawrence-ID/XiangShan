...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_43(
  input          clock,
  input          reset,
  input          io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pdest = {_RANDOM[5'h16][31:27], _RANDOM[5'h17][2:0]};
        data_rfWen = _RANDOM[5'h17][3];
        data_fpWen = _RANDOM[5'h17][4];
        data_vecWen = _RANDOM[5'h17][5];
        data_v0Wen = _RANDOM[5'h17][6];
        data_vlWen = _RANDOM[5'h17][7];
        data_fpu_wflags = _RANDOM[5'h17][12];
        data_vpu_vma = _RANDOM[5'h17][28];
        data_vpu_vta = _RANDOM[5'h17][29];
        data_vpu_vsew = _RANDOM[5'h17][31:30];
        data_vpu_vlmul = _RANDOM[5'h18][2:0];
        data_vpu_vm = _RANDOM[5'h18][11];
        data_vpu_vstart = _RANDOM[5'h18][19:12];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h18][27];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h18][28];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h18][29];
        data_vpu_vuopIdx = _RANDOM[5'h19][6:0];
        data_vpu_lastUop = _RANDOM[5'h19][7];
        data_vpu_isNarrow = _RANDOM[5'h1D][23];
        data_vpu_isDstMask = _RANDOM[5'h1D][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
