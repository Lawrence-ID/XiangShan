  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_flag = _RANDOM[6'h6][14];
        bits_1_robIdx_value = _RANDOM[6'h6][22:15];
        bits_1_pdest = {_RANDOM[6'h6][31:28], _RANDOM[6'h7][3:0]};
        bits_1_rfWen = _RANDOM[6'h7][4];
        bits_1_loadDependency_0 = _RANDOM[6'h9][12:11];
        bits_1_loadDependency_1 = _RANDOM[6'h9][14:13];
        bits_1_loadDependency_2 = _RANDOM[6'h9][16:15];
        bits_2_fuType = {_RANDOM[6'h1B][31:18], _RANDOM[6'h1C][20:0]};
        bits_2_robIdx_flag = _RANDOM[6'h21][30];
        bits_2_robIdx_value = {_RANDOM[6'h21][31], _RANDOM[6'h22][6:0]};
        bits_2_pdest = _RANDOM[6'h22][19:12];
        bits_2_rfWen = _RANDOM[6'h22][20];
        bits_2_loadDependency_0 = _RANDOM[6'h24][28:27];
        bits_2_loadDependency_1 = _RANDOM[6'h24][30:29];
        bits_2_loadDependency_2 = {_RANDOM[6'h24][31], _RANDOM[6'h25][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
