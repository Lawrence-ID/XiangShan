...
module RRArbiter(
  ...
  output [23:0] io_out_bits_hptw_resp_entry_ppn,
  ...
  assign io_chosen_choice =
    ctrl_validMask_1
      ...
      : ctrl_validMask_2
          ...
          : ctrl_validMask_3
              ? 3'h3
              : ctrl_validMask_4 ? 3'h4 : ctrl_validMask_5 ? 3'h5 : _GEN_6;
  always @(posedge clock) begin
    if (io_out_ready & io_out_valid_0) begin
      if (ctrl_validMask_1)
        ...
        ctrl_validMask_grantMask_lastGrant <= _GEN_6;
    end
  end // always @(posedge)
  ...
  assign io_out_bits_hptw_resp_entry_ppn = _GEN_4[io_chosen_choice];
  assign io_out_bits_hptw_resp_entry_level = _GEN_5[io_chosen_choice];
