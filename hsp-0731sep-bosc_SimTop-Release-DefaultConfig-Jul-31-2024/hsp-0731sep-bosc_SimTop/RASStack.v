...
module RASStack(
  ...
  wire [5:0]        _GEN_22 = {BOS_flag, BOS_value};
  wire              _GEN_23 = io_spec_push_valid & 5'(TOSW_value + 5'h1) == BOS_value;
  wire              _GEN_24 = 5'(io_s3_meta_TOSW_value + 5'h1) == BOS_value;
  wire [2:0]        _GEN_25 = _GEN_5[nsp];
  wire [2:0]        _commit_stack_ctr_T = 3'(_GEN_25 - 3'h1);
  wire              _GEN_26 = io_commit_meta_ssp == 4'h0;
  wire              _GEN_27 = io_commit_pop_valid & (|_GEN_25) & _GEN_26;
  wire              _GEN_28 = io_commit_meta_ssp == 4'h1;
  wire              _GEN_29 = io_commit_pop_valid & (|_GEN_25) & _GEN_28;
  wire              _GEN_30 = io_commit_meta_ssp == 4'h2;
  wire              _GEN_31 = io_commit_pop_valid & (|_GEN_25) & _GEN_30;
  wire              _GEN_32 = io_commit_meta_ssp == 4'h3;
  wire              _GEN_33 = io_commit_pop_valid & (|_GEN_25) & _GEN_32;
  wire              _GEN_34 = io_commit_meta_ssp == 4'h4;
  wire              _GEN_35 = io_commit_pop_valid & (|_GEN_25) & _GEN_34;
  wire              _GEN_36 = io_commit_meta_ssp == 4'h5;
  wire              _GEN_37 = io_commit_pop_valid & (|_GEN_25) & _GEN_36;
  wire              _GEN_38 = io_commit_meta_ssp == 4'h6;
  wire              _GEN_39 = io_commit_pop_valid & (|_GEN_25) & _GEN_38;
  wire              _GEN_40 = io_commit_meta_ssp == 4'h7;
  wire              _GEN_41 = io_commit_pop_valid & (|_GEN_25) & _GEN_40;
  wire              _GEN_42 = io_commit_meta_ssp == 4'h8;
  wire              _GEN_43 = io_commit_pop_valid & (|_GEN_25) & _GEN_42;
  wire              _GEN_44 = io_commit_meta_ssp == 4'h9;
  wire              _GEN_45 = io_commit_pop_valid & (|_GEN_25) & _GEN_44;
  wire              _GEN_46 = io_commit_meta_ssp == 4'hA;
  wire              _GEN_47 = io_commit_pop_valid & (|_GEN_25) & _GEN_46;
  wire              _GEN_48 = io_commit_meta_ssp == 4'hB;
  wire              _GEN_49 = io_commit_pop_valid & (|_GEN_25) & _GEN_48;
  wire              _GEN_50 = io_commit_meta_ssp == 4'hC;
  wire              _GEN_51 = io_commit_pop_valid & (|_GEN_25) & _GEN_50;
  wire              _GEN_52 = io_commit_meta_ssp == 4'hD;
  wire              _GEN_53 = io_commit_pop_valid & (|_GEN_25) & _GEN_52;
  wire              _GEN_54 = io_commit_meta_ssp == 4'hE;
  wire              _GEN_55 = io_commit_pop_valid & (|_GEN_25) & _GEN_54;
  wire              _GEN_56 = io_commit_pop_valid & (|_GEN_25) & (&io_commit_meta_ssp);
  wire              _GEN_57 =
    _GEN_25 != 3'h7 & _GEN_3[nsp] == _GEN_0[io_commit_meta_TOSW_value];
  wire [3:0]        _nsp_T_2 = 4'(io_commit_meta_ssp + 4'h1);
  wire              _GEN_58 = _nsp_T_2 == 4'h0;
  wire              _GEN_59 = _nsp_T_2 == 4'h1;
  wire              _GEN_60 = _nsp_T_2 == 4'h2;
  wire              _GEN_61 = _nsp_T_2 == 4'h3;
  wire              _GEN_62 = _nsp_T_2 == 4'h4;
  wire              _GEN_63 = _nsp_T_2 == 4'h5;
  wire              _GEN_64 = _nsp_T_2 == 4'h6;
  wire              _GEN_65 = _nsp_T_2 == 4'h7;
  wire              _GEN_66 = _nsp_T_2 == 4'h8;
  wire              _GEN_67 = _nsp_T_2 == 4'h9;
  wire              _GEN_68 = _nsp_T_2 == 4'hA;
  wire              _GEN_69 = _nsp_T_2 == 4'hB;
  wire              _GEN_70 = _nsp_T_2 == 4'hC;
  wire              _GEN_71 = _nsp_T_2 == 4'hD;
  wire              _GEN_72 = _nsp_T_2 == 4'hE;
  wire              _GEN_73 =
  ...
  wire [2:0]        _commit_stack_ctr_T_2 = 3'(_GEN_25 + 3'h1);
  ...
  wire              _GEN_76 = _s3_missPushEntry_ctr_T & io_s3_meta_sctr != 3'h7;
  wire              inflightValid_4 =
    _GEN_19 & (topNos_flag ^ TOSW_flag ^ topNos_value < TOSW_value);
  wire [5:0]        _BOS_new_ptr_T_11 = 6'(_GEN_22 + 6'h1);
  wire [5:0]        _BOS_new_ptr_T_6 = 6'(_GEN_22 + 6'h1);
  wire [5:0]        _BOS_new_ptr_T_1 = 6'(_GEN_22 + 6'h1);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (~io_commit_push_valid | _GEN_57 | ~_GEN_58) begin
      end
      else
      ...
      if (io_redirect_valid) begin
        ...
        TOSR_flag <=
          io_s3_missed_push
            ...
            : _GEN_75 ? io_s3_meta_NOS_flag : io_s3_meta_TOSR_flag;
        TOSR_value <=
          io_s3_missed_push
            ? io_s3_meta_TOSW_value
            : _GEN_75 ? io_s3_meta_NOS_value : io_s3_meta_TOSR_value;
      ...
      else if (io_s3_cancel & io_s3_missed_push & _GEN_24) begin
      ...
      spec_overflowed <=
        ...
        & (io_s3_cancel & io_s3_missed_push
             ? _GEN_24 | _GEN_23 | spec_overflowed
             : _GEN_23 | spec_overflowed);
