...
module LinkMonitor(
  ...
  input  [6:0]   io_in_tx_req_bits_tgtID,
  input  [7:0]   io_in_tx_req_bits_txnID,
  input  [6:0]   io_in_tx_req_bits_returnNID,
  input          io_in_tx_req_bits_stashNIDValid,
  input  [7:0]   io_in_tx_req_bits_returnTxnID,
  input  [5:0]   io_in_tx_req_bits_opcode,
  ...
  input  [4:0]   io_in_tx_req_bits_lpID,
  ...
  input  [6:0]   io_in_tx_rsp_bits_tgtID,
  input  [7:0]   io_in_tx_rsp_bits_txnID,
  input  [3:0]   io_in_tx_rsp_bits_opcode,
  input  [1:0]   io_in_tx_rsp_bits_respErr,
  input  [2:0]   io_in_tx_rsp_bits_resp,
  input  [2:0]   io_in_tx_rsp_bits_fwdState,
  input  [7:0]   io_in_tx_rsp_bits_dbID,
  ...
  input  [6:0]   io_in_tx_dat_bits_tgtID,
  input  [7:0]   io_in_tx_dat_bits_txnID,
  input  [6:0]   io_in_tx_dat_bits_homeNID,
  input  [2:0]   io_in_tx_dat_bits_opcode,
  input  [1:0]   io_in_tx_dat_bits_respErr,
  input  [2:0]   io_in_tx_dat_bits_resp,
  input  [2:0]   io_in_tx_dat_bits_fwdState,
  input  [7:0]   io_in_tx_dat_bits_dbID,
  ...
  output [6:0]   io_in_rx_rsp_bits_tgtID,
  output [6:0]   io_in_rx_rsp_bits_srcID,
  output [7:0]   io_in_rx_rsp_bits_txnID,
  output [3:0]   io_in_rx_rsp_bits_opcode,
  output [1:0]   io_in_rx_rsp_bits_respErr,
  output [2:0]   io_in_rx_rsp_bits_resp,
  output [2:0]   io_in_rx_rsp_bits_fwdState,
  output [7:0]   io_in_rx_rsp_bits_dbID,
  ...
  output [6:0]   io_in_rx_dat_bits_tgtID,
  output [6:0]   io_in_rx_dat_bits_srcID,
  output [7:0]   io_in_rx_dat_bits_txnID,
  output [6:0]   io_in_rx_dat_bits_homeNID,
  output [2:0]   io_in_rx_dat_bits_opcode,
  output [1:0]   io_in_rx_dat_bits_respErr,
  output [2:0]   io_in_rx_dat_bits_resp,
  output [2:0]   io_in_rx_dat_bits_fwdState,
  output [7:0]   io_in_rx_dat_bits_dbID,
  ...
  output [6:0]   io_in_rx_snp_bits_srcID,
  output [7:0]   io_in_rx_snp_bits_txnID,
  output [6:0]   io_in_rx_snp_bits_fwdNID,
  output [7:0]   io_in_rx_snp_bits_fwdTxnID,
  ...
  wire [1:0]      _txState_T = {~reset, io_out_tx_linkactiveack};
  wire [1:0]      _rxState_T = {io_out_rx_linkactivereq, hetVecWire_1_linkactiveack};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_rx_linkactiveack_REG = _RANDOM[/*Zero width*/ 1'b0][4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        txState = 2'h0;
        rxState = 2'h0;
  ...
  Decoupled2LCredit Decoupled2LCredit_txreq (
    ...
    .io_in_bits_lpID              (io_in_tx_req_bits_lpID),
  ...
  Decoupled2LCredit_2 Decoupled2LCredit_txdat (
    ...
    .io_in_bits_fwdState (io_in_tx_dat_bits_fwdState),
  ...
  LCredit2Decoupled LCredit2Decoupled_rxsnp (
    .clock                   (clock),
    .reset                   (reset),
    .io_in_flitpend          (io_out_rx_snp_flitpend),
  ...
  LCredit2Decoupled_1 LCredit2Decoupled_rxrsp (
    .clock                (clock),
    .reset                (reset),
    .io_in_flitpend       (io_out_rx_rsp_flitpend),
  ...
  LCredit2Decoupled_2 LCredit2Decoupled_rxdat (
    .clock                (clock),
    .reset                (reset),
    .io_in_flitpend       (io_out_rx_dat_flitpend),
    ...
    .io_out_bits_fwdState (io_in_rx_dat_bits_fwdState),
  ...
  assign io_out_tx_req_flitpend = 1'h1;
  assign io_out_tx_rsp_flitpend = 1'h1;
  assign io_out_tx_dat_flitpend = 1'h1;
