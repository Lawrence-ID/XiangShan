...
module AXI4RAM(
  ...
  wire [35:0]  nodeIn_aw_bits_addr = auto_in_aw_bits_addr;
  ...
  wire [35:0]  nodeIn_ar_bits_addr = auto_in_ar_bits_addr;
  ...
  wire [33:0]  _wIdx_T =
    34'((_nodeIn_b_bits_user_T ? nodeIn_aw_bits_addr[33:0] : waddr_hold_data[33:0])
        - 34'h80000000);
  wire [33:0]  _rIdx_T =
    34'((_rdata_T_106 ? nodeIn_ar_bits_addr[33:0] : raddr_hold_data[33:0])
        - 34'h80000000);
  wire [28:0]  _rIdx_T_4 = 29'(_rIdx_T[33:5] + {21'h0, readBeatCnt});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        raddr_hold_data = {_RANDOM[4'h0][31:18], _RANDOM[4'h1][21:0]};
        writeBeatCnt = _RANDOM[4'h1][29:22];
        waddr_hold_data = {_RANDOM[4'h1][31:30], _RANDOM[4'h2], _RANDOM[4'h3][1:0]};
        nodeIn_b_bits_id_r = _RANDOM[4'h3][15:2];
        nodeIn_r_bits_id_r = _RANDOM[4'h3][29:16];
        rdata_REG = _RANDOM[4'h3][30];
        rdata_REG_1 = _RANDOM[4'h3][31];
        rdata_r_0 = {_RANDOM[4'h4], _RANDOM[4'h5]};
        rdata_r_1 = {_RANDOM[4'h6], _RANDOM[4'h7]};
        rdata_r_2 = {_RANDOM[4'h8], _RANDOM[4'h9]};
        rdata_r_3 = {_RANDOM[4'hA], _RANDOM[4'hB]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  DifftestMem1P rdata_mem (
    ...
    .read_index
      ({35'h0, _rdata_T_107 & ~nodeIn_r_bits_last ? 29'(_rIdx_T_4 + 29'h1) : _rIdx_T_4}),
    ...
    .write_valid  (wen),
    .write_index  ({35'h0, 29'(_wIdx_T[33:5] + {21'h0, writeBeatCnt})}),
