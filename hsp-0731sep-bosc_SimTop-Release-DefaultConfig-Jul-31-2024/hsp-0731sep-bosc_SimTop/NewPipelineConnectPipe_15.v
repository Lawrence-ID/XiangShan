  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_immType = _RANDOM[6'h2][10:7];
        data_common_fuType = {_RANDOM[6'h2][31:11], _RANDOM[6'h3][13:0]};
        data_common_fuOpType = _RANDOM[6'h3][22:14];
        data_common_imm = {_RANDOM[6'h17][31:23], _RANDOM[6'h18][22:0]};
        data_common_robIdx_flag = _RANDOM[6'h18][23];
        data_common_robIdx_value = _RANDOM[6'h18][31:24];
        data_common_pdest = _RANDOM[6'h19][12:5];
        data_common_rfWen = _RANDOM[6'h19][13];
        data_common_fpWen = _RANDOM[6'h19][14];
        data_common_vecWen = _RANDOM[6'h19][15];
        data_common_v0Wen = _RANDOM[6'h19][16];
        data_common_vlWen = _RANDOM[6'h19][17];
        data_common_fpu_wflags = _RANDOM[6'h19][22];
        data_common_vpu_vma = _RANDOM[6'h1A][6];
        data_common_vpu_vta = _RANDOM[6'h1A][7];
        data_common_vpu_vsew = _RANDOM[6'h1A][9:8];
        data_common_vpu_vlmul = _RANDOM[6'h1A][12:10];
        data_common_vpu_vm = _RANDOM[6'h1A][21];
        data_common_vpu_vstart = _RANDOM[6'h1A][29:22];
        data_common_vpu_fpu_isFoldTo1_2 = _RANDOM[6'h1B][5];
        data_common_vpu_fpu_isFoldTo1_4 = _RANDOM[6'h1B][6];
        data_common_vpu_fpu_isFoldTo1_8 = _RANDOM[6'h1B][7];
        data_common_vpu_vuopIdx = _RANDOM[6'h1B][16:10];
        data_common_vpu_lastUop = _RANDOM[6'h1B][17];
        data_common_vpu_isNarrow = _RANDOM[6'h20][1];
        data_common_vpu_isDstMask = _RANDOM[6'h20][2];
        data_common_dataSources_0_value = _RANDOM[6'h20][10:7];
        data_common_dataSources_1_value = _RANDOM[6'h20][14:11];
        data_common_dataSources_2_value = _RANDOM[6'h20][18:15];
        data_common_dataSources_3_value = _RANDOM[6'h20][22:19];
        data_common_dataSources_4_value = _RANDOM[6'h20][26:23];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
