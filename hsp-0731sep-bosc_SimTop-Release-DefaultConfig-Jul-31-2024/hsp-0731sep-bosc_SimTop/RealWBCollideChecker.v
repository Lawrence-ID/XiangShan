...
module RealWBCollideChecker(
  ...
  input         io_in_15_bits_rfWen,
  input         io_in_15_bits_fpWen,
  input  [7:0]  io_in_15_bits_pdest,
  ...
  RealWBArbiter_1 arbiters_1 (
    ...
    .io_in_2_valid      (io_in_12_valid),
    .io_in_2_bits_rfWen (io_in_12_bits_rfWen),
    .io_in_2_bits_pdest (io_in_12_bits_pdest),
    .io_in_2_bits_data  (io_in_12_bits_data),
  ...
  RealWBArbiter_2 arbiters_3 (
    ...
    .io_in_1_ready      (/* unused */),
    .io_in_1_valid      (io_in_11_valid),
    .io_in_1_bits_rfWen (io_in_11_bits_rfWen),
    .io_in_1_bits_fpWen (io_in_11_bits_fpWen),
    .io_in_1_bits_pdest (io_in_11_bits_pdest),
    .io_in_1_bits_data  (io_in_11_bits_data),
  ...
  RealWBArbiter_5 arbiters_7 (
    .io_in_0_valid      (io_in_15_valid),
    .io_in_0_bits_rfWen (io_in_15_bits_rfWen),
    .io_in_0_bits_fpWen (io_in_15_bits_fpWen),
    .io_in_0_bits_pdest (io_in_15_bits_pdest),
    .io_in_0_bits_data  (io_in_15_bits_data),
