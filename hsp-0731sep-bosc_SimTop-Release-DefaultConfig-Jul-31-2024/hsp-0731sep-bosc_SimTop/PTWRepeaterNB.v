...
module PTWRepeaterNB(
  ...
  output [25:0] io_tlb_resp_bits_s1_entry_tag,
  ...
  output [25:0] io_tlb_resp_bits_s1_entry_ppn,
  ...
  output [28:0] io_tlb_resp_bits_s2_entry_tag,
  output [13:0] io_tlb_resp_bits_s2_entry_vmid,
  output [23:0] io_tlb_resp_bits_s2_entry_ppn,
  ...
  reg         resp_s1_pf;
  reg         resp_s1_af;
  reg  [28:0] resp_s2_entry_tag;
  reg  [13:0] resp_s2_entry_vmid;
  reg  [23:0] resp_s2_entry_ppn;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_vpn = _RANDOM[4'h0][28:0];
        req_s2xlate = _RANDOM[4'h0][30:29];
        sent = _RANDOM[4'h0][31];
        resp_s2xlate = _RANDOM[4'h1][1:0];
        resp_s1_entry_tag = _RANDOM[4'h1][27:2];
        resp_s1_entry_asid = {_RANDOM[4'h1][31:28], _RANDOM[4'h2][11:0]};
        resp_s1_entry_vmid = _RANDOM[4'h2][25:12];
        resp_s1_entry_perm_d = _RANDOM[4'h2][26];
        resp_s1_entry_perm_a = _RANDOM[4'h2][27];
        resp_s1_entry_perm_g = _RANDOM[4'h2][28];
        resp_s1_entry_perm_u = _RANDOM[4'h2][29];
        resp_s1_entry_perm_x = _RANDOM[4'h2][30];
        resp_s1_entry_perm_w = _RANDOM[4'h2][31];
        resp_s1_entry_perm_r = _RANDOM[4'h3][0];
        resp_s1_entry_level = _RANDOM[4'h3][2:1];
        resp_s1_entry_ppn = _RANDOM[4'h3][30:5];
        resp_s1_addr_low = {_RANDOM[4'h3][31], _RANDOM[4'h4][1:0]};
        resp_s1_ppn_low_0 = _RANDOM[4'h4][4:2];
        resp_s1_ppn_low_1 = _RANDOM[4'h4][7:5];
        resp_s1_ppn_low_2 = _RANDOM[4'h4][10:8];
        resp_s1_ppn_low_3 = _RANDOM[4'h4][13:11];
        resp_s1_ppn_low_4 = _RANDOM[4'h4][16:14];
        resp_s1_ppn_low_5 = _RANDOM[4'h4][19:17];
        resp_s1_ppn_low_6 = _RANDOM[4'h4][22:20];
        resp_s1_ppn_low_7 = _RANDOM[4'h4][25:23];
        resp_s1_valididx_0 = _RANDOM[4'h4][26];
        resp_s1_valididx_1 = _RANDOM[4'h4][27];
        resp_s1_valididx_2 = _RANDOM[4'h4][28];
        resp_s1_valididx_3 = _RANDOM[4'h4][29];
        resp_s1_valididx_4 = _RANDOM[4'h4][30];
        resp_s1_valididx_5 = _RANDOM[4'h4][31];
        resp_s1_valididx_6 = _RANDOM[4'h5][0];
        resp_s1_valididx_7 = _RANDOM[4'h5][1];
        resp_s1_pteidx_0 = _RANDOM[4'h5][2];
        resp_s1_pteidx_1 = _RANDOM[4'h5][3];
        resp_s1_pteidx_2 = _RANDOM[4'h5][4];
        resp_s1_pteidx_3 = _RANDOM[4'h5][5];
        resp_s1_pteidx_4 = _RANDOM[4'h5][6];
        resp_s1_pteidx_5 = _RANDOM[4'h5][7];
        resp_s1_pteidx_6 = _RANDOM[4'h5][8];
        resp_s1_pteidx_7 = _RANDOM[4'h5][9];
        resp_s1_pf = _RANDOM[4'h5][10];
        resp_s1_af = _RANDOM[4'h5][11];
        resp_s2_entry_tag = {_RANDOM[4'h5][31:12], _RANDOM[4'h6][8:0]};
        resp_s2_entry_vmid = {_RANDOM[4'h6][31:25], _RANDOM[4'h7][6:0]};
        resp_s2_entry_ppn = _RANDOM[4'h7][30:7];
        resp_s2_entry_perm_d = _RANDOM[4'h7][31];
        resp_s2_entry_perm_a = _RANDOM[4'h8][0];
        resp_s2_entry_perm_g = _RANDOM[4'h8][1];
        resp_s2_entry_perm_u = _RANDOM[4'h8][2];
        resp_s2_entry_perm_x = _RANDOM[4'h8][3];
        resp_s2_entry_perm_w = _RANDOM[4'h8][4];
        resp_s2_entry_perm_r = _RANDOM[4'h8][5];
        resp_s2_entry_level = _RANDOM[4'h8][7:6];
        resp_s2_gpf = _RANDOM[4'h8][10];
        resp_s2_gaf = _RANDOM[4'h8][11];
        recv = _RANDOM[4'h8][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        sent = 1'h0;
        recv = 1'h0;
