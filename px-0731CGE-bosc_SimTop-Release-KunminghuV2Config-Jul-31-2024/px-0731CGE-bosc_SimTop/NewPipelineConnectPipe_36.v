...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_36(
  input         clock,
  input         reset,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_flag = _RANDOM[4'h8][13];
        data_robIdx_value = _RANDOM[4'h8][21:14];
        data_pdest = {_RANDOM[4'h8][31:27], _RANDOM[4'h9][2:0]};
        data_rfWen = _RANDOM[4'h9][3];
        data_fpWen = _RANDOM[4'h9][4];
        data_vecWen = _RANDOM[4'h9][5];
        data_v0Wen = _RANDOM[4'h9][6];
        data_fpu_wflags = _RANDOM[4'h9][11];
        data_fpu_rm = _RANDOM[4'h9][25:23];
        data_vpu_vsew = _RANDOM[4'h9][30:29];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
