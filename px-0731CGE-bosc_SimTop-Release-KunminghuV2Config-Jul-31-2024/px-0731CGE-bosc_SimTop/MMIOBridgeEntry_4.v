...
module MMIOBridgeEntry_4(
  ...
  always @(posedge clock) begin
    ...
    if (_GEN) begin
      ...
      corrupt <= corrupt | io_chi_rx_dat_bits_respErr == 2'h2;
    end
    else
    ...
    if (_GEN_2)
      denied <= denied | (&io_chi_rx_rsp_bits_respErr);
    else if (_GEN)
  ...
  assign io_chi_tx_req_bits_txnID = {5'h0, io_id};
  assign io_chi_tx_req_bits_opcode =
    {3'h0, req_opcode == 3'h4, 2'h0} | (req_opcode == 3'h0 ? 6'h1D : 6'h0)
