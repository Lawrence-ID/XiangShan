...
module VldMergeUnit(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wbReg_bits_vls_vpu_vma = _RANDOM[4'h5][14];
        wbReg_bits_vls_vpu_vta = _RANDOM[4'h5][15];
        wbReg_bits_vls_vpu_vsew = _RANDOM[4'h5][17:16];
        wbReg_bits_vls_vpu_vm = _RANDOM[4'h5][29];
        wbReg_bits_vls_vpu_vstart = {_RANDOM[4'h5][31:30], _RANDOM[4'h6][5:0]};
        wbReg_bits_vls_vpu_vmask =
          {_RANDOM[4'h6][31:26],
           ...
           _RANDOM[4'h9],
           _RANDOM[4'hA][25:0]};
        wbReg_bits_vls_vpu_vl = {_RANDOM[4'hA][31:26], _RANDOM[4'hB][1:0]};
        wbReg_bits_vls_vpu_veew = _RANDOM[4'hB][6:5];
        wbReg_bits_vls_vdIdxInField = _RANDOM[4'hB][28:26];
        wbReg_bits_vls_isIndexed = _RANDOM[4'hB][29];
        wbReg_bits_vls_isMasked = _RANDOM[4'hB][30];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  VldMgu mgu (
    ...
    .io_out_vd          (io_writebackAfterMerge_bits_data_0)
  );
