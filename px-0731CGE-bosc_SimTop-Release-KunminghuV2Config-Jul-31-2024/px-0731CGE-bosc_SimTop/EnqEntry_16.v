...
module EnqEntry_16(
  ...
  wire       entryUpdate_status_issued =
    ~((|{common_srcCancelVec_1, common_srcCancelVec_0})
      | (|{wakeupVec_1_0 & cancelSel_0, wakeupVec_0_0 & cancelSel_0})
  ...
  wire [3:0] _GEN_11 = {wakeupVec_0_3, wakeupVec_0_2, wakeupVec_0_1, wakeupVec_0_0};
  wire [3:0] _GEN_12 = {wakeupVec_1_3, wakeupVec_1_2, wakeupVec_1_1, wakeupVec_1_0};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_fuOpType = _RANDOM[6'hB][13:5];
        entryReg_payload_fpWen = _RANDOM[6'hB][15];
        entryReg_payload_fpu_wflags = _RANDOM[6'hD][0];
        entryReg_payload_fpu_rm = _RANDOM[6'hD][14:12];
        entryReg_payload_vpu_vsew = _RANDOM[6'hD][19:18];
        entryReg_payload_pdest = {_RANDOM[6'h16][31:26], _RANDOM[6'h17][1:0]};
        enqDelayValidReg_last_REG = _RANDOM[6'h2A][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
  ...
  assign io_commonOut_fuType = {20'h0, entryReg_status_fuType_14, 14'h0};
  ...
  assign io_commonOut_srcWakeUpL1ExuOH_0_8 =
    (|_GEN_11) ? wakeupVec_0_0 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_8;
  assign io_commonOut_srcWakeUpL1ExuOH_0_9 =
    (|_GEN_11) ? wakeupVec_0_1 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_9;
  assign io_commonOut_srcWakeUpL1ExuOH_0_10 =
    (|_GEN_11) ? wakeupVec_0_2 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_10;
  assign io_commonOut_srcWakeUpL1ExuOH_0_11 =
    (|_GEN_11) ? wakeupVec_0_3 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_11;
  assign io_commonOut_srcWakeUpL1ExuOH_1_8 =
    (|_GEN_12) ? wakeupVec_1_0 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_8;
  assign io_commonOut_srcWakeUpL1ExuOH_1_9 =
    (|_GEN_12) ? wakeupVec_1_1 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_9;
  assign io_commonOut_srcWakeUpL1ExuOH_1_10 =
    (|_GEN_12) ? wakeupVec_1_2 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_10;
  assign io_commonOut_srcWakeUpL1ExuOH_1_11 =
    (|_GEN_12) ? wakeupVec_1_3 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_11;
