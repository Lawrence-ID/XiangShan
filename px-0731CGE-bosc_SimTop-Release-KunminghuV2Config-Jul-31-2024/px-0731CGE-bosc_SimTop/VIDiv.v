  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outData_r_src_4 = {_RANDOM[5'h6][31:30], _RANDOM[5'h7][5:0]};
        outData_r_src_3 =
          {_RANDOM[5'h7][31:6],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:6],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][5:0]};
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][6];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1B][14:7];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1B][22:15];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1B][23];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1B][24];
      `endif // RANDOMIZE_REG_INIT
    end // initial
