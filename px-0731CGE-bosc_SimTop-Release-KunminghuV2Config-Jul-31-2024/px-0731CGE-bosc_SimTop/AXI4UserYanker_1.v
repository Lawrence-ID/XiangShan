...
module AXI4UserYanker_1(
  ...
  wire            _Queue9_BundleMap_1_io_enq_ready;
  wire [2:0]      _Queue9_BundleMap_1_io_deq_bits_extra_id;
  ...
  wire            _Queue9_BundleMap_io_enq_ready;
  wire [2:0]      _Queue9_BundleMap_io_deq_bits_extra_id;
  wire [3:0]      _GEN =
  ...
  Queue9_BundleMap Queue9_BundleMap (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue9_BundleMap Queue9_BundleMap_1 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue8_BundleMap Queue8_BundleMap_4 (
    .clock                (clock),
    .reset                (reset),
  ...
  Queue8_BundleMap Queue8_BundleMap_5 (
    .clock                (clock),
    .reset                (reset),
