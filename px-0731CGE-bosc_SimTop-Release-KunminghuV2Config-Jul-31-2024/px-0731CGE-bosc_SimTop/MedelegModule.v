  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_EX_IGPF = _RANDOM[/*Zero width*/ 1'b0][15];
        reg_EX_LGPF = _RANDOM[/*Zero width*/ 1'b0][16];
        reg_EX_VI = _RANDOM[/*Zero width*/ 1'b0][17];
        reg_EX_SGPF = _RANDOM[/*Zero width*/ 1'b0][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_EX_IAM = 1'h0;
        reg_EX_IAF = 1'h0;
