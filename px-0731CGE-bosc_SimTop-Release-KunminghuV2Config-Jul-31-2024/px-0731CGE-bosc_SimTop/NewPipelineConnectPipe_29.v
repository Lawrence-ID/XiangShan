...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_29(
  input         clock,
  input         reset,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[4'h7][31:4], _RANDOM[4'h8][10:0]};
        data_preDecode_valid = _RANDOM[4'h8][11];
        data_preDecode_isRVC = _RANDOM[4'h8][12];
        data_preDecode_brType = _RANDOM[4'h8][14:13];
        data_preDecode_isCall = _RANDOM[4'h8][15];
        data_preDecode_isRet = _RANDOM[4'h8][16];
        data_ftqIdx_flag = _RANDOM[4'h8][17];
        data_ftqIdx_value = _RANDOM[4'h8][23:18];
        data_ftqOffset = _RANDOM[4'h8][27:24];
        data_predictInfo_target =
          {_RANDOM[4'h8][31:28], _RANDOM[4'h9], _RANDOM[4'hA][2:0]};
        data_predictInfo_taken = _RANDOM[4'hA][3];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
