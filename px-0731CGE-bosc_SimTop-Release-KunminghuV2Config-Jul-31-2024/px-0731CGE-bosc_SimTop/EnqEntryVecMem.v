...
module EnqEntryVecMem(
  ...
  wire         common_deqSuccess =
    entryReg_status_issued & io_commonIn_issueResp_valid
    ...
    & {common_srcLoadCancelVec_4,
       ...
       common_srcLoadCancelVec_0} == 5'h0;
  ...
  assign common_srcLoadCancelVec_3 =
  ...
  assign common_srcLoadCancelVec_4 =
  ...
  wire         entryUpdate_status_srcStatus_2_srcState =
    ...
    & ((|{io_commonIn_wakeUpFromWB_5_bits_pdest == _GEN_1
          ...
          io_commonIn_wakeUpFromWB_0_bits_pdest == _GEN_1
            & entryReg_status_srcStatus_2_srcType[2]
            & io_commonIn_wakeUpFromWB_0_bits_vecWen & io_commonIn_wakeUpFromWB_0_valid})
       | currentStatus_srcStatus_2_srcState | ignoreOldVd_2);
  ...
  wire         entryUpdate_status_srcStatus_4_srcState =
    ~common_srcLoadCancelVec_4 & ((|hi_hi_hi_4) | currentStatus_srcStatus_4_srcState);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_vpu_vill = _RANDOM[6'hE][11];
        ...
        entryReg_payload_vpu_specVill = _RANDOM[6'hE][19];
        entryReg_payload_vpu_specVma = _RANDOM[6'hE][20];
        entryReg_payload_vpu_specVta = _RANDOM[6'hE][21];
        entryReg_payload_vpu_specVsew = _RANDOM[6'hE][23:22];
        entryReg_payload_vpu_specVlmul = _RANDOM[6'hE][26:24];
        entryReg_payload_vpu_vm = _RANDOM[6'hE][27];
        entryReg_payload_vpu_vstart = {_RANDOM[6'hE][31:28], _RANDOM[6'hF][3:0]};
        entryReg_payload_vpu_frm = _RANDOM[6'hF][6:4];
        entryReg_payload_vpu_fpu_isFpToVecInst = _RANDOM[6'hF][7];
        entryReg_payload_vpu_fpu_isFP32Instr = _RANDOM[6'hF][8];
        entryReg_payload_vpu_fpu_isFP64Instr = _RANDOM[6'hF][9];
        entryReg_payload_vpu_fpu_isReduction = _RANDOM[6'hF][10];
        entryReg_payload_vpu_fpu_isFoldTo1_2 = _RANDOM[6'hF][11];
        entryReg_payload_vpu_fpu_isFoldTo1_4 = _RANDOM[6'hF][12];
        entryReg_payload_vpu_fpu_isFoldTo1_8 = _RANDOM[6'hF][13];
        entryReg_payload_vpu_vxrm = _RANDOM[6'hF][15:14];
        ...
        entryReg_payload_vpu_isReverse = _RANDOM[6'h14][5];
        entryReg_payload_vpu_isExt = _RANDOM[6'h14][6];
        entryReg_payload_vpu_isNarrow = _RANDOM[6'h14][7];
        entryReg_payload_vpu_isDstMask = _RANDOM[6'h14][8];
        entryReg_payload_vpu_isOpMask = _RANDOM[6'h14][9];
        entryReg_payload_vpu_isMove = _RANDOM[6'h14][10];
        ...
        entryReg_payload_lastUop = _RANDOM[6'h14][25];
        entryReg_payload_pdest = _RANDOM[6'h17][29:22];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2B][0];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2B][7:1];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2B][8];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2B][14:9];
        enqDelayValidReg_last_REG = _RANDOM[6'h2B][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
