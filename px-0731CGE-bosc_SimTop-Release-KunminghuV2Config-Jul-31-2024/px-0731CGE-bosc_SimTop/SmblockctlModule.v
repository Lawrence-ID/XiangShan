  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_UNCACHE_WRITE_OUTSTANDING_ENABLE = _RANDOM[/*Zero width*/ 1'b0][0];
        reg_CACHE_ERROR_ENABLE = _RANDOM[/*Zero width*/ 1'b0][1];
        reg_SOFT_PREFETCH_ENABLE = _RANDOM[/*Zero width*/ 1'b0][2];
        reg_LDLD_VIO_CHECK_ENABLE = _RANDOM[/*Zero width*/ 1'b0][3];
        reg_SBUFFER_THRESHOLD = _RANDOM[/*Zero width*/ 1'b0][7:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_UNCACHE_WRITE_OUTSTANDING_ENABLE = 1'h0;
        reg_CACHE_ERROR_ENABLE = 1'h1;
