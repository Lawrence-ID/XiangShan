...
module FDivSqrt(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_flag = _RANDOM[4'h0][9];
        outCtrl_r_robIdx_value = _RANDOM[4'h0][17:10];
        outCtrl_r_vpu_vsew = _RANDOM[4'h1][18:17];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[4'hD][16];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[4'hD][24:17];
        io_out_bits_ctrl_pdest_r = {_RANDOM[4'hD][31:25], _RANDOM[4'hE][0]};
        io_out_bits_ctrl_fpWen_r = _RANDOM[4'hE][1];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[4'hE][6];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  FloatDivider fdiv (
    ...
    .io_opa_i                (io_in_bits_data_src_1),
    .io_opb_i                (io_in_bits_data_src_0),
  ...
  assign io_out_bits_res_data =
    (outCtrl_vpu_vsew == 2'h1 ? {48'hFFFFFFFFFFFF, _fdiv_io_fpdiv_res_o[15:0]} : 64'h0)
    | (outCtrl_vpu_vsew == 2'h2 ? {32'hFFFFFFFF, _fdiv_io_fpdiv_res_o[31:0]} : 64'h0)
    | ((&outCtrl_vpu_vsew) ? _fdiv_io_fpdiv_res_o : 64'h0);
endmodule
