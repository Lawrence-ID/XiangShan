...
module VTypeGen(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      vtypeArch_illegal <= 1'h0;
      vtypeArch_vma <= 1'h0;
      vtypeArch_vta <= 1'h0;
      vtypeArch_vsew <= 2'h0;
      vtypeArch_vlmul <= 3'h0;
      vtypeSpec_illegal <= 1'h0;
      vtypeSpec_vma <= 1'h0;
      vtypeSpec_vta <= 1'h0;
      vtypeSpec_vsew <= 2'h0;
      ...
      else if (io_redirect & io_commitVType_vtype_valid) begin
        vtypeSpec_illegal <= io_commitVType_vtype_bits_illegal;
        vtypeSpec_vma <= io_commitVType_vtype_bits_vma;
        vtypeSpec_vta <= io_commitVType_vtype_bits_vta;
        vtypeSpec_vsew <= io_commitVType_vtype_bits_vsew;
        vtypeSpec_vlmul <= io_commitVType_vtype_bits_vlmul;
      end
      else if (io_redirect & ~io_commitVType_vtype_valid) begin
