...
module TLBNonBlock_2(
  ...
  wire             _GEN_6 = _readResult_T_5 | ~_readResult_T_17;
  wire             _GEN_7 = _readResult_T_42 | ~_readResult_T_54;
  always @(posedge clock) begin
    ...
    need_gpa_robidx_flag <=
      _GEN_7 & (_GEN_6 ? need_gpa_robidx_flag : req_out_0_debug_robIdx_flag);
    if (_GEN_7) begin
      if (_GEN_6) begin
      end
      else
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        (|req_in_s2xlate_0)
          ? {5'h0, _GEN_4[io_ptw_resp_bits_s2_entry_level]}
          : readResult_ppn_s1;
      ...
      readResult_p_ppn_1 <=
        (|req_in_s2xlate_1)
          ? {5'h0, _GEN_5[io_ptw_resp_bits_s2_entry_level]}
          : readResult_ppn_s1_1;
  ...
  wire [2:0]       _readResult_s1tag_T_2 = _GEN_8 | _GEN_9;
  ...
  wire [1:0]       readResult_level_1 =
    _ptw_just_back_level_T_1
      ? io_ptw_resp_bits_s2_entry_level
      : io_ptw_resp_bits_s1_entry_level;
  wire [2:0]       _readResult_s1tag_T_10 = _GEN_8 | _GEN_9;
