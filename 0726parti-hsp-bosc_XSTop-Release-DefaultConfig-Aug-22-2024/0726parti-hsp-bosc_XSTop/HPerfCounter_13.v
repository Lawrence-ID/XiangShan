...
module HPerfCounter_13(
  ...
  input  [5:0]  io_events_sets_127_value,
  input  [5:0]  io_events_sets_128_value,
  input  [5:0]  io_events_sets_129_value,
  input  [5:0]  io_events_sets_131_value,
  input  [5:0]  io_events_sets_132_value,
  input  [5:0]  io_events_sets_133_value,
  input  [5:0]  io_events_sets_134_value,
  input  [5:0]  io_events_sets_135_value,
  input  [5:0]  io_events_sets_136_value,
  input  [5:0]  io_events_sets_137_value,
  input  [5:0]  io_events_sets_139_value,
  input  [5:0]  io_events_sets_140_value,
  input  [5:0]  io_events_sets_141_value,
  input  [5:0]  io_events_sets_142_value,
  ...
  always @(posedge clock) begin
    events_incr_0_value <= _GEN_0[io_hpm_event[7:0]];
    events_incr_1_value <= _GEN_0[io_hpm_event[17:10]];
    events_incr_2_value <= _GEN_0[io_hpm_event[27:20]];
    events_incr_3_value <= _GEN_0[io_hpm_event[37:30]];
