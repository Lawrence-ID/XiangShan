  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_fuOpType = _RANDOM[6'hB][21:13];
        entryReg_payload_fpWen = _RANDOM[6'hB][23];
        entryReg_payload_vecWen = _RANDOM[6'hB][24];
        entryReg_payload_v0Wen = _RANDOM[6'hB][25];
        entryReg_payload_fpu_wflags = _RANDOM[6'hD][8];
        entryReg_payload_vpu_vma = _RANDOM[6'hD][24];
        entryReg_payload_vpu_vta = _RANDOM[6'hD][25];
        entryReg_payload_vpu_vsew = _RANDOM[6'hD][27:26];
        entryReg_payload_vpu_vlmul = _RANDOM[6'hD][30:28];
        entryReg_payload_vpu_vm = _RANDOM[6'hE][7];
        entryReg_payload_vpu_vstart = _RANDOM[6'hE][15:8];
        entryReg_payload_vpu_fpu_isFoldTo1_2 = _RANDOM[6'hE][23];
        entryReg_payload_vpu_fpu_isFoldTo1_4 = _RANDOM[6'hE][24];
        entryReg_payload_vpu_fpu_isFoldTo1_8 = _RANDOM[6'hE][25];
        entryReg_payload_vpu_isExt = _RANDOM[6'h13][18];
        entryReg_payload_vpu_isNarrow = _RANDOM[6'h13][19];
        entryReg_payload_vpu_isDstMask = _RANDOM[6'h13][20];
        entryReg_payload_vpu_isOpMask = _RANDOM[6'h13][21];
        entryReg_payload_vpu_isDependOldvd = _RANDOM[6'h13][23];
        entryReg_payload_vpu_isWritePartVd = _RANDOM[6'h13][24];
        entryReg_payload_uopIdx = {_RANDOM[6'h13][31:28], _RANDOM[6'h14][2:0]};
        entryReg_payload_lastUop = _RANDOM[6'h14][5];
        entryReg_payload_pdest = _RANDOM[6'h17][9:2];
        enqDelayValidReg_last_REG = _RANDOM[6'h2B][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
