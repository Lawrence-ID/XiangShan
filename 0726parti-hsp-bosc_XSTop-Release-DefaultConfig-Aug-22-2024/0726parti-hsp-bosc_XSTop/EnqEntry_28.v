  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_imm = {_RANDOM[6'h3][31:6], _RANDOM[6'h4][5:0]};
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[6'h8][3];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'h8][10];
        entryReg_payload_ftqPtr_value = _RANDOM[6'h8][16:11];
        entryReg_payload_ftqOffset = _RANDOM[6'h8][20:17];
        entryReg_payload_fuOpType = _RANDOM[6'hA][26:18];
        entryReg_payload_rfWen = _RANDOM[6'hA][27];
        entryReg_payload_fpWen = _RANDOM[6'hA][28];
        entryReg_payload_pdest = _RANDOM[6'h16][14:7];
        entryReg_payload_storeSetHit = _RANDOM[6'h29][0];
        entryReg_payload_waitForRobIdx_flag = _RANDOM[6'h29][1];
        entryReg_payload_waitForRobIdx_value = _RANDOM[6'h29][9:2];
        entryReg_payload_loadWaitBit = _RANDOM[6'h29][10];
        entryReg_payload_loadWaitStrict = _RANDOM[6'h29][11];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h29][17];
        entryReg_payload_lqIdx_value = _RANDOM[6'h29][24:18];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h29][25];
        entryReg_payload_sqIdx_value = _RANDOM[6'h29][31:26];
        enqDelayValidReg_last_REG = _RANDOM[6'h2A][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
