...
module ITTageTable(
  ...
  wire [3:0]  update_folded_hist_hist_12_folded_hist = io_update_ghist[3:0];
  wire [7:0]  update_idx =
    {io_update_pc[8:5], io_update_pc[4:1] ^ update_folded_hist_hist_12_folded_hist};
  reg         needReset;
  ...
  FoldedSRAMTemplate_21 table_0 (
    ...
    .io_w_req_bits_data_0_tag
      ({io_update_pc[17:14],
        {io_update_pc[13], io_update_pc[12:9] ^ update_folded_hist_hist_12_folded_hist}
          ^ {update_folded_hist_hist_12_folded_hist, 1'h0}}),
