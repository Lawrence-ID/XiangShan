...
module TLBNonBlock(
  ...
  wire [19:0]      readResult_s1tagFix =
    ~(|io_ptw_resp_bits_s1_entry_level) & _ptw_just_back_onlyS2_hit_T_24
      ? _GEN_5
      : ~(|io_ptw_resp_bits_s1_entry_level) & _ptw_just_back_onlyS2_hit_T_21
          ? _GEN_4
  ...
  wire             _readResult_ppn_s1_T_53 = io_ptw_resp_bits_s1_entry_level == 2'h1;
  wire             _readResult_ppn_s1_T_55 = io_ptw_resp_bits_s1_entry_level == 2'h2;
  wire [28:0]      readResult_ppn_s1 =
    _readResult_ppn_s1_T_55
      ? {io_ptw_resp_bits_s1_entry_ppn, _GEN_17[io_requestor_0_req_bits_vaddr[14:12]]}
      : _readResult_ppn_s1_T_53
  ...
  always @(posedge clock) begin
    ...
    else if (_readResult_T_138 | ~_GEN_24)
      need_gpa_gvpn <= io_ptw_resp_bits_s2_entry_tag;
    ...
    if (io_ptw_resp_valid) begin
      ...
      readResult_p_ppn_1 <=
        (|req_in_s2xlate_1)
          ? {5'h0, _GEN_19[io_ptw_resp_bits_s2_entry_level]}
          : readResult_ppn_s1_1;
      ...
      readResult_p_ppn_2 <=
        (|req_in_s2xlate_2)
          ? {5'h0, _GEN_20[io_ptw_resp_bits_s2_entry_level]}
          : readResult_ppn_s1_2;
      ...
      readResult_p_ppn_3 <=
        (|req_in_s2xlate_3)
          ? {5'h0, _GEN_21[io_ptw_resp_bits_s2_entry_level]}
          : readResult_ppn_s1_3;
