...
module Queue1_PrefetchTrain(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][16:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_needT = ram[30];
  assign io_deq_bits_source = ram[37:31];
  assign io_deq_bits_vaddr = ram[70:38];
  assign io_deq_bits_reqsource = ram[79:76];
endmodule
