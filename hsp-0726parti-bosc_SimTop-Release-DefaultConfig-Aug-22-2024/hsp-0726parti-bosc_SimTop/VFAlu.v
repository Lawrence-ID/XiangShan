...
module VFAlu(
  ...
  reg             ctrlVec_1_vpu_fpu_isFoldTo1_2;
  reg             ctrlVec_1_vpu_fpu_isFoldTo1_4;
  reg             ctrlVec_1_vpu_fpu_isFoldTo1_8;
  reg  [6:0]      ctrlVec_1_vpu_vuopIdx;
  reg             ctrlVec_1_vpu_lastUop;
  ...
  wire            vfalus_0_io_maskForReduction_isFold =
    fflagsRedMask_f32Fold | io_in_bits_ctrl_vpu_fpu_isFoldTo1_8;
  ...
  wire [7:0]      vfalus_1_io_maskForReduction_outMask =
    ...
    | (_vfalus_1_io_maskForReduction_outMask_T_2
         ...
         : 8'h0);
  reg  [127:0]    vs1Reg;
  wire            outIsVfRedUnSum = ctrlVec_1_fuOpType == 9'h1A;
  wire            _outIsResuction_T_1 = ctrlVec_1_fuOpType == 9'h15;
  wire            _outIsResuction_T_3 = ctrlVec_1_fuOpType == 9'h14;
  wire            outIsVfRedUnComp = _outIsResuction_T_1 | _outIsResuction_T_3;
  wire            _taIsFalseForVFREDO_T = ctrlVec_1_fuOpType == 9'h16;
  wire            _taIsFalseForVFREDO_T_1 = ctrlVec_1_fuOpType == 9'h36;
  wire [127:0]    resultDataUInt =
    (outIsVfRedUnSum | _outIsResuction_T_1 | _outIsResuction_T_3) & ctrlVec_1_vpu_lastUop
    & ~existMaskReg
      ? vs1Reg
      : {_vfalus_1_io_fp_result, _vfalus_0_io_fp_result};
  wire            _fflagsRedMask_T_3 = ctrlVec_1_vpu_vsew == 2'h1;
  wire            _outOldVdForREDO_T_2 = ctrlVec_1_vpu_vsew == 2'h2;
  reg             outEew_r;
  wire [1:0]      outEew = outEew_r ? 2'(ctrlVec_1_vpu_vsew + 2'h1) : ctrlVec_1_vpu_vsew;
  ...
  wire [4:0]      vlMaxThisUop =
    ctrlVec_1_vpu_vlmul[2]
      ? vlMax
        >> (ctrlVec_1_vpu_vlmul[2]
              ? 2'(~(ctrlVec_1_vpu_vlmul[1:0]) + 2'h1)
              : ctrlVec_1_vpu_vlmul[1:0])
      : vlMax;
  wire [7:0]      _GEN_7 = {5'h0, ctrlVec_1_vpu_vuopIdx[2:0]};
  ...
  wire [7:0]      vlMaskRShift =
    8'hFF
    >> 4'(4'h8 - {1'h0, vlSetThisUop < _GEN_8 ? vlSetThisUop[2:0] : vlMaxThisUop[2:0]});
  wire            _outIsFisrtGroup_T_10 = ctrlVec_1_vpu_vlmul == 3'h3;
  wire            firstNeedFFlags =
    (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h0 | ctrlVec_1_vpu_vuopIdx[2:0] == 3'h1
     & (ctrlVec_1_vpu_vlmul == 3'h2 | _outIsFisrtGroup_T_10)
     | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h2 | ctrlVec_1_vpu_vuopIdx[2:0] == 3'h3)
     & _outIsFisrtGroup_T_10) & outIsVfRedUnComp;
  wire            _mgu_io_in_info_ma_T = ctrlVec_1_fuOpType == 9'h12;
  wire [127:0]    maskToMgu =
    ctrlVec_1_fuOpType == 9'h4 | _mgu_io_in_info_ma_T | outIsResuction | ctrlVec_1_vpu_vm
      ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      : dataVec_1_src_3;
  ...
  wire [7:0]      _GEN_9 =
    outIsResuction
      ? {{7{firstNeedFFlags | outIsVfRedUnSum}}
           & ((~(&ctrlVec_1_vpu_vsew) | io_in_bits_ctrl_vpu_fpu_isFoldTo1_2
                 ? 7'h0
                 : 7'h7F)
              | (_outOldVdForREDO_T_2
                   ? (fflagsRedMask_f32Fold
                        ? {6'h0, io_in_bits_ctrl_vpu_fpu_isFoldTo1_2}
                        : 7'h7F)
                   : 7'h0)
              | (_fflagsRedMask_T_3
                   ? (fflagsRedMask_f32Fold | io_in_bits_ctrl_vpu_fpu_isFoldTo1_8
                        ...
                        : 7'h7F)
                   : 7'h0)),
         ctrlVec_1_vpu_lastUop & outIsVfRedUnComp | firstNeedFFlags
  ...
  wire            _outOldVdForWREDO_T_7 = ctrlVec_1_vpu_vsew == 2'h1;
  wire [5:0]      _cmpResultOldVdRshiftWidth_T_9 =
    _outOldVdForWREDO_T_7 ? {ctrlVec_1_vpu_vuopIdx[2:0], 3'h0} : 6'h0;
  wire [4:0]      _GEN_10 =
    _cmpResultOldVdRshiftWidth_T_9[4:0]
    | (_outOldVdForREDO_T_2 ? {ctrlVec_1_vpu_vuopIdx[2:0], 2'h0} : 5'h0);
  wire [127:0]    _cmpResultOldVd_T =
    ...
    >> {122'h0,
        ...
        _GEN_10[4],
        _GEN_10[3:0]
          | ((&ctrlVec_1_vpu_vsew) ? {ctrlVec_1_vpu_vuopIdx[2:0], 1'h0} : 4'h0)};
  wire [6:0]      _GEN_11 =
     ...
     {1'h0,
      {1'h0,
       ...
       | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h4
            ...
            : 7'h0) | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h5 ? 7'(_GEN_11 * 7'h5) : 7'h0)
       | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h6 ? 7'(_GEN_11 * 7'h6) : 7'h0)
       | ((&(ctrlVec_1_vpu_vuopIdx[2:0])) ? 7'(_GEN_11 * 7'h7) : 7'h0)};
  wire            outIsFold =
    ctrlVec_1_vpu_fpu_isFoldTo1_2 | ctrlVec_1_vpu_fpu_isFoldTo1_4
    | ctrlVec_1_vpu_fpu_isFoldTo1_8;
  wire [111:0]    _outOldVdForREDO_T_6 =
    _outOldVdForWREDO_T_7 ? dataVec_1_src_2[127:16] : 112'h0;
  wire [95:0]     _GEN_13 =
    _outOldVdForREDO_T_6[95:0] | (_outOldVdForREDO_T_2 ? dataVec_1_src_2[127:32] : 96'h0);
  wire [3:0]      numOfUopVFREDOSUM_uvlMax =
    (&ctrlVec_1_vpu_vsew)
      ? 4'h2
      : ctrlVec_1_vpu_vsew == 2'h2 ? 4'h4 : {ctrlVec_1_vpu_vsew == 2'h1, 3'h0};
  wire            _mgu_io_in_info_ta_T = ctrlVec_1_fuOpType == 9'h11;
  ...
  wire [3:0][2:0] _GEN_14 = '{3'h7, 3'h6, 3'h5, 3'h0};
  wire [1:0]      outEew_s0 =
    io_in_bits_ctrl_fuOpType[5]
      ? 2'(io_in_bits_ctrl_vpu_vsew + 2'h1)
      : io_in_bits_ctrl_vpu_vsew;
  wire            _outIsResuction_s0_T_5 = io_in_bits_ctrl_fuOpType == 9'h16;
  wire            _outIsResuction_s0_T_7 = io_in_bits_ctrl_fuOpType == 9'h36;
  wire            outIsResuction_s0 =
    io_in_bits_ctrl_fuOpType == 9'h1A | io_in_bits_ctrl_fuOpType == 9'h15
    | io_in_bits_ctrl_fuOpType == 9'h14 | _outIsResuction_s0_T_5 | _outIsResuction_s0_T_7;
  always @(posedge clock) begin
    if (_GEN) begin
      ...
      ctrlVec_1_vpu_fpu_isFoldTo1_2 <= io_in_bits_ctrl_vpu_fpu_isFoldTo1_2;
      ctrlVec_1_vpu_fpu_isFoldTo1_4 <= io_in_bits_ctrl_vpu_fpu_isFoldTo1_4;
      ctrlVec_1_vpu_fpu_isFoldTo1_8 <= io_in_bits_ctrl_vpu_fpu_isFoldTo1_8;
      ctrlVec_1_vpu_vuopIdx <= io_in_bits_ctrl_vpu_vuopIdx;
      ctrlVec_1_vpu_lastUop <= io_in_bits_ctrl_vpu_lastUop;
    ...
    if (io_in_valid) begin
      ...
      outEew_r <= io_in_bits_ctrl_fuOpType[5];
      outVlFix <=
        io_in_bits_ctrl_fuOpType == 9'h11
          ? 8'h1
          : io_in_bits_ctrl_fuOpType == 9'h12
              ? {7'h0, |io_in_bits_data_src_4}
              : outIsResuction_s0
                  ? {3'h0,
                     io_in_bits_ctrl_vpu_vuopIdx == {3'h0,
                                                     4'((io_in_bits_ctrl_vpu_vlmul == 3'h3
                                                           ? 4'h8
                                                           : io_in_bits_ctrl_vpu_vlmul == 3'h2
                                                               ...
                                                               : io_in_bits_ctrl_vpu_vlmul == 3'h1
                                                                   ...
                                                                   : 4'h1)
                                                        + 4'({1'h0,
                                                              3'((io_in_bits_ctrl_vpu_vlmul[2]
                                                                    ? io_in_bits_ctrl_vpu_vlmul
                                                                    : 3'h0)
                                                                 - _GEN_14[io_in_bits_ctrl_vpu_vsew])}
                                                             - 4'h1))}
      ...
      mgu_io_in_info_vdIdx_r <= outIsResuction_s0 ? 7'h0 : io_in_bits_ctrl_vpu_vuopIdx;
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ctrlVec_1_fpWen = _RANDOM[6'h0][27];
        ctrlVec_1_vecWen = _RANDOM[6'h0][28];
        ctrlVec_1_v0Wen = _RANDOM[6'h0][29];
        ctrlVec_1_fpu_wflags = _RANDOM[6'h1][2];
        ctrlVec_1_vpu_vma = _RANDOM[6'h1][18];
        ctrlVec_1_vpu_vta = _RANDOM[6'h1][19];
        ctrlVec_1_vpu_vsew = _RANDOM[6'h1][21:20];
        ctrlVec_1_vpu_vlmul = _RANDOM[6'h1][24:22];
        ctrlVec_1_vpu_vm = _RANDOM[6'h2][1];
        ctrlVec_1_vpu_vstart = _RANDOM[6'h2][9:2];
        ctrlVec_1_vpu_fpu_isFoldTo1_2 = _RANDOM[6'h2][17];
        ctrlVec_1_vpu_fpu_isFoldTo1_4 = _RANDOM[6'h2][18];
        ctrlVec_1_vpu_fpu_isFoldTo1_8 = _RANDOM[6'h2][19];
        ctrlVec_1_vpu_vuopIdx = _RANDOM[6'h2][28:22];
        ctrlVec_1_vpu_lastUop = _RANDOM[6'h2][29];
        ctrlVec_1_vpu_isNarrow = _RANDOM[6'h7][13];
        ctrlVec_1_vpu_isDstMask = _RANDOM[6'h7][14];
        dataVec_1_src_4 = _RANDOM[6'h7][26:19];
        dataVec_1_src_3 =
          {_RANDOM[6'h7][31:27],
           _RANDOM[6'h8],
           _RANDOM[6'h9],
        ...
        vs1Reg =
          {_RANDOM[6'h2E][31:1],
           ...
           _RANDOM[6'h31],
           _RANDOM[6'h32][0]};
        outEew_r = _RANDOM[6'h32][1];
        outVlFix = _RANDOM[6'h32][9:2];
        mgu_io_in_info_eew_r = _RANDOM[6'h32][11:10];
        mgu_io_in_info_vdIdx_r = _RANDOM[6'h32][18:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVec_1 = 1'h0;
    end // initial
  ...
  Mgu mgu (
    .io_in_vd
      (ctrlVec_1_vpu_isDstMask
         ? {120'h0,
            8'(_GEN_12 + 8'h7) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[7]
                   ? _fflagsRedMask_T_3 & resultDataUInt[112]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[7]),
            8'(_GEN_12 + 8'h6) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[6]
                   ? _fflagsRedMask_T_3 & resultDataUInt[96]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[6]),
            8'(_GEN_12 + 8'h5) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[5]
                   ? _fflagsRedMask_T_3 & resultDataUInt[80]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[5]),
            8'(_GEN_12 + 8'h4) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[4]
                   ? _fflagsRedMask_T_3 & resultDataUInt[64]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[4]),
            8'(_GEN_12 + 8'h3) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[3]
                   ? _fflagsRedMask_T_3 & resultDataUInt[48] | _outOldVdForREDO_T_2
                     & resultDataUInt[96]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[3]),
            8'(_GEN_12 + 8'h2) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[2]
                   ? _fflagsRedMask_T_3 & resultDataUInt[32] | _outOldVdForREDO_T_2
                     & resultDataUInt[64]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[2]),
            8'(_GEN_12 + 8'h1) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[1]
                   ? _fflagsRedMask_T_3 & resultDataUInt[16] | _outOldVdForREDO_T_2
                     & resultDataUInt[32] | (&ctrlVec_1_vpu_vsew) & resultDataUInt[64]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[1]),
            _GEN_12 >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[0]
                   ? resultDataUInt[0]
                   : ctrlVec_1_vpu_vma | _cmpResultOldVd_T[0])}
         : resultDataUInt),
    .io_in_oldVd
      ((_taIsFalseForVFREDO_T & outIsFold | _taIsFalseForVFREDO_T_1)
       & ~ctrlVec_1_vpu_lastUop
         ? (_taIsFalseForVFREDO_T
              ? {16'h0,
                 _outOldVdForREDO_T_6[111:96],
                 _GEN_13[95:64],
                 _GEN_13[63:0]
                   | ((&ctrlVec_1_vpu_vsew) ? dataVec_1_src_2[127:64] : 64'h0)}
              : outIsFold
                  ? (_outOldVdForWREDO_T_7
                       ? (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h1
                            ? dataVec_1_src_2
                            : {16'h0, dataVec_1_src_2[127:16]})
                       : ctrlVec_1_vpu_vuopIdx[1:0] == 2'h1
                           ? dataVec_1_src_2
                           : {32'h0, dataVec_1_src_2[127:32]})
                  : _outOldVdForWREDO_T_7
                      ? {dataVec_1_src_2[111:16], 32'h0}
                      : {dataVec_1_src_2[95:32], 64'h0})
         : dataVec_1_src_2),
    .io_in_mask         (maskToMgu),
    .io_in_info_ta
      (_mgu_io_in_info_ta_T
       | ~((_taIsFalseForVFREDO_T | _taIsFalseForVFREDO_T_1)
           & ctrlVec_1_vpu_vuopIdx != 7'((ctrlVec_1_vpu_vlmul[2]
                                            ? {3'h0,
                                               numOfUopVFREDOSUM_uvlMax
                                                 >> 2'(2'h0 - ctrlVec_1_vpu_vlmul[1:0])}
                                            : {3'h0, numOfUopVFREDOSUM_uvlMax}
                                              << ctrlVec_1_vpu_vlmul[1:0]) - 7'h1))
       & ctrlVec_1_vpu_vta),
    .io_in_info_ma      (_mgu_io_in_info_ma_T | ctrlVec_1_vpu_vma),
  ...
  Mgtu mgtu (
    .io_in_vd  (ctrlVec_1_vpu_isDstMask ? _mgu_io_out_vd : resultDataUInt),
  ...
  assign io_out_bits_res_data =
    ~_mgu_io_in_info_ta_T & dataVec_1_src_4 == 8'h0
      ? dataVec_1_src_2
      : ctrlVec_1_vpu_isDstMask ? _mgtu_io_out_vd : _mgu_io_out_vd;
  assign io_out_bits_res_fflags =
    (_GEN_9[0] ? _vfalus_0_io_fflags[4:0] : 5'h0)
    | (_GEN_9[1] ? _vfalus_0_io_fflags[9:5] : 5'h0)
    | (_GEN_9[2] ? _vfalus_0_io_fflags[14:10] : 5'h0)
    | (_GEN_9[3] ? _vfalus_0_io_fflags[19:15] : 5'h0)
    | (_GEN_9[4] ? _vfalus_1_io_fflags[4:0] : 5'h0)
    | (_GEN_9[5] ? _vfalus_1_io_fflags[9:5] : 5'h0)
    | (_GEN_9[6] ? _vfalus_1_io_fflags[14:10] : 5'h0)
    | (_GEN_9[7] ? _vfalus_1_io_fflags[19:15] : 5'h0);
endmodule
