...
module VSMergeBufferImp(
  ...
  wire               feedbackValid = selFire & _GEN_36[entryIdx];
  wire [15:0]        _GEN_68 =
    {{needRSReplay_15},
     {needRSReplay_14},
     {needRSReplay_13},
  ...
  wire               pipelineOut_0_valid =
    feedbackValid & ~_GEN_68[entryIdx]
    & ~(io_redirect_valid
  ...
  always @(posedge clock) begin
    ...
    if (feedbackValid) begin
      io_feedback_0_bits_r_hit <= ~_GEN_68[entryIdx];
      io_feedback_0_bits_r_sqIdx_flag <= _GEN_86[entryIdx];
      io_feedback_0_bits_r_sqIdx_value <= _GEN_87[entryIdx];
      io_feedback_0_bits_r_lqIdx_flag <= _GEN_88[entryIdx];
      io_feedback_0_bits_r_lqIdx_value <= _GEN_89[entryIdx];
    end
  end // always @(posedge)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_feedback_0_valid_REG = _RANDOM[10'h2DD][0];
        io_feedback_0_bits_r_hit = _RANDOM[10'h2DD][10];
        io_feedback_0_bits_r_sqIdx_flag = _RANDOM[10'h2DD][23];
        io_feedback_0_bits_r_sqIdx_value = _RANDOM[10'h2DD][29:24];
        io_feedback_0_bits_r_lqIdx_flag = _RANDOM[10'h2DD][30];
        io_feedback_0_bits_r_lqIdx_value = {_RANDOM[10'h2DD][31], _RANDOM[10'h2DE][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        allocated_0 = 1'h0;
        allocated_1 = 1'h0;
  ...
  NewPipelineConnectPipe_56 VMergebufferPipelineConnect0 (
    ...
    .io_in_bits_uop_replayInst       (_GEN_83[entryIdx]),
  ...
  assign io_uopWriteback_0_bits_uop_robIdx_value =
    _VMergebufferPipelineConnect0_io_out_bits_uop_robIdx_value;
  assign io_toLsq_0_valid = feedbackValid & ~_GEN_68[entryIdx];
  ...
  assign io_toLsq_0_bits_vaddr = _GEN_84[entryIdx];
  assign io_toLsq_0_bits_feedback_0 = |_GEN_85;
  assign io_toLsq_0_bits_feedback_1 = ~(|_GEN_85);
