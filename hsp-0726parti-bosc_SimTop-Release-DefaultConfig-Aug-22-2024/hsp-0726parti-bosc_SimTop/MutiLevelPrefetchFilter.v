...
module MutiLevelPrefetchFilter(
  ...
  wire              _GEN_172 = _GEN_151[s2_tlb_update_index[3:0]] == 2'h0;
  wire              _GEN_173 = _GEN_62 & s2_tlb_update_index[4];
  wire              s0_pf_fire =
  ...
  always @(posedge clock) begin
    ...
    if (s1_l1_alloc) begin
      ...
      l1_array_0_sink <= 2'h0;
    if (_GEN_62 & ~(s2_tlb_update_index[4])) begin
      l1_array_0_is_vaddr <= ~_GEN_79 & (_GEN_63 ? io_tlb_req_resp_bits_miss : _GEN_95);
      l1_array_1_is_vaddr <= ~_GEN_80 & (_GEN_64 ? io_tlb_req_resp_bits_miss : _GEN_96);
      l1_array_2_is_vaddr <= ~_GEN_81 & (_GEN_65 ? io_tlb_req_resp_bits_miss : _GEN_97);
      l1_array_3_is_vaddr <= ~_GEN_82 & (_GEN_66 ? io_tlb_req_resp_bits_miss : _GEN_98);
      l1_array_4_is_vaddr <= ~_GEN_83 & (_GEN_67 ? io_tlb_req_resp_bits_miss : _GEN_99);
      l1_array_5_is_vaddr <= ~_GEN_84 & (_GEN_68 ? io_tlb_req_resp_bits_miss : _GEN_100);
      l1_array_6_is_vaddr <= ~_GEN_85 & (_GEN_69 ? io_tlb_req_resp_bits_miss : _GEN_101);
      l1_array_7_is_vaddr <= ~_GEN_86 & (_GEN_70 ? io_tlb_req_resp_bits_miss : _GEN_102);
      l1_array_8_is_vaddr <= ~_GEN_87 & (_GEN_71 ? io_tlb_req_resp_bits_miss : _GEN_103);
      l1_array_9_is_vaddr <= ~_GEN_88 & (_GEN_72 ? io_tlb_req_resp_bits_miss : _GEN_104);
      l1_array_10_is_vaddr <= ~_GEN_89 & (_GEN_73 ? io_tlb_req_resp_bits_miss : _GEN_105);
      l1_array_11_is_vaddr <= ~_GEN_90 & (_GEN_74 ? io_tlb_req_resp_bits_miss : _GEN_106);
      l1_array_12_is_vaddr <= ~_GEN_91 & (_GEN_75 ? io_tlb_req_resp_bits_miss : _GEN_107);
      l1_array_13_is_vaddr <= ~_GEN_92 & (_GEN_76 ? io_tlb_req_resp_bits_miss : _GEN_108);
      l1_array_14_is_vaddr <= ~_GEN_93 & (_GEN_77 ? io_tlb_req_resp_bits_miss : _GEN_109);
      l1_array_15_is_vaddr <=
        ~_GEN_94 & ((&(s2_tlb_update_index[3:0])) ? io_tlb_req_resp_bits_miss : _GEN_110);
    end
    else begin
      l1_array_0_is_vaddr <= _GEN_95;
      l1_array_1_is_vaddr <= _GEN_96;
      l1_array_2_is_vaddr <= _GEN_97;
      l1_array_3_is_vaddr <= _GEN_98;
      l1_array_4_is_vaddr <= _GEN_99;
      l1_array_5_is_vaddr <= _GEN_100;
      l1_array_6_is_vaddr <= _GEN_101;
      l1_array_7_is_vaddr <= _GEN_102;
      l1_array_8_is_vaddr <= _GEN_103;
      l1_array_9_is_vaddr <= _GEN_104;
      l1_array_10_is_vaddr <= _GEN_105;
      l1_array_11_is_vaddr <= _GEN_106;
      l1_array_12_is_vaddr <= _GEN_107;
      l1_array_13_is_vaddr <= _GEN_108;
      l1_array_14_is_vaddr <= _GEN_109;
      l1_array_15_is_vaddr <= _GEN_110;
    end
    if (_GEN_3) begin
    ...
    if (_GEN_62 & s2_tlb_update_index[4] & ~io_tlb_req_resp_bits_miss & _GEN_78 & _GEN_172
        & _GEN_63)
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_63) begin
      if (_GEN_31)
    ...
    if (s1_l2_alloc) begin
      ...
      l2_array_0_sink <= s1_l2_prefetch_req_sink;
    if (_GEN_173)
      l2_array_0_is_vaddr <= ~_GEN_79 & (_GEN_63 ? io_tlb_req_resp_bits_miss : _GEN_132);
    else
      l2_array_0_is_vaddr <= _GEN_132;
    if (_GEN_33) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_64) begin
      if (_GEN_33)
    ...
    if (_GEN_173)
      l2_array_1_is_vaddr <= ~_GEN_80 & (_GEN_64 ? io_tlb_req_resp_bits_miss : _GEN_133);
    else
      l2_array_1_is_vaddr <= _GEN_133;
    if (_GEN_35) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_65) begin
      if (_GEN_35)
    ...
    if (_GEN_173)
      l2_array_2_is_vaddr <= ~_GEN_81 & (_GEN_65 ? io_tlb_req_resp_bits_miss : _GEN_134);
    else
      l2_array_2_is_vaddr <= _GEN_134;
    if (_GEN_37) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_66) begin
      if (_GEN_37)
    ...
    if (_GEN_173)
      l2_array_3_is_vaddr <= ~_GEN_82 & (_GEN_66 ? io_tlb_req_resp_bits_miss : _GEN_135);
    else
      l2_array_3_is_vaddr <= _GEN_135;
    if (_GEN_39) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_67) begin
      if (_GEN_39)
    ...
    if (_GEN_173)
      l2_array_4_is_vaddr <= ~_GEN_83 & (_GEN_67 ? io_tlb_req_resp_bits_miss : _GEN_136);
    else
      l2_array_4_is_vaddr <= _GEN_136;
    if (_GEN_41) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_68) begin
      if (_GEN_41)
    ...
    if (_GEN_173)
      l2_array_5_is_vaddr <= ~_GEN_84 & (_GEN_68 ? io_tlb_req_resp_bits_miss : _GEN_137);
    else
      l2_array_5_is_vaddr <= _GEN_137;
    if (_GEN_43) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_69) begin
      if (_GEN_43)
    ...
    if (_GEN_173)
      l2_array_6_is_vaddr <= ~_GEN_85 & (_GEN_69 ? io_tlb_req_resp_bits_miss : _GEN_138);
    else
      l2_array_6_is_vaddr <= _GEN_138;
    if (_GEN_45) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_70) begin
      if (_GEN_45)
    ...
    if (_GEN_173)
      l2_array_7_is_vaddr <= ~_GEN_86 & (_GEN_70 ? io_tlb_req_resp_bits_miss : _GEN_139);
    else
      l2_array_7_is_vaddr <= _GEN_139;
    if (_GEN_47) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_71) begin
      if (_GEN_47)
    ...
    if (_GEN_173)
      l2_array_8_is_vaddr <= ~_GEN_87 & (_GEN_71 ? io_tlb_req_resp_bits_miss : _GEN_140);
    else
      l2_array_8_is_vaddr <= _GEN_140;
    if (_GEN_49) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_72) begin
      if (_GEN_49)
    ...
    if (_GEN_173)
      l2_array_9_is_vaddr <= ~_GEN_88 & (_GEN_72 ? io_tlb_req_resp_bits_miss : _GEN_141);
    else
      l2_array_9_is_vaddr <= _GEN_141;
    if (_GEN_51) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_73) begin
      if (_GEN_51)
    ...
    if (_GEN_173)
      l2_array_10_is_vaddr <= ~_GEN_89 & (_GEN_73 ? io_tlb_req_resp_bits_miss : _GEN_142);
    else
      l2_array_10_is_vaddr <= _GEN_142;
    if (_GEN_53) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_74) begin
      if (_GEN_53)
    ...
    if (_GEN_173)
      l2_array_11_is_vaddr <= ~_GEN_90 & (_GEN_74 ? io_tlb_req_resp_bits_miss : _GEN_143);
    else
      l2_array_11_is_vaddr <= _GEN_143;
    if (_GEN_55) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_75) begin
      if (_GEN_55)
    ...
    if (_GEN_173)
      l2_array_12_is_vaddr <= ~_GEN_91 & (_GEN_75 ? io_tlb_req_resp_bits_miss : _GEN_144);
    else
      l2_array_12_is_vaddr <= _GEN_144;
    if (_GEN_57) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_76) begin
      if (_GEN_57)
    ...
    if (_GEN_173)
      l2_array_13_is_vaddr <= ~_GEN_92 & (_GEN_76 ? io_tlb_req_resp_bits_miss : _GEN_145);
    else
      l2_array_13_is_vaddr <= _GEN_145;
    if (_GEN_59) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172 | ~_GEN_77) begin
      if (_GEN_59)
    ...
    if (_GEN_173)
      l2_array_14_is_vaddr <= ~_GEN_93 & (_GEN_77 ? io_tlb_req_resp_bits_miss : _GEN_146);
    else
      l2_array_14_is_vaddr <= _GEN_146;
    if (_GEN_60) begin
    ...
    else if (~_GEN_62 | ~(s2_tlb_update_index[4]) | ~_GEN_170 | _GEN_172
    ...
    if (_GEN_173)
      l2_array_15_is_vaddr <=
        ~_GEN_94 & ((&(s2_tlb_update_index[3:0])) ? io_tlb_req_resp_bits_miss : _GEN_147);
    else
      l2_array_15_is_vaddr <= _GEN_147;
