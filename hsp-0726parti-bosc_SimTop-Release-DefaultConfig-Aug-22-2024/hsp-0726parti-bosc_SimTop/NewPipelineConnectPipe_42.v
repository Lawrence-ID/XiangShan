...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_42(
  input          clock,
  input          reset,
  output         io_in_ready,
  input          io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpu_wflags = _RANDOM[5'h17][8];
        data_vpu_vma = _RANDOM[5'h17][24];
        data_vpu_vta = _RANDOM[5'h17][25];
        data_vpu_vsew = _RANDOM[5'h17][27:26];
        data_vpu_vlmul = _RANDOM[5'h17][30:28];
        data_vpu_vm = _RANDOM[5'h18][7];
        data_vpu_vstart = _RANDOM[5'h18][15:8];
        data_vpu_vuopIdx = {_RANDOM[5'h18][31:28], _RANDOM[5'h19][2:0]};
        data_vpu_isExt = _RANDOM[5'h1D][18];
        data_vpu_isNarrow = _RANDOM[5'h1D][19];
        data_vpu_isDstMask = _RANDOM[5'h1D][20];
        data_vpu_isOpMask = _RANDOM[5'h1D][21];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
