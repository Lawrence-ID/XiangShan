...
module Queue1_ChosenQBundle(
  ...
  output [6:0]  io_deq_bits_bits_task_tgtID,
  output [6:0]  io_deq_bits_bits_task_srcID,
  output [7:0]  io_deq_bits_bits_task_txnID,
  output [6:0]  io_deq_bits_bits_task_homeNID,
  output [7:0]  io_deq_bits_bits_task_dbID,
  output [6:0]  io_deq_bits_bits_task_fwdNID,
  output [7:0]  io_deq_bits_bits_task_fwdTxnID,
  output [5:0]  io_deq_bits_bits_task_chiOpcode,
  ...
  assign io_deq_bits_bits_task_tgtID = ram[221:215];
  assign io_deq_bits_bits_task_srcID = ram[228:222];
  assign io_deq_bits_bits_task_txnID = ram[236:229];
  assign io_deq_bits_bits_task_homeNID = ram[243:237];
  assign io_deq_bits_bits_task_dbID = ram[251:244];
  assign io_deq_bits_bits_task_fwdNID = ram[258:252];
  assign io_deq_bits_bits_task_fwdTxnID = ram[266:259];
  assign io_deq_bits_bits_task_chiOpcode = ram[272:267];
  assign io_deq_bits_bits_task_resp = ram[275:273];
  assign io_deq_bits_bits_task_fwdState = ram[278:276];
  assign io_deq_bits_bits_task_pCrdType = ram[282:279];
  assign io_deq_bits_bits_task_retToSrc = ram[283];
  assign io_deq_bits_bits_task_expCompAck = ram[284];
  assign io_deq_bits_bits_task_allowRetry = ram[285];
  assign io_deq_bits_bits_task_memAttr_allocate = ram[286];
  assign io_deq_bits_bits_task_memAttr_cacheable = ram[287];
  assign io_deq_bits_bits_task_memAttr_device = ram[288];
  assign io_deq_bits_bits_task_memAttr_ewa = ram[289];
  assign io_deq_bits_id = ram[311:310];
endmodule
