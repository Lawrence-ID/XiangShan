...
module SMSTrainFilter(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:498];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [8:0] i = 9'h0; i < 9'h1F3; i += 9'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_reorder_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[9'h31][2];
        ld_reorder_res_0_1_0_bits_uop_robIdx_value = _RANDOM[9'h31][10:3];
        ld_reorder_res_0_1_0_bits_vaddr =
          {_RANDOM[9'h44][31:26], _RANDOM[9'h45], _RANDOM[9'h46][2:0]};
        ld_reorder_res_0_1_0_bits_paddr = {_RANDOM[9'h46][31:3], _RANDOM[9'h47][6:0]};
        ld_reorder_res_0_1_1_valid = _RANDOM[9'h54][4];
        ld_reorder_res_0_1_1_bits_uop_pc = {_RANDOM[9'h55][31:5], _RANDOM[9'h56][13:0]};
        ld_reorder_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[9'h66][14];
        ld_reorder_res_0_1_1_bits_uop_robIdx_value = _RANDOM[9'h66][22:15];
        ld_reorder_res_0_1_1_bits_vaddr = {_RANDOM[9'h7A][31:6], _RANDOM[9'h7B][14:0]};
        ld_reorder_res_0_1_1_bits_paddr = {_RANDOM[9'h7B][31:15], _RANDOM[9'h7C][18:0]};
        ld_reorder_res_0_1_2_valid = _RANDOM[9'h89][16];
        ld_reorder_res_0_1_2_bits_uop_pc = {_RANDOM[9'h8A][31:17], _RANDOM[9'h8B][25:0]};
        ld_reorder_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[9'h9B][26];
        ld_reorder_res_0_1_2_bits_uop_robIdx_value =
          {_RANDOM[9'h9B][31:27], _RANDOM[9'h9C][2:0]};
        ld_reorder_res_0_1_2_bits_vaddr = {_RANDOM[9'hAF][31:18], _RANDOM[9'hB0][26:0]};
        ld_reorder_res_0_1_2_bits_paddr = {_RANDOM[9'hB0][31:27], _RANDOM[9'hB1][30:0]};
        ld_reorder_res_1_2_0_valid = _RANDOM[9'hBE][28];
        ld_reorder_res_1_2_0_bits_uop_pc =
          {_RANDOM[9'hBF][31:29], _RANDOM[9'hC0], _RANDOM[9'hC1][5:0]};
        ld_reorder_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[9'hD1][6];
        ld_reorder_res_1_2_0_bits_uop_robIdx_value = _RANDOM[9'hD1][14:7];
        ld_reorder_res_1_2_0_bits_vaddr =
          {_RANDOM[9'hE4][31:30], _RANDOM[9'hE5], _RANDOM[9'hE6][6:0]};
        ld_reorder_res_1_2_0_bits_paddr = {_RANDOM[9'hE6][31:7], _RANDOM[9'hE7][10:0]};
        ld_reorder_res_1_2_1_valid = _RANDOM[9'hF4][8];
        ld_reorder_res_1_2_1_bits_uop_pc = {_RANDOM[9'hF5][31:9], _RANDOM[9'hF6][17:0]};
        ld_reorder_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[9'h106][18];
        ld_reorder_res_1_2_1_bits_uop_robIdx_value = _RANDOM[9'h106][26:19];
        ld_reorder_res_1_2_1_bits_vaddr = {_RANDOM[9'h11A][31:10], _RANDOM[9'h11B][18:0]};
        ld_reorder_res_1_2_1_bits_paddr = {_RANDOM[9'h11B][31:19], _RANDOM[9'h11C][22:0]};
        ld_reorder_res_1_2_2_valid = _RANDOM[9'h129][20];
        ld_reorder_res_1_2_2_bits_uop_pc =
          {_RANDOM[9'h12A][31:21], _RANDOM[9'h12B][29:0]};
        ld_reorder_res_1_2_2_bits_vaddr = {_RANDOM[9'h14F][31:22], _RANDOM[9'h150][30:0]};
        ld_reorder_res_1_2_2_bits_paddr =
          {_RANDOM[9'h150][31], _RANDOM[9'h151], _RANDOM[9'h152][2:0]};
        ld_reorder_0_valid = _RANDOM[9'h15F][0];
        ld_reorder_0_bits_uop_pc = {_RANDOM[9'h160][31:1], _RANDOM[9'h161][9:0]};
        ld_reorder_0_bits_vaddr = {_RANDOM[9'h185][31:2], _RANDOM[9'h186][10:0]};
        ld_reorder_0_bits_paddr = {_RANDOM[9'h186][31:11], _RANDOM[9'h187][14:0]};
        ld_reorder_1_valid = _RANDOM[9'h194][12];
        ld_reorder_1_bits_uop_pc = {_RANDOM[9'h195][31:13], _RANDOM[9'h196][21:0]};
        ld_reorder_1_bits_vaddr = {_RANDOM[9'h1BA][31:14], _RANDOM[9'h1BB][22:0]};
        ld_reorder_1_bits_paddr = {_RANDOM[9'h1BB][31:23], _RANDOM[9'h1BC][26:0]};
        ld_reorder_2_valid = _RANDOM[9'h1C9][24];
        ld_reorder_2_bits_uop_pc =
          {_RANDOM[9'h1CA][31:25], _RANDOM[9'h1CB], _RANDOM[9'h1CC][1:0]};
        ld_reorder_2_bits_vaddr =
          {_RANDOM[9'h1EF][31:26], _RANDOM[9'h1F0], _RANDOM[9'h1F1][2:0]};
        ld_reorder_2_bits_paddr = {_RANDOM[9'h1F1][31:3], _RANDOM[9'h1F2][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_0_vaddr = 41'h0;
        entries_0_paddr = 36'h0;
