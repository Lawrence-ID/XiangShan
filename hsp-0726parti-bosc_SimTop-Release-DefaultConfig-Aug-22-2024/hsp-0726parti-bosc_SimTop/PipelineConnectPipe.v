...
module PipelineConnectPipe(
  ...
  always @(posedge clock) begin
    ...
    data_vpu_fpu_isReduction <= ~leftFire & data_vpu_fpu_isReduction;
    data_vpu_isMove <= ~leftFire & data_vpu_isMove;
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_vpu_frm = _RANDOM[5'hA][3:1];
        data_vpu_fpu_isFpToVecInst = _RANDOM[5'hA][4];
        data_vpu_fpu_isFP32Instr = _RANDOM[5'hA][5];
        data_vpu_fpu_isFP64Instr = _RANDOM[5'hA][6];
        data_vpu_fpu_isReduction = _RANDOM[5'hA][7];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'hA][8];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'hA][9];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'hA][10];
        data_vpu_vxrm = _RANDOM[5'hA][12:11];
        data_vpu_vmask =
          {_RANDOM[5'hA][31:21],
           _RANDOM[5'hB],
           _RANDOM[5'hC],
        ...
        data_vpu_isReverse = _RANDOM[5'hF][2];
        ...
        data_vpu_isMove = _RANDOM[5'hF][7];
