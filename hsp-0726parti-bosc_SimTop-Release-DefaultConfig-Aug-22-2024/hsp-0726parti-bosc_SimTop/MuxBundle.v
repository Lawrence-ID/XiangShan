...
module MuxBundle(
  ...
  input         io_in_5_valid,
  input  [35:0] io_in_5_bits_acquire_address,
  input  [7:0]  io_in_5_bits_vSetIdx,
  output        io_in_6_ready,
  input         io_in_6_valid,
  input  [35:0] io_in_6_bits_acquire_address,
  input  [7:0]  io_in_6_bits_vSetIdx,
  output        io_in_7_ready,
  input         io_in_7_valid,
  input  [35:0] io_in_7_bits_acquire_address,
  input  [7:0]  io_in_7_bits_vSetIdx,
  output        io_in_8_ready,
  input         io_in_8_valid,
  input  [35:0] io_in_8_bits_acquire_address,
  input  [7:0]  io_in_8_bits_vSetIdx,
  output        io_in_9_ready,
  input         io_in_9_valid,
  input  [35:0] io_in_9_bits_acquire_address,
