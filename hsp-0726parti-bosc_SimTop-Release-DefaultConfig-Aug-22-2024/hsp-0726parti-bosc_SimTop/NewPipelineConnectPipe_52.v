...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_52(
  input          clock,
  input          reset,
  output         io_in_ready,
  input          io_in_valid,
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_src_4 =
          {_RANDOM[6'h11][31:13],
           ...
           _RANDOM[6'h14],
           _RANDOM[6'h15][12:0]};
        data_imm = {_RANDOM[6'h15][31:13], _RANDOM[6'h16][12:0]};
        data_robIdx_flag = _RANDOM[6'h16][13];
        data_robIdx_value = _RANDOM[6'h16][21:14];
        data_pdest = {_RANDOM[6'h16][31:27], _RANDOM[6'h17][1:0]};
        data_vecWen = _RANDOM[6'h17][2];
        data_v0Wen = _RANDOM[6'h17][3];
        data_vpu_vill = _RANDOM[6'h17][4];
        data_vpu_vma = _RANDOM[6'h17][5];
        data_vpu_vta = _RANDOM[6'h17][6];
        data_vpu_vsew = _RANDOM[6'h17][8:7];
        data_vpu_vlmul = _RANDOM[6'h17][11:9];
        data_vpu_specVill = _RANDOM[6'h17][12];
        data_vpu_specVma = _RANDOM[6'h17][13];
        data_vpu_specVta = _RANDOM[6'h17][14];
        data_vpu_specVsew = _RANDOM[6'h17][16:15];
        data_vpu_specVlmul = _RANDOM[6'h17][19:17];
        data_vpu_vm = _RANDOM[6'h17][20];
        data_vpu_vstart = _RANDOM[6'h17][28:21];
        data_vpu_frm = _RANDOM[6'h17][31:29];
        data_vpu_fpu_isFpToVecInst = _RANDOM[6'h18][0];
        data_vpu_fpu_isFP32Instr = _RANDOM[6'h18][1];
        data_vpu_fpu_isFP64Instr = _RANDOM[6'h18][2];
        data_vpu_fpu_isReduction = _RANDOM[6'h18][3];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[6'h18][4];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[6'h18][5];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[6'h18][6];
        data_vpu_vxrm = _RANDOM[6'h18][8:7];
        data_vpu_vuopIdx = _RANDOM[6'h18][15:9];
        data_vpu_lastUop = _RANDOM[6'h18][16];
        data_vpu_vmask =
          {_RANDOM[6'h18][31:17],
           _RANDOM[6'h19],
           _RANDOM[6'h1A],
           _RANDOM[6'h1B],
           _RANDOM[6'h1C][16:0]};
        data_vpu_nf = _RANDOM[6'h1C][27:25];
        data_vpu_veew = _RANDOM[6'h1C][29:28];
        data_vpu_isReverse = _RANDOM[6'h1C][30];
        data_vpu_isExt = _RANDOM[6'h1C][31];
        data_vpu_isNarrow = _RANDOM[6'h1D][0];
        data_vpu_isDstMask = _RANDOM[6'h1D][1];
        data_vpu_isOpMask = _RANDOM[6'h1D][2];
        data_vpu_isMove = _RANDOM[6'h1D][3];
        data_vpu_isDependOldvd = _RANDOM[6'h1D][4];
        data_vpu_isWritePartVd = _RANDOM[6'h1D][5];
        data_ftqIdx_flag = _RANDOM[6'h1D][7];
        data_ftqIdx_value = _RANDOM[6'h1D][13:8];
        data_ftqOffset = _RANDOM[6'h1D][17:14];
        data_numLsElem = _RANDOM[6'h1D][22:18];
        data_sqIdx_flag = _RANDOM[6'h1D][23];
        data_sqIdx_value = _RANDOM[6'h1D][29:24];
        data_lqIdx_flag = _RANDOM[6'h1D][30];
        data_lqIdx_value = {_RANDOM[6'h1D][31], _RANDOM[6'h1E][5:0]};
        data_perfDebugInfo_eliminatedMove = _RANDOM[6'h1E][26];
        data_perfDebugInfo_renameTime =
          {_RANDOM[6'h1E][31:27], _RANDOM[6'h1F], _RANDOM[6'h20][26:0]};
        data_perfDebugInfo_dispatchTime =
          {_RANDOM[6'h20][31:27], _RANDOM[6'h21], _RANDOM[6'h22][26:0]};
        data_perfDebugInfo_enqRsTime =
          {_RANDOM[6'h22][31:27], _RANDOM[6'h23], _RANDOM[6'h24][26:0]};
        data_perfDebugInfo_selectTime =
          {_RANDOM[6'h24][31:27], _RANDOM[6'h25], _RANDOM[6'h26][26:0]};
        data_perfDebugInfo_issueTime =
          {_RANDOM[6'h26][31:27], _RANDOM[6'h27], _RANDOM[6'h28][26:0]};
        data_perfDebugInfo_writebackTime =
          {_RANDOM[6'h28][31:27], _RANDOM[6'h29], _RANDOM[6'h2A][26:0]};
        data_perfDebugInfo_runahead_checkpoint_id =
          {_RANDOM[6'h2A][31:27], _RANDOM[6'h2B], _RANDOM[6'h2C][26:0]};
        data_perfDebugInfo_tlbFirstReqTime =
          {_RANDOM[6'h2C][31:27], _RANDOM[6'h2D], _RANDOM[6'h2E][26:0]};
        data_perfDebugInfo_tlbRespTime =
          {_RANDOM[6'h2E][31:27], _RANDOM[6'h2F], _RANDOM[6'h30][26:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
