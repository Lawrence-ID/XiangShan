...
`endif // not def SYNTHESIS
module NewPipelineConnectPipe_60(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_robIdx_flag = _RANDOM[6'h14][15];
        data_uop_robIdx_value = _RANDOM[6'h14][23:16];
        data_uop_storeSetHit = _RANDOM[6'h27][0];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h27][1];
        data_uop_waitForRobIdx_value = _RANDOM[6'h27][9:2];
        data_uop_loadWaitBit = _RANDOM[6'h27][10];
        data_uop_loadWaitStrict = _RANDOM[6'h27][11];
        data_uop_lqIdx_flag = _RANDOM[6'h27][17];
        data_uop_lqIdx_value = _RANDOM[6'h27][24:18];
        data_uop_sqIdx_flag = _RANDOM[6'h27][25];
        data_uop_sqIdx_value = _RANDOM[6'h27][31:26];
        data_usSecondInv = _RANDOM[6'h28][7];
        data_mBIndex = _RANDOM[6'h28][11:8];
        data_elemIdx = _RANDOM[6'h28][19:12];
        data_elemIdxInsideVd = _RANDOM[6'h28][27:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
