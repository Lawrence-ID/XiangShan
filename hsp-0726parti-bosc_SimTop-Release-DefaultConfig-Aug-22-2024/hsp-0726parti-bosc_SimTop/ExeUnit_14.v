...
module ExeUnit_14(
  ...
  wire [6:0]   _in1ToN_io_out_2_bits_pdest;
  ...
  wire [127:0] _in1ToN_io_out_3_bits_src_0;
  wire [127:0] _in1ToN_io_out_3_bits_src_1;
  wire [127:0] _in1ToN_io_out_3_bits_src_2;
  wire [127:0] _in1ToN_io_out_3_bits_src_3;
  wire [127:0] _in1ToN_io_out_3_bits_src_4;
  wire         _in1ToN_io_out_3_bits_robIdx_flag;
  wire [7:0]   _in1ToN_io_out_3_bits_robIdx_value;
  wire [6:0]   _in1ToN_io_out_3_bits_pdest;
  wire         _in1ToN_io_out_3_bits_vecWen;
  wire         _in1ToN_io_out_3_bits_v0Wen;
  ...
  reg          fuVldVec_1_3;
  reg          fuVldVec_2_2;
  wire         fuVld_en_3 = io_in_valid | fuVldVec_1_3 | fuVldVec_2_2;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fuVld_en_reg_2 = _RANDOM[/*Zero width*/ 1'b0][8];
        fuVldVec_1_2 = _RANDOM[/*Zero width*/ 1'b0][10];
        fuVldVec_2_1 = _RANDOM[/*Zero width*/ 1'b0][11];
        fuVld_en_reg_3 = _RANDOM[/*Zero width*/ 1'b0][12];
        fuVldVec_1_3 = _RANDOM[/*Zero width*/ 1'b0][14];
        fuVldVec_2_2 = _RANDOM[/*Zero width*/ 1'b0][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  VIMacU Vimac (
    ...
    .io_in_bits_ctrl_pdest         ({1'h0, _in1ToN_io_out_2_bits_pdest}),
  ...
  VPPU Vppu (
    ...
    .io_in_bits_ctrl_pdest           ({1'h0, _in1ToN_io_out_3_bits_pdest}),
    .io_in_bits_ctrl_vecWen          (_in1ToN_io_out_3_bits_vecWen),
    .io_in_bits_ctrl_v0Wen           (_in1ToN_io_out_3_bits_v0Wen),
    ...
    .io_in_bits_data_src_3           (_in1ToN_io_out_3_bits_src_3),
  ...
  Dispatcher_14 in1ToN (
    ...
    .io_out_3_bits_src_3         (_in1ToN_io_out_3_bits_src_3),
    ...
    .io_out_3_bits_vecWen        (_in1ToN_io_out_3_bits_vecWen),
    .io_out_3_bits_v0Wen         (_in1ToN_io_out_3_bits_v0Wen),
