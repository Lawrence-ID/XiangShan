...
module RRArbiter_4(
  ...
  input  [6:0]  io_in_0_bits_fwdNID,
  input  [7:0]  io_in_0_bits_fwdTxnID,
  ...
  input  [6:0]  io_in_1_bits_fwdNID,
  input  [7:0]  io_in_1_bits_fwdTxnID,
  ...
  input  [6:0]  io_in_2_bits_fwdNID,
  input  [7:0]  io_in_2_bits_fwdTxnID,
  ...
  input  [6:0]  io_in_3_bits_srcID,
  input  [7:0]  io_in_3_bits_txnID,
  input  [6:0]  io_in_3_bits_homeNID,
  input  [7:0]  io_in_3_bits_dbID,
  input  [6:0]  io_in_3_bits_fwdNID,
  input  [7:0]  io_in_3_bits_fwdTxnID,
  ...
  wire [3:0][7:0]  _GEN_58 =
    {{io_in_3_bits_dbID}, {io_in_2_bits_dbID}, {io_in_1_bits_dbID}, {io_in_0_bits_dbID}};
  ...
  wire [3:0][7:0]  _GEN_60 =
    {{io_in_3_bits_fwdTxnID},
     {io_in_2_bits_fwdTxnID},
     {io_in_1_bits_fwdTxnID},
     {io_in_0_bits_fwdTxnID}};
  ...
  wire [3:0][2:0]  _GEN_62 =
    {{io_in_3_bits_resp}, {io_in_2_bits_resp}, {io_in_1_bits_resp}, {io_in_0_bits_resp}};
  wire [3:0][2:0]  _GEN_63 =
    {{io_in_3_bits_fwdState},
     {io_in_2_bits_fwdState},
     {io_in_1_bits_fwdState},
     {io_in_0_bits_fwdState}};
  wire [3:0][3:0]  _GEN_64 =
  ...
  assign io_chosen_choice =
    ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : ctrl_validMask_3 ? 2'h3 : _GEN_72;
  always @(posedge clock) begin
    if (io_out_ready & io_out_valid_0) begin
      if (ctrl_validMask_1)
        ...
        ctrl_validMask_grantMask_lastGrant <= _GEN_72;
    end
  end // always @(posedge)
  ...
  assign io_out_bits_aliasTask = _GEN_16[io_chosen_choice];
  assign io_out_bits_useProbeData = _GEN_17[io_chosen_choice];
  assign io_out_bits_mshrRetry = _GEN_18[io_chosen_choice];
  assign io_out_bits_fromL2pft = _GEN_19[io_chosen_choice];
  assign io_out_bits_needHint = _GEN_20[io_chosen_choice];
  assign io_out_bits_dirty = _GEN_21[io_chosen_choice];
  assign io_out_bits_way = _GEN_22[io_chosen_choice];
  assign io_out_bits_meta_dirty = _GEN_23[io_chosen_choice];
  assign io_out_bits_meta_state = _GEN_24[io_chosen_choice];
  assign io_out_bits_meta_clients = _GEN_25[io_chosen_choice];
  assign io_out_bits_meta_alias = _GEN_26[io_chosen_choice];
  assign io_out_bits_meta_prefetch = _GEN_27[io_chosen_choice];
  assign io_out_bits_meta_prefetchSrc = _GEN_28[io_chosen_choice];
  assign io_out_bits_meta_accessed = _GEN_29[io_chosen_choice];
  assign io_out_bits_metaWen = _GEN_30[io_chosen_choice];
  assign io_out_bits_tagWen = _GEN_31[io_chosen_choice];
  assign io_out_bits_dsWen = _GEN_32[io_chosen_choice];
  assign io_out_bits_wayMask = _GEN_33[io_chosen_choice];
  assign io_out_bits_replTask = _GEN_34[io_chosen_choice];
  assign io_out_bits_reqSource = _GEN_35[io_chosen_choice];
  assign io_out_bits_mergeA = _GEN_36[io_chosen_choice];
  assign io_out_bits_aMergeTask_off = _GEN_37[io_chosen_choice];
  assign io_out_bits_aMergeTask_alias = _GEN_38[io_chosen_choice];
  assign io_out_bits_aMergeTask_vaddr = _GEN_39[io_chosen_choice];
  assign io_out_bits_aMergeTask_isKeyword = _GEN_40[io_chosen_choice];
  assign io_out_bits_aMergeTask_opcode = _GEN_41[io_chosen_choice];
  assign io_out_bits_aMergeTask_param = _GEN_42[io_chosen_choice];
  assign io_out_bits_aMergeTask_sourceId = _GEN_43[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_dirty = _GEN_44[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_state = _GEN_45[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_clients = _GEN_46[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_alias = _GEN_47[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_prefetch = _GEN_48[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_prefetchSrc = _GEN_49[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_accessed = _GEN_50[io_chosen_choice];
  assign io_out_bits_snpHitRelease = _GEN_51[io_chosen_choice];
  assign io_out_bits_snpHitReleaseWithData = _GEN_52[io_chosen_choice];
  assign io_out_bits_snpHitReleaseIdx = _GEN_53[io_chosen_choice];
  assign io_out_bits_tgtID = _GEN_54[io_chosen_choice];
  assign io_out_bits_srcID = _GEN_55[io_chosen_choice];
  assign io_out_bits_txnID = _GEN_56[io_chosen_choice];
  assign io_out_bits_homeNID = _GEN_57[io_chosen_choice];
  assign io_out_bits_dbID = _GEN_58[io_chosen_choice];
  assign io_out_bits_fwdNID = _GEN_59[io_chosen_choice];
  assign io_out_bits_fwdTxnID = _GEN_60[io_chosen_choice];
  assign io_out_bits_chiOpcode = _GEN_61[io_chosen_choice];
  assign io_out_bits_resp = _GEN_62[io_chosen_choice];
  assign io_out_bits_fwdState = _GEN_63[io_chosen_choice];
  assign io_out_bits_pCrdType = _GEN_64[io_chosen_choice];
  assign io_out_bits_retToSrc = _GEN_65[io_chosen_choice];
  assign io_out_bits_expCompAck = _GEN_66[io_chosen_choice];
  assign io_out_bits_allowRetry = _GEN_67[io_chosen_choice];
  assign io_out_bits_memAttr_allocate = _GEN_68[io_chosen_choice];
  assign io_out_bits_memAttr_cacheable = _GEN_69[io_chosen_choice];
  assign io_out_bits_memAttr_device = _GEN_70[io_chosen_choice];
  assign io_out_bits_memAttr_ewa = _GEN_71[io_chosen_choice];
endmodule
