...
module ICache(
  ...
  input  [40:0]  io_prefetch_req_bits_startAddr,
  input  [40:0]  io_prefetch_req_bits_nextlineStart,
  input          io_prefetch_req_bits_ftqIdx_flag,
  input  [5:0]   io_prefetch_req_bits_ftqIdx_value,
  input          io_prefetch_flushFromBpu_s2_valid,
  input          io_prefetch_flushFromBpu_s2_bits_flag,
  input  [5:0]   io_prefetch_flushFromBpu_s2_bits_value,
  input          io_prefetch_flushFromBpu_s3_valid,
  input          io_prefetch_flushFromBpu_s3_bits_flag,
  input  [5:0]   io_prefetch_flushFromBpu_s3_bits_value,
  input          io_stop,
  ...
  output [35:0]  io_pmp_3_req_bits_addr,
  input          io_pmp_3_resp_instr,
  output         io_itlb_0_req_valid,
  output [40:0]  io_itlb_0_req_bits_vaddr,
  input  [35:0]  io_itlb_0_resp_bits_paddr_0,
  input  [40:0]  io_itlb_0_resp_bits_gpaddr_0,
  ...
  output [40:0]  io_itlb_1_req_bits_vaddr,
  input  [35:0]  io_itlb_1_resp_bits_paddr_0,
  input  [40:0]  io_itlb_1_resp_bits_gpaddr_0,
  ...
  wire [23:0]  _wayLookup_io_read_bits_entry_ptag_0;
  wire [23:0]  _wayLookup_io_read_bits_entry_ptag_1;
  wire         _wayLookup_io_read_bits_entry_excp_tlb_af_0;
  wire         _wayLookup_io_read_bits_entry_excp_tlb_af_1;
  wire         _wayLookup_io_read_bits_entry_excp_tlb_pf_0;
  wire         _wayLookup_io_read_bits_entry_excp_tlb_pf_1;
  wire         _wayLookup_io_read_bits_entry_meta_errors_0;
  wire         _wayLookup_io_read_bits_entry_meta_errors_1;
  wire         _wayLookup_io_read_bits_gpf_excp_tlb_gpf_0;
  wire         _wayLookup_io_read_bits_gpf_excp_tlb_gpf_1;
  wire [40:0]  _wayLookup_io_read_bits_gpf_gpaddr;
  ...
  wire [29:0]  _prefetcher_io_MSHRReq_bits_blkPaddr;
  ...
  wire [23:0]  _prefetcher_io_wayLookupWrite_bits_entry_ptag_0;
  wire [23:0]  _prefetcher_io_wayLookupWrite_bits_entry_ptag_1;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_0;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_1;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_0;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_1;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_meta_errors_0;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_meta_errors_1;
  wire         _prefetcher_io_wayLookupWrite_bits_gpf_excp_tlb_gpf_0;
  wire         _prefetcher_io_wayLookupWrite_bits_gpf_excp_tlb_gpf_1;
  wire [40:0]  _prefetcher_io_wayLookupWrite_bits_gpf_gpaddr;
  wire [1:0]   _replacer_io_victim_way;
  wire         _missUnit_io_fetch_req_ready;
  wire         _missUnit_io_fetch_resp_valid;
  wire [29:0]  _missUnit_io_fetch_resp_bits_blkPaddr;
  ...
  wire [23:0]  _missUnit_io_meta_write_bits_phyTag;
  ...
  wire [23:0]  _metaArray_io_readResp_metaData_0_0_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_0_1_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_0_2_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_0_3_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_1_0_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_1_1_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_1_2_tag;
  wire [23:0]  _metaArray_io_readResp_metaData_1_3_tag;
  wire         _metaArray_io_readResp_errors_0_0;
  wire         _metaArray_io_readResp_errors_0_1;
  wire         _metaArray_io_readResp_errors_0_2;
  wire         _metaArray_io_readResp_errors_0_3;
  wire         _metaArray_io_readResp_errors_1_0;
  wire         _metaArray_io_readResp_errors_1_1;
  wire         _metaArray_io_readResp_errors_1_2;
  wire         _metaArray_io_readResp_errors_1_3;
    ...
    if (reset) begin
      ...
      if (errors_valid) begin
        io_error_bits_r_paddr <=
          (_mainPipe_io_errors_0_valid ? _mainPipe_io_errors_0_bits_paddr : 36'h0)
          | (_mainPipe_io_errors_1_valid ? _mainPipe_io_errors_1_bits_paddr : 36'h0);
        io_error_bits_r_report_to_beu <=
          _mainPipe_io_errors_0_valid & _mainPipe_io_errors_0_bits_report_to_beu
          | _mainPipe_io_errors_1_valid & _mainPipe_io_errors_1_bits_report_to_beu;
      end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_error_bits_r_paddr = {_RANDOM[1'h0][31:9], _RANDOM[1'h1][12:0]};
        io_error_bits_r_report_to_beu = _RANDOM[1'h1][13];
        io_error_valid_REG = _RANDOM[1'h1][14];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        io_error_bits_r_paddr = 36'h0;
        io_error_bits_r_report_to_beu = 1'h0;
  ...
  ICacheMetaArray metaArray (
    .clock                        (clock),
    .reset                        (reset),
    .io_write_valid               (_missUnit_io_meta_write_valid),
    .io_write_bits_virIdx         (_missUnit_io_meta_write_bits_virIdx),
    .io_write_bits_phyTag         (_missUnit_io_meta_write_bits_phyTag),
    .io_write_bits_waymask        (_missUnit_io_meta_write_bits_waymask),
    .io_write_bits_bankIdx        (_missUnit_io_meta_write_bits_bankIdx),
    .io_read_ready                (_metaArray_io_read_ready),
    .io_read_valid                (_prefetcher_io_metaRead_toIMeta_valid),
    .io_read_bits_vSetIdx_0       (_prefetcher_io_metaRead_toIMeta_bits_vSetIdx_0),
    .io_read_bits_vSetIdx_1       (_prefetcher_io_metaRead_toIMeta_bits_vSetIdx_1),
    .io_read_bits_isDoubleLine    (_prefetcher_io_metaRead_toIMeta_bits_isDoubleLine),
    .io_readResp_metaData_0_0_tag (_metaArray_io_readResp_metaData_0_0_tag),
    .io_readResp_metaData_0_1_tag (_metaArray_io_readResp_metaData_0_1_tag),
    .io_readResp_metaData_0_2_tag (_metaArray_io_readResp_metaData_0_2_tag),
    .io_readResp_metaData_0_3_tag (_metaArray_io_readResp_metaData_0_3_tag),
    .io_readResp_metaData_1_0_tag (_metaArray_io_readResp_metaData_1_0_tag),
    .io_readResp_metaData_1_1_tag (_metaArray_io_readResp_metaData_1_1_tag),
    .io_readResp_metaData_1_2_tag (_metaArray_io_readResp_metaData_1_2_tag),
    .io_readResp_metaData_1_3_tag (_metaArray_io_readResp_metaData_1_3_tag),
    .io_readResp_errors_0_0       (_metaArray_io_readResp_errors_0_0),
    .io_readResp_errors_0_1       (_metaArray_io_readResp_errors_0_1),
    .io_readResp_errors_0_2       (_metaArray_io_readResp_errors_0_2),
    .io_readResp_errors_0_3       (_metaArray_io_readResp_errors_0_3),
    .io_readResp_errors_1_0       (_metaArray_io_readResp_errors_1_0),
    .io_readResp_errors_1_1       (_metaArray_io_readResp_errors_1_1),
    .io_readResp_errors_1_2       (_metaArray_io_readResp_errors_1_2),
    .io_readResp_errors_1_3       (_metaArray_io_readResp_errors_1_3),
  ...
  ICacheDataArray dataArray (
    .clock                      (clock),
    .reset                      (reset),
    .io_write_valid             (_missUnit_io_data_write_valid),
    .io_write_bits_virIdx       (_missUnit_io_data_write_bits_virIdx),
    .io_write_bits_data         (_missUnit_io_data_write_bits_data),
    .io_write_bits_waymask      (_missUnit_io_data_write_bits_waymask),
  ...
  ICacheMainPipe mainPipe (
    .clock                                       (clock),
    .reset                                       (reset),
    .io_dataArray_toIData_0_valid                (_mainPipe_io_dataArray_toIData_0_valid),
    ...
    .io_dataArray_toIData_1_valid                (_mainPipe_io_dataArray_toIData_1_valid),
    ...
    .io_dataArray_toIData_2_valid                (_mainPipe_io_dataArray_toIData_2_valid),
    ...
    .io_dataArray_toIData_3_valid                (_mainPipe_io_dataArray_toIData_3_valid),
    ...
    .io_wayLookupRead_bits_entry_excp_tlb_af_0
      (_wayLookup_io_read_bits_entry_excp_tlb_af_0),
    .io_wayLookupRead_bits_entry_excp_tlb_af_1
      (_wayLookup_io_read_bits_entry_excp_tlb_af_1),
    .io_wayLookupRead_bits_entry_excp_tlb_pf_0
      (_wayLookup_io_read_bits_entry_excp_tlb_pf_0),
    .io_wayLookupRead_bits_entry_excp_tlb_pf_1
      (_wayLookup_io_read_bits_entry_excp_tlb_pf_1),
    .io_wayLookupRead_bits_entry_meta_errors_0
      (_wayLookup_io_read_bits_entry_meta_errors_0),
    .io_wayLookupRead_bits_entry_meta_errors_1
      (_wayLookup_io_read_bits_entry_meta_errors_1),
    .io_wayLookupRead_bits_gpf_excp_tlb_gpf_0
      (_wayLookup_io_read_bits_gpf_excp_tlb_gpf_0),
    .io_wayLookupRead_bits_gpf_excp_tlb_gpf_1
      (_wayLookup_io_read_bits_gpf_excp_tlb_gpf_1),
    ...
    .io_fetch_resp_0_bits_tlbExcp_pageFault      (io_fetch_resp_0_bits_tlbExcp_pageFault),
    .io_fetch_resp_0_bits_tlbExcp_guestPageFault
      (io_fetch_resp_0_bits_tlbExcp_guestPageFault),
    .io_fetch_resp_0_bits_tlbExcp_accessFault
      (io_fetch_resp_0_bits_tlbExcp_accessFault),
    .io_fetch_resp_0_bits_tlbExcp_mmio           (io_fetch_resp_0_bits_tlbExcp_mmio),
    .io_fetch_resp_1_valid                       (io_fetch_resp_1_valid),
    .io_fetch_resp_1_bits_vaddr                  (io_fetch_resp_1_bits_vaddr),
    .io_fetch_resp_1_bits_tlbExcp_pageFault      (io_fetch_resp_1_bits_tlbExcp_pageFault),
    .io_fetch_resp_1_bits_tlbExcp_guestPageFault
      (io_fetch_resp_1_bits_tlbExcp_guestPageFault),
    .io_fetch_resp_1_bits_tlbExcp_accessFault
      (io_fetch_resp_1_bits_tlbExcp_accessFault),
  ...
  IPrefetchPipe prefetcher (
    ...
    .reset                                      (reset),
    .io_flush                                   (io_flush),
    .io_ftqReq_req_ready                        (io_prefetch_req_ready),
    .io_ftqReq_req_valid                        (io_prefetch_req_valid),
    .io_ftqReq_req_bits_startAddr               (io_prefetch_req_bits_startAddr),
    .io_ftqReq_req_bits_nextlineStart           (io_prefetch_req_bits_nextlineStart),
    .io_ftqReq_req_bits_ftqIdx_flag             (io_prefetch_req_bits_ftqIdx_flag),
    .io_ftqReq_req_bits_ftqIdx_value            (io_prefetch_req_bits_ftqIdx_value),
    .io_ftqReq_flushFromBpu_s2_valid            (io_prefetch_flushFromBpu_s2_valid),
    .io_ftqReq_flushFromBpu_s2_bits_flag        (io_prefetch_flushFromBpu_s2_bits_flag),
    .io_ftqReq_flushFromBpu_s2_bits_value       (io_prefetch_flushFromBpu_s2_bits_value),
    .io_ftqReq_flushFromBpu_s3_valid            (io_prefetch_flushFromBpu_s3_valid),
    .io_ftqReq_flushFromBpu_s3_bits_flag        (io_prefetch_flushFromBpu_s3_bits_flag),
    .io_ftqReq_flushFromBpu_s3_bits_value       (io_prefetch_flushFromBpu_s3_bits_value),
    ...
    .io_metaRead_toIMeta_ready                  (_metaArray_io_read_ready),
    .io_metaRead_toIMeta_valid                  (_prefetcher_io_metaRead_toIMeta_valid),
    ...
    .io_metaRead_fromIMeta_metaData_0_0_tag     (_metaArray_io_readResp_metaData_0_0_tag),
    .io_metaRead_fromIMeta_metaData_0_1_tag     (_metaArray_io_readResp_metaData_0_1_tag),
    .io_metaRead_fromIMeta_metaData_0_2_tag     (_metaArray_io_readResp_metaData_0_2_tag),
    .io_metaRead_fromIMeta_metaData_0_3_tag     (_metaArray_io_readResp_metaData_0_3_tag),
    .io_metaRead_fromIMeta_metaData_1_0_tag     (_metaArray_io_readResp_metaData_1_0_tag),
    .io_metaRead_fromIMeta_metaData_1_1_tag     (_metaArray_io_readResp_metaData_1_1_tag),
    .io_metaRead_fromIMeta_metaData_1_2_tag     (_metaArray_io_readResp_metaData_1_2_tag),
    .io_metaRead_fromIMeta_metaData_1_3_tag     (_metaArray_io_readResp_metaData_1_3_tag),
    .io_metaRead_fromIMeta_errors_0_0           (_metaArray_io_readResp_errors_0_0),
    .io_metaRead_fromIMeta_errors_0_1           (_metaArray_io_readResp_errors_0_1),
    .io_metaRead_fromIMeta_errors_0_2           (_metaArray_io_readResp_errors_0_2),
    .io_metaRead_fromIMeta_errors_0_3           (_metaArray_io_readResp_errors_0_3),
    .io_metaRead_fromIMeta_errors_1_0           (_metaArray_io_readResp_errors_1_0),
    .io_metaRead_fromIMeta_errors_1_1           (_metaArray_io_readResp_errors_1_1),
    .io_metaRead_fromIMeta_errors_1_2           (_metaArray_io_readResp_errors_1_2),
    .io_metaRead_fromIMeta_errors_1_3           (_metaArray_io_readResp_errors_1_3),
    .io_metaRead_fromIMeta_entryValid_0_0       (_metaArray_io_readResp_entryValid_0_0),
    .io_metaRead_fromIMeta_entryValid_0_1       (_metaArray_io_readResp_entryValid_0_1),
    .io_metaRead_fromIMeta_entryValid_0_2       (_metaArray_io_readResp_entryValid_0_2),
    .io_metaRead_fromIMeta_entryValid_0_3       (_metaArray_io_readResp_entryValid_0_3),
    .io_metaRead_fromIMeta_entryValid_1_0       (_metaArray_io_readResp_entryValid_1_0),
    .io_metaRead_fromIMeta_entryValid_1_1       (_metaArray_io_readResp_entryValid_1_1),
    .io_metaRead_fromIMeta_entryValid_1_2       (_metaArray_io_readResp_entryValid_1_2),
    .io_metaRead_fromIMeta_entryValid_1_3       (_metaArray_io_readResp_entryValid_1_3),
    ...
    .io_MSHRResp_bits_blkPaddr                  (_missUnit_io_fetch_resp_bits_blkPaddr),
    ...
    .io_wayLookupWrite_bits_entry_excp_tlb_af_0
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_0),
    .io_wayLookupWrite_bits_entry_excp_tlb_af_1
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_1),
    .io_wayLookupWrite_bits_entry_excp_tlb_pf_0
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_0),
    .io_wayLookupWrite_bits_entry_excp_tlb_pf_1
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_1),
    .io_wayLookupWrite_bits_entry_meta_errors_0
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_errors_0),
    .io_wayLookupWrite_bits_entry_meta_errors_1
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_errors_1),
    .io_wayLookupWrite_bits_gpf_excp_tlb_gpf_0
      (_prefetcher_io_wayLookupWrite_bits_gpf_excp_tlb_gpf_0),
    .io_wayLookupWrite_bits_gpf_excp_tlb_gpf_1
      (_prefetcher_io_wayLookupWrite_bits_gpf_excp_tlb_gpf_1),
  ...
  WayLookup wayLookup (
    ...
    .io_read_bits_entry_excp_tlb_af_0  (_wayLookup_io_read_bits_entry_excp_tlb_af_0),
    .io_read_bits_entry_excp_tlb_af_1  (_wayLookup_io_read_bits_entry_excp_tlb_af_1),
    .io_read_bits_entry_excp_tlb_pf_0  (_wayLookup_io_read_bits_entry_excp_tlb_pf_0),
    .io_read_bits_entry_excp_tlb_pf_1  (_wayLookup_io_read_bits_entry_excp_tlb_pf_1),
    .io_read_bits_entry_meta_errors_0  (_wayLookup_io_read_bits_entry_meta_errors_0),
    .io_read_bits_entry_meta_errors_1  (_wayLookup_io_read_bits_entry_meta_errors_1),
    .io_read_bits_gpf_excp_tlb_gpf_0   (_wayLookup_io_read_bits_gpf_excp_tlb_gpf_0),
    .io_read_bits_gpf_excp_tlb_gpf_1   (_wayLookup_io_read_bits_gpf_excp_tlb_gpf_1),
    ...
    .io_write_bits_entry_waymask_1
      (_prefetcher_io_wayLookupWrite_bits_entry_waymask_1),
    .io_write_bits_entry_ptag_0        (_prefetcher_io_wayLookupWrite_bits_entry_ptag_0),
    .io_write_bits_entry_ptag_1        (_prefetcher_io_wayLookupWrite_bits_entry_ptag_1),
    .io_write_bits_entry_excp_tlb_af_0
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_0),
    .io_write_bits_entry_excp_tlb_af_1
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_af_1),
    .io_write_bits_entry_excp_tlb_pf_0
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_0),
    .io_write_bits_entry_excp_tlb_pf_1
      (_prefetcher_io_wayLookupWrite_bits_entry_excp_tlb_pf_1),
