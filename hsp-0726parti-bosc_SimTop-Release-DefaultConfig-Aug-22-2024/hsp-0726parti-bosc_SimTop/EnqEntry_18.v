  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_rfWen = _RANDOM[6'hC][5];
        entryReg_payload_fpWen = _RANDOM[6'hC][6];
        entryReg_payload_vecWen = _RANDOM[6'hC][7];
        entryReg_payload_v0Wen = _RANDOM[6'hC][8];
        entryReg_payload_vlWen = _RANDOM[6'hC][9];
        entryReg_payload_selImm = _RANDOM[6'hC][18:15];
        entryReg_payload_fpu_wflags = _RANDOM[6'hD][23];
        entryReg_payload_vpu_vma = _RANDOM[6'hE][7];
        entryReg_payload_vpu_vta = _RANDOM[6'hE][8];
        entryReg_payload_vpu_vsew = _RANDOM[6'hE][10:9];
        entryReg_payload_vpu_vlmul = _RANDOM[6'hE][13:11];
        entryReg_payload_vpu_vm = _RANDOM[6'hE][22];
        entryReg_payload_vpu_vstart = _RANDOM[6'hE][30:23];
        entryReg_payload_vpu_fpu_isFoldTo1_2 = _RANDOM[6'hF][6];
        entryReg_payload_vpu_fpu_isFoldTo1_4 = _RANDOM[6'hF][7];
        entryReg_payload_vpu_fpu_isFoldTo1_8 = _RANDOM[6'hF][8];
        entryReg_payload_vpu_isExt = _RANDOM[6'h14][1];
        entryReg_payload_vpu_isNarrow = _RANDOM[6'h14][2];
        entryReg_payload_vpu_isDstMask = _RANDOM[6'h14][3];
        entryReg_payload_vpu_isOpMask = _RANDOM[6'h14][4];
        entryReg_payload_vpu_isDependOldvd = _RANDOM[6'h14][6];
        entryReg_payload_vpu_isWritePartVd = _RANDOM[6'h14][7];
        entryReg_payload_uopIdx = _RANDOM[6'h14][17:11];
        entryReg_payload_lastUop = _RANDOM[6'h14][20];
        entryReg_payload_pdest = _RANDOM[6'h17][24:17];
        enqDelayValidReg_last_REG = _RANDOM[6'h2B][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
