...
module FPToVecDecoder(
  ...
  output        io_vpuCtrl_fpu_isFP32Instr,
  output        io_vpuCtrl_fpu_isFP64Instr,
  ...
  assign io_vpuCtrl_fpu_isFP32Instr = isFP32Instr;
  assign io_vpuCtrl_fpu_isFP64Instr =
    _GEN == 14'hD3 | _GEN == 14'h2D3 | _GEN_0 == 17'h14553 | _GEN_0 == 17'h144D3
    | _GEN_0 == 17'h14453 | _GEN_0 == 17'h5453 | _GEN_0 == 17'h54D3 | _GEN == 14'h4D3
    | _GEN == 14'h6D3 | _GEN_1 == 19'h2D053 | _GEN_2 == 9'hC3 | _GEN_2 == 9'hC7
    | _GEN_2 == 9'hCF | _GEN_2 == 9'hCB | _GEN_3 == 22'h3880D3 | _GEN_0 == 17'h4453
    | _GEN_0 == 17'h4553 | _GEN_0 == 17'h44D3;
