...
module TrainFilter_1(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:495];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [8:0] i = 9'h0; i < 9'h1F0; i += 9'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[9'h21][22];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[9'h21][30:23];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[9'h35][31:14], _RANDOM[9'h36][22:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[9'h44][24];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[9'h57][2];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[9'h57][10:3];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[9'h6A][31:26], _RANDOM[9'h6B], _RANDOM[9'h6C][2:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[9'h7A][4];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[9'h8C][14];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[9'h8C][22:15];
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[9'hA0][31:6], _RANDOM[9'hA1][14:0]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[9'hAF][16];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[9'hC1][26];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value =
          {_RANDOM[9'hC1][31:27], _RANDOM[9'hC2][2:0]};
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[9'hD5][31:18], _RANDOM[9'hD6][26:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[9'hE4][28];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[9'hF7][6];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[9'hF7][14:7];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[9'h10A][31:30], _RANDOM[9'h10B], _RANDOM[9'h10C][6:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[9'h11A][8];
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[9'h140][31:10], _RANDOM[9'h141][18:0]};
        ld_in_reordered_0_valid = _RANDOM[9'h14F][20];
        ld_in_reordered_0_bits_vaddr = {_RANDOM[9'h175][31:22], _RANDOM[9'h176][30:0]};
        ld_in_reordered_1_valid = _RANDOM[9'h185][0];
        ld_in_reordered_1_bits_vaddr = {_RANDOM[9'h1AB][31:2], _RANDOM[9'h1AC][10:0]};
        ld_in_reordered_2_valid = _RANDOM[9'h1BA][12];
        ld_in_reordered_2_bits_vaddr = {_RANDOM[9'h1E0][31:14], _RANDOM[9'h1E1][22:0]};
        REG = _RANDOM[9'h1EF][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
