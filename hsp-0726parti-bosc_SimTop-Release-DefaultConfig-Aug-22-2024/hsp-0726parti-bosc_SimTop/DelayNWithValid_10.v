  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_paddr = {_RANDOM[2'h0][31:10], _RANDOM[2'h1][13:0]};
        data_report_to_beu = _RANDOM[2'h1][14];
        valid_REG_1 = _RANDOM[2'h1][15];
        res_bits_paddr = {_RANDOM[2'h1][31:25], _RANDOM[2'h2][28:0]};
        res_bits_report_to_beu = _RANDOM[2'h2][29];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valid_REG = 1'h0;
        valid_REG_1 = 1'h0;
