...
module VSipModule(
  ...
  wire [61:0] originIP;
  wire [61:0] _GEN =
    {50'h0, hideleg_LCOFI, 2'h0, hideleg_VSEI, 3'h0, hideleg_VSTI, 3'h0, hideleg_VSSI};
  assign originIP =
  ...
  assign toMip_LCOFIP_valid = w_wen & mideleg_LCOFI & hideleg_LCOFI;
  assign toMip_LCOFIP_bits = w_wdata[13];
  assign toMvip_LCOFIP_valid = w_wen & ~mideleg_LCOFI & hideleg_LCOFI & mvien_LCOFIE;
  assign toMvip_LCOFIP_bits = w_wdata[13];
  assign toHvip_VSSIP_valid = w_wen & hideleg_VSSI;
  assign toHvip_VSSIP_bits = w_wdata[1];
  assign toHvip_LCOFIP_valid = w_wen & ~hideleg_LCOFI & mvien_LCOFIE;
  assign toHvip_LCOFIP_bits = w_wdata[13];
  assign toHvip_LC14IP_valid = w_wen & mvien_LC14IE;
  assign toHvip_LC14IP_bits = w_wdata[14];
  assign toHvip_LC15IP_valid = w_wen & mvien_LC15IE;
  assign toHvip_LC15IP_bits = w_wdata[15];
  assign toHvip_LC16IP_valid = w_wen & mvien_LC16IE;
  assign toHvip_LC16IP_bits = w_wdata[16];
  assign toHvip_LC17IP_valid = w_wen & mvien_LC17IE;
  assign toHvip_LC17IP_bits = w_wdata[17];
  assign toHvip_LC18IP_valid = w_wen & mvien_LC18IE;
  assign toHvip_LC18IP_bits = w_wdata[18];
  assign toHvip_LC19IP_valid = w_wen & mvien_LC19IE;
  assign toHvip_LC19IP_bits = w_wdata[19];
  assign toHvip_LC20IP_valid = w_wen & mvien_LC20IE;
  assign toHvip_LC20IP_bits = w_wdata[20];
  assign toHvip_LC21IP_valid = w_wen & mvien_LC21IE;
  assign toHvip_LC21IP_bits = w_wdata[21];
  assign toHvip_LC22IP_valid = w_wen & mvien_LC22IE;
  assign toHvip_LC22IP_bits = w_wdata[22];
  assign toHvip_LC23IP_valid = w_wen & mvien_LC23IE;
  assign toHvip_LC23IP_bits = w_wdata[23];
  assign toHvip_LC24IP_valid = w_wen & mvien_LC24IE;
  assign toHvip_LC24IP_bits = w_wdata[24];
  assign toHvip_LC25IP_valid = w_wen & mvien_LC25IE;
  assign toHvip_LC25IP_bits = w_wdata[25];
  assign toHvip_LC26IP_valid = w_wen & mvien_LC26IE;
  assign toHvip_LC26IP_bits = w_wdata[26];
  assign toHvip_LC27IP_valid = w_wen & mvien_LC27IE;
  assign toHvip_LC27IP_bits = w_wdata[27];
  assign toHvip_LC28IP_valid = w_wen & mvien_LC28IE;
  assign toHvip_LC28IP_bits = w_wdata[28];
  assign toHvip_LC29IP_valid = w_wen & mvien_LC29IE;
  assign toHvip_LC29IP_bits = w_wdata[29];
  assign toHvip_LC30IP_valid = w_wen & mvien_LC30IE;
  assign toHvip_LC30IP_bits = w_wdata[30];
  assign toHvip_LC31IP_valid = w_wen & mvien_LC31IE;
  assign toHvip_LC31IP_bits = w_wdata[31];
  assign toHvip_LC32IP_valid = w_wen & mvien_LC32IE;
  assign toHvip_LC32IP_bits = w_wdata[32];
  assign toHvip_LC33IP_valid = w_wen & mvien_LC33IE;
  assign toHvip_LC33IP_bits = w_wdata[33];
  assign toHvip_LC34IP_valid = w_wen & mvien_LC34IE;
  assign toHvip_LC34IP_bits = w_wdata[34];
  assign toHvip_LPRASEIP_valid = w_wen & mvien_LPRASEIE;
  assign toHvip_LPRASEIP_bits = w_wdata[35];
  assign toHvip_LC36IP_valid = w_wen & mvien_LC36IE;
  assign toHvip_LC36IP_bits = w_wdata[36];
  assign toHvip_LC37IP_valid = w_wen & mvien_LC37IE;
  assign toHvip_LC37IP_bits = w_wdata[37];
  assign toHvip_LC38IP_valid = w_wen & mvien_LC38IE;
  assign toHvip_LC38IP_bits = w_wdata[38];
  assign toHvip_LC39IP_valid = w_wen & mvien_LC39IE;
  assign toHvip_LC39IP_bits = w_wdata[39];
  assign toHvip_LC40IP_valid = w_wen & mvien_LC40IE;
  assign toHvip_LC40IP_bits = w_wdata[40];
  assign toHvip_LC41IP_valid = w_wen & mvien_LC41IE;
  assign toHvip_LC41IP_bits = w_wdata[41];
  assign toHvip_LC42IP_valid = w_wen & mvien_LC42IE;
  assign toHvip_LC42IP_bits = w_wdata[42];
  assign toHvip_HPRASEIP_valid = w_wen & mvien_HPRASEIE;
  assign toHvip_HPRASEIP_bits = w_wdata[43];
  assign toHvip_LC44IP_valid = w_wen & mvien_LC44IE;
  assign toHvip_LC44IP_bits = w_wdata[44];
  assign toHvip_LC45IP_valid = w_wen & mvien_LC45IE;
  assign toHvip_LC45IP_bits = w_wdata[45];
  assign toHvip_LC46IP_valid = w_wen & mvien_LC46IE;
  assign toHvip_LC46IP_bits = w_wdata[46];
  assign toHvip_LC47IP_valid = w_wen & mvien_LC47IE;
  assign toHvip_LC47IP_bits = w_wdata[47];
  assign toHvip_LC48IP_valid = w_wen & mvien_LC48IE;
  assign toHvip_LC48IP_bits = w_wdata[48];
  assign toHvip_LC49IP_valid = w_wen & mvien_LC49IE;
  assign toHvip_LC49IP_bits = w_wdata[49];
  assign toHvip_LC50IP_valid = w_wen & mvien_LC50IE;
  assign toHvip_LC50IP_bits = w_wdata[50];
  assign toHvip_LC51IP_valid = w_wen & mvien_LC51IE;
  assign toHvip_LC51IP_bits = w_wdata[51];
  assign toHvip_LC52IP_valid = w_wen & mvien_LC52IE;
  assign toHvip_LC52IP_bits = w_wdata[52];
  assign toHvip_LC53IP_valid = w_wen & mvien_LC53IE;
  assign toHvip_LC53IP_bits = w_wdata[53];
  assign toHvip_LC54IP_valid = w_wen & mvien_LC54IE;
  assign toHvip_LC54IP_bits = w_wdata[54];
  assign toHvip_LC55IP_valid = w_wen & mvien_LC55IE;
  assign toHvip_LC55IP_bits = w_wdata[55];
  assign toHvip_LC56IP_valid = w_wen & mvien_LC56IE;
  assign toHvip_LC56IP_bits = w_wdata[56];
  assign toHvip_LC57IP_valid = w_wen & mvien_LC57IE;
  assign toHvip_LC57IP_bits = w_wdata[57];
  assign toHvip_LC58IP_valid = w_wen & mvien_LC58IE;
  assign toHvip_LC58IP_bits = w_wdata[58];
  assign toHvip_LC59IP_valid = w_wen & mvien_LC59IE;
  assign toHvip_LC59IP_bits = w_wdata[59];
  assign toHvip_LC60IP_valid = w_wen & mvien_LC60IE;
  assign toHvip_LC60IP_bits = w_wdata[60];
  assign toHvip_LC61IP_valid = w_wen & mvien_LC61IE;
  assign toHvip_LC61IP_bits = w_wdata[61];
  assign toHvip_LC62IP_valid = w_wen & mvien_LC62IE;
  assign toHvip_LC62IP_bits = w_wdata[62];
  assign toHvip_LC63IP_valid = w_wen & mvien_LC63IE;
