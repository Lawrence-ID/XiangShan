...
module Uncache(
  ...
  wire [1:0]       _entries_3_io_mem_acquire_bits_size;
  wire [1:0]       _entries_3_io_mem_acquire_bits_source;
  wire [30:0]      _entries_3_io_mem_acquire_bits_address;
  ...
  wire [1:0]       _entries_2_io_mem_acquire_bits_size;
  wire [1:0]       _entries_2_io_mem_acquire_bits_source;
  wire [30:0]      _entries_2_io_mem_acquire_bits_address;
  ...
  wire [1:0]       _entries_1_io_mem_acquire_bits_size;
  wire [1:0]       _entries_1_io_mem_acquire_bits_source;
  wire [30:0]      _entries_1_io_mem_acquire_bits_address;
  ...
  wire [1:0]       _entries_0_io_mem_acquire_bits_size;
  wire [1:0]       _entries_0_io_mem_acquire_bits_source;
  wire [30:0]      _entries_0_io_mem_acquire_bits_address;
  ...
  reg              state_2;
  reg              state_3;
  wire             muxState_0 = beatsLeft ? state_0 : _entries_0_io_mem_acquire_valid;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft <=
        ~(~beatsLeft & auto_client_out_a_ready)
        & 1'(beatsLeft - (auto_client_out_a_ready & clientNodeOut_a_valid));
      if (beatsLeft) begin
      end
      else begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM[/*Zero width*/ 1'b0][10];
  ...
  MMIOEntry entries_0 (
    ...
    .io_mem_acquire_ready        (auto_client_out_a_ready & (~beatsLeft | state_0)),
  ...
  MMIOEntry entries_1 (
    ...
    .io_mem_acquire_ready
      (auto_client_out_a_ready
       & (beatsLeft ? state_1 : ~_entries_0_io_mem_acquire_valid)),
  ...
  MMIOEntry entries_2 (
    ...
    .io_mem_acquire_ready
      (auto_client_out_a_ready & (beatsLeft ? state_2 : ~_GEN_8)),
  ...
  MMIOEntry entries_3 (
    ...
    .io_mem_acquire_ready
      (auto_client_out_a_ready & (beatsLeft ? state_3 : ~_GEN_9)),
  ...
  assign auto_client_out_a_bits_size =
    (muxState_0 ? _entries_0_io_mem_acquire_bits_size : 2'h0)
    | (muxState_1 ? _entries_1_io_mem_acquire_bits_size : 2'h0)
    | (muxState_2 ? _entries_2_io_mem_acquire_bits_size : 2'h0)
    | (muxState_3 ? _entries_3_io_mem_acquire_bits_size : 2'h0);
  ...
  assign auto_client_out_a_bits_address =
    (muxState_0 ? _entries_0_io_mem_acquire_bits_address : 31'h0)
    | (muxState_1 ? _entries_1_io_mem_acquire_bits_address : 31'h0)
    | (muxState_2 ? _entries_2_io_mem_acquire_bits_address : 31'h0)
    | (muxState_3 ? _entries_3_io_mem_acquire_bits_address : 31'h0);
