...
module BankedDataArray(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_read_fire = _RANDOM[6'h23][8];
        r_bank_addr_0 = _RANDOM[6'h23][13:10];
        r_bank_addr_1 = _RANDOM[6'h23][17:14];
        rr_read_fire = _RANDOM[6'h23][18];
        rr_bank_addr_r_0 = _RANDOM[6'h23][24:21];
        rr_bank_addr_r_1 = _RANDOM[6'h23][28:25];
        rr_bank_addr_0 = {_RANDOM[6'h23][31:29], _RANDOM[6'h24][0]};
        rr_bank_addr_1 = _RANDOM[6'h24][4:1];
        io_read_error_delayed_0_0_REG = _RANDOM[6'h24][11];
        io_read_error_delayed_0_1_REG = _RANDOM[6'h24][12];
        r_read_fire_1 = _RANDOM[6'h24][13];
        r_bank_addr_1_0 = _RANDOM[6'h24][18:15];
        r_bank_addr_1_1 = _RANDOM[6'h24][22:19];
        rr_read_fire_1 = _RANDOM[6'h24][23];
        rr_bank_addr_r_1_0 = _RANDOM[6'h24][29:26];
        rr_bank_addr_r_1_1 = {_RANDOM[6'h24][31:30], _RANDOM[6'h25][1:0]};
        rr_bank_addr_1_0 = _RANDOM[6'h25][5:2];
        rr_bank_addr_1_1 = _RANDOM[6'h25][9:6];
        io_read_error_delayed_1_0_REG = _RANDOM[6'h25][16];
        io_read_error_delayed_1_1_REG = _RANDOM[6'h25][17];
        r_read_fire_2 = _RANDOM[6'h25][18];
        r_bank_addr_2_0 = _RANDOM[6'h25][23:20];
        r_bank_addr_2_1 = _RANDOM[6'h25][27:24];
        rr_read_fire_2 = _RANDOM[6'h25][28];
        rr_bank_addr_r_2_0 = {_RANDOM[6'h25][31], _RANDOM[6'h26][2:0]};
        rr_bank_addr_r_2_1 = _RANDOM[6'h26][6:3];
        rr_bank_addr_2_0 = _RANDOM[6'h26][10:7];
        rr_bank_addr_2_1 = _RANDOM[6'h26][14:11];
        io_read_error_delayed_2_0_REG = _RANDOM[6'h26][21];
        io_read_error_delayed_2_1_REG = _RANDOM[6'h26][22];
        io_readline_error_delayed_REG = _RANDOM[6'h26][24];
        io_readline_error_delayed_REG_1 = _RANDOM[6'h26][25];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  DataSRAMBank data_banks_0_0 (
    .clock       (clock),
    .io_w_en     (_GEN_5 | write_bank_mask_reg[0] & write_valid_dup_reg_0),
  ...
  DataSRAMBank data_banks_0_1 (
    .clock       (clock),
    .io_w_en     (_GEN_5 | write_bank_mask_reg[1] & write_valid_dup_reg_1),
  ...
  DataSRAMBank data_banks_0_2 (
    .clock       (clock),
    .io_w_en     (_GEN_6 | write_bank_mask_reg[2] & write_valid_dup_reg_2),
  ...
  DataSRAMBank data_banks_0_3 (
    .clock       (clock),
    .io_w_en     (_GEN_6 | write_bank_mask_reg[3] & write_valid_dup_reg_3),
  ...
  DataSRAMBank data_banks_0_4 (
    .clock       (clock),
    .io_w_en     (_GEN_7 | write_bank_mask_reg[4] & write_valid_dup_reg_4),
  ...
  DataSRAMBank data_banks_0_5 (
    .clock       (clock),
    .io_w_en     (_GEN_7 | write_bank_mask_reg[5] & write_valid_dup_reg_5),
  ...
  DataSRAMBank data_banks_0_6 (
    .clock       (clock),
    .io_w_en     (_GEN_8 | write_bank_mask_reg[6] & write_valid_dup_reg_6),
  ...
  DataSRAMBank data_banks_0_7 (
    .clock       (clock),
    .io_w_en     (_GEN_8 | write_bank_mask_reg[7] & write_valid_dup_reg_7),
