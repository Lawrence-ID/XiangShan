  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[4'h7][31:5], _RANDOM[4'h8][11:0]};
        data_preDecode_valid = _RANDOM[4'h8][12];
        data_preDecode_isRVC = _RANDOM[4'h8][13];
        data_preDecode_brType = _RANDOM[4'h8][15:14];
        data_preDecode_isCall = _RANDOM[4'h8][16];
        data_preDecode_isRet = _RANDOM[4'h8][17];
        data_ftqIdx_flag = _RANDOM[4'h8][18];
        data_ftqIdx_value = _RANDOM[4'h8][24:19];
        data_ftqOffset = _RANDOM[4'h8][28:25];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
