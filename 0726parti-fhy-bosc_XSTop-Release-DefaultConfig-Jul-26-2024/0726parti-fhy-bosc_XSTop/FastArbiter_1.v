...
module FastArbiter_1(
  ...
  assign io_out_bits_tag =
    (chosenOH[0] ? io_in_0_bits_tag : 21'h0) | (chosenOH[1] ? io_in_1_bits_tag : 21'h0)
    | (chosenOH[2] ? io_in_2_bits_tag : 21'h0) | (chosenOH[3] ? io_in_3_bits_tag : 21'h0);
  ...
  assign io_out_bits_vaddr =
    (chosenOH[0] ? io_in_0_bits_vaddr : 33'h0)
    | (chosenOH[1] ? io_in_1_bits_vaddr : 33'h0)
    | (chosenOH[2] ? io_in_2_bits_vaddr : 33'h0)
    | (chosenOH[3] ? io_in_3_bits_vaddr : 33'h0);
