...
module WBArbiter_59(
  ...
  wire       _GEN_3 = ~hasFull | ~(io_in_0_valid & isFull_0 | io_in_1_valid & isFull_1);
  wire       finalValid_0 = io_in_0_valid & (_GEN_3 | isFull_0);
  wire       finalValid_1 = io_in_1_valid & (_GEN_3 | isFull_1);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      hasFull <= |{isFullNext_1, isFullNext_0};
    end
