      ...
      fuBusyTable <=
        {1'h0,
         ~(io_in_og1Resp_valid & io_in_og1Resp_bits_resp == 2'h0
             ? {2'h0, io_in_og1Resp_bits_fuType[27]}
             : 3'h0)
           & ~(io_in_og0Resp_valid
                 ? {1'h0, io_in_og0Resp_bits_fuType[27], io_in_og0Resp_bits_fuType[24]}
                 : 3'h0) & fuBusyTable[3:1]}
        | (io_in_deqResp_valid
             ? {1'h0, io_in_deqResp_bits_fuType[27], io_in_deqResp_bits_fuType[24], 1'h0}
             : 4'h0);
