...
module TLBNonBlock_2(
  ...
  wire [1:0]       mode_0 = isHyperInst_0 ? {1'h0, io_csr_priv_spvp} : io_csr_priv_dmode;
  reg              virt_out_0;
  reg              virt_out_1;
  ...
  wire             _s2xlateEnable_T_11 = io_csr_priv_dmode != 2'h3;
  ...
  wire             portTranslateEnable_1 =
    (~virt_out_1 & _vmEnable_T_7 & _s2xlateEnable_T_11 | virt_out_1
  ...
  wire             hasPf =
    ...
    & portTranslateEnable_0 & ~onlyS2 & ~af;
  assign hasGpf_0 =
    ((~(req_out_0_hlvx
          ? readResult_0_5_0_x
          : (readResult_p_hit_last_REG
  ...
  wire             fault_valid_2 = s1_valid_2 | s2_valid_2;
  wire             _io_requestor_1_resp_bits_excp_0_pf_ld_T =
    (~(~_modeCheck_T_26
       & ((readResult_p_hit_last_REG_1
             ? readResult_p_perm_1_r
             : _entries_io_r_resp_1_bits_perm_0_r)
          | (virt_out_1 & io_csr_priv_vmxr | io_csr_priv_mxr) & readResult_1_4_0_x))
     | readResult_1_4_0_pf) & ~(|(req_out_1_cmd[1:0])) & ~_stGpf_T_18
    | ~readResult_1_4_0_a & ~(|(req_out_1_cmd[1:0])) & ~_stGpf_T_18;
  wire             hasPf_2 =
    (_io_requestor_1_resp_bits_excp_0_pf_ld_T | stPf_2 | stUpdate_2
  ...
  assign hasGpf_1 =
    ((~((readResult_p_hit_last_REG_1
      ...
      | readResult_1_5_0_pf) & ~(|(req_out_1_cmd[1:0])) & ~_stGpf_T_18
     | ~readResult_1_5_0_a & ~(|(req_out_1_cmd[1:0])) & ~_stGpf_T_18) & s2_valid_2 & ~af_2
    & ~hasPf_2
    | ((~(readResult_p_hit_last_REG_1
  ...
  wire [3:0][28:0] _GEN_4 =
    {{29'h0},
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_3[io_requestor_0_req_bits_vaddr[14:12]]}},
  ...
  wire [17:0]      readResult_gvpn =
    req_in_s2xlate_0 == 2'h2
      ? io_requestor_0_req_bits_vaddr[29:12]
      : _GEN_4[io_ptw_resp_bits_s1_entry_level][17:0];
  wire [3:0][28:0] _GEN_5 =
    {{29'h0},
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_3[io_requestor_1_req_bits_vaddr[14:12]]}},
  ...
  wire [17:0]      readResult_gvpn_2 =
    req_in_s2xlate_1 == 2'h2
      ? io_requestor_1_req_bits_vaddr[29:12]
      : _GEN_5[io_ptw_resp_bits_s1_entry_level][17:0];
  wire [3:0][23:0] _GEN_6 =
    {{24'h0},
  ...
  wire [3:0][23:0] _GEN_7 =
    {{24'h0},
     {io_ptw_resp_bits_s2_entry_ppn},
     {{io_ptw_resp_bits_s2_entry_ppn[23:9], readResult_gvpn_2[8:0]}},
     {{io_ptw_resp_bits_s2_entry_ppn[23:18], readResult_gvpn_2}}};
  wire             _GEN_8 = _readResult_T_5 | ~_readResult_T_17;
  wire             _GEN_9 = _readResult_T_42 | ~_readResult_T_54;
  always @(posedge clock) begin
    ...
    need_gpa_robidx_flag <=
      _GEN_9 & (_GEN_8 ? need_gpa_robidx_flag : req_out_0_debug_robIdx_flag);
    if (_GEN_9) begin
      if (_GEN_8) begin
      end
      else
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        (|req_in_s2xlate_0)
          ? {5'h0, _GEN_6[io_ptw_resp_bits_s2_entry_level]}
          : _GEN_4[io_ptw_resp_bits_s1_entry_level];
      ...
      readResult_p_ppn_1 <=
        (|req_in_s2xlate_1)
          ? {5'h0, _GEN_7[io_ptw_resp_bits_s2_entry_level]}
          : _GEN_5[io_ptw_resp_bits_s1_entry_level];
  ...
  wire             _readResult_s1tagFix_T_26 = io_ptw_resp_bits_s1_entry_level == 2'h0;
  ...
  wire [2:0]       _readResult_s1tag_T_2 = _GEN_10 | _GEN_11;
  ...
  wire [19:0]      readResult_s1tagFix =
    _readResult_s1tagFix_T_26 & _ptw_just_back_onlyS2_hit_T_10
      ? _GEN_13
      : _readResult_s1tagFix_T_26 & _ptw_just_back_onlyS2_hit_T_7
          ? _GEN_12
  ...
  wire [1:0]       readResult_level_1 =
    _ptw_just_back_level_T_1
      ? io_ptw_resp_bits_s2_entry_level
      : io_ptw_resp_bits_s1_entry_level;
  wire [2:0]       _readResult_s1tag_T_10 = _GEN_10 | _GEN_11;
      ...
      need_gpa <=
        ...
        & (_readResult_T_54
           | ~(req_out_v_0 & hasGpf_0 & resp_gpa_refill & readResult_need_gpa_vpn_hit
               | _readResult_T_5) & (_readResult_T_17 | need_gpa));
      resp_gpa_refill <=
        ~(_readResult_T_42 | _readResult_T_54)
                                ...
                                : (&io_ptw_resp_bits_s2xlate)
                                    ? (readResult_level_1 == 2'h1
                                         ...
                                         : readResult_level_1 == 2'h0
                                             ? {readResult_s1tagFix_1[19:9],
                                                need_gpa_vpn[17:0]}
                                             : readResult_s1tag_1)
                                    : readResult_s1tag_1)
           | ~(_readResult_T_5 | _readResult_T_17)
           & (io_ptw_resp_valid & need_gpa
              & need_gpa_vpn == (_ptw_just_back_T_13
                                   ? io_ptw_resp_bits_s2_entry_tag
                                   : (&io_ptw_resp_bits_s2xlate)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_out_0_cmd = _RANDOM[6'h1][11:9];
        req_out_0_hyperinst = _RANDOM[6'h1][12];
        req_out_0_hlvx = _RANDOM[6'h1][13];
        ...
        req_out_1_cmd = _RANDOM[6'h6][21:19];
        ...
        portTranslateEnable_r = _RANDOM[6'hC][29];
        portTranslateEnable_r_1 = _RANDOM[6'hC][30];
        ...
        readResult_p_perm_x = _RANDOM[6'hE][23];
        readResult_p_perm_w = _RANDOM[6'hE][24];
        readResult_p_perm_r = _RANDOM[6'hE][25];
        ...
        readResult_p_g_perm_x = _RANDOM[6'hF][29];
        readResult_p_g_perm_w = _RANDOM[6'hF][30];
        readResult_p_g_perm_r = _RANDOM[6'hF][31];
        ...
        readResult_p_perm_1_x = _RANDOM[6'h12][15];
        readResult_p_perm_1_w = _RANDOM[6'h12][16];
        readResult_p_perm_1_r = _RANDOM[6'h12][17];
        ...
        readResult_p_g_perm_1_x = _RANDOM[6'h13][21];
        readResult_p_g_perm_1_w = _RANDOM[6'h13][22];
        readResult_p_g_perm_1_r = _RANDOM[6'h13][23];
        REG_1 = _RANDOM[6'h15][4];
  ...
  assign io_requestor_1_resp_bits_excp_0_pf_st =
    (stPf_2 | stUpdate_2) & s1_valid_2 & ~af_2;
  assign io_requestor_1_resp_bits_excp_0_af_ld =
    af_2 & ~(|(req_out_1_cmd[1:0])) & fault_valid_2;
  assign io_requestor_1_resp_bits_excp_0_af_st =
    af_2 & req_out_1_cmd[1:0] == 2'h1 & fault_valid_2;
             ...
             ? ptw_resp_bits_reg_1_s1_entry_asid == ((|ptw_resp_bits_reg_1_s2xlate)
               ...
               & (ptw_resp_bits_reg_1_s1_entry_level == 2'h2
                    ...
                    : (ptw_resp_bits_reg_1_s1_entry_level != 2'h1
                       | ptw_already_back_noS2_hit_hit1_1)
                      & ptw_already_back_noS2_hit_hit0_1) & _GEN_2[req_out_1_vaddr[14:12]]
  ...
  assign io_pmp_1_bits_addr = REG_1 ? 36'h0 : io_requestor_1_resp_bits_paddr_0_0;
