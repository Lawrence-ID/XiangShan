...
module ICacheMissUnit(
  ...
  input  [29:0]  io_fetch_req_bits_blkPaddr,
  input  [7:0]   io_fetch_req_bits_vSetIdx,
  output         io_fetch_resp_valid,
  output [29:0]  io_fetch_resp_bits_blkPaddr,
  ...
  input  [29:0]  io_prefetch_req_bits_blkPaddr,
  ...
  wire [35:0]       _prefetchMSHRs_9_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_9_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_9_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_9_io_resp_bits_waymask;
  wire              _prefetchMSHRs_8_io_req_ready;
  wire              _prefetchMSHRs_8_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_8_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_8_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_8_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_8_io_resp_bits_waymask;
  wire              _prefetchMSHRs_7_io_req_ready;
  wire              _prefetchMSHRs_7_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_7_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_7_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_7_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_7_io_resp_bits_waymask;
  wire              _prefetchMSHRs_6_io_req_ready;
  wire              _prefetchMSHRs_6_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_6_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_6_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_6_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_6_io_resp_bits_waymask;
  wire              _prefetchMSHRs_5_io_req_ready;
  wire              _prefetchMSHRs_5_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_5_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_5_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_5_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_5_io_resp_bits_waymask;
  wire              _prefetchMSHRs_4_io_req_ready;
  wire              _prefetchMSHRs_4_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_4_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_4_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_4_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_4_io_resp_bits_waymask;
  wire              _prefetchMSHRs_3_io_req_ready;
  wire              _prefetchMSHRs_3_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_3_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_3_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_3_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_3_io_resp_bits_waymask;
  wire              _prefetchMSHRs_2_io_req_ready;
  wire              _prefetchMSHRs_2_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_2_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_2_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_2_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_2_io_resp_bits_waymask;
  wire              _prefetchMSHRs_1_io_req_ready;
  wire              _prefetchMSHRs_1_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_1_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_1_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_1_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_1_io_resp_bits_waymask;
  wire              _prefetchMSHRs_0_io_req_ready;
  wire              _prefetchMSHRs_0_io_acquire_valid;
  wire [35:0]       _prefetchMSHRs_0_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _prefetchMSHRs_0_io_resp_bits_blkPaddr;
  wire [7:0]        _prefetchMSHRs_0_io_resp_bits_vSetIdx;
  wire [1:0]        _prefetchMSHRs_0_io_resp_bits_waymask;
  wire              _fetchMSHRs_3_io_req_ready;
  wire              _fetchMSHRs_3_io_acquire_valid;
  wire [35:0]       _fetchMSHRs_3_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _fetchMSHRs_3_io_resp_bits_blkPaddr;
  wire [7:0]        _fetchMSHRs_3_io_resp_bits_vSetIdx;
  wire [1:0]        _fetchMSHRs_3_io_resp_bits_waymask;
  wire              _fetchMSHRs_2_io_req_ready;
  wire              _fetchMSHRs_2_io_acquire_valid;
  wire [35:0]       _fetchMSHRs_2_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _fetchMSHRs_2_io_resp_bits_blkPaddr;
  wire [7:0]        _fetchMSHRs_2_io_resp_bits_vSetIdx;
  wire [1:0]        _fetchMSHRs_2_io_resp_bits_waymask;
  wire              _fetchMSHRs_1_io_req_ready;
  wire              _fetchMSHRs_1_io_acquire_valid;
  wire [35:0]       _fetchMSHRs_1_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _fetchMSHRs_1_io_resp_bits_blkPaddr;
  wire [7:0]        _fetchMSHRs_1_io_resp_bits_vSetIdx;
  wire [1:0]        _fetchMSHRs_1_io_resp_bits_waymask;
  wire              _fetchMSHRs_0_io_req_ready;
  wire              _fetchMSHRs_0_io_acquire_valid;
  wire [35:0]       _fetchMSHRs_0_io_acquire_bits_acquire_address;
  ...
  wire [29:0]       _fetchMSHRs_0_io_resp_bits_blkPaddr;
  wire [7:0]        _fetchMSHRs_0_io_resp_bits_vSetIdx;
  wire [1:0]        _fetchMSHRs_0_io_resp_bits_waymask;
  ...
  wire [15:0][29:0] _GEN_0 =
    {{_fetchMSHRs_0_io_resp_bits_blkPaddr},
     ...
     {_fetchMSHRs_0_io_resp_bits_blkPaddr}};
  wire [29:0]       io_fetch_resp_bits_blkPaddr_0 = _GEN_0[id_r];
  wire [15:0][7:0]  _GEN_1 =
    {{_fetchMSHRs_0_io_resp_bits_vSetIdx},
     ...
     {_fetchMSHRs_0_io_resp_bits_vSetIdx}};
  wire [7:0]        io_data_write_bits_virIdx_0 = _GEN_1[id_r];
  wire [15:0][1:0]  _GEN_2 =
    {{_fetchMSHRs_0_io_resp_bits_waymask},
     {_fetchMSHRs_0_io_resp_bits_waymask},
     {_prefetchMSHRs_9_io_resp_bits_waymask},
     {_prefetchMSHRs_8_io_resp_bits_waymask},
     {_prefetchMSHRs_7_io_resp_bits_waymask},
     {_prefetchMSHRs_6_io_resp_bits_waymask},
     {_prefetchMSHRs_5_io_resp_bits_waymask},
     {_prefetchMSHRs_4_io_resp_bits_waymask},
     {_prefetchMSHRs_3_io_resp_bits_waymask},
     {_prefetchMSHRs_2_io_resp_bits_waymask},
     {_prefetchMSHRs_1_io_resp_bits_waymask},
     {_prefetchMSHRs_0_io_resp_bits_waymask},
     {_fetchMSHRs_3_io_resp_bits_waymask},
     {_fetchMSHRs_2_io_resp_bits_waymask},
     {_fetchMSHRs_1_io_resp_bits_waymask},
     {_fetchMSHRs_0_io_resp_bits_waymask}};
  wire [3:0]        waymask = 4'h1 << _GEN_2[id_r];
  wire              fetch_resp_valid = _GEN[id_r] & last_fire_r & ~io_flush & ~io_fencei;
  wire              write_sram_valid = fetch_resp_valid & ~corrupt_r;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_3)
        readBeatCnt <=
          ~(readBeatCnt | io_mem_grant_bits_corrupt) & 1'(readBeatCnt - 1'h1);
  ...
  always @(posedge clock) begin
    last_fire_r <=
      io_mem_grant_valid & io_mem_grant_bits_opcode[0]
      & (readBeatCnt | io_mem_grant_bits_corrupt);
    id_r <= io_mem_grant_bits_source;
    corrupt_r <= io_mem_grant_bits_corrupt;
  end // always @(posedge)
  ...
  ICacheMSHR fetchMSHRs_0 (
    ...
    .io_resp_bits_waymask            (_fetchMSHRs_0_io_resp_bits_waymask),
  ...
  ICacheMSHR_1 fetchMSHRs_1 (
    ...
    .io_resp_bits_waymask            (_fetchMSHRs_1_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_2 fetchMSHRs_2 (
    ...
    .io_resp_bits_waymask            (_fetchMSHRs_2_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_3 fetchMSHRs_3 (
    ...
    .io_resp_bits_waymask            (_fetchMSHRs_3_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_4 prefetchMSHRs_0 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_0_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_5 prefetchMSHRs_1 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_1_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_6 prefetchMSHRs_2 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_2_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_7 prefetchMSHRs_3 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_3_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_8 prefetchMSHRs_4 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_4_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_9 prefetchMSHRs_5 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_5_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_10 prefetchMSHRs_6 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_6_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_11 prefetchMSHRs_7 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_7_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_12 prefetchMSHRs_8 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_8_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ICacheMSHR_13 prefetchMSHRs_9 (
    ...
    .io_resp_bits_waymask            (_prefetchMSHRs_9_io_resp_bits_waymask),
    .io_victimWay                    (io_victim_way)
  );
  ...
  assign io_fetch_resp_bits_blkPaddr = io_fetch_resp_bits_blkPaddr_0;
  assign io_fetch_resp_bits_vSetIdx = io_data_write_bits_virIdx_0;
  ...
  assign io_meta_write_bits_virIdx = io_data_write_bits_virIdx_0;
  assign io_meta_write_bits_phyTag = io_fetch_resp_bits_blkPaddr_0[29:6];
  assign io_meta_write_bits_waymask = waymask;
  assign io_meta_write_bits_bankIdx = io_data_write_bits_virIdx_0[0];
  assign io_data_write_valid = write_sram_valid;
  assign io_data_write_bits_virIdx = io_data_write_bits_virIdx_0;
