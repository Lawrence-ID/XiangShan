  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_common_fpWen = _RANDOM[6'h19][13];
        data_common_vecWen = _RANDOM[6'h19][14];
        data_common_v0Wen = _RANDOM[6'h19][15];
        data_common_fpu_wflags = _RANDOM[6'h19][20];
        data_common_vpu_vma = _RANDOM[6'h1A][4];
        data_common_vpu_vta = _RANDOM[6'h1A][5];
        data_common_vpu_vsew = _RANDOM[6'h1A][7:6];
        data_common_vpu_vlmul = _RANDOM[6'h1A][10:8];
        data_common_vpu_vm = _RANDOM[6'h1A][19];
        data_common_vpu_vstart = _RANDOM[6'h1A][27:20];
        data_common_vpu_fpu_isFoldTo1_2 = _RANDOM[6'h1B][3];
        data_common_vpu_fpu_isFoldTo1_4 = _RANDOM[6'h1B][4];
        data_common_vpu_fpu_isFoldTo1_8 = _RANDOM[6'h1B][5];
        data_common_vpu_vuopIdx = _RANDOM[6'h1B][14:8];
        data_common_vpu_lastUop = _RANDOM[6'h1B][15];
        data_common_vpu_isNarrow = _RANDOM[6'h1F][31];
        data_common_vpu_isDstMask = _RANDOM[6'h20][0];
        data_common_dataSources_0_value = _RANDOM[6'h20][8:5];
        data_common_dataSources_1_value = _RANDOM[6'h20][12:9];
        data_common_dataSources_2_value = _RANDOM[6'h20][16:13];
        data_common_dataSources_3_value = _RANDOM[6'h20][20:17];
        data_common_dataSources_4_value = _RANDOM[6'h20][24:21];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
