...
module LCredit2Decoupled(
  ...
  Queue4_CHISNP queue (
    ...
    .io_enq_bits_srcID       (io_in_flit[10:4]),
    .io_enq_bits_txnID       (io_in_flit[18:11]),
    .io_enq_bits_fwdNID      (io_in_flit[25:19]),
    .io_enq_bits_fwdTxnID    (io_in_flit[33:26]),
    .io_enq_bits_opcode      (io_in_flit[38:34]),
    .io_enq_bits_addr        (io_in_flit[83:39]),
    .io_enq_bits_ns          (io_in_flit[84]),
    .io_enq_bits_doNotGoToSD (io_in_flit[85]),
    .io_enq_bits_retToSrc    (io_in_flit[86]),
    .io_enq_bits_traceTag    (io_in_flit[87]),
