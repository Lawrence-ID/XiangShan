...
module MultiWakeupQueue_4(
  ...
  wire        _pipes_3_io_deq_bits_rfWen;
  wire        _pipes_3_io_deq_bits_fpWen;
  wire        _pipes_3_io_deq_bits_vecWen;
  wire        _pipes_3_io_deq_bits_v0Wen;
  wire [1:0]  _pipes_3_io_deq_bits_loadDependency_0;
  wire [1:0]  _pipes_3_io_deq_bits_loadDependency_1;
  wire [1:0]  _pipes_3_io_deq_bits_loadDependency_2;
  wire        _pipes_2_io_deq_valid;
  wire [34:0] _pipes_2_io_deq_bits_fuType;
  wire [7:0]  _pipes_2_io_deq_bits_pdest;
  wire        _pipes_2_io_deq_bits_rfWen;
  wire        _pipes_2_io_deq_bits_fpWen;
  wire        _pipes_2_io_deq_bits_vecWen;
  wire        _pipes_2_io_deq_bits_v0Wen;
  wire [1:0]  _pipes_2_io_deq_bits_loadDependency_0;
  wire [1:0]  _pipes_2_io_deq_bits_loadDependency_1;
  wire [1:0]  _pipes_2_io_deq_bits_loadDependency_2;
  ...
  wire        pipesValidVec_3 =
    ...
    & ~(io_flush_redirect_valid
        ...
        | io_flush_ldCancel_0_ld2Cancel & _pipes_3_io_deq_bits_loadDependency_0[1]
        | io_flush_ldCancel_1_ld2Cancel & _pipes_3_io_deq_bits_loadDependency_1[1]
        | io_flush_ldCancel_2_ld2Cancel & _pipes_3_io_deq_bits_loadDependency_2[1]);
  always @(posedge clock) begin
    ...
    lastConnect_bits_rfWen <=
      ...
      & _pipes_1_io_deq_bits_rfWen | _pipes_2_io_deq_valid & _pipes_2_io_deq_bits_rfWen
      | pipesValidVec_3 & _pipes_3_io_deq_bits_rfWen;
    ...
    lastConnect_bits_loadDependency_0 <=
      ...
      | (_pipes_2_io_deq_valid ? _pipes_2_io_deq_bits_loadDependency_0 : 2'h0)
      | (pipesValidVec_3 ? {_pipes_3_io_deq_bits_loadDependency_0[0], 1'h0} : 2'h0);
    lastConnect_bits_loadDependency_1 <=
      ...
      | (_pipes_2_io_deq_valid ? _pipes_2_io_deq_bits_loadDependency_1 : 2'h0)
      | (pipesValidVec_3 ? {_pipes_3_io_deq_bits_loadDependency_1[0], 1'h0} : 2'h0);
    lastConnect_bits_loadDependency_2 <=
      ...
      | (_pipes_2_io_deq_valid ? _pipes_2_io_deq_bits_loadDependency_2 : 2'h0)
      | (pipesValidVec_3 ? {_pipes_3_io_deq_bits_loadDependency_2[0], 1'h0} : 2'h0);
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_fuType = {_RANDOM[5'h0][31:1], _RANDOM[5'h1][3:0]};
        ...
        lastConnect_bits_vecWen = _RANDOM[5'h9][5];
        lastConnect_bits_v0Wen = _RANDOM[5'h9][6];
        lastConnect_bits_loadDependency_0 = _RANDOM[5'h13][6:5];
        lastConnect_bits_loadDependency_1 = _RANDOM[5'h13][8:7];
        lastConnect_bits_loadDependency_2 = _RANDOM[5'h13][10:9];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  PipeWithFlush_8 pipes_2 (
    ...
    .io_deq_bits_rfWen            (_pipes_2_io_deq_bits_rfWen),
    ...
    .io_deq_bits_loadDependency_0 (_pipes_2_io_deq_bits_loadDependency_0),
    .io_deq_bits_loadDependency_1 (_pipes_2_io_deq_bits_loadDependency_1),
    .io_deq_bits_loadDependency_2 (_pipes_2_io_deq_bits_loadDependency_2)
  );
  PipeWithFlush_9 pipes_3 (
    ...
    .io_deq_bits_rfWen                   (_pipes_3_io_deq_bits_rfWen),
    ...
    .io_deq_bits_loadDependency_0        (_pipes_3_io_deq_bits_loadDependency_0),
    .io_deq_bits_loadDependency_1        (_pipes_3_io_deq_bits_loadDependency_1),
    .io_deq_bits_loadDependency_2        (_pipes_3_io_deq_bits_loadDependency_2)
  );
