...
module TLBNonBlock_1(
  ...
  wire [17:0]      readResult_gvpn =
    readResult_onlyS2
      ...
      : _GEN_11[io_ptw_resp_bits_s1_entry_level][17:0];
  ...
  wire [17:0]      readResult_gvpn_2 =
    readResult_onlyS2_1
      ...
      : _GEN_12[io_ptw_resp_bits_s1_entry_level][17:0];
  ...
  always @(posedge clock) begin
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        (|req_in_s2xlate_0)
          ? {5'h0, _GEN_13[io_ptw_resp_bits_s2_entry_level]}
      ...
      readResult_p_ppn_1 <=
        (|req_in_s2xlate_1)
          ? {5'h0, _GEN_14[io_ptw_resp_bits_s2_entry_level]}
          : _GEN_12[io_ptw_resp_bits_s1_entry_level];
