...
module TLDebugModule(
  ...
  output [36:0] auto_dmInner_dmInner_sb2tlOpt_out_a_bits_address,
  output [7:0]  auto_dmInner_dmInner_sb2tlOpt_out_a_bits_mask,
  output [63:0] auto_dmInner_dmInner_sb2tlOpt_out_a_bits_data,
  output        auto_dmInner_dmInner_sb2tlOpt_out_d_ready,
  input         auto_dmInner_dmInner_sb2tlOpt_out_d_valid,
  input  [2:0]  auto_dmInner_dmInner_sb2tlOpt_out_d_bits_opcode,
  input  [1:0]  auto_dmInner_dmInner_sb2tlOpt_out_d_bits_param,
  input  [2:0]  auto_dmInner_dmInner_sb2tlOpt_out_d_bits_size,
  input         auto_dmInner_dmInner_sb2tlOpt_out_d_bits_sink,
  input         auto_dmInner_dmInner_sb2tlOpt_out_d_bits_denied,
  input  [63:0] auto_dmInner_dmInner_sb2tlOpt_out_d_bits_data,
  ...
  input  [5:0]  auto_dmInner_dmInner_tl_in_a_bits_source,
  ...
  output [5:0]  auto_dmInner_dmInner_tl_in_d_bits_source,
  ...
  TLDebugModuleInnerAsync dmInner (
    ...
    .auto_dmInner_sb2tlOpt_out_a_bits_mask
