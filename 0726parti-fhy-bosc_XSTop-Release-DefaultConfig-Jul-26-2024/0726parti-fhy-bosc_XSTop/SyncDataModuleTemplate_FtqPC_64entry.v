...
module SyncDataModuleTemplate_FtqPC_64entry(
  ...
  wire [40:0] _dataBanks_3_io_rdata_1_nextLineAddr;
  ...
  wire [40:0] _dataBanks_2_io_rdata_1_nextLineAddr;
  ...
  wire [40:0] _dataBanks_1_io_rdata_1_nextLineAddr;
  ...
  wire [40:0] _dataBanks_0_io_rdata_1_nextLineAddr;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_startAddr = {_RANDOM[5'h1][31:17], _RANDOM[5'h2][25:0]};
        r_nextLineAddr = {_RANDOM[5'h2][31:26], _RANDOM[5'h3], _RANDOM[5'h4][2:0]};
        r_fallThruError = _RANDOM[5'h4][19];
        raddr_dup_1_0 = _RANDOM[5'h4][25:20];
        raddr_dup_1_1 = _RANDOM[5'h4][31:26];
        raddr_dup_1_2 = _RANDOM[5'h5][5:0];
        raddr_dup_1_3 = _RANDOM[5'h5][11:6];
        raddr_dup_1_4 = _RANDOM[5'h5][17:12];
        raddr_dup_1_5 = _RANDOM[5'h5][23:18];
        raddr_dup_1_6 = _RANDOM[5'h5][29:24];
        wen_dup_last_REG_1 = _RANDOM[5'h5][30];
        waddr_dup_0_1 = {_RANDOM[5'h5][31], _RANDOM[5'h6][4:0]};
        r_1_startAddr = {_RANDOM[5'h6][31:5], _RANDOM[5'h7][13:0]};
        r_1_nextLineAddr = {_RANDOM[5'h7][31:14], _RANDOM[5'h8][22:0]};
        r_1_fallThruError = _RANDOM[5'h9][7];
        raddr_dup_2_0 = _RANDOM[5'h9][13:8];
        raddr_dup_2_1 = _RANDOM[5'h9][19:14];
        raddr_dup_2_2 = _RANDOM[5'h9][25:20];
        raddr_dup_2_3 = _RANDOM[5'h9][31:26];
        raddr_dup_2_4 = _RANDOM[5'hA][5:0];
        raddr_dup_2_5 = _RANDOM[5'hA][11:6];
        raddr_dup_2_6 = _RANDOM[5'hA][17:12];
        wen_dup_last_REG_2 = _RANDOM[5'hA][18];
        waddr_dup_0_2 = _RANDOM[5'hA][24:19];
        r_2_startAddr = {_RANDOM[5'hA][31:25], _RANDOM[5'hB], _RANDOM[5'hC][1:0]};
        r_2_nextLineAddr = {_RANDOM[5'hC][31:2], _RANDOM[5'hD][10:0]};
        r_2_fallThruError = _RANDOM[5'hD][27];
        raddr_dup_3_0 = {_RANDOM[5'hD][31:28], _RANDOM[5'hE][1:0]};
        raddr_dup_3_1 = _RANDOM[5'hE][7:2];
        raddr_dup_3_2 = _RANDOM[5'hE][13:8];
        raddr_dup_3_3 = _RANDOM[5'hE][19:14];
        raddr_dup_3_4 = _RANDOM[5'hE][25:20];
        raddr_dup_3_5 = _RANDOM[5'hE][31:26];
        raddr_dup_3_6 = _RANDOM[5'hF][5:0];
        wen_dup_last_REG_3 = _RANDOM[5'hF][6];
        waddr_dup_0_3 = _RANDOM[5'hF][12:7];
        r_3_startAddr = {_RANDOM[5'hF][31:13], _RANDOM[5'h10][21:0]};
        r_3_nextLineAddr = {_RANDOM[5'h10][31:22], _RANDOM[5'h11][30:0]};
        r_3_fallThruError = _RANDOM[5'h12][15];
        raddr_dup_4_0 = _RANDOM[5'h12][21:16];
        raddr_dup_5_0 = _RANDOM[5'h12][27:22];
        raddr_dup_6_0 = {_RANDOM[5'h12][31:28], _RANDOM[5'h13][1:0]};
        raddr_dup_7 = _RANDOM[5'h13][7:2];
        raddr_dup_8 = _RANDOM[5'h13][13:8];
        raddr_dup_9 = _RANDOM[5'h13][19:14];
        raddr_dup_10 = _RANDOM[5'h13][25:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        wen_dup_last_REG = 1'h0;
        wen_dup_last_REG_1 = 1'h0;
  ...
  NegedgeDataModule_FtqPC_16entry dataBanks_0 (
    .clock                    (clock),
  ...
  NegedgeDataModule_FtqPC_16entry dataBanks_1 (
    .clock                    (clock),
  ...
  NegedgeDataModule_FtqPC_16entry dataBanks_2 (
    .clock                    (clock),
  ...
  NegedgeDataModule_FtqPC_16entry dataBanks_3 (
    .clock                    (clock),
  ...
  assign io_rdata_0_startAddr =
    ...
    | ((&(raddr_dup_4_0[5:4])) ? _dataBanks_3_io_rdata_0_startAddr : 41'h0);
  assign io_rdata_0_nextLineAddr =
    ...
    | ((&(raddr_dup_4_0[5:4])) ? _dataBanks_3_io_rdata_0_nextLineAddr : 41'h0);
  ...
  assign io_rdata_1_startAddr =
    (_io_rdata_1_T ? _dataBanks_0_io_rdata_1_startAddr : 41'h0)
    | (_io_rdata_1_T_1 ? _dataBanks_1_io_rdata_1_startAddr : 41'h0)
    | (_io_rdata_1_T_2 ? _dataBanks_2_io_rdata_1_startAddr : 41'h0)
    | ((&(raddr_dup_5_0[5:4])) ? _dataBanks_3_io_rdata_1_startAddr : 41'h0);
  assign io_rdata_1_nextLineAddr =
    (_io_rdata_1_T ? _dataBanks_0_io_rdata_1_nextLineAddr : 41'h0)
    | (_io_rdata_1_T_1 ? _dataBanks_1_io_rdata_1_nextLineAddr : 41'h0)
    | (_io_rdata_1_T_2 ? _dataBanks_2_io_rdata_1_nextLineAddr : 41'h0)
    | ((&(raddr_dup_5_0[5:4])) ? _dataBanks_3_io_rdata_1_nextLineAddr : 41'h0);
  ...
  assign io_rdata_2_startAddr =
    (raddr_dup_6_0[5:4] == 2'h0 ? _dataBanks_0_io_rdata_2_startAddr : 41'h0)
    | (raddr_dup_6_0[5:4] == 2'h1 ? _dataBanks_1_io_rdata_2_startAddr : 41'h0)
    | (raddr_dup_6_0[5:4] == 2'h2 ? _dataBanks_2_io_rdata_2_startAddr : 41'h0)
    | ((&(raddr_dup_6_0[5:4])) ? _dataBanks_3_io_rdata_2_startAddr : 41'h0);
  assign io_rdata_3_startAddr =
    ...
    | ((&(raddr_dup_7[5:4])) ? _dataBanks_3_io_rdata_3_startAddr : 41'h0);
  assign io_rdata_3_nextLineAddr =
    ...
    | ((&(raddr_dup_7[5:4])) ? _dataBanks_3_io_rdata_3_nextLineAddr : 41'h0);
  assign io_rdata_4_startAddr =
    ...
    | ((&(raddr_dup_8[5:4])) ? _dataBanks_3_io_rdata_4_startAddr : 41'h0);
  assign io_rdata_4_nextLineAddr =
    ...
    | ((&(raddr_dup_8[5:4])) ? _dataBanks_3_io_rdata_4_nextLineAddr : 41'h0);
  assign io_rdata_5_startAddr =
    (raddr_dup_9[5:4] == 2'h0 ? _dataBanks_0_io_rdata_5_startAddr : 41'h0)
    | (raddr_dup_9[5:4] == 2'h1 ? _dataBanks_1_io_rdata_5_startAddr : 41'h0)
    | (raddr_dup_9[5:4] == 2'h2 ? _dataBanks_2_io_rdata_5_startAddr : 41'h0)
    | ((&(raddr_dup_9[5:4])) ? _dataBanks_3_io_rdata_5_startAddr : 41'h0);
  assign io_rdata_6_startAddr =
    (raddr_dup_10[5:4] == 2'h0 ? _dataBanks_0_io_rdata_6_startAddr : 41'h0)
    | (raddr_dup_10[5:4] == 2'h1 ? _dataBanks_1_io_rdata_6_startAddr : 41'h0)
    | (raddr_dup_10[5:4] == 2'h2 ? _dataBanks_2_io_rdata_6_startAddr : 41'h0)
    | ((&(raddr_dup_10[5:4])) ? _dataBanks_3_io_rdata_6_startAddr : 41'h0);
endmodule
