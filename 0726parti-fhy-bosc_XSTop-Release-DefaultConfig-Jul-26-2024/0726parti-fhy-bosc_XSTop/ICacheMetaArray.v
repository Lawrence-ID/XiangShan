...
module ICacheMetaArray(
  ...
  wire [24:0]       _tagArrays_1_io_r_resp_data_0;
  wire [24:0]       _tagArrays_1_io_r_resp_data_1;
  wire [24:0]       _tagArrays_1_io_r_resp_data_2;
  wire [24:0]       _tagArrays_1_io_r_resp_data_3;
  wire              _tagArrays_0_io_r_req_ready;
  wire [24:0]       _tagArrays_0_io_r_resp_data_0;
  wire [24:0]       _tagArrays_0_io_r_resp_data_1;
  wire [24:0]       _tagArrays_0_io_r_resp_data_2;
  wire [24:0]       _tagArrays_0_io_r_resp_data_3;
  ...
  wire              io_read_ready_0 =
    ~io_write_valid & ~io_fencei & _tagArrays_0_io_r_req_ready
    & _tagArrays_1_io_r_req_ready;
  reg               read_fire_delay1;
  reg               read_fire_delay2;
  reg               io_readResp_errors_0_0_r;
  reg               io_readResp_errors_0_1_r;
  reg               io_readResp_errors_0_2_r;
  reg               io_readResp_errors_0_3_r;
  reg               io_readResp_errors_1_0_r;
  reg               io_readResp_errors_1_1_r;
  reg               io_readResp_errors_1_2_r;
  reg               io_readResp_errors_1_3_r;
  wire [24:0]       write_meta_bits = {^io_write_bits_phyTag, io_write_bits_phyTag};
  wire [1:0]        way_num =
  ...
  wire              _read_fire_delay1_T = io_read_ready_0 & io_read_valid;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      read_fire_delay1 <= 1'h0;
      read_fire_delay2 <= 1'h0;
      io_readResp_errors_0_0_r <= 1'h0;
      io_readResp_errors_0_1_r <= 1'h0;
      io_readResp_errors_0_2_r <= 1'h0;
      io_readResp_errors_0_3_r <= 1'h0;
      io_readResp_errors_1_0_r <= 1'h0;
      io_readResp_errors_1_1_r <= 1'h0;
      io_readResp_errors_1_2_r <= 1'h0;
      io_readResp_errors_1_3_r <= 1'h0;
    end
    else begin
      if (_read_fire_delay1_T) begin
      ...
      read_fire_delay1 <= _read_fire_delay1_T;
      read_fire_delay2 <= read_fire_delay1;
      if (read_fire_delay1) begin
        io_readResp_errors_0_0_r <= ^_tagArrays_0_io_r_resp_data_0;
        io_readResp_errors_0_1_r <= ^_tagArrays_0_io_r_resp_data_1;
        io_readResp_errors_0_2_r <= ^_tagArrays_0_io_r_resp_data_2;
        io_readResp_errors_0_3_r <= ^_tagArrays_0_io_r_resp_data_3;
        io_readResp_errors_1_0_r <= ^_tagArrays_1_io_r_resp_data_0;
        io_readResp_errors_1_1_r <= ^_tagArrays_1_io_r_resp_data_1;
        io_readResp_errors_1_2_r <= ^_tagArrays_1_io_r_resp_data_2;
        io_readResp_errors_1_3_r <= ^_tagArrays_1_io_r_resp_data_3;
      end
    end
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        valid_array_3 =
          {_RANDOM[6'h18][31:20],
           ...
           _RANDOM[6'h1F],
           _RANDOM[6'h20][19:0]};
        read_fire_delay1 = _RANDOM[6'h20][20];
        read_fire_delay2 = _RANDOM[6'h20][21];
        io_readResp_errors_0_0_r = _RANDOM[6'h20][22];
        io_readResp_errors_0_1_r = _RANDOM[6'h20][23];
        io_readResp_errors_0_2_r = _RANDOM[6'h20][24];
        io_readResp_errors_0_3_r = _RANDOM[6'h20][25];
        io_readResp_errors_1_0_r = _RANDOM[6'h20][26];
        io_readResp_errors_1_1_r = _RANDOM[6'h20][27];
        io_readResp_errors_1_2_r = _RANDOM[6'h20][28];
        io_readResp_errors_1_3_r = _RANDOM[6'h20][29];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        port_0_read_0_reg = 1'h0;
        port_1_read_0_reg = 1'h0;
  ...
  SRAMTemplate tagArrays_0 (
    ...
    .io_r_resp_data_0      (_tagArrays_0_io_r_resp_data_0),
    .io_r_resp_data_1      (_tagArrays_0_io_r_resp_data_1),
    .io_r_resp_data_2      (_tagArrays_0_io_r_resp_data_2),
    .io_r_resp_data_3      (_tagArrays_0_io_r_resp_data_3),
    .io_w_req_valid        (io_write_valid & ~io_write_bits_bankIdx),
    .io_w_req_bits_setIdx  (io_write_bits_virIdx[7:1]),
    .io_w_req_bits_data_0  (write_meta_bits),
    .io_w_req_bits_data_1  (write_meta_bits),
    .io_w_req_bits_data_2  (write_meta_bits),
    .io_w_req_bits_data_3  (write_meta_bits),
  ...
  SRAMTemplate tagArrays_1 (
    ...
    .io_r_resp_data_0      (_tagArrays_1_io_r_resp_data_0),
    .io_r_resp_data_1      (_tagArrays_1_io_r_resp_data_1),
    .io_r_resp_data_2      (_tagArrays_1_io_r_resp_data_2),
    .io_r_resp_data_3      (_tagArrays_1_io_r_resp_data_3),
    .io_w_req_valid        (io_write_valid & io_write_bits_bankIdx),
    .io_w_req_bits_setIdx  (io_write_bits_virIdx[7:1]),
    .io_w_req_bits_data_0  (write_meta_bits),
    .io_w_req_bits_data_1  (write_meta_bits),
  ...
  assign io_readResp_metaData_0_0_tag =
    port_0_read_0_reg
      ? _tagArrays_0_io_r_resp_data_0[23:0]
      : _tagArrays_1_io_r_resp_data_0[23:0];
  assign io_readResp_metaData_0_1_tag =
    port_0_read_0_reg
      ? _tagArrays_0_io_r_resp_data_1[23:0]
      : _tagArrays_1_io_r_resp_data_1[23:0];
  assign io_readResp_metaData_0_2_tag =
    port_0_read_0_reg
      ? _tagArrays_0_io_r_resp_data_2[23:0]
      : _tagArrays_1_io_r_resp_data_2[23:0];
  assign io_readResp_metaData_0_3_tag =
    port_0_read_0_reg
      ? _tagArrays_0_io_r_resp_data_3[23:0]
      : _tagArrays_1_io_r_resp_data_3[23:0];
  assign io_readResp_metaData_1_0_tag =
    port_1_read_0_reg
      ? _tagArrays_0_io_r_resp_data_0[23:0]
      : _tagArrays_1_io_r_resp_data_0[23:0];
  assign io_readResp_metaData_1_1_tag =
    port_1_read_0_reg
      ? _tagArrays_0_io_r_resp_data_1[23:0]
      : _tagArrays_1_io_r_resp_data_1[23:0];
  assign io_readResp_metaData_1_2_tag =
    port_1_read_0_reg
      ? _tagArrays_0_io_r_resp_data_2[23:0]
      : _tagArrays_1_io_r_resp_data_2[23:0];
  assign io_readResp_metaData_1_3_tag =
    port_1_read_0_reg
      ? _tagArrays_0_io_r_resp_data_3[23:0]
      : _tagArrays_1_io_r_resp_data_3[23:0];
  assign io_readResp_errors_0_0 = io_readResp_errors_0_0_r & read_fire_delay2;
  assign io_readResp_errors_0_1 = io_readResp_errors_0_1_r & read_fire_delay2;
  assign io_readResp_errors_0_2 = io_readResp_errors_0_2_r & read_fire_delay2;
  assign io_readResp_errors_0_3 = io_readResp_errors_0_3_r & read_fire_delay2;
  assign io_readResp_errors_1_0 = io_readResp_errors_1_0_r & read_fire_delay2;
  assign io_readResp_errors_1_1 = io_readResp_errors_1_1_r & read_fire_delay2;
  assign io_readResp_errors_1_2 = io_readResp_errors_1_2_r & read_fire_delay2;
  assign io_readResp_errors_1_3 = io_readResp_errors_1_3_r & read_fire_delay2;
