...
module MMIOEntry(
  ...
  output [1:0]   io_mem_acquire_bits_size,
  output [1:0]   io_mem_acquire_bits_source,
  output [30:0]  io_mem_acquire_bits_address,
  ...
  wire        io_mem_acquire_valid_0 = state == 2'h1 & io_select;
  ...
  always @(posedge clock or posedge reset) begin
    ...
    else if (io_mem_acquire_ready & io_mem_acquire_valid_0)
      state <= 2'h2;
    else if (_GEN)
      state <= 2'h1;
  ...
  always @(posedge clock) begin
    ...
    resp_nderr <= _GEN_0 ? io_mem_grant_bits_denied : ~_GEN & resp_nderr;
  end // always @(posedge)
  ...
  assign io_mem_acquire_bits_size = lgSize;
  assign io_mem_acquire_bits_source = io_hartId[1:0];
  assign io_mem_acquire_bits_address = req_addr[30:0];
