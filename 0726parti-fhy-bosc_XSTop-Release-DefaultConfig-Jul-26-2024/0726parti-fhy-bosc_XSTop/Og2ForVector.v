...
module Og2ForVector(
  ...
  wire         io_fromOg1NoReg_0_0_ready_0 =
    (io_toVfExu_0_0_ready | ~io_fromOg1NoReg_0_0_valid)
    & ~(s2_toVfExuValid_0_0 & ~toVfExuFire_0_0);
  ...
  wire         io_fromOg1NoReg_1_0_ready_0 =
    (io_toVfExu_1_0_ready | ~io_fromOg1NoReg_1_0_valid)
    & ~(s2_toVfExuValid_1_0 & ~toVfExuFire_1_0);
  ...
  wire         io_fromOg1NoReg_2_0_ready_0 =
    (io_toVfExu_2_0_ready | ~io_fromOg1NoReg_2_0_valid)
    & ~(s2_toVfExuValid_2_0 & ~toVfExuFire_2_0);
  reg  [31:0]  r_1_imm;
  reg  [3:0]   r_1_immType;
  ...
  always @(posedge clock) begin
    s2_toVfExuValid_2_0 <= _GEN_3;
    s2_toVfExuValid_1_1 <= _GEN_2;
    s2_toVfExuValid_1_0 <= _GEN_1;
    s2_toVfExuValid_0_1 <= _GEN_0;
    s2_toVfExuValid_0_0 <= _GEN;
    if (_GEN_3) begin
