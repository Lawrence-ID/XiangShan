...
module SstcInterruptGen(
  ...
  input  [63:0] i_stimecmp,
  input  [63:0] i_vstimecmp,
  input         i_menvcfgSTCE,
  input         i_henvcfgSTCE,
  output        o_STIP,
  output        o_VSTIP
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (i_stime_valid & i_menvcfgSTCE)
        o_STIP_r <= i_stime_bits >= i_stimecmp;
      if (i_vstime_valid & i_henvcfgSTCE)
        o_VSTIP_r <= i_vstime_bits >= i_vstimecmp;
    end
