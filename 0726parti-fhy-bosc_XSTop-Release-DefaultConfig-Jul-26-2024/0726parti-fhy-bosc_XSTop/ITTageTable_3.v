...
module ITTageTable_3(
  ...
  wire [7:0]  update_folded_hist_hist_14_folded_hist = 8'h0;
  ...
  wire [8:0]  update_folded_hist_hist_6_folded_hist =
    {io_update_ghist[8:7], io_update_ghist[6:0] ^ io_update_ghist[15:9]};
  wire [7:0]  update_folded_hist_hist_2_folded_hist =
    io_update_ghist[7:0] ^ io_update_ghist[15:8];
  wire [8:0]  update_idx = io_update_pc[9:1] ^ update_folded_hist_hist_6_folded_hist;
  reg         needReset;
  ...
  FoldedSRAMTemplate_23 table_0 (
    ...
    .io_w_req_bits_data_0_tag
      (io_update_pc[18:10] ^ update_folded_hist_hist_6_folded_hist
       ^ {update_folded_hist_hist_2_folded_hist, 1'h0}),
