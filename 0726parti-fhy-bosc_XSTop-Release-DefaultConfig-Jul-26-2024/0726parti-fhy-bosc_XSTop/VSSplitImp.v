...
module VSSplitImp(
  ...
  wire [40:0]  _splitPipeline_io_out_bits_baseAddr;
  ...
  wire [34:0]  _splitPipeline_io_out_bits_uop_fuType;
  wire [8:0]   _splitPipeline_io_out_bits_uop_fuOpType;
  wire [31:0]  _splitPipeline_io_out_bits_uop_imm;
  ...
  wire [127:0] _splitPipeline_io_out_bits_uopOffset;
  ...
  VSSplitPipelineImp splitPipeline (
    ...
    .io_out_bits_uop_fuType                     (_splitPipeline_io_out_bits_uop_fuType),
    .io_out_bits_uop_fuOpType                   (_splitPipeline_io_out_bits_uop_fuOpType),
    .io_out_bits_uop_imm                        (_splitPipeline_io_out_bits_uop_imm),
    ...
    .io_out_bits_uop_lastUop                    (_splitPipeline_io_out_bits_uop_lastUop),
    ...
    .io_out_bits_uopOffset                      (_splitPipeline_io_out_bits_uopOffset),
  ...
  VSSplitBufferImp splitBuffer (
    ...
    .io_in_bits_uop_fuType               (_splitPipeline_io_out_bits_uop_fuType),
    .io_in_bits_uop_fuOpType             (_splitPipeline_io_out_bits_uop_fuOpType),
    .io_in_bits_uop_imm                  (_splitPipeline_io_out_bits_uop_imm),
    ...
    .io_in_bits_uop_lastUop              (_splitPipeline_io_out_bits_uop_lastUop),
    ...
    .io_in_bits_uopOffset                (_splitPipeline_io_out_bits_uopOffset),
    ...
    .io_out_bits_uop_imm                 (io_out_bits_uop_imm),
    .io_out_bits_uop_uopIdx              (io_out_bits_uop_uopIdx),
    .io_out_bits_uop_lastUop             (io_out_bits_uop_lastUop),
    ...
    .io_out_bits_usSecondInv             (io_out_bits_usSecondInv),
    ...
    .io_vstd_bits_uop_fuType             (io_vstd_bits_uop_fuType),
