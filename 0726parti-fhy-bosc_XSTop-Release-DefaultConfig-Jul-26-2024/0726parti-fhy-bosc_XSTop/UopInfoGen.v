...
module UopInfoGen(
  ...
  wire [6:0]      numOfUop =
    io_in_preInfo_typeOfSplit == 6'h33
      ...
      : io_in_preInfo_typeOfSplit == 6'h32
          ? {2'h0, 5'(_GEN_1 + 5'h2)}
                  ...
                  : io_in_preInfo_typeOfSplit == 6'h30
                      ? {1'h0,
                         _numOfUopVcompress_T_4
                           ? 6'h2B
                           : {2'h0,
                              _numOfUopWX_T_4 ? 4'hD : _numOfUopWX_T_2 ? 4'h4 : 4'h1}}
                                                                                    ...
                                                                                    | io_in_preInfo_typeOfSplit == 6'h1F
                                                                                      ...
                                                                                      : io_in_preInfo_typeOfSplit == 6'h3D
                                                                                          ? (io_in_preInfo_vlmul[2]
                                                                                               ? {3'h0,
                                                                                                  _GEN[io_in_preInfo_vsew]
                                                                                                    >> 2'(2'h0
                                                                                                          - io_in_preInfo_vlmul[1:0])}
                                                                                               : {3'h0,
                                                                                                  _GEN[io_in_preInfo_vsew]}
                                                                                                 << io_in_preInfo_vlmul[1:0])
                                                                                              ...
                                                                                              ? {3'h0,
                                                                                                 4'((io_in_preInfo_vlmul == 3'h3
                                                                                                       ...
                                                                                                       : io_in_preInfo_vlmul == 3'h2
                                                                                                           ? 4'h4
                                                                                                           : io_in_preInfo_vlmul == 3'h1
                                                                                                               ? 4'h2
                                                                                                               : 4'h1)
                                                                                                    + {1'h0,
                                                                                                       3'((io_in_preInfo_vlmul[2]
                                                                                                             ? io_in_preInfo_vlmul
                                                                                                             : 3'h0)
  ...
  assign io_out_isComplex = |io_in_preInfo_typeOfSplit;
  assign io_out_uopInfo_numOfUop = numOfUop;
  assign io_out_uopInfo_numOfWB = numOfUop;
