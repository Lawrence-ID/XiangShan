    ...
    if (reset) begin
      ...
      beatsLeft <=
        latch
          ...
          : 3'(beatsLeft - {2'h0, auto_out_0_a_ready & out_0_a_valid});
      ...
      beatsLeft_1 <=
        latch_1
          ? (winner_1_0 & ~(auto_in_0_a_bits_opcode[2])
               ? ~(_beatsAI_decode_T[5:3])
               : 3'h0) | (winner_1_1 & ~(auto_in_1_a_bits_opcode[2]) ? 3'h3 : 3'h0)
          : 3'(beatsLeft_1 - {2'h0, auto_out_1_a_ready & out_1_a_valid});
      ...
      beatsLeft_2 <=
        latch_2
          ? (winner_2_0 & ~(auto_in_0_a_bits_opcode[2])
               ? ~(_beatsAI_decode_T[5:3])
               : 3'h0) | (winner_2_1 & ~(auto_in_1_a_bits_opcode[2]) ? 3'h3 : 3'h0)
          : 3'(beatsLeft_2 - {2'h0, auto_out_2_a_ready & out_2_a_valid});
          ...
          ? {maskedBeats_0_3[2],
             maskedBeats_0_3[1:0]
               | (winner_3_1 & auto_out_1_d_bits_opcode[0]
                    ...
                    : 2'h0)}
          : 3'(beatsLeft_3 - {2'h0, auto_in_0_d_ready & in_0_d_valid});
          ...
          ? {maskedBeats_0_4[2],
             maskedBeats_0_4[1:0]
               | (winner_4_1 & auto_out_1_d_bits_opcode[0]
                    ? ~(_beatsDO_decode_T_3[4:3])
                    : 2'h0)}
          : 3'(beatsLeft_4 - {2'h0, auto_in_1_d_ready & in_1_d_valid});
