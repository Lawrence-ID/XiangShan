      ...
      if (io_wen) begin
        valids_0_0 <=
          hit
            ...
            : io_write_way_mask_0 & _GEN_6 | ~_GEN_6 & valids_0_0;
        valids_0_1 <=
          hit
            ? io_write_way_mask_1 & _GEN | valids_0_1
            : io_write_way_mask_1 & _GEN_6 | ~_GEN_6 & valids_0_1;
        valids_1_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_0 | valids_1_0
            : io_write_way_mask_0 & _GEN_7 | ~_GEN_7 & valids_1_0;
        valids_1_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_0 | valids_1_1
            : io_write_way_mask_1 & _GEN_7 | ~_GEN_7 & valids_1_1;
        valids_2_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_1 | valids_2_0
            : io_write_way_mask_0 & _GEN_8 | ~_GEN_8 & valids_2_0;
        valids_2_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_1 | valids_2_1
            : io_write_way_mask_1 & _GEN_8 | ~_GEN_8 & valids_2_1;
        valids_3_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_2 | valids_3_0
            : io_write_way_mask_0 & _GEN_9 | ~_GEN_9 & valids_3_0;
        valids_3_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_2 | valids_3_1
            : io_write_way_mask_1 & _GEN_9 | ~_GEN_9 & valids_3_1;
        valids_4_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_3 | valids_4_0
            : io_write_way_mask_0 & _GEN_10 | ~_GEN_10 & valids_4_0;
        valids_4_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_3 | valids_4_1
            : io_write_way_mask_1 & _GEN_10 | ~_GEN_10 & valids_4_1;
        valids_5_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_4 | valids_5_0
            : io_write_way_mask_0 & _GEN_11 | ~_GEN_11 & valids_5_0;
        valids_5_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_4 | valids_5_1
            : io_write_way_mask_1 & _GEN_11 | ~_GEN_11 & valids_5_1;
        valids_6_0 <=
          hit
            ? io_write_way_mask_0 & _GEN_5 | valids_6_0
            : io_write_way_mask_0 & _GEN_12 | ~_GEN_12 & valids_6_0;
        valids_6_1 <=
          hit
            ? io_write_way_mask_1 & _GEN_5 | valids_6_1
            : io_write_way_mask_1 & _GEN_12 | ~_GEN_12 & valids_6_1;
        valids_7_0 <=
          hit
            ? io_write_way_mask_0 & (&hit_idx) | valids_7_0
            : io_write_way_mask_0 & (&enq_idx) | ~(&enq_idx) & valids_7_0;
        valids_7_1 <=
          hit
            ? io_write_way_mask_1 & (&hit_idx) | valids_7_1
            : io_write_way_mask_1 & (&enq_idx) | ~(&enq_idx) & valids_7_1;
        state_reg <=
