  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_size = _RANDOM[1'h0][6:5];
        mem_0_source = _RANDOM[1'h0][7];
        mem_0_data = {_RANDOM[1'h0][31:10], _RANDOM[1'h1][9:0]};
        widx_widx_bin = _RANDOM[1'h1][11];
        ready_reg = _RANDOM[1'h1][12];
        widx_gray = _RANDOM[1'h1][13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 1'h0;
        ready_reg = 1'h0;
