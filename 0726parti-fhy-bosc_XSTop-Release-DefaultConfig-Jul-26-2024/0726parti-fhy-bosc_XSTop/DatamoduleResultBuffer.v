...
module DatamoduleResultBuffer(
  ...
  output [40:0]  io_deq_0_bits_vaddr,
  ...
  output [40:0]  io_deq_1_bits_vaddr,
  ...
  reg  [35:0]  data_0_addr;
  reg  [40:0]  data_0_vaddr;
  reg  [127:0] data_0_data;
  reg  [15:0]  data_0_mask;
  reg          data_0_wline;
  reg  [5:0]   data_0_sqPtr_value;
  reg          data_0_vecValid;
  reg  [35:0]  data_1_addr;
  reg  [40:0]  data_1_vaddr;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      valids_0 <= _GEN_2 ? ~_enq_flag_T_4 | _GEN_0 | _GEN_5 : _GEN_0 | _GEN_5;
      valids_1 <= _GEN_2 ? _enq_flag_T_4 | _GEN_1 | _GEN_6 : _GEN_1 | _GEN_6;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_0_addr = {_RANDOM[4'h0], _RANDOM[4'h1][3:0]};
        data_0_vaddr = {_RANDOM[4'h1][31:4], _RANDOM[4'h2][12:0]};
        data_0_data =
          {_RANDOM[4'h2][31:13],
           _RANDOM[4'h3],
           _RANDOM[4'h4],
           _RANDOM[4'h5],
           _RANDOM[4'h6][12:0]};
        data_0_mask = _RANDOM[4'h6][28:13];
        data_0_wline = _RANDOM[4'h6][29];
        data_0_sqPtr_value = {_RANDOM[4'h6][31], _RANDOM[4'h7][4:0]};
        data_0_vecValid = _RANDOM[4'h7][6];
        data_1_addr = {_RANDOM[4'h7][31:7], _RANDOM[4'h8][10:0]};
        data_1_vaddr = {_RANDOM[4'h8][31:11], _RANDOM[4'h9][19:0]};
        data_1_data =
          {_RANDOM[4'h9][31:20],
           _RANDOM[4'hA],
           _RANDOM[4'hB],
           _RANDOM[4'hC],
           _RANDOM[4'hD][19:0]};
        data_1_mask = {_RANDOM[4'hD][31:20], _RANDOM[4'hE][3:0]};
        data_1_wline = _RANDOM[4'hE][4];
        data_1_sqPtr_value = _RANDOM[4'hE][11:6];
        data_1_vecValid = _RANDOM[4'hE][13];
        valids_0 = _RANDOM[4'hE][14];
        valids_1 = _RANDOM[4'hE][15];
        enq_flag = _RANDOM[4'hE][16];
        deq_flag = _RANDOM[4'hE][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
