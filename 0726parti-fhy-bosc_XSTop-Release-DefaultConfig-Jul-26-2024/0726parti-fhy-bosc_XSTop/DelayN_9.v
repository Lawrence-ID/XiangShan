  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_bits_addr = {_RANDOM[2'h0][31:3], _RANDOM[2'h1][11:0]};
        REG_bits_id = _RANDOM[2'h1][27:12];
        REG_bits_flushPipe = _RANDOM[2'h1][28];
        REG_bits_hv = _RANDOM[2'h1][29];
        REG_bits_hg = _RANDOM[2'h1][30];
        REG_1_valid = _RANDOM[2'h1][31];
        REG_1_bits_rs1 = _RANDOM[2'h2][0];
        REG_1_bits_rs2 = _RANDOM[2'h2][1];
        REG_1_bits_addr = {_RANDOM[2'h2][31:2], _RANDOM[2'h3][10:0]};
        REG_1_bits_id = _RANDOM[2'h3][26:11];
        REG_1_bits_flushPipe = _RANDOM[2'h3][27];
        REG_1_bits_hv = _RANDOM[2'h3][28];
        REG_1_bits_hg = _RANDOM[2'h3][29];
      `endif // RANDOMIZE_REG_INIT
    end // initial
