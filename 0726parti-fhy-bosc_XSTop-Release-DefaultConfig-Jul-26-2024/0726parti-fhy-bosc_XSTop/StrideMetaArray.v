...
module StrideMetaArray(
  ...
  input  [40:0] io_train_req_bits_pc,
  ...
  wire              _s2_stride_T =
    ~s1_alloc & s1_update & res_stride_valid & res_stride_match & (&_GEN_23);
  reg               s2_valid_last_REG;
  reg  [40:0]       s2_vaddr;
  reg  [15:0]       s2_stride;
  reg               s3_valid_last_REG;
  reg  [30:0]       s3_l1_pf_req_bits_region;
  reg  [15:0]       s3_l1_pf_req_bits_bit_vec;
  reg  [30:0]       s3_l2_pf_req_bits_region;
  reg  [15:0]       s3_l2_pf_req_bits_bit_vec;
  reg               s4_valid_last_REG;
  reg  [30:0]       s4_l2_pf_req_bits_region;
  ...
  wire [40:0]       _s2_l1_pf_vaddr_T = 41'({23'h0, s2_stride, 2'h0} + s2_vaddr);
  wire [40:0]       _s2_l2_pf_vaddr_T = 41'({20'h0, s2_stride, 5'h0} + s2_vaddr);
  always @(posedge clock) begin
    ...
    if (s2_valid_last_REG) begin
      s3_l1_pf_req_bits_region <= _s2_l1_pf_vaddr_T[40:10];
      s3_l1_pf_req_bits_bit_vec <= 16'h1 << _s2_l1_pf_vaddr_T[9:6];
      s3_l2_pf_req_bits_region <= _s2_l2_pf_vaddr_T[40:10];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_vaddr = {_RANDOM[6'h10][31:17], _RANDOM[6'h11][25:0]};
        s1_hit = _RANDOM[6'h11][26];
        s2_valid_last_REG = _RANDOM[6'h11][27];
        s2_vaddr = {_RANDOM[6'h11][31:28], _RANDOM[6'h12], _RANDOM[6'h13][4:0]};
        s2_stride = _RANDOM[6'h13][20:5];
        s3_valid_last_REG = _RANDOM[6'h13][21];
        s3_l1_pf_req_bits_region = {_RANDOM[6'h13][31:22], _RANDOM[6'h14][20:0]};
        s3_l1_pf_req_bits_bit_vec = {_RANDOM[6'h14][31:21], _RANDOM[6'h15][4:0]};
        s3_l2_pf_req_bits_region = {_RANDOM[6'h17][31:28], _RANDOM[6'h18][26:0]};
        s3_l2_pf_req_bits_bit_vec = {_RANDOM[6'h18][31:27], _RANDOM[6'h19][10:0]};
        s4_valid_last_REG = _RANDOM[6'h1C][2];
        s4_l2_pf_req_bits_region = {_RANDOM[6'h1C][31:3], _RANDOM[6'h1D][1:0]};
        s4_l2_pf_req_bits_bit_vec = _RANDOM[6'h1D][17:2];
        last_REG = _RANDOM[6'h20][9];
        last_REG_1 = _RANDOM[6'h20][10];
        last_REG_2 = _RANDOM[6'h20][11];
        last_REG_3 = _RANDOM[6'h20][12];
        last_REG_4 = _RANDOM[6'h20][13];
        last_REG_5 = _RANDOM[6'h20][14];
        last_REG_6 = _RANDOM[6'h20][15];
        last_REG_7 = _RANDOM[6'h20][16];
        last_REG_8 = _RANDOM[6'h20][17];
        last_REG_9 = _RANDOM[6'h20][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
