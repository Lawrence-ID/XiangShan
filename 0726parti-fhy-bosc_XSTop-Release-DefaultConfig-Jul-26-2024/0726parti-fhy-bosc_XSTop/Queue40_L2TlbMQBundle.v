...
module Queue40_L2TlbMQBundle(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_flush) begin
        ...
        if (do_enq)
          enq_ptr_value <= enq_ptr_value == 6'h27 ? 6'h0 : 6'(enq_ptr_value + 6'h1);
        if (do_deq)
          deq_ptr_value <= deq_ptr_value == 6'h27 ? 6'h0 : 6'(deq_ptr_value + 6'h1);
      end
  ...
  assign io_deq_bits_req_info_vpn = _ram_ext_R0_data[28:0];
  assign io_deq_bits_req_info_s2xlate = _ram_ext_R0_data[30:29];
  assign io_deq_bits_req_info_source = _ram_ext_R0_data[32:31];
  assign io_deq_bits_isHptwReq = _ram_ext_R0_data[33];
  assign io_deq_bits_isLLptw = _ram_ext_R0_data[34];
  assign io_deq_bits_hptwId = _ram_ext_R0_data[37:35];
endmodule
