...
module CVT16(
  ...
  wire [9:0]  out_exp_clz_io_in = _sig_T_2[9:0] | (is_vfr ? _in_T_5[9:0] : 10'h0);
  ...
  wire        _out_sign_T =
    is_vfrsqrt7 & ~_sign_T_8 & (is_normal | ~(|exp) & (|out_exp_clz_io_in));
  ...
  wire [10:0] clz_sig_clz_io_in =
    (_out_sign_T & is_normal | _sig_normalized_T_2 ? {1'h0, out_exp_clz_io_in} : 11'h0)
    | (_out_sign_T & ~(|exp) | _sig_normalized_T_6 ? {out_exp_clz_io_in, 1'h0} : 11'h0);
  ...
  wire        is_inf = (&exp) & out_exp_clz_io_in == 10'h0;
  wire        is_nan = (&exp) & (|out_exp_clz_io_in);
  wire        _is_pos2_b_bplus1_T_1 = exp == 5'h1E;
  wire        _is_pos2_bminus1_b_T_1 = exp == 5'h1D;
  wire [41:0] _lpath_sig_shifted_T_2 =
    {31'h0, _sig_T_2[10], out_exp_clz_io_in} << (_min_int_T ? 5'(exp + 5'h7) : 5'h0);
    ...
    if (reset) begin
      ...
      if (io_fire) begin
        ...
        is_neginf_negzero_reg0 <=
          _sign_T_8 & (is_normal | ~(|exp) & (|out_exp_clz_io_in));
        is_negzero_reg0 <= _sign_T_8 & ~(|exp) & out_exp_clz_io_in == 10'h0;
        is_poszero_reg0 <= ~_sign_T_8 & ~(|exp) & out_exp_clz_io_in == 10'h0;
        is_snan_reg0 <= ~(out_exp_clz_io_in[9]) & is_nan;
        ...
        is_neg2_negbminus1_negzero_reg0 <=
          _sign_T_8 & out_exp_clz_io_in[9:8] == 2'h0 & ~(|exp) & (|out_exp_clz_io_in);
        ...
        max_min_int_reg0 <=
          (&exp) & (|out_exp_clz_io_in) | ~_sign_T_8
            ? {_max_int_T_8[15:8],
  ...
  always @(posedge clock) begin
    ...
    if (io_fire) begin
      ...
      sig_normalized_reg0 <= clz_sig_clz_io_in;
