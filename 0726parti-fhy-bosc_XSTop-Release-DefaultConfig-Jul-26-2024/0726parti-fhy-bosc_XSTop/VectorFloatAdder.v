...
module VectorFloatAdder(
  ...
  wire [1:0]  U_F32_Mixed_1_io_fp_format = 2'(io_fp_format - 2'h1);
  wire [31:0] _f32_0_fp_a_T_13 =
    (io_is_fold[0] ? io_vs2_fold[95:64] : 32'h0)
    | (io_is_fold[1] ? io_vs2_fold[63:32] : 32'h0);
  wire        _U_F32_Mixed_1_io_maskForReduction_T = U_F32_Mixed_1_io_fp_format == 2'h1;
  ...
  FloatAdderF32WidenF16MixedPipeline U_F32_Mixed_0 (
    ...
    .io_fp_format        (U_F32_Mixed_1_io_fp_format),
  ...
  FloatAdderF32WidenF16MixedPipeline U_F32_Mixed_1 (
    ...
    .io_fp_a
      ((io_is_fold[0] ? io_vs2_fold[127:96] : 32'h0)
       | (io_is_fold[1] ? io_vs2_fold[95:64] : 32'h0)
  ...
  FloatAdderF16Pipeline U_F16_1 (
    .clock               (clock),
    .io_fire             (io_fire),
    .io_fp_a             (io_is_fold[0] ? io_vs2_fold[95:80] : io_fp_a[31:16]),
