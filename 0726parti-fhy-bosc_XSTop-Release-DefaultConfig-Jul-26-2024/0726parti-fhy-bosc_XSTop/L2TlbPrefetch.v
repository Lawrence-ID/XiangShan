...
module L2TlbPrefetch(
  ...
  reg         old_v_3;
  reg  [1:0]  old_index;
  wire [25:0] _next_line_T_1 = 26'(io_in_bits_vpn[28:3] + 26'h1);
  reg  [28:0] next_req;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_v_T)
        old_index <= (&old_index) ? 2'h0 : 2'(old_index + 2'h1);
      v <=
        ~flush
        & (io_in_valid & ~flush
           & {old_reqs_0[28:3] == _next_line_T_1 & old_v_0,
              old_reqs_1[28:3] == _next_line_T_1 & old_v_1,
              old_reqs_2[28:3] == _next_line_T_1 & old_v_2,
              old_reqs_3[28:3] == _next_line_T_1 & old_v_3} == 4'h0 | ~_v_T & v);
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        old_reqs_0 = _RANDOM[3'h0][28:0];
        old_reqs_1 = {_RANDOM[3'h0][31:29], _RANDOM[3'h1][25:0]};
        old_reqs_2 = {_RANDOM[3'h1][31:26], _RANDOM[3'h2][22:0]};
        old_reqs_3 = {_RANDOM[3'h2][31:23], _RANDOM[3'h3][19:0]};
        old_v_0 = _RANDOM[3'h3][20];
        old_v_1 = _RANDOM[3'h3][21];
        old_v_2 = _RANDOM[3'h3][22];
        old_v_3 = _RANDOM[3'h3][23];
        old_index = _RANDOM[3'h3][25:24];
        next_req = {_RANDOM[3'h3][31:26], _RANDOM[3'h4][22:0]};
        v = _RANDOM[3'h4][23];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        old_v_0 = 1'h0;
