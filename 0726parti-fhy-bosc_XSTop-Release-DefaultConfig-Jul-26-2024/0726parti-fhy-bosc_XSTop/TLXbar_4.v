...
module TLXbar_4(
  ...
  output         auto_out_3_a_bits_user_alias,
  output [34:0]  auto_out_3_a_bits_user_vaddr,
  ...
  output         auto_out_3_c_bits_user_alias,
  output [34:0]  auto_out_3_c_bits_user_vaddr,
  ...
  output         auto_out_2_a_bits_user_alias,
  output [34:0]  auto_out_2_a_bits_user_vaddr,
  ...
  output         auto_out_2_c_bits_user_alias,
  output [34:0]  auto_out_2_c_bits_user_vaddr,
  ...
  output         auto_out_1_a_bits_user_alias,
  output [34:0]  auto_out_1_a_bits_user_vaddr,
  ...
  output         auto_out_1_c_bits_user_alias,
  output [34:0]  auto_out_1_c_bits_user_vaddr,
  ...
  output [34:0]  auto_out_0_a_bits_user_vaddr,
  ...
  output [34:0]  auto_out_0_c_bits_user_vaddr,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft_5 <=
        latch_5
          ? winner_5_0 & auto_out_0_d_bits_opcode[0] & ~(_beatsDO_decode_T[5])
            | winner_5_1 & auto_out_1_d_bits_opcode[0] & ~(_beatsDO_decode_T_3[5])
            | winner_5_2 & auto_out_2_d_bits_opcode[0] & ~(_beatsDO_decode_T_6[5])
            | winner_5_3 & auto_out_3_d_bits_opcode[0] & ~(_beatsDO_decode_T_9[5])
          : 1'(beatsLeft_5 - (auto_in_0_d_ready & in_0_d_valid));
      ...
      beatsLeft_7 <=
        latch_7
          ? winner_7_0 & auto_out_0_d_bits_opcode[0] & ~(_beatsDO_decode_T[5])
            | winner_7_1 & auto_out_1_d_bits_opcode[0] & ~(_beatsDO_decode_T_3[5])
            | winner_7_2 & auto_out_2_d_bits_opcode[0] & ~(_beatsDO_decode_T_6[5])
            | winner_7_3 & auto_out_3_d_bits_opcode[0] & ~(_beatsDO_decode_T_9[5])
          : 1'(beatsLeft_7 - (auto_in_2_d_ready & in_2_d_valid));
  ...
  assign auto_in_2_d_bits_opcode =
    (muxState_7_0 ? auto_out_0_d_bits_opcode : 3'h0)
    | (muxState_7_1 ? auto_out_1_d_bits_opcode : 3'h0)
    | (muxState_7_2 ? auto_out_2_d_bits_opcode : 3'h0)
    | (muxState_7_3 ? auto_out_3_d_bits_opcode : 3'h0);
  ...
  assign auto_in_0_b_bits_address =
    (muxState_4_0 ? auto_out_0_b_bits_address : 36'h0)
    | (muxState_4_1 ? auto_out_1_b_bits_address : 36'h0)
    | (muxState_4_2 ? auto_out_2_b_bits_address : 36'h0)
    | (muxState_4_3 ? auto_out_3_b_bits_address : 36'h0);
  ...
  assign auto_out_3_a_bits_user_alias =
    muxState_3_0 & auto_in_0_a_bits_user_alias | muxState_3_1
    & auto_in_1_a_bits_user_alias;
  assign auto_out_3_a_bits_user_vaddr =
    muxState_3_0 ? auto_in_0_a_bits_user_vaddr : 35'h0;
  ...
  assign auto_out_2_a_bits_address =
    ...
    | (muxState_2_2 ? auto_in_2_a_bits_address : 36'h0);
  ...
  assign auto_out_2_a_bits_user_alias =
    muxState_2_0 & auto_in_0_a_bits_user_alias | muxState_2_1
    & auto_in_1_a_bits_user_alias;
  assign auto_out_2_a_bits_user_vaddr =
    muxState_2_0 ? auto_in_0_a_bits_user_vaddr : 35'h0;
  ...
  assign auto_out_1_a_bits_address =
    ...
    | (muxState_1_2 ? auto_in_2_a_bits_address : 36'h0);
  ...
  assign auto_out_1_a_bits_user_alias =
    muxState_1_0 & auto_in_0_a_bits_user_alias | muxState_1_1
    & auto_in_1_a_bits_user_alias;
  assign auto_out_1_a_bits_user_vaddr =
    muxState_1_0 ? auto_in_0_a_bits_user_vaddr : 35'h0;
  ...
  assign auto_out_0_a_bits_user_alias =
    muxState_0 & auto_in_0_a_bits_user_alias | muxState_1 & auto_in_1_a_bits_user_alias;
  assign auto_out_0_a_bits_user_vaddr = muxState_0 ? auto_in_0_a_bits_user_vaddr : 35'h0;
