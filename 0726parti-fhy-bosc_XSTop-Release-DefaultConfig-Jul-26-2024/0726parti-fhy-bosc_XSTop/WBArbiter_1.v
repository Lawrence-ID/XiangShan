...
module WBArbiter_1(
  ...
  wire       _GEN_5 = io_in_3_valid & ~io_in_3_ready_0;
  wire       _GEN_6 = io_in_3_valid & io_in_3_ready_0;
  wire       isFullNext_3 = _GEN_5 ? (&(cancelCounter_3[2:1])) : ~_GEN_6 & isFull_3;
  wire       _GEN_7 =
    ~hasFull
    | ~(io_in_0_valid & isFull_0 | io_in_1_valid & isFull_1 | io_in_2_valid & isFull_2
        | io_in_3_valid & isFull_3);
  wire       finalValid_0 = io_in_0_valid & (_GEN_7 | isFull_0);
  wire       finalValid_1 = io_in_1_valid & (_GEN_7 | isFull_1);
  wire       finalValid_2 = io_in_2_valid & (_GEN_7 | isFull_2);
  wire       finalValid_3 = io_in_3_valid & (_GEN_7 | isFull_3);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_3)
        ...
        cancelCounter_2 <= 3'h0;
      if (_GEN_5)
        cancelCounter_3 <= (&cancelCounter_3) ? 3'h7 : 3'(cancelCounter_3 + 3'h1);
      else if (_GEN_6)
        cancelCounter_3 <= 3'h0;
      isFull_0 <= isFullNext_0;
      isFull_1 <= isFullNext_1;
      isFull_2 <= isFullNext_2;
      isFull_3 <= isFullNext_3;
      hasFull <= |{isFullNext_3, isFullNext_2, isFullNext_1, isFullNext_0};
    end
