...
module StdFreeList_2(
  ...
  wire [5:0]       _GEN_16 = {1'h0, _GEN_15[lastCycleSnpt_snptSelect]};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastCycleRedirect_last_REG = _RANDOM[3'h0][0];
        lastCycleSnpt_useSnpt = _RANDOM[3'h0][3];
        lastCycleSnpt_snptSelect = _RANDOM[3'h0][5:4];
        headPtr_flag = _RANDOM[3'h0][10];
        shiftAmount = _RANDOM[3'h0][15:11];
        headPtrOH = {_RANDOM[3'h0][31:16], _RANDOM[3'h1][4:0]};
        archHeadPtr_flag = _RANDOM[3'h1][5];
        archHeadPtr_value = _RANDOM[3'h1][10:6];
        freeList_0 = _RANDOM[3'h1][18:11];
        freeList_1 = _RANDOM[3'h1][26:19];
        freeList_2 = {_RANDOM[3'h1][31:27], _RANDOM[3'h2][2:0]};
        freeList_3 = _RANDOM[3'h2][10:3];
        freeList_4 = _RANDOM[3'h2][18:11];
        freeList_5 = _RANDOM[3'h2][26:19];
        freeList_6 = {_RANDOM[3'h2][31:27], _RANDOM[3'h3][2:0]};
        freeList_7 = _RANDOM[3'h3][10:3];
        freeList_8 = _RANDOM[3'h3][18:11];
        freeList_9 = _RANDOM[3'h3][26:19];
        freeList_10 = {_RANDOM[3'h3][31:27], _RANDOM[3'h4][2:0]};
        freeList_11 = _RANDOM[3'h4][10:3];
        freeList_12 = _RANDOM[3'h4][18:11];
        freeList_13 = _RANDOM[3'h4][26:19];
        freeList_14 = {_RANDOM[3'h4][31:27], _RANDOM[3'h5][2:0]};
        freeList_15 = _RANDOM[3'h5][10:3];
        freeList_16 = _RANDOM[3'h5][18:11];
        freeList_17 = _RANDOM[3'h5][26:19];
        freeList_18 = {_RANDOM[3'h5][31:27], _RANDOM[3'h6][2:0]};
        freeList_19 = _RANDOM[3'h6][10:3];
        freeList_20 = _RANDOM[3'h6][18:11];
        lastTailPtr_flag = _RANDOM[3'h6][19];
        lastTailPtr_value = _RANDOM[3'h6][24:20];
        io_canAllocate_last_REG = _RANDOM[3'h7][14];
        freeRegCntReg = _RANDOM[3'h7][19:15];
        io_perf_0_value_REG = _RANDOM[3'h7][20];
        io_perf_0_value_REG_1 = _RANDOM[3'h7][21];
        io_perf_1_value_REG = _RANDOM[3'h7][22];
        io_perf_1_value_REG_1 = _RANDOM[3'h7][23];
        io_perf_2_value_REG = _RANDOM[3'h7][24];
        io_perf_2_value_REG_1 = _RANDOM[3'h7][25];
        io_perf_3_value_REG = _RANDOM[3'h7][26];
        io_perf_3_value_REG_1 = _RANDOM[3'h7][27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        lastCycleRedirect_last_REG = 1'h0;
        lastCycleSnpt_useSnpt = 1'h0;
