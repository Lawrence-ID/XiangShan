...
module ICacheDataArray(
  ...
  wire [64:0] writeEntries_0 = {io_write_bits_data[63:0], ^(io_write_bits_data[63:0])};
  wire [64:0] writeEntries_1 =
    {io_write_bits_data[127:64], ^(io_write_bits_data[127:64])};
  wire [64:0] writeEntries_2 =
    {io_write_bits_data[191:128], ^(io_write_bits_data[191:128])};
  wire [64:0] writeEntries_3 =
    {io_write_bits_data[255:192], ^(io_write_bits_data[255:192])};
  wire [64:0] writeEntries_4 =
    {io_write_bits_data[319:256], ^(io_write_bits_data[319:256])};
  wire [64:0] writeEntries_5 =
    {io_write_bits_data[383:320], ^(io_write_bits_data[383:320])};
  wire [64:0] writeEntries_6 =
    {io_write_bits_data[447:384], ^(io_write_bits_data[447:384])};
  wire [64:0] writeEntries_7 =
    {io_write_bits_data[511:448], ^(io_write_bits_data[511:448])};
  ...
  wire [7:0]  dataArrays_3_0_io_r_req_bits_setIdx =
    (|(io_read_0_bits_blkOffset[5:3]))
      ? io_read_0_bits_vSetIdx_1
      : io_read_0_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_1_io_r_req_bits_setIdx =
    (|(io_read_0_bits_blkOffset[5:4]))
      ? io_read_1_bits_vSetIdx_1
      : io_read_1_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_2_io_r_req_bits_setIdx =
    lineSel_2 ? io_read_2_bits_vSetIdx_1 : io_read_2_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_3_io_r_req_bits_setIdx =
    io_read_0_bits_blkOffset[5] ? io_read_3_bits_vSetIdx_1 : io_read_3_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_4_io_r_req_bits_setIdx =
    lineSel_4 ? io_read_0_bits_vSetIdx_1 : io_read_0_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_5_io_r_req_bits_setIdx =
    lineSel_5 ? io_read_1_bits_vSetIdx_1 : io_read_1_bits_vSetIdx_0;
  wire [7:0]  dataArrays_3_6_io_r_req_bits_setIdx =
    (&(io_read_0_bits_blkOffset[5:3]))
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_0 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_0_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_1 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_1_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_2 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_2_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_3 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_3_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_4 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_4_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_5 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_5_io_r_req_bits_setIdx),
  ...
  SRAMTemplateWithFixedWidth dataArrays_0_6 (
    ...
    .io_r_req_bits_setIdx (dataArrays_3_6_io_r_req_bits_setIdx),
