...
module VTypeBuffer(
  ...
  wire            _io_canEnq_T = state == 2'h0;
  wire            _vtypeBufferReadPtrVecNext_T_1 = stateNext == 2'h2;
  wire            _walkPtrNext_T_2 = _io_canEnq_T & _vtypeBufferReadPtrVecNext_T_1;
  ...
  wire [6:0]      _deqPtrNext_new_ptr_T_1 =
    7'({deqPtrVec_0_flag, shiftAmount}
       + {4'h0,
          (_io_canEnq_T ? commitCount : 3'h0)
            | (_spclWalkCount_T ? spclWalkCount : 3'h0)});
  ...
  wire            commitValidVec_0 =
    _io_canEnq_T & (|commitSize) | _spclWalkCount_T & (|spclWalkSize);
  wire            walkValidVec_0 =
    _walkCount_T & (|walkSize) | _spclWalkCount_T & (|spclWalkSize);
  wire            commitValidVec_1 =
    _io_canEnq_T & (|(commitSize[5:1])) | _spclWalkCount_T & (|(spclWalkSize[5:1]));
  wire            walkValidVec_1 =
  ...
  wire            commitValidVec_2 =
    _io_canEnq_T & commitSize > 6'h2 | _spclWalkCount_T & _walkValidVec_2_T_4;
  wire            walkValidVec_2 =
    _walkCount_T & walkSize > 6'h2 | _spclWalkCount_T & _walkValidVec_2_T_4;
  wire            commitValidVec_3 =
    _io_canEnq_T & (|(commitSize[5:2])) | _spclWalkCount_T & (|(spclWalkSize[5:2]));
  wire            walkValidVec_3 =
  ...
  wire            commitValidVec_4 =
    _io_canEnq_T & commitSize > 6'h4 | _spclWalkCount_T & _walkValidVec_4_T_4;
  wire            walkValidVec_4 =
  ...
  wire            commitValidVec_5 =
    _io_canEnq_T & commitSize > 6'h5 | _spclWalkCount_T & _walkValidVec_5_T_4;
  wire            walkValidVec_5 =
  ...
  wire            commitValidVec_6 =
    _io_canEnq_T & commitSize > 6'h6 | _spclWalkCount_T & _walkValidVec_6_T_4;
  wire            walkValidVec_6 =
    _walkCount_T & walkSize > 6'h6 | _spclWalkCount_T & _walkValidVec_6_T_4;
  wire            commitValidVec_7 =
    _io_canEnq_T & (|(commitSize[5:3])) | _spclWalkCount_T & (|(spclWalkSize[5:3]));
  wire            walkValidVec_7 =
  ...
  wire            _GEN_13 =
    _walkCount_T & (io_fromRob_walkEnd | robWalkEndReg) & walkEndNext;
  assign stateNext =
    io_redirect_valid
      ? _GEN_12
      : _io_canEnq_T
          ? 2'h0
          : _spclWalkCount_T ? (spclWalkEndNext ? 2'h2 : state) : _GEN_13 ? 2'h0 : state;
  ...
  wire [6:0]      _enqPtrNext_new_ptr_T_1 =
    7'({enqPtrVec_0_flag, enqPtrVec_0_value} + _GEN_14);
  ...
  wire [6:0]      _GEN_15 = {enqPtrNext_flag, enqPtrNext_value};
  wire [6:0]      _enqPtrVecNext_1_new_ptr_T_1 = 7'(_GEN_15 + 7'h1);
  wire [6:0]      _enqPtrVecNext_2_new_ptr_T_1 = 7'(_GEN_15 + 7'h2);
  wire [6:0]      _enqPtrVecNext_3_new_ptr_T_1 = 7'(_GEN_15 + 7'h3);
  wire [6:0]      _enqPtrVecNext_4_new_ptr_T_1 = 7'(_GEN_15 + 7'h4);
  wire [6:0]      _enqPtrVecNext_5_new_ptr_T_1 = 7'(_GEN_15 + 7'h5);
  wire            _GEN_16 = _walkCount_T & (|walkCount);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_redirect_valid)
        state <= _GEN_12;
      else if (_io_canEnq_T)
        state <= 2'h0;
      else if (_spclWalkCount_T) begin
        if (spclWalkEndNext)
          state <= 2'h2;
      end
      else if (_GEN_13)
      ...
      allowEnqueue_last_REG <= 7'(numValidEntries + _GEN_14) < 7'h3B;
      decodeResumeVType_valid <=
        ~reset & (_spclWalkCount_T ? (|_commitVTypeValid_T) : useSnapshot | _GEN_16);
      if (reset) begin
      end
      else if (_spclWalkCount_T) begin
  ...
  wire            useSnapshotNext =
    _io_canEnq_T & _vtypeBufferReadPtrVecNext_T_1 | _walkCount_T & io_snpt_useSnpt
    & io_redirect_valid;
  always @(posedge clock) begin
    ...
    if (useSnapshotNext) begin
      snapshotVType_illegal <= _GEN_17[io_snpt_snptSelect];
      snapshotVType_vma <= _GEN_18[io_snpt_snptSelect];
      snapshotVType_vta <= _GEN_19[io_snpt_snptSelect];
      snapshotVType_vsew <= _GEN_20[io_snpt_snptSelect];
      snapshotVType_vlmul <= _GEN_21[io_snpt_snptSelect];
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        decodeResumeVType_valid = _RANDOM[4'hA][4];
        decodeResumeVType_bits_illegal = _RANDOM[4'hA][5];
        decodeResumeVType_bits_vma = _RANDOM[4'hA][6];
        decodeResumeVType_bits_vta = _RANDOM[4'hA][7];
        decodeResumeVType_bits_vsew = _RANDOM[4'hA][9:8];
        decodeResumeVType_bits_vlmul = _RANDOM[4'hA][12:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        state = 2'h0;
        enqPtrVec_0_flag = 1'h0;
  ...
  assign io_canEnq = allowEnqueue_last_REG & _io_canEnq_T;
