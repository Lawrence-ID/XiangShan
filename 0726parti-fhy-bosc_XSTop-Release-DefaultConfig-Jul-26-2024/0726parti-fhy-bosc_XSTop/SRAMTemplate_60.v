...
module SRAMTemplate_60(
  ...
  input  [107:0] io_w_req_bits_flattened_bitmask
);

  wire [6:0]   setIdx;
  wire         realRen;
  wire         wen;
  wire [107:0] _array_RW0_rdata;
  reg          _resetState;
  reg  [6:0]   _resetSet;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        rdata_last_REG = _RANDOM[4'h4][25];
        rdata_hold_data_0 = {_RANDOM[4'h4][31:26], _RANDOM[4'h5], _RANDOM[4'h6][15:0]};
        rdata_hold_data_1 = {_RANDOM[4'h6][31:16], _RANDOM[4'h7], _RANDOM[4'h8][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
  ...
  array_6 array (
    ...
    .RW0_wmask
      (_resetState ? 108'hFFFFFFFFFFFFFFFFFFFFFFFFFFF : io_w_req_bits_flattened_bitmask)
  );
