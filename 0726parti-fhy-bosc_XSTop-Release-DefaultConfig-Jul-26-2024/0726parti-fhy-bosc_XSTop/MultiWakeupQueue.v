  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdestCopy_0 = {_RANDOM[4'h6][31:27], _RANDOM[4'h7][2:0]};
        lastConnect_bits_pdestCopy_1 = _RANDOM[4'h7][10:3];
        lastConnect_bits_pdestCopy_2 = _RANDOM[4'h7][18:11];
        lastConnect_bits_pdestCopy_3 = _RANDOM[4'h7][26:19];
        lastConnect_bits_pdestCopy_4 = {_RANDOM[4'h7][31:27], _RANDOM[4'h8][2:0]};
        lastConnect_bits_pdestCopy_5 = _RANDOM[4'h8][10:3];
        lastConnect_bits_rfWenCopy_0 = _RANDOM[4'h8][11];
        lastConnect_bits_rfWenCopy_1 = _RANDOM[4'h8][12];
        lastConnect_bits_rfWenCopy_2 = _RANDOM[4'h8][13];
        lastConnect_bits_rfWenCopy_3 = _RANDOM[4'h8][14];
        lastConnect_bits_rfWenCopy_4 = _RANDOM[4'h8][15];
        lastConnect_bits_rfWenCopy_5 = _RANDOM[4'h8][16];
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'h8][18:17];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'h8][20:19];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'h8][22:21];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'h8][24:23];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'h8][26:25];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'h8][28:27];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'h8][30:29];
        lastConnect_bits_loadDependencyCopy_2_1 = {_RANDOM[4'h8][31], _RANDOM[4'h9][0]};
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'h9][2:1];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'h9][4:3];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'h9][6:5];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'h9][8:7];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'h9][10:9];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'h9][12:11];
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'h9][14:13];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'h9][16:15];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'h9][18:17];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'h9][20:19];
        lastConnect_bits_pdest = _RANDOM[4'h9][28:21];
        lastConnect_bits_rfWen = _RANDOM[4'h9][29];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hC][5:4];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hC][7:6];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hC][9:8];
      `endif // RANDOMIZE_REG_INIT
    end // initial
