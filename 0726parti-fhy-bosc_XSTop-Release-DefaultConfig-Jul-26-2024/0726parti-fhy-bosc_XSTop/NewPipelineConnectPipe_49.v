...
module NewPipelineConnectPipe_49(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_imm = {_RANDOM[3'h3][31:13], _RANDOM[3'h4][12:0]};
        data_robIdx_flag = _RANDOM[3'h4][13];
        data_robIdx_value = _RANDOM[3'h4][21:14];
        data_pdest = {_RANDOM[3'h4][31:27], _RANDOM[3'h5][2:0]};
        data_rfWen = _RANDOM[3'h5][3];
        data_fpWen = _RANDOM[3'h5][4];
        data_preDecode_isRVC = _RANDOM[3'h5][7];
        data_ftqIdx_flag = _RANDOM[3'h5][12];
        data_ftqIdx_value = _RANDOM[3'h5][18:13];
        data_ftqOffset = _RANDOM[3'h5][22:19];
        data_loadWaitBit = _RANDOM[3'h5][23];
        data_waitForRobIdx_flag = _RANDOM[3'h5][24];
        data_waitForRobIdx_value = {_RANDOM[3'h5][31:25], _RANDOM[3'h6][0]};
        data_storeSetHit = _RANDOM[3'h6][1];
        data_loadWaitStrict = _RANDOM[3'h6][2];
        data_sqIdx_flag = _RANDOM[3'h6][8];
        data_sqIdx_value = _RANDOM[3'h6][14:9];
        data_lqIdx_flag = _RANDOM[3'h6][15];
        data_lqIdx_value = _RANDOM[3'h6][22:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
