    ...
    if (reset) begin
      ...
      s3_valid <=
        _s2_fire_T_1
          ...
          : ~(s3_valid & ~s3_kill | s3_kill) & s3_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_uop_robIdx_value = _RANDOM[9'h14][18:11];
        s1_in_uop_sqIdx_flag = _RANDOM[9'h27][20];
        s1_in_uop_sqIdx_value = _RANDOM[9'h27][26:21];
        s1_in_vaddr = {_RANDOM[9'h28][31:2], _RANDOM[9'h29][10:0]};
        s1_in_mask = {_RANDOM[9'h2B][31:24], _RANDOM[9'h2C][7:0]};
        s1_in_wlineflag = _RANDOM[9'h30][9];
        s1_in_isvec = _RANDOM[9'h35][2];
        s1_in_is128bit = _RANDOM[9'h35][4];
        s1_in_usSecondInv = _RANDOM[9'h35][6];
        s1_in_elemIdx = _RANDOM[9'h35][14:7];
        s1_in_mbIndex = _RANDOM[9'h35][21:18];
        s1_in_vecActive = _RANDOM[9'h36][2];
        s1_vecActive = _RANDOM[9'h37][8];
        s1_isvec = _RANDOM[9'h37][9];
        io_issue_bits_r_uop_robIdx_value = _RANDOM[9'h49][27:20];
        s2_valid = _RANDOM[9'h65][16];
        s2_in_uop_exceptionVec_3 = _RANDOM[9'h68][7];
        s2_in_uop_exceptionVec_6 = _RANDOM[9'h68][10];
        s2_in_uop_exceptionVec_7 = _RANDOM[9'h68][11];
        s2_in_uop_exceptionVec_15 = _RANDOM[9'h68][19];
        s2_in_uop_exceptionVec_23 = _RANDOM[9'h68][27];
        s2_in_uop_trigger_backendHit_0 = _RANDOM[9'h69][5];
        s2_in_uop_trigger_backendHit_1 = _RANDOM[9'h69][6];
        s2_in_uop_trigger_backendHit_2 = _RANDOM[9'h69][7];
        s2_in_uop_trigger_backendHit_3 = _RANDOM[9'h69][8];
        s2_in_uop_trigger_backendCanFire_0 = _RANDOM[9'h69][9];
        s2_in_uop_trigger_backendCanFire_1 = _RANDOM[9'h69][10];
        s2_in_uop_trigger_backendCanFire_2 = _RANDOM[9'h69][11];
        s2_in_uop_trigger_backendCanFire_3 = _RANDOM[9'h69][12];
        s2_in_uop_fuType = {_RANDOM[9'h6A][31:26], _RANDOM[9'h6B][28:0]};
        s2_in_uop_robIdx_flag = _RANDOM[9'h77][26];
        s2_in_uop_robIdx_value = {_RANDOM[9'h77][31:27], _RANDOM[9'h78][2:0]};
        s2_in_vaddr = {_RANDOM[9'h8B][31:18], _RANDOM[9'h8C][26:0]};
        s2_in_mask = _RANDOM[9'h8F][23:8];
        s2_in_mmio = _RANDOM[9'h93][30];
        s2_in_atomic = _RANDOM[9'h93][31];
        s2_in_isvec = _RANDOM[9'h98][18];
        s2_in_usSecondInv = _RANDOM[9'h98][22];
        s2_in_elemIdx = _RANDOM[9'h98][30:23];
        s2_in_mbIndex = _RANDOM[9'h99][5:2];
        s2_vecActive = _RANDOM[9'h9A][24];
        s2_exception_REG = _RANDOM[9'h9A][25];
        s2_mmio_REG = _RANDOM[9'h9A][26];
        s2_out_uop_exceptionVec_7_REG = _RANDOM[9'h9A][27];
        io_feedback_slow_valid_last_REG = _RANDOM[9'h9A][28];
        io_feedback_slow_bits_r_hit = _RANDOM[9'h9B][6];
        io_feedback_slow_bits_r_sqIdx_flag = _RANDOM[9'h9B][19];
        io_feedback_slow_bits_r_sqIdx_value = _RANDOM[9'h9B][25:20];
        s2_vecFeedback_REG = _RANDOM[9'h9C][2];
        s3_valid = _RANDOM[9'hD0][16];
        s3_in_uop_exceptionVec_3 = _RANDOM[9'hD3][7];
        s3_in_uop_exceptionVec_6 = _RANDOM[9'hD3][10];
        s3_in_uop_exceptionVec_7 = _RANDOM[9'hD3][11];
        s3_in_uop_exceptionVec_15 = _RANDOM[9'hD3][19];
        s3_in_uop_exceptionVec_23 = _RANDOM[9'hD3][27];
        s3_in_uop_trigger_backendHit_0 = _RANDOM[9'hD4][5];
        s3_in_uop_trigger_backendHit_1 = _RANDOM[9'hD4][6];
        s3_in_uop_trigger_backendHit_2 = _RANDOM[9'hD4][7];
        s3_in_uop_trigger_backendHit_3 = _RANDOM[9'hD4][8];
        s3_in_uop_trigger_backendCanFire_0 = _RANDOM[9'hD4][9];
        s3_in_uop_trigger_backendCanFire_1 = _RANDOM[9'hD4][10];
        s3_in_uop_trigger_backendCanFire_2 = _RANDOM[9'hD4][11];
        s3_in_uop_trigger_backendCanFire_3 = _RANDOM[9'hD4][12];
        s3_in_uop_fuType = {_RANDOM[9'hD5][31:26], _RANDOM[9'hD6][28:0]};
        s3_in_uop_robIdx_flag = _RANDOM[9'hE2][26];
        s3_in_uop_robIdx_value = {_RANDOM[9'hE2][31:27], _RANDOM[9'hE3][2:0]};
        s3_in_vaddr = {_RANDOM[9'hF6][31:18], _RANDOM[9'hF7][26:0]};
        s3_in_mask = _RANDOM[9'hFA][23:8];
        s3_in_usSecondInv = _RANDOM[9'h103][22];
        s3_in_elemIdx = _RANDOM[9'h103][30:23];
        s3_in_mbIndex = _RANDOM[9'h104][5:2];
        s3_vecFeedback = _RANDOM[9'h105][24];
        sx_valid_1_r = _RANDOM[9'h105][25];
        sx_in_1_r_output_uop_exceptionVec_3 = _RANDOM[9'h108][16];
        sx_in_1_r_output_uop_exceptionVec_6 = _RANDOM[9'h108][19];
        sx_in_1_r_output_uop_exceptionVec_7 = _RANDOM[9'h108][20];
        sx_in_1_r_output_uop_exceptionVec_15 = _RANDOM[9'h108][28];
        sx_in_1_r_output_uop_exceptionVec_23 = _RANDOM[9'h109][4];
        sx_in_1_r_output_uop_trigger_backendHit_0 = _RANDOM[9'h109][14];
        sx_in_1_r_output_uop_trigger_backendHit_1 = _RANDOM[9'h109][15];
        sx_in_1_r_output_uop_trigger_backendHit_2 = _RANDOM[9'h109][16];
        sx_in_1_r_output_uop_trigger_backendHit_3 = _RANDOM[9'h109][17];
        sx_in_1_r_output_uop_trigger_backendCanFire_0 = _RANDOM[9'h109][18];
        sx_in_1_r_output_uop_trigger_backendCanFire_1 = _RANDOM[9'h109][19];
        sx_in_1_r_output_uop_trigger_backendCanFire_2 = _RANDOM[9'h109][20];
        sx_in_1_r_output_uop_trigger_backendCanFire_3 = _RANDOM[9'h109][21];
        sx_in_1_r_output_uop_fuType = {_RANDOM[9'h10B][31:3], _RANDOM[9'h10C][5:0]};
        sx_in_1_r_output_uop_robIdx_flag = _RANDOM[9'h118][3];
        sx_in_1_r_output_uop_robIdx_value = _RANDOM[9'h118][11:4];
        sx_in_1_r_vecFeedback = _RANDOM[9'h136][16];
        sx_in_1_r_usSecondInv = _RANDOM[9'h136][18];
        sx_in_1_r_elemIdx = _RANDOM[9'h136][26:19];
        sx_in_1_r_mbIndex = {_RANDOM[9'h136][31:30], _RANDOM[9'h137][1:0]};
        sx_in_1_r_mask = _RANDOM[9'h137][17:2];
        sx_in_1_r_vaddr = {_RANDOM[9'h137][31:18], _RANDOM[9'h138][26:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_vecActive = 1'h1;
