...
module InstrMMIOEntry(
  ...
  output [30:0] io_mmio_acquire_bits_address,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr = {_RANDOM[2'h0][31:2], _RANDOM[2'h1][5:0]};
        respDataReg = {_RANDOM[2'h1][31:6], _RANDOM[2'h2], _RANDOM[2'h3][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 2'h0;
    end // initial
  ...
  assign io_mmio_acquire_bits_address = {req_addr[30:3], 3'h0};
