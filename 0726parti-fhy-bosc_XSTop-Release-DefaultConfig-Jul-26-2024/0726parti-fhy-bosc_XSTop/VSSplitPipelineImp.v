...
module VSSplitPipelineImp(
  ...
  wire [127:0]  uopOffset_otherVUopOffset =
  ...
  wire [4:0]    activeNum =
    s1_in_r_preIsSplit
      ...
      : s1_in_r_flowNum;
  wire [3:0]    _usLowBitsAddr_T_2 =
    4'(s1_in_r_baseAddr[3:0] + uopOffset_otherVUopOffset[3:0]);
  ...
  assign io_out_bits_uopOffset = uopOffset_otherVUopOffset;
