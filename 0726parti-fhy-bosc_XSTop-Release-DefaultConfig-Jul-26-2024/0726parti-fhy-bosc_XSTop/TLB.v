...
module TLB(
  ...
  wire             io_requestor_2_resp_valid;
  wire             hasGpf_2;
  wire             miss_req_v;
  wire             io_requestor_2_req_ready;
  wire             hasGpf_1;
  wire             hasGpf_0;
  ...
  wire             _perfEvents_T_2 = io_requestor_2_req_ready & io_requestor_2_req_valid;
  ...
  wire             _s2_paddr_T_12 = io_ptw_resp_bits_s2_entry_level == 2'h2;
  wire             _s2_paddr_T_10 = io_ptw_resp_bits_s2_entry_level == 2'h1;
  ...
  wire             _s1_paddr_T_10 = io_ptw_resp_bits_s1_entry_level == 2'h0;
  ...
  wire [19:0]      readResult_s1tagFix =
    _s1_paddr_T_10 & _s2_paddr_T_10
      ? _GEN_5
      : _s1_paddr_T_10 & _s2_paddr_T_12
          ? _GEN_4
          : _s1_paddr_T_12 & _s2_paddr_T_12
  ...
  assign io_requestor_2_req_ready = ~req_out_v_2 | io_requestor_2_resp_valid;
  wire [1:0]       miss_req_s2xlate =
    virt_out_2
      ? ((|io_csr_vsatp_mode) & (|io_csr_hgatp_mode)
           ? 2'h3
           : _miss_req_s2xlate_T_5 ? 2'h2 : {1'h0, _miss_req_s2xlate_T_6 | hasGpf_2})
      : 2'h0;
  ...
  wire             _GEN_11 =
    (miss_req_s2xlate_reg == 2'h2
       ? hit_s2_vmid_hit
         & (_s2_paddr_T_12
              ? io_ptw_resp_bits_s2_entry_tag[8:0] == req_out_2_vaddr[20:12] & hit_s2_hit1
                & hit_s2_hit0
              : (~_s2_paddr_T_10 | hit_s2_hit1) & hit_s2_hit0)
       : io_ptw_resp_bits_s1_entry_asid == ((|miss_req_s2xlate_reg)
                                              ? io_csr_vsatp_asid
                                              : io_csr_satp_asid)
         & (~(|miss_req_s2xlate_reg) | _hit_s1_vmid_hit_T)
         & (_s1_paddr_T_14
              ? io_ptw_resp_bits_s1_entry_tag[5:0] == req_out_2_vaddr[20:15] & hit_s1_hit1
                & hit_s1_hit0
              : (~_s1_paddr_T_12 | hit_s1_hit1) & hit_s1_hit0)
         & _GEN_0[req_out_2_vaddr[14:12]]) & io_ptw_resp_valid
    & miss_req_s2xlate_reg == io_ptw_resp_bits_s2xlate & req_out_v_2
    & _portTranslateEnable_T_4;
  wire [3:0][28:0] _GEN_12 =
    {{29'h0},
  ...
  assign io_requestor_2_resp_valid =
    _GEN_14 | _GEN_11 | req_out_v_2 & ~(miss_v & _portTranslateEnable_T_4);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      req_out_v_2 <=
        ~io_flushPipe_2 & (_perfEvents_T_2 | ~io_requestor_2_resp_valid & req_out_v_2);
      need_gpa <=
        ...
        (_ptw_just_back_T_12
           ? io_ptw_resp_bits_s1_entry_asid == ((|io_ptw_resp_bits_s2xlate)
             ...
             & (_s1_paddr_T_14
                  ...
                  : (~_s1_paddr_T_12 | readResult_resp_hit_noS2_hit_hit1)
                    & readResult_resp_hit_noS2_hit_hit0)
           ...
           : onlyS2_4
               ? hit_s2_vmid_hit
                 & (_s2_paddr_T_12
                      ...
                      : (~_s2_paddr_T_10 | readResult_resp_hit_onlyS2_hit_hit1)
                        & readResult_resp_hit_onlyS2_hit_hit0)
        ...
        (_ptw_just_back_T_12
           ? io_ptw_resp_bits_s1_entry_asid == ((|io_ptw_resp_bits_s2xlate)
             ...
             & (_s1_paddr_T_14
                  ...
                  : (~_s1_paddr_T_12 | readResult_resp_hit_noS2_hit_hit1_1)
                    & readResult_resp_hit_noS2_hit_hit0_1)
           ...
           : onlyS2_4
               ? hit_s2_vmid_hit
                 & (_s2_paddr_T_12
                      ...
                      : (~_s2_paddr_T_10 | readResult_resp_hit_onlyS2_hit_hit1_1)
                        & readResult_resp_hit_onlyS2_hit_hit0_1)
        ...
        (_ptw_just_back_T_12
           ? io_ptw_resp_bits_s1_entry_asid == ((|io_ptw_resp_bits_s2xlate)
             ...
             & (_s1_paddr_T_14
                  ...
                  : (~_s1_paddr_T_12 | readResult_resp_hit_noS2_hit_hit1_2)
                    & readResult_resp_hit_noS2_hit_hit0_2)
           ...
           : onlyS2_4
               ? hit_s2_vmid_hit
                 & (_s2_paddr_T_12
                      ...
                      : (~_s2_paddr_T_10 | readResult_resp_hit_onlyS2_hit_hit1_2)
                        & readResult_resp_hit_onlyS2_hit_hit0_2)
      ...
      miss_v_valid <=
        ~(io_flushPipe_2 | io_requestor_2_resp_valid) & (miss_wire | miss_v_valid);
      miss_req_v_valid <=
        ~(io_flushPipe_2 | _miss_req_v_T_4 | io_requestor_2_resp_valid)
        & (_miss_req_v_T_3 | miss_req_v_valid);
    end
  end // always @(posedge, posedge)
  wire             _GEN_15 = _GEN_6 | ~_readResult_T_27;
  wire             readResult_onlyS2 = req_in_s2xlate_0 == 2'h2;
  wire [3:0][28:0] _GEN_16 =
    {{29'h0},
  ...
  wire [17:0]      readResult_gvpn =
    readResult_onlyS2
      ...
      : _GEN_16[io_ptw_resp_bits_s1_entry_level][17:0];
  wire             readResult_onlyS2_1 = req_in_s2xlate_1 == 2'h2;
  wire [3:0][28:0] _GEN_17 =
    {{29'h0},
  ...
  wire [17:0]      readResult_gvpn_2 =
    readResult_onlyS2_1
      ...
      : _GEN_17[io_ptw_resp_bits_s1_entry_level][17:0];
    ...
    if (io_ptw_resp_valid) begin
      ...
      readResult_p_ppn_1 <=
        (|req_in_s2xlate_1)
          ...
          : _GEN_17[io_ptw_resp_bits_s1_entry_level];
  ...
  assign io_requestor_2_resp_bits_paddr_0 =
    _GEN_11
      ? {(|io_ptw_resp_bits_s2xlate)
           ...
           : _GEN_12[io_ptw_resp_bits_s1_entry_level][23:0],
  ...
  assign io_requestor_2_resp_bits_gpaddr_0 =
    _GEN_11
      ? {_GEN_12[io_ptw_resp_bits_s1_entry_level], req_out_2_vaddr[11:0]}
      : (readResult_p_hit_last_REG_2
          ...
          : {hasGpf_2
               ...
               : 29'h0,
             req_out_2_vaddr[11:0]};
  assign io_requestor_2_resp_bits_miss = ~_GEN_11 & miss_read_2;
  ...
  assign io_requestor_2_resp_bits_excp_0_af_instr =
    _GEN_11 ? af_3 & (s1_valid_3 | s2_valid_3) : af_2 & (s1_valid_2 | s2_valid_2);
        ...
        & (_ptw_just_back_T_12
             ? io_ptw_resp_bits_s1_entry_asid == ((|io_ptw_resp_bits_s2xlate)
               ...
               & (_s1_paddr_T_14
                    ...
                    : (~_s1_paddr_T_12 | ptw_just_back_noS2_hit_hit1)
             ...
             : onlyS2_4
                 ? hit_s2_vmid_hit
                   & (_s2_paddr_T_12
                        ...
                        : (~_s2_paddr_T_10 | ptw_just_back_onlyS2_hit_hit1)
        ...
        & (_ptw_just_back_T_12
             ? io_ptw_resp_bits_s1_entry_asid == ((|io_ptw_resp_bits_s2xlate)
               ...
               & (_s1_paddr_T_14
                    ...
                    : (~_s1_paddr_T_12 | ptw_just_back_noS2_hit_hit1_1)
             ...
             : onlyS2_4
                 ? hit_s2_vmid_hit
                   & (_s2_paddr_T_12
                        ...
                        : (~_s2_paddr_T_10 | ptw_just_back_onlyS2_hit_hit1_1)
                          & ptw_just_back_onlyS2_hit_hit0_1)
