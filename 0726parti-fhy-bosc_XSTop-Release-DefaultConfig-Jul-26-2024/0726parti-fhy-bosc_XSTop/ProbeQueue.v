...
module ProbeQueue(
  ...
  wire        pipe_req_arb_io_out_ready;
  ...
  wire [40:0] _entries_7_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_7_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_6_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_6_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_5_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_5_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_4_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_4_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_3_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_3_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_2_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_2_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_1_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_1_io_pipe_req_bits_addr;
  ...
  wire [40:0] _entries_0_io_pipe_req_bits_vaddr;
  wire [35:0] _entries_0_io_pipe_req_bits_addr;
  ...
  wire [40:0] _pipe_req_arb_io_out_bits_vaddr;
  wire [35:0] _pipe_req_arb_io_out_bits_addr;
  ...
  wire [40:0] req_vaddr =
    {5'h0,
     io_mem_probe_bits_address[35:13],
     io_mem_probe_bits_data[1],
  ...
  wire        _selected_lrsc_blocked_T =
    pipe_req_arb_io_out_ready & _pipe_req_arb_io_out_valid;
  reg  [1:0]  selected_req_bits_probe_param;
  reg         selected_req_bits_probe_need_data;
  reg  [40:0] selected_req_bits_vaddr;
  reg  [35:0] selected_req_bits_addr;
  reg         resvsetProbeBlock;
  assign pipe_req_arb_io_out_ready = ~selected_req_valid | perfEvents_0_2;
    ...
    resvsetProbeBlock <=
      ...
      | (_selected_lrsc_blocked_T
           ? io_lrsc_locked_block_valid
             & io_lrsc_locked_block_bits[35:6] == _pipe_req_arb_io_out_bits_addr[35:6]
           : io_lrsc_locked_block_valid
             & io_lrsc_locked_block_bits[35:6] == selected_req_bits_addr[35:6]
             & selected_req_valid);
    perfValidCount <=
      4'({1'h0,
          3'({1'h0,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        selected_req_bits_vaddr = {_RANDOM[5'h0][31:22], _RANDOM[5'h1][30:0]};
        selected_req_bits_addr = {_RANDOM[5'h1][31], _RANDOM[5'h2], _RANDOM[5'h3][2:0]};
        selected_req_bits_id = {_RANDOM[5'h17][31:28], _RANDOM[5'h18][1:0]};
        resvsetProbeBlock = _RANDOM[5'h18][2];
        perfValidCount = _RANDOM[5'h18][6:3];
        io_perf_0_value_REG = _RANDOM[5'h18][7];
        io_perf_0_value_REG_1 = _RANDOM[5'h18][8];
        io_perf_1_value_REG = _RANDOM[5'h18][9];
        io_perf_1_value_REG_1 = _RANDOM[5'h18][10];
        io_perf_2_value_REG = _RANDOM[5'h18][11];
        io_perf_2_value_REG_1 = _RANDOM[5'h18][12];
        io_perf_3_value_REG = _RANDOM[5'h18][13];
        io_perf_3_value_REG_1 = _RANDOM[5'h18][14];
        io_perf_4_value_REG = _RANDOM[5'h18][15];
        io_perf_4_value_REG_1 = _RANDOM[5'h18][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        selected_req_valid = 1'h0;
    end // initial
