...
module GPAMem(
  ...
  input  [40:0] io_fromIFU_gpaddrMem_wdata,
  ...
  output [40:0] io_exceptionReadData
);

  wire [40:0] _mem_io_rdata_0;
  reg  [3:0]  ftqOffset;
  ...
  SyncDataModuleTemplate__64entry_4 mem (
    ...
    .io_rdata_0 (_mem_io_rdata_0),
    .io_wen_0   (io_fromIFU_gpaddrMem_wen),
    .io_waddr_0 (io_fromIFU_gpaddrMem_waddr),
    .io_wdata_0 (io_fromIFU_gpaddrMem_wdata)
  );
  assign io_exceptionReadData = 41'(_mem_io_rdata_0 + {36'h0, ftqOffset, 1'h0});
endmodule
