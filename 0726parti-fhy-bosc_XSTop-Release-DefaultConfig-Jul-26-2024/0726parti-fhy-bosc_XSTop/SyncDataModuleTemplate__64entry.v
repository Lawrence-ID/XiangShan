...
module SyncDataModuleTemplate__64entry(
  ...
  wire [40:0] _dataBanks_3_io_rdata_0_topAddr;
  ...
  wire [40:0] _dataBanks_2_io_rdata_0_topAddr;
  ...
  wire [40:0] _dataBanks_1_io_rdata_0_topAddr;
  ...
  wire [40:0] _dataBanks_0_io_rdata_0_topAddr;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_topAddr = {_RANDOM[4'h1][31:27], _RANDOM[4'h2], _RANDOM[4'h3][3:0]};
        raddr_dup_0_1 = _RANDOM[4'h3][9:4];
        raddr_dup_1_1 = _RANDOM[4'h3][15:10];
        raddr_dup_2_1 = _RANDOM[4'h3][21:16];
        wen_dup_last_REG_1 = _RANDOM[4'h3][22];
        waddr_dup_0_1 = _RANDOM[4'h3][28:23];
        r_1_histPtr_flag = _RANDOM[4'h3][29];
        r_1_histPtr_value = {_RANDOM[4'h3][31:30], _RANDOM[4'h4][5:0]};
        r_1_ssp = _RANDOM[4'h4][9:6];
        r_1_sctr = _RANDOM[4'h4][12:10];
        r_1_TOSW_flag = _RANDOM[4'h4][13];
        r_1_TOSW_value = _RANDOM[4'h4][18:14];
        r_1_TOSR_flag = _RANDOM[4'h4][19];
        r_1_TOSR_value = _RANDOM[4'h4][24:20];
        r_1_NOS_flag = _RANDOM[4'h4][25];
        r_1_NOS_value = _RANDOM[4'h4][30:26];
        r_1_topAddr = {_RANDOM[4'h4][31], _RANDOM[4'h5], _RANDOM[4'h6][7:0]};
        raddr_dup_0_2 = _RANDOM[4'h6][13:8];
        raddr_dup_1_2 = _RANDOM[4'h6][19:14];
        raddr_dup_2_2 = _RANDOM[4'h6][25:20];
        wen_dup_last_REG_2 = _RANDOM[4'h6][26];
        waddr_dup_0_2 = {_RANDOM[4'h6][31:27], _RANDOM[4'h7][0]};
        r_2_histPtr_flag = _RANDOM[4'h7][1];
        r_2_histPtr_value = _RANDOM[4'h7][9:2];
        r_2_ssp = _RANDOM[4'h7][13:10];
        r_2_sctr = _RANDOM[4'h7][16:14];
        r_2_TOSW_flag = _RANDOM[4'h7][17];
        r_2_TOSW_value = _RANDOM[4'h7][22:18];
        r_2_TOSR_flag = _RANDOM[4'h7][23];
        r_2_TOSR_value = _RANDOM[4'h7][28:24];
        r_2_NOS_flag = _RANDOM[4'h7][29];
        r_2_NOS_value = {_RANDOM[4'h7][31:30], _RANDOM[4'h8][2:0]};
        r_2_topAddr = {_RANDOM[4'h8][31:3], _RANDOM[4'h9][11:0]};
        raddr_dup_0_3 = _RANDOM[4'h9][17:12];
        raddr_dup_1_3 = _RANDOM[4'h9][23:18];
        raddr_dup_2_3 = _RANDOM[4'h9][29:24];
        wen_dup_last_REG_3 = _RANDOM[4'h9][30];
        waddr_dup_0_3 = {_RANDOM[4'h9][31], _RANDOM[4'hA][4:0]};
        r_3_histPtr_flag = _RANDOM[4'hA][5];
        r_3_histPtr_value = _RANDOM[4'hA][13:6];
        r_3_ssp = _RANDOM[4'hA][17:14];
        r_3_sctr = _RANDOM[4'hA][20:18];
        r_3_TOSW_flag = _RANDOM[4'hA][21];
        r_3_TOSW_value = _RANDOM[4'hA][26:22];
        r_3_TOSR_flag = _RANDOM[4'hA][27];
        r_3_TOSR_value = {_RANDOM[4'hA][31:28], _RANDOM[4'hB][0]};
        r_3_NOS_flag = _RANDOM[4'hB][1];
        r_3_NOS_value = _RANDOM[4'hB][6:2];
        r_3_topAddr = {_RANDOM[4'hB][31:7], _RANDOM[4'hC][15:0]};
        raddr_dup = _RANDOM[4'hC][21:16];
        raddr_dup_3 = _RANDOM[4'hC][27:22];
        raddr_dup_4 = {_RANDOM[4'hC][31:28], _RANDOM[4'hD][1:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        wen_dup_last_REG = 1'h0;
        wen_dup_last_REG_1 = 1'h0;
  ...
  NegedgeDataModule__16entry dataBanks_0 (
    .clock                    (clock),
  ...
  NegedgeDataModule__16entry dataBanks_1 (
    .clock                    (clock),
  ...
  NegedgeDataModule__16entry dataBanks_2 (
    .clock                    (clock),
  ...
  NegedgeDataModule__16entry dataBanks_3 (
    .clock                    (clock),
  ...
  assign io_rdata_0_topAddr =
    (_io_rdata_0_T ? _dataBanks_0_io_rdata_0_topAddr : 41'h0)
    | (_io_rdata_0_T_1 ? _dataBanks_1_io_rdata_0_topAddr : 41'h0)
    | (_io_rdata_0_T_2 ? _dataBanks_2_io_rdata_0_topAddr : 41'h0)
    | ((&(raddr_dup[5:4])) ? _dataBanks_3_io_rdata_0_topAddr : 41'h0);
