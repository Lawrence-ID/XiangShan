...
module Rename(
  ...
  wire       intFreeList_io_doAllocate =
  ...
  assign _genSnapshot_T_12 =
    {io_out_0_valid_0 & io_out_0_bits_snapshot_0,
  ...
  wire       _renamePerf_T = canOut & io_in_0_valid;
  ...
  wire       robIdxHeadNext_flag =
    io_redirect_valid
      ? io_redirect_bits_robIdx_flag
      : lastCycleMisprediction_last_REG
          ? robIdxHeadNext_reverse_flag ^ robIdxHead_flag
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      else if (lastCycleMisprediction_last_REG)
      ...
      notInSameSnpt_last_REG <=
        (|(robIdxHeadNext_flag == io_snptLastEnq_bits_flag
  ...
  StdFreeList_1 vecFreeList (
    ...
    .io_doAllocate           (vecFreeList_io_doAllocate),
  ...
  StdFreeList_2 v0FreeList (
    ...
    .io_doAllocate           (v0FreeList_io_doAllocate),
  ...
  StdFreeList_3 vlFreeList (
    ...
    .io_doAllocate           (vlFreeList_io_doAllocate),
  ...
  assign io_intRenamePorts_0_wen =
    needIntDest_0 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
  ...
  assign io_intRenamePorts_1_wen =
    needIntDest_1 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_intRenamePorts_2_wen =
    needIntDest_2 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_intRenamePorts_3_wen =
    needIntDest_3 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_intRenamePorts_4_wen =
    needIntDest_4 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_intRenamePorts_5_wen =
    needIntDest_5 & _intFreeList_io_canAllocate & intFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_0_wen =
    needFpDest_0 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_1_wen =
    needFpDest_1 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_2_wen =
    needFpDest_2 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_3_wen =
    needFpDest_3 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_4_wen =
    needFpDest_4 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_fpRenamePorts_5_wen =
    needFpDest_5 & _fpFreeList_io_canAllocate & fpFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_0_wen =
    needVecDest_0 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_1_wen =
    needVecDest_1 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_2_wen =
    needVecDest_2 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_3_wen =
    needVecDest_3 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_4_wen =
    needVecDest_4 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
  ...
  assign io_vecRenamePorts_5_wen =
    needVecDest_5 & _vecFreeList_io_canAllocate & vecFreeList_io_doAllocate
    & ~io_rabCommits_isWalk & ~io_redirect_valid;
