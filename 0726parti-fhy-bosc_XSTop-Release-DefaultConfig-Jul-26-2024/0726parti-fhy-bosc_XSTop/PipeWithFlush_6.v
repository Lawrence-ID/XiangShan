  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_fuType = {_RANDOM[5'h0][31:1], _RANDOM[5'h1][3:0]};
        ...
        bits_1_vecWen = _RANDOM[5'h9][5];
        bits_1_v0Wen = _RANDOM[5'h9][6];
        bits_1_loadDependency_0 = _RANDOM[5'h13][6:5];
        bits_1_loadDependency_1 = _RANDOM[5'h13][8:7];
        bits_1_loadDependency_2 = _RANDOM[5'h13][10:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valids_1 = 1'h0;
    end // initial
