...
module BusyTable_9(
  ...
  always @(posedge clock) begin
    ...
    busyCount <= 5'(busyCount_REG + busyCount_REG_1);
    io_perf_0_value_REG <= busyCount < 5'h8;
    io_perf_0_value_REG_1 <= io_perf_0_value_REG;
    io_perf_1_value_REG <= busyCount > 5'h8 & busyCount < 5'h11;
    io_perf_1_value_REG_1 <= io_perf_1_value_REG;
    io_perf_2_value_REG <= busyCount > 5'h10 & busyCount < 5'h19;
    io_perf_2_value_REG_1 <= io_perf_2_value_REG;
    io_perf_3_value_REG <= busyCount > 5'h18;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        busyCount_REG = _RANDOM[3'h7][4:0];
        busyCount_REG_1 = _RANDOM[3'h7][9:5];
        busyCount = _RANDOM[3'h7][14:10];
        io_perf_0_value_REG = _RANDOM[3'h7][15];
        io_perf_0_value_REG_1 = _RANDOM[3'h7][16];
        io_perf_1_value_REG = _RANDOM[3'h7][17];
        io_perf_1_value_REG_1 = _RANDOM[3'h7][18];
        io_perf_2_value_REG = _RANDOM[3'h7][19];
        io_perf_2_value_REG_1 = _RANDOM[3'h7][20];
        io_perf_3_value_REG = _RANDOM[3'h7][21];
        io_perf_3_value_REG_1 = _RANDOM[3'h7][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        loadDependency_0_0 = 2'h0;
        loadDependency_0_1 = 2'h0;
