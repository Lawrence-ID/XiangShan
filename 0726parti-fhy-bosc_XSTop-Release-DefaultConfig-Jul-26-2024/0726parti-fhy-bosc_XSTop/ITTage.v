...
module ITTage(
  ...
  wire         _s2_tageTarget_T_3 = providerNull & selectedInfo_hasTwo;
  wire [40:0]  _s2_tageTarget_T_12 =
    (selectedInfo_hasOne & ~_s2_tageTarget_T_3 ? selectedInfo_first_target : 41'h0)
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (&tickCtr)
        ...
        tickCtr <=
          (&tickCtr) & ~(io_update_bits_meta[85])
            ? 8'hFF
            : tickCtr == 8'h0 & io_update_bits_meta[85]
                ? 8'h0
                : io_update_bits_meta[85] ? 8'(tickCtr - 8'h1) : 8'(tickCtr + 8'h1);
