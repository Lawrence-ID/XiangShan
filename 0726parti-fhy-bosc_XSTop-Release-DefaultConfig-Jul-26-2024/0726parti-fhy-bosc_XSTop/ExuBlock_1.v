...
module ExuBlock_1(
  ...
  input  [34:0]  io_in_4_1_bits_fuType,
  input  [8:0]   io_in_4_1_bits_fuOpType,
  input  [63:0]  io_in_4_1_bits_src_0,
  input  [63:0]  io_in_4_1_bits_src_1,
  input          io_in_4_1_bits_robIdx_flag,
  input  [7:0]   io_in_4_1_bits_robIdx_value,
  input  [7:0]   io_in_4_1_bits_pdest,
  input          io_in_4_1_bits_fpWen,
  input          io_in_4_1_bits_fpu_wflags,
  input  [2:0]   io_in_4_1_bits_fpu_rm,
  input  [1:0]   io_in_4_1_bits_vpu_vsew,
  output         io_in_4_0_ready,
  input          io_in_4_0_valid,
  input  [34:0]  io_in_4_0_bits_fuType,
  input  [8:0]   io_in_4_0_bits_fuOpType,
  input  [63:0]  io_in_4_0_bits_src_0,
  input  [63:0]  io_in_4_0_bits_src_1,
  input          io_in_4_0_bits_robIdx_flag,
  input  [7:0]   io_in_4_0_bits_robIdx_value,
  input  [7:0]   io_in_4_0_bits_pdest,
  input          io_in_4_0_bits_fpWen,
  input          io_in_4_0_bits_fpu_wflags,
  input  [2:0]   io_in_4_0_bits_fpu_rm,
  input  [1:0]   io_in_4_0_bits_vpu_vsew,
  ...
  input  [63:0]  io_in_3_0_bits_src_2,
  ...
  input          io_in_3_0_bits_fpWen,
  input          io_in_3_0_bits_fpu_wflags,
  input  [2:0]   io_in_3_0_bits_fpu_rm,
  input  [1:0]   io_in_3_0_bits_vpu_vsew,
  ...
  output [63:0]  io_out_4_1_bits_data_1,
  ...
  output [4:0]   io_out_4_1_bits_fflags,
  output         io_out_4_1_bits_wflags,
  input          io_out_4_0_ready,
  output         io_out_4_0_valid,
  output [63:0]  io_out_4_0_bits_data_1,
  ...
  output [4:0]   io_out_4_0_bits_fflags,
  output         io_out_4_0_bits_wflags,
  output         io_out_3_0_valid,
  output [63:0]  io_out_3_0_bits_data_0,
  output [63:0]  io_out_3_0_bits_data_1,
  output [63:0]  io_out_3_0_bits_data_2,
  ...
  output [4:0]   io_out_3_0_bits_fflags,
  output         io_out_3_0_bits_wflags,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        exus_io_frm_REG_5 = _RANDOM[/*Zero width*/ 1'b0][17:15];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ExeUnit_9 exus_3 (
    ...
    .io_in_bits_src_2           (io_in_3_0_bits_src_2),
    ...
    .io_in_bits_fpWen           (io_in_3_0_bits_fpWen),
    .io_in_bits_fpu_wflags      (io_in_3_0_bits_fpu_wflags),
    .io_in_bits_fpu_rm          (io_in_3_0_bits_fpu_rm),
    .io_in_bits_vpu_vsew        (io_in_3_0_bits_vpu_vsew),
    .io_out_valid               (io_out_3_0_valid),
    .io_out_bits_data_0         (io_out_3_0_bits_data_0),
    .io_out_bits_data_1         (io_out_3_0_bits_data_1),
    .io_out_bits_data_2         (io_out_3_0_bits_data_2),
    ...
    .io_out_bits_fpWen          (io_out_3_0_bits_fpWen),
    .io_out_bits_fflags         (io_out_3_0_bits_fflags),
    .io_out_bits_wflags         (io_out_3_0_bits_wflags),
  ...
  ExeUnit_12 exus_4 (
    ...
    .io_in_bits_fuType          (io_in_4_0_bits_fuType),
    .io_in_bits_fuOpType        (io_in_4_0_bits_fuOpType),
    .io_in_bits_src_0           (io_in_4_0_bits_src_0),
    .io_in_bits_src_1           (io_in_4_0_bits_src_1),
    .io_in_bits_robIdx_flag     (io_in_4_0_bits_robIdx_flag),
    .io_in_bits_robIdx_value    (io_in_4_0_bits_robIdx_value),
    .io_in_bits_pdest           (io_in_4_0_bits_pdest),
    .io_in_bits_fpWen           (io_in_4_0_bits_fpWen),
    .io_in_bits_fpu_wflags      (io_in_4_0_bits_fpu_wflags),
    .io_in_bits_fpu_rm          (io_in_4_0_bits_fpu_rm),
    .io_in_bits_vpu_vsew        (io_in_4_0_bits_vpu_vsew),
    .io_out_ready               (io_out_4_0_ready),
    .io_out_valid               (io_out_4_0_valid),
    .io_out_bits_data_1         (io_out_4_0_bits_data_1),
    ...
    .io_out_bits_fpWen          (io_out_4_0_bits_fpWen),
    .io_out_bits_fflags         (io_out_4_0_bits_fflags),
    .io_out_bits_wflags         (io_out_4_0_bits_wflags),
  ...
  ExeUnit_12 exus_5 (
    ...
    .io_flush_bits_robIdx_value (io_flush_bits_robIdx_value),
    .io_flush_bits_level        (io_flush_bits_level),
    .io_in_ready                (io_in_4_1_ready),
    .io_in_valid                (io_in_4_1_valid),
    .io_in_bits_fuType          (io_in_4_1_bits_fuType),
    .io_in_bits_fuOpType        (io_in_4_1_bits_fuOpType),
    .io_in_bits_src_0           (io_in_4_1_bits_src_0),
    .io_in_bits_src_1           (io_in_4_1_bits_src_1),
    .io_in_bits_robIdx_flag     (io_in_4_1_bits_robIdx_flag),
    .io_in_bits_robIdx_value    (io_in_4_1_bits_robIdx_value),
    .io_in_bits_pdest           (io_in_4_1_bits_pdest),
    .io_in_bits_fpWen           (io_in_4_1_bits_fpWen),
    .io_in_bits_fpu_wflags      (io_in_4_1_bits_fpu_wflags),
    .io_in_bits_fpu_rm          (io_in_4_1_bits_fpu_rm),
    .io_in_bits_vpu_vsew        (io_in_4_1_bits_vpu_vsew),
    .io_out_ready               (io_out_4_1_ready),
    .io_out_valid               (io_out_4_1_valid),
    .io_out_bits_data_1         (io_out_4_1_bits_data_1),
    .io_out_bits_pdest          (io_out_4_1_bits_pdest),
    .io_out_bits_robIdx_flag    (io_out_4_1_bits_robIdx_flag),
    .io_out_bits_robIdx_value   (io_out_4_1_bits_robIdx_value),
    .io_out_bits_fpWen          (io_out_4_1_bits_fpWen),
    .io_out_bits_fflags         (io_out_4_1_bits_fflags),
    .io_out_bits_wflags         (io_out_4_1_bits_wflags),
    .io_frm                     (exus_io_frm_REG_5)
  );
endmodule
