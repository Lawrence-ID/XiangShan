...
module ITTageTable_2(
  ...
  wire [8:0]  update_folded_hist_hist_13_folded_hist =
    {io_update_ghist[8:4], io_update_ghist[3:0] ^ io_update_ghist[12:9]};
  wire [7:0]  update_folded_hist_hist_4_folded_hist =
    {io_update_ghist[7:5], io_update_ghist[4:0] ^ io_update_ghist[12:8]};
  wire [8:0]  update_idx = io_update_pc[9:1] ^ update_folded_hist_hist_13_folded_hist;
  reg         needReset;
  ...
  FoldedSRAMTemplate_23 table_0 (
    ...
    .io_w_req_bits_data_0_tag
      (io_update_pc[18:10] ^ update_folded_hist_hist_13_folded_hist
       ^ {update_folded_hist_hist_4_folded_hist, 1'h0}),
