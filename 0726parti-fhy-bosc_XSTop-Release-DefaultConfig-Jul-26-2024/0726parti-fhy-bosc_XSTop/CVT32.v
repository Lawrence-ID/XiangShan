...
module CVT32(
  ...
  wire [22:0]  out_exp_fp32_clz_io_in = _sig_T_2[22:0] | (is_vfr ? _in_T_5[22:0] : 23'h0);
  ...
  wire [23:0]  rounder_io_in = {_round_in_reg0_T_10[23], _GEN_4[22:10], _cout_reg0_T_14};
  wire         _out_reg0_T = is_fp2int_reg0 | is_int2fp_reg0;
  reg          sel_lpath_reg0;
  reg  [31:0]  max_min_int_reg0;
  wire         _clz_fp16_T = is_vfr & _in_is_fp16_T_7;
  wire         _clz_fp32_T = is_vfr & _in_is_fp32_T_5;
  wire         _is_normal_T_14 =
    _clz_fp16_T & (|(exp[4:0])) & exp[4:0] != 5'h1F | _clz_fp32_T & (|exp) & ~(&exp);
  wire         is_subnormal = _clz_fp16_T & exp[4:0] == 5'h0 | _clz_fp32_T & ~(|exp);
  wire         is_poszero_posinf =
    _clz_fp16_T & ~_sign_T_11
    & (_is_normal_T_14 | is_subnormal & (|(out_exp_fp32_clz_io_in[22:13]))) | _clz_fp32_T
    & ~_sign_T_11 & (_is_normal_T_14 | is_subnormal & (|out_exp_fp32_clz_io_in));
  wire [3:0]   zero_minus_lzc_f16 =
    _clz_fp16_T ? 4'(4'h0 - _zero_minus_lzc_f16_clz_io_out) : 4'h0;
  wire [4:0]   zero_minus_lzc_f32 =
    _clz_fp32_T ? 5'(5'h0 - _zero_minus_lzc_f32_clz_io_out) : 5'h0;
  ...
  wire [10:0]  clz_fp16_clz_io_in =
    (_in_is_fp16_T_7 & (_out_sign_T & _is_normal_T_14 | _sig_normalized_24_T_2)
       ? {1'h0, out_exp_fp32_clz_io_in[22:13]}
       : 11'h0)
    | (_in_is_fp16_T_7 & (_out_sign_T & ~_is_normal_T_14 | is_vfrec7 & ~_is_normal_T_14)
         ? {out_exp_fp32_clz_io_in[22:13], 1'h0}
         : 11'h0);
  wire [23:0]  clz_fp32_clz_io_in =
    (_in_is_fp32_T_5 & (_out_sign_T & _is_normal_T_14 | _sig_normalized_24_T_2)
       ? {1'h0, out_exp_fp32_clz_io_in}
       : 24'h0)
    | (_in_is_fp32_T_5 & (_out_sign_T & ~_is_normal_T_14 | is_vfrec7 & ~_is_normal_T_14)
         ? {out_exp_fp32_clz_io_in, 1'h0}
         : 24'h0);
  reg  [3:0]   clz_fp16_reg0;
  reg  [7:0]   clz_fp32_reg0;
  wire         _out_exp_fp16_T_7 = is_vfrec7 & _in_is_fp16_T_7;
  wire [4:0]   _out_exp_normalized_fp16_T_1 = 5'(5'h1D - _exp_normalized_5_T_17);
  wire [4:0]   out_exp_normalized_fp16 =
    _out_exp_fp16_T_7 ? _out_exp_normalized_fp16_T_1 : 5'h0;
  wire         _out_exp_fp32_T_7 = is_vfrec7 & _in_is_fp32_T_5;
  wire [7:0]   _out_exp_normalized_fp32_T_1 = 8'(8'hFD - _exp_normalized_8_T_18);
  wire [7:0]   out_exp_normalized_fp32 =
    _out_exp_fp32_T_7 ? _out_exp_normalized_fp32_T_1 : 8'h0;
  reg          out_exp_zero_negone_reg0;
  wire         _out_exp_zero_negone_T_12 =
    _out_exp_fp16_T_7 & (out_exp_normalized_fp16 == 5'h0 | (&out_exp_normalized_fp16))
    | _out_exp_fp32_T_7 & (out_exp_normalized_fp32 == 8'h0 | (&out_exp_normalized_fp32));
  ...
  wire [15:0]  _rpath_neg_of_reg0_T_6 = {_GEN_4[15:10], _cout_reg0_T_14};
  wire         cout_reg0 =
    _rounder_io_r_up
    & (_int_reg0_T_1 & (&rounder_io_in) | _int_reg0_T
       & (&{_GEN_4[14:10], _cout_reg0_T_14}) | fp16toint8_reg0 & (&(_cout_reg0_T_14[6:0]))
       | int16tofp32_reg0 & (&_rpath_neg_of_reg0_T_6) | int32tofp32_reg0
  ...
  wire         _is_inf_T_16 =
    _clz_fp16_T & (&(exp[4:0])) & out_exp_fp32_clz_io_in[22:13] == 10'h0 | _clz_fp32_T
    & (&exp) & out_exp_fp32_clz_io_in == 23'h0;
  wire         _is_nan_T_14 =
    _clz_fp16_T & (&(exp[4:0])) & (|(out_exp_fp32_clz_io_in[22:13])) | _clz_fp32_T
    & (&exp) & (|out_exp_fp32_clz_io_in);
  ...
  wire [31:0]  _result0_T_161 =
                   ...
                   {_out_sig_23_reg0_T_27[22],
                    _out_sig_23_reg0_T_27[21:0]
                     ...
                     | (_result1H_T_70 & ~out_exp_zero_negone_reg0
                          ...
                          : 23'h0)}
                : 32'h0)
         : 32'h0) | (result1H[19] ? {is_negzero_reg0, 31'h7F800000} : 32'h0)
    | (result1H[20]
    ...
    | {_result0_T_142[31] | result1H[18] & is_neginf_reg0,
       ...
       _result0_T_142[15:0]
         ...
         | (result1H[13]
              ? (_result0_T_51 | _result0_T_52 ? 16'h7BFF : 16'h7C00)
              : 16'h0)};
    ...
    if (reset) begin
      ...
      if (io_fire) begin
        ...
        is_neginf_negzero_reg0 <=
          _clz_fp16_T & _sign_T_11
          & (_is_normal_T_14 | is_subnormal & (|(out_exp_fp32_clz_io_in[22:13])))
          | _clz_fp32_T & _sign_T_11
          & (_is_normal_T_14 | is_subnormal & (|out_exp_fp32_clz_io_in));
        is_negzero_reg0 <=
          _clz_fp16_T & _is_negzero_T_8 & out_exp_fp32_clz_io_in[22:13] == 10'h0
          | _clz_fp32_T & _is_negzero_T_8 & out_exp_fp32_clz_io_in == 23'h0;
        is_poszero_reg0 <=
          _clz_fp16_T & ~_sign_T_11 & is_subnormal
          & out_exp_fp32_clz_io_in[22:13] == 10'h0 | _clz_fp32_T & ~_sign_T_11
          & is_subnormal & out_exp_fp32_clz_io_in == 23'h0;
        is_snan_reg0 <=
          is_vfr & ~(out_exp_fp32_clz_io_in[22]) & _is_nan_T_14 | _sigNotZero_T
          & (&(src[27:23])) & (|(src[22:13])) & ~(src[22]);
        is_neg2_bplus1_b_reg0 <=
          _clz_fp16_T & _sign_T_11 & exp[4:0] == 5'h1E | _clz_fp32_T & _sign_T_11
          & _is_pos2_b_bplus1_T_7;
        is_neg2_b_bminus1_reg0 <=
          _clz_fp16_T & _sign_T_11 & exp[4:0] == 5'h1D | _clz_fp32_T & _sign_T_11
          & _is_pos2_bminus1_b_T_7;
        is_neg2_negbminus1_negzero_reg0 <=
          _clz_fp16_T & _sign_T_11 & out_exp_fp32_clz_io_in[22:21] == 2'h0 & is_subnormal
          & (|(out_exp_fp32_clz_io_in[22:13])) | _clz_fp32_T & _sign_T_11
          & out_exp_fp32_clz_io_in[22:21] == 2'h0 & is_subnormal
          & (|out_exp_fp32_clz_io_in);
        ...
        out_exp_fp16_reg0 <=
          ...
          | (_out_exp_fp16_T_7 & ~_out_exp_zero_negone_T_12
        ...
        out_exp_fp32_reg0 <=
          ...
          | (_out_exp_fp32_T_7 & ~_out_exp_zero_negone_T_12
  ...
  wire [54:0]  _GEN_14 = {31'h0, _sig_T_2[23], out_exp_fp32_clz_io_in};
  wire [54:0]  _GEN_15 =
    {50'h0,
     5'(exp[4:0] - ((fp32toint32 ? 5'h16 : 5'h0) | (_sign_or_nan_T_1 ? 5'h19 : 5'h0)))};
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      lpath_sig_shifted_reg0 <=
        {_lpath_sig_shifted_T_7[31:19],
         _lpath_sig_shifted_T_7[18:0]
           | (_sign_or_nan_T_1 ? _lpath_sig_shifted_T_5[31:13] : 19'h0)};
      lpath_of_reg0 <=
        (_lpath_of_T | fp16toint32) & io_opType[0] & exp == max_int_exp
        & (~_sign_T_11 | _sign_T_11 & (|(_in_T_5[22:0])));
      sig_cat0_reg <= {_sig_T_2[23], out_exp_fp32_clz_io_in, 1'h0};
      rpath_shamt_reg0 <=
        8'({_rpath_shamt_T_5[7:5],
            _rpath_shamt_T_5[4:0] | (_sign_or_nan_T_1 ? 5'h19 : 5'h0)
      ...
      sig_normalized_11_reg0 <= clz_fp16_clz_io_in;
      sig_normalized_24_reg0 <= clz_fp32_clz_io_in;
      clz_fp16_reg0 <= _clz_fp16_T ? _clz_fp16_clz_io_out : 4'h0;
      clz_fp32_reg0 <= {3'h0, _clz_fp32_T ? _clz_fp32_clz_io_out : 5'h0};
