...
module VIAluFix(
  ...
  wire             _needNoMask_T_2 = ctrlVec_1_fuOpType == 9'h84;
  wire             _needNoMask_T_5 = ctrlVec_1_fuOpType == 9'h86;
  ...
  wire             _decoderOut_invMatrixOutputs_T_2 =
    {&{decoderOut_invInputs[1],
       decoderOut_invInputs[3],
       decoderOut_invInputs[4],
       decoderOut_invInputs[5]},
     ...
     &{decoderOut_invInputs[0],
       ...
       io_in_bits_ctrl_fuOpType[4],
       decoderOut_invInputs[5]}} == 8'h0;
  wire             isFixp =
    _decoderOut_invMatrixOutputs_T_2
  ...
  wire [7:0]       vIntFixpAlus_1_io_narrow = {7'h0, io_in_bits_ctrl_vpu_isNarrow};
  reg              outIsVwsll;
  ...
  wire [7:0]       elementsComputed =
    ...
    | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h4
         ? {1'h0,
            ...
            outEewVs1_oneHot[3],
            3'h0}
         : 8'h0) | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h5 ? 8'(_GEN_43 * 8'h5) : 8'h0)
    | (ctrlVec_1_vpu_vuopIdx[2:0] == 3'h6 ? 8'(_GEN_43 * 8'h6) : 8'h0)
    | ((&(ctrlVec_1_vpu_vuopIdx[2:0])) ? 8'(_GEN_43 * 8'h7) : 8'h0);
  wire [8:0]       _GEN_44 = {1'h0, elementsComputed};
  wire [8:0]       _GEN_45 = {1'h0, dataVec_1_src_4};
  wire [15:0]      outVxsat =
  ...
  VIntFixpAlu64b vIntFixpAlus_0 (
    ...
    .io_narrow      (vIntFixpAlus_1_io_narrow),
    .io_isSub       (|_decoderOut_orMatrixOutputs_T_4),
    .io_isMisc      (_decoderOut_invMatrixOutputs_T_2),
    .io_isFixp      (isFixp),
    .io_widen       (widen),
      ...
      (ctrlVec_1_vpu_isNarrow
         ...
         : ctrlVec_1_vpu_isDstMask
             ? {112'h0,
                ...
                elementsComputed >= dataVec_1_src_4 | _GEN_42[0]}
             : outVd),
    .io_in_oldVd        (dataVec_1_src_2),
    .io_in_mask
      (ctrlVec_1_fuOpType == 9'h3 | ctrlVec_1_fuOpType == 9'h104 | _needNoMask_T_2
       | ctrlVec_1_fuOpType == 9'h5 | ctrlVec_1_fuOpType == 9'h106 | _needNoMask_T_5
       | ctrlVec_1_fuOpType == 9'h19
         ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
         : _needNoMask_T_2 | _needNoMask_T_5
             ? 128'h0
             : ctrlVec_1_vpu_vm
                 ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                 : dataVec_1_src_3),
