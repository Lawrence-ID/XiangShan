      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_src_4 =
          {_RANDOM[5'h11][31:13],
           ...
           _RANDOM[5'h14],
           _RANDOM[5'h15][12:0]};
        data_imm = {_RANDOM[5'h15][31:13], _RANDOM[5'h16][12:0]};
        data_robIdx_flag = _RANDOM[5'h16][13];
        data_robIdx_value = _RANDOM[5'h16][21:14];
        data_pdest = {_RANDOM[5'h16][31:27], _RANDOM[5'h17][1:0]};
        data_vecWen = _RANDOM[5'h17][2];
        data_v0Wen = _RANDOM[5'h17][3];
        data_vpu_vma = _RANDOM[5'h17][5];
        data_vpu_vta = _RANDOM[5'h17][6];
        data_vpu_vsew = _RANDOM[5'h17][8:7];
        data_vpu_vlmul = _RANDOM[5'h17][11:9];
        data_vpu_vm = _RANDOM[5'h17][20];
        data_vpu_vstart = _RANDOM[5'h17][28:21];
        data_vpu_vuopIdx = _RANDOM[5'h18][15:9];
        data_vpu_vmask =
          {_RANDOM[5'h18][31:17],
           _RANDOM[5'h19],
           _RANDOM[5'h1A],
           _RANDOM[5'h1B],
           _RANDOM[5'h1C][16:0]};
        data_vpu_nf = _RANDOM[5'h1C][27:25];
        data_vpu_veew = _RANDOM[5'h1C][29:28];
        data_ftqIdx_flag = _RANDOM[5'h1D][7];
        data_ftqIdx_value = _RANDOM[5'h1D][13:8];
        data_ftqOffset = _RANDOM[5'h1D][17:14];
        data_numLsElem = _RANDOM[5'h1D][22:18];
        data_sqIdx_flag = _RANDOM[5'h1D][23];
        data_sqIdx_value = _RANDOM[5'h1D][29:24];
        data_lqIdx_flag = _RANDOM[5'h1D][30];
        data_lqIdx_value = {_RANDOM[5'h1D][31], _RANDOM[5'h1E][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
