  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_1 = {_RANDOM[6'h2], _RANDOM[6'h3]};
        mem_2 = {_RANDOM[6'h4], _RANDOM[6'h5]};
        mem_3 = {_RANDOM[6'h6], _RANDOM[6'h7]};
        mem_4 = {_RANDOM[6'h8], _RANDOM[6'h9]};
        mem_5 = {_RANDOM[6'hA], _RANDOM[6'hB]};
        mem_6 = {_RANDOM[6'hC], _RANDOM[6'hD]};
        mem_7 = {_RANDOM[6'hE], _RANDOM[6'hF]};
        mem_8 = {_RANDOM[6'h10], _RANDOM[6'h11]};
        mem_9 = {_RANDOM[6'h12], _RANDOM[6'h13]};
        mem_10 = {_RANDOM[6'h14], _RANDOM[6'h15]};
        mem_11 = {_RANDOM[6'h16], _RANDOM[6'h17]};
        mem_12 = {_RANDOM[6'h18], _RANDOM[6'h19]};
        mem_13 = {_RANDOM[6'h1A], _RANDOM[6'h1B]};
        mem_14 = {_RANDOM[6'h1C], _RANDOM[6'h1D]};
        mem_15 = {_RANDOM[6'h1E], _RANDOM[6'h1F]};
        mem_16 = {_RANDOM[6'h20], _RANDOM[6'h21]};
        mem_17 = {_RANDOM[6'h22], _RANDOM[6'h23]};
        mem_18 = {_RANDOM[6'h24], _RANDOM[6'h25]};
        mem_19 = {_RANDOM[6'h26], _RANDOM[6'h27]};
        mem_20 = {_RANDOM[6'h28], _RANDOM[6'h29]};
        mem_21 = {_RANDOM[6'h2A], _RANDOM[6'h2B]};
        io_readPorts_0_data_REG = _RANDOM[6'h2C][4:0];
        io_readPorts_1_data_REG = _RANDOM[6'h2C][9:5];
        io_readPorts_2_data_REG = _RANDOM[6'h2C][14:10];
        io_readPorts_3_data_REG = _RANDOM[6'h2C][19:15];
      `endif // RANDOMIZE_REG_INIT
    end // initial
