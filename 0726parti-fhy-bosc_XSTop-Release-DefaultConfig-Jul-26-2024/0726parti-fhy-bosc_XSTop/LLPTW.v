...
module LLPTW(
  ...
  wire             _GEN_43 = _hptw_req_arb_io_in_0_ready & _hyper_arb1_io_out_valid;
  wire             _GEN_44 =
    _GEN_43 & is_hptw_req_0 & entries_0_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_0_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h0;
  wire             _GEN_45 =
    _GEN_43 & is_hptw_req_1 & entries_1_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_1_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h1;
  wire             _GEN_46 =
    _GEN_43 & is_hptw_req_2 & entries_2_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_2_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h2;
  wire             _GEN_47 =
    _GEN_43 & is_hptw_req_3 & entries_3_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_3_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h3;
  wire             _GEN_48 =
    _GEN_43 & is_hptw_req_4 & entries_4_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_4_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h4;
  wire             _GEN_49 =
    _GEN_43 & is_hptw_req_5 & entries_5_ppn == _hyper_arb1_io_out_bits_ppn
    & (&entries_5_req_info_s2xlate) & _hyper_arb1_io_chosen == 3'h5;
  wire             _GEN_50 = _hptw_req_arb_io_in_1_ready & _hyper_arb2_io_out_valid;
  wire             _GEN_51 =
    _GEN_50 & is_last_hptw_req_0 & entries_0_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_0_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h0;
  wire             _GEN_52 =
    _GEN_50 & is_last_hptw_req_1 & entries_1_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_1_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h1;
  wire             _GEN_53 =
    _GEN_50 & is_last_hptw_req_2 & entries_2_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_2_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h2;
  wire             _GEN_54 =
    _GEN_50 & is_last_hptw_req_3 & entries_3_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_3_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h3;
  wire             _GEN_55 =
    _GEN_50 & is_last_hptw_req_4 & entries_4_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_4_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h4;
  wire             _GEN_56 =
    _GEN_50 & is_last_hptw_req_5 & entries_5_ppn == _hyper_arb2_io_out_bits_ppn
    & (&entries_5_req_info_s2xlate) & _hyper_arb2_io_chosen == 3'h5;
  wire             _GEN_57 = io_hptw_resp_bits_id == entries_0_wait_id;
  wire             _GEN_58 = io_hptw_resp_bits_h_resp_entry_tag == entries_0_ppn;
  wire             _GEN_59 = is_hptw_resp_0 & _GEN_57 & _GEN_58;
  ...
  wire             _GEN_60 = is_last_hptw_resp_0 & _GEN_57 & _GEN_58;
  wire             _GEN_61 = io_hptw_resp_bits_id == entries_1_wait_id;
  wire             _GEN_62 = io_hptw_resp_bits_h_resp_entry_tag == entries_1_ppn;
  wire             _GEN_63 = is_hptw_resp_1 & _GEN_61 & _GEN_62;
  ...
  wire             need_to_waiting_vec_5_1 =
    is_waiting_5 & entries_5_req_info_vpn[28:3] == _GEN_21[io_hptw_resp_bits_id][28:3];
  wire             _GEN_64 = is_last_hptw_resp_1 & _GEN_61 & _GEN_62;
  wire             _GEN_65 = io_hptw_resp_bits_id == entries_2_wait_id;
  wire             _GEN_66 = io_hptw_resp_bits_h_resp_entry_tag == entries_2_ppn;
  wire             _GEN_67 = is_hptw_resp_2 & _GEN_65 & _GEN_66;
  ...
  wire             need_to_waiting_vec_5_2 =
    is_waiting_5 & entries_5_req_info_vpn[28:3] == _GEN_21[io_hptw_resp_bits_id][28:3];
  wire             _GEN_68 = is_last_hptw_resp_2 & _GEN_65 & _GEN_66;
  wire             _GEN_69 = io_hptw_resp_bits_id == entries_3_wait_id;
  wire             _GEN_70 = io_hptw_resp_bits_h_resp_entry_tag == entries_3_ppn;
  wire             _GEN_71 = is_hptw_resp_3 & _GEN_69 & _GEN_70;
  ...
  wire             need_to_waiting_vec_5_3 =
    is_waiting_5 & entries_5_req_info_vpn[28:3] == _GEN_21[io_hptw_resp_bits_id][28:3];
  wire             _GEN_72 = is_last_hptw_resp_3 & _GEN_69 & _GEN_70;
  wire             _GEN_73 = io_hptw_resp_bits_id == entries_4_wait_id;
  wire             _GEN_74 = io_hptw_resp_bits_h_resp_entry_tag == entries_4_ppn;
  wire             _GEN_75 = is_hptw_resp_4 & _GEN_73 & _GEN_74;
  ...
  wire             need_to_waiting_vec_5_4 =
    is_waiting_5 & entries_5_req_info_vpn[28:3] == _GEN_21[io_hptw_resp_bits_id][28:3];
  wire             _GEN_76 = is_last_hptw_resp_4 & _GEN_73 & _GEN_74;
  wire             _GEN_77 = io_hptw_resp_bits_id == entries_5_wait_id;
  wire             _GEN_78 = io_hptw_resp_bits_h_resp_entry_tag == entries_5_ppn;
  wire             _GEN_79 = is_hptw_resp_5 & _GEN_77 & _GEN_78;
  ...
  wire             need_to_waiting_vec_5_5 =
    is_waiting_5 & entries_5_req_info_vpn[28:3] == _GEN_21[io_hptw_resp_bits_id][28:3];
  wire             _GEN_80 = is_last_hptw_resp_5 & _GEN_77 & _GEN_78;
  ...
  wire [28:0]      _entries_ppn_T =
    to_last_hptw_req
      ? {_GEN_85[io_in_bits_req_info_vpn[2:0]][4:0],
         _GEN_86[io_in_bits_req_info_vpn[2:0]]}
      : io_in_bits_ppn;
  wire [2:0]       _entries_wait_id_T = to_wait ? wait_id : enq_ptr;
  wire [28:0]      _GEN_87 = _GEN_1[_mem_arb_io_chosen];
  wire [13:0]      _GEN_88 = _GEN_2[_mem_arb_io_chosen];
  wire [23:0]      _GEN_89 = _GEN_3[_mem_arb_io_chosen];
  wire             _GEN_90 = _GEN_4[_mem_arb_io_chosen];
  wire             _GEN_91 = _GEN_5[_mem_arb_io_chosen];
  wire             _GEN_92 = _GEN_6[_mem_arb_io_chosen];
  wire             _GEN_93 = _GEN_7[_mem_arb_io_chosen];
  wire             _GEN_94 = _GEN_8[_mem_arb_io_chosen];
  wire             _GEN_95 = _GEN_9[_mem_arb_io_chosen];
  wire             _GEN_96 = _GEN_10[_mem_arb_io_chosen];
  wire [1:0]       _GEN_97 = _GEN_11[_mem_arb_io_chosen];
  wire             _GEN_98 = _GEN_12[_mem_arb_io_chosen];
  wire             _GEN_99 = _GEN_13[_mem_arb_io_chosen];
  wire [7:0][19:0] _GEN_100 =
    {{io_mem_resp_bits_value[501:482]},
     {io_mem_resp_bits_value[437:418]},
     {io_mem_resp_bits_value[373:354]},
     {io_mem_resp_bits_value[309:290]},
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_37)
      entries_0_ppn <=
        {_GEN_100[entries_0_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_0_req_info_vpn[2:0]]};
    else if (_GEN_14)
      entries_0_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_59) | _entries_0_first_s2xlate_fault_T) begin
      if (_GEN_51)
    ...
    entries_0_af <= _GEN_25 ? accessFault : ~_GEN_14 & entries_0_af;
    if (io_hptw_resp_valid & (_GEN_60 | _GEN_59)) begin
      ...
      entries_0_hptw_resp_entry_tag <= _GEN_87;
      entries_0_hptw_resp_entry_vmid <= _GEN_88;
      entries_0_hptw_resp_entry_ppn <= _GEN_89;
      entries_0_hptw_resp_entry_perm_d <= _GEN_90;
      entries_0_hptw_resp_entry_perm_a <= _GEN_91;
      entries_0_hptw_resp_entry_perm_g <= _GEN_92;
      entries_0_hptw_resp_entry_perm_u <= _GEN_93;
      entries_0_hptw_resp_entry_perm_x <= _GEN_94;
      entries_0_hptw_resp_entry_perm_w <= _GEN_95;
      entries_0_hptw_resp_entry_perm_r <= _GEN_96;
      entries_0_hptw_resp_entry_level <= _GEN_97;
      entries_0_hptw_resp_gpf <= _GEN_98;
      entries_0_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_0_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_59 & _entries_0_first_s2xlate_fault_T
        ? _entries_0_first_s2xlate_fault_T
        : ~_GEN_14 & entries_0_first_s2xlate_fault;
    if (_GEN_15) begin
    ...
    if (_GEN_38)
      entries_1_ppn <=
        {_GEN_100[entries_1_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_1_req_info_vpn[2:0]]};
    else if (_GEN_15)
      entries_1_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_63) | _entries_1_first_s2xlate_fault_T) begin
      if (_GEN_52)
    ...
    entries_1_af <= _GEN_26 ? accessFault : ~_GEN_15 & entries_1_af;
    if (io_hptw_resp_valid & (_GEN_64 | _GEN_63)) begin
      ...
      entries_1_hptw_resp_entry_tag <= _GEN_87;
      entries_1_hptw_resp_entry_vmid <= _GEN_88;
      entries_1_hptw_resp_entry_ppn <= _GEN_89;
      entries_1_hptw_resp_entry_perm_d <= _GEN_90;
      entries_1_hptw_resp_entry_perm_a <= _GEN_91;
      entries_1_hptw_resp_entry_perm_g <= _GEN_92;
      entries_1_hptw_resp_entry_perm_u <= _GEN_93;
      entries_1_hptw_resp_entry_perm_x <= _GEN_94;
      entries_1_hptw_resp_entry_perm_w <= _GEN_95;
      entries_1_hptw_resp_entry_perm_r <= _GEN_96;
      entries_1_hptw_resp_entry_level <= _GEN_97;
      entries_1_hptw_resp_gpf <= _GEN_98;
      entries_1_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_1_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_63 & _entries_1_first_s2xlate_fault_T
        ? _entries_1_first_s2xlate_fault_T
        : ~_GEN_15 & entries_1_first_s2xlate_fault;
    if (_GEN_16) begin
    ...
    if (_GEN_39)
      entries_2_ppn <=
        {_GEN_100[entries_2_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_2_req_info_vpn[2:0]]};
    else if (_GEN_16)
      entries_2_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_67) | _entries_2_first_s2xlate_fault_T) begin
      if (_GEN_53)
    ...
    entries_2_af <= _GEN_27 ? accessFault : ~_GEN_16 & entries_2_af;
    if (io_hptw_resp_valid & (_GEN_68 | _GEN_67)) begin
      ...
      entries_2_hptw_resp_entry_tag <= _GEN_87;
      entries_2_hptw_resp_entry_vmid <= _GEN_88;
      entries_2_hptw_resp_entry_ppn <= _GEN_89;
      entries_2_hptw_resp_entry_perm_d <= _GEN_90;
      entries_2_hptw_resp_entry_perm_a <= _GEN_91;
      entries_2_hptw_resp_entry_perm_g <= _GEN_92;
      entries_2_hptw_resp_entry_perm_u <= _GEN_93;
      entries_2_hptw_resp_entry_perm_x <= _GEN_94;
      entries_2_hptw_resp_entry_perm_w <= _GEN_95;
      entries_2_hptw_resp_entry_perm_r <= _GEN_96;
      entries_2_hptw_resp_entry_level <= _GEN_97;
      entries_2_hptw_resp_gpf <= _GEN_98;
      entries_2_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_2_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_67 & _entries_2_first_s2xlate_fault_T
        ? _entries_2_first_s2xlate_fault_T
        : ~_GEN_16 & entries_2_first_s2xlate_fault;
    if (_GEN_17) begin
    ...
    if (_GEN_40)
      entries_3_ppn <=
        {_GEN_100[entries_3_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_3_req_info_vpn[2:0]]};
    else if (_GEN_17)
      entries_3_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_71) | _entries_3_first_s2xlate_fault_T) begin
      if (_GEN_54)
    ...
    entries_3_af <= _GEN_28 ? accessFault : ~_GEN_17 & entries_3_af;
    if (io_hptw_resp_valid & (_GEN_72 | _GEN_71)) begin
      ...
      entries_3_hptw_resp_entry_tag <= _GEN_87;
      entries_3_hptw_resp_entry_vmid <= _GEN_88;
      entries_3_hptw_resp_entry_ppn <= _GEN_89;
      entries_3_hptw_resp_entry_perm_d <= _GEN_90;
      entries_3_hptw_resp_entry_perm_a <= _GEN_91;
      entries_3_hptw_resp_entry_perm_g <= _GEN_92;
      entries_3_hptw_resp_entry_perm_u <= _GEN_93;
      entries_3_hptw_resp_entry_perm_x <= _GEN_94;
      entries_3_hptw_resp_entry_perm_w <= _GEN_95;
      entries_3_hptw_resp_entry_perm_r <= _GEN_96;
      entries_3_hptw_resp_entry_level <= _GEN_97;
      entries_3_hptw_resp_gpf <= _GEN_98;
      entries_3_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_3_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_71 & _entries_3_first_s2xlate_fault_T
        ? _entries_3_first_s2xlate_fault_T
        : ~_GEN_17 & entries_3_first_s2xlate_fault;
    if (_GEN_18) begin
    ...
    if (_GEN_41)
      entries_4_ppn <=
        {_GEN_100[entries_4_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_4_req_info_vpn[2:0]]};
    else if (_GEN_18)
      entries_4_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_75) | _entries_4_first_s2xlate_fault_T) begin
      if (_GEN_55)
    ...
    entries_4_af <= _GEN_29 ? accessFault : ~_GEN_18 & entries_4_af;
    if (io_hptw_resp_valid & (_GEN_76 | _GEN_75)) begin
      ...
      entries_4_hptw_resp_entry_tag <= _GEN_87;
      entries_4_hptw_resp_entry_vmid <= _GEN_88;
      entries_4_hptw_resp_entry_ppn <= _GEN_89;
      entries_4_hptw_resp_entry_perm_d <= _GEN_90;
      entries_4_hptw_resp_entry_perm_a <= _GEN_91;
      entries_4_hptw_resp_entry_perm_g <= _GEN_92;
      entries_4_hptw_resp_entry_perm_u <= _GEN_93;
      entries_4_hptw_resp_entry_perm_x <= _GEN_94;
      entries_4_hptw_resp_entry_perm_w <= _GEN_95;
      entries_4_hptw_resp_entry_perm_r <= _GEN_96;
      entries_4_hptw_resp_entry_level <= _GEN_97;
      entries_4_hptw_resp_gpf <= _GEN_98;
      entries_4_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_4_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_75 & _entries_4_first_s2xlate_fault_T
        ? _entries_4_first_s2xlate_fault_T
        : ~_GEN_18 & entries_4_first_s2xlate_fault;
    if (_GEN_19) begin
    ...
    if (_GEN_42)
      entries_5_ppn <=
        {_GEN_100[entries_5_req_info_vpn[2:0]][4:0],
         _GEN_101[entries_5_req_info_vpn[2:0]]};
    else if (_GEN_19)
      entries_5_ppn <= _entries_ppn_T;
    if (~(io_hptw_resp_valid & _GEN_79) | _entries_5_first_s2xlate_fault_T) begin
      if (_GEN_56)
    ...
    entries_5_af <= _GEN_30 ? accessFault : ~_GEN_19 & entries_5_af;
    if (io_hptw_resp_valid & (_GEN_80 | _GEN_79)) begin
      ...
      entries_5_hptw_resp_entry_tag <= _GEN_87;
      entries_5_hptw_resp_entry_vmid <= _GEN_88;
      entries_5_hptw_resp_entry_ppn <= _GEN_89;
      entries_5_hptw_resp_entry_perm_d <= _GEN_90;
      entries_5_hptw_resp_entry_perm_a <= _GEN_91;
      entries_5_hptw_resp_entry_perm_g <= _GEN_92;
      entries_5_hptw_resp_entry_perm_u <= _GEN_93;
      entries_5_hptw_resp_entry_perm_x <= _GEN_94;
      entries_5_hptw_resp_entry_perm_w <= _GEN_95;
      entries_5_hptw_resp_entry_perm_r <= _GEN_96;
      entries_5_hptw_resp_entry_level <= _GEN_97;
      entries_5_hptw_resp_gpf <= _GEN_98;
      entries_5_hptw_resp_gaf <= _GEN_99;
    end
    ...
    entries_5_first_s2xlate_fault <=
      io_hptw_resp_valid & _GEN_79 & _entries_5_first_s2xlate_fault_T
        ? _entries_5_first_s2xlate_fault_T
        : ~_GEN_19 & entries_5_first_s2xlate_fault;
    enq_ptr_reg <= enq_ptr;
  ...
  wire [3:0]       _state_0_T_1 = {3'h3, &entries_0_req_info_s2xlate};
  wire [3:0]       _state_1_T_1 = {3'h3, &entries_1_req_info_s2xlate};
  wire [3:0]       _state_2_T_1 = {3'h3, &entries_2_req_info_s2xlate};
  wire [3:0]       _state_3_T_1 = {3'h3, &entries_3_req_info_s2xlate};
  wire [3:0]       _state_4_T_1 = {3'h3, &entries_4_req_info_s2xlate};
  wire [3:0]       _state_5_T_1 = {3'h3, &entries_5_req_info_s2xlate};
  wire [2:0]       cache_ptr =
  ...
  wire             _GEN_102 = io_out_ready & _io_out_valid_T_4;
  wire             _GEN_103 = io_cache_ready & (|_io_cache_valid_T);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (flush | _GEN_103 & cache_ptr == 3'h0 | _GEN_102 & mem_ptr == 3'h0)
        state_0 <= 4'h0;
        ...
        state_0 <= enq_state;
      if (flush | _GEN_103 & cache_ptr == 3'h1 | _GEN_102 & mem_ptr == 3'h1)
        state_1 <= 4'h0;
      else if (io_hptw_resp_valid) begin
        if (_GEN_64)
          state_1 <= 4'h6;
        ...
        state_1 <= enq_state;
      if (flush | _GEN_103 & cache_ptr == 3'h2 | _GEN_102 & mem_ptr == 3'h2)
        state_2 <= 4'h0;
      else if (io_hptw_resp_valid) begin
        if (_GEN_68)
          state_2 <= 4'h6;
        ...
        state_2 <= enq_state;
      if (flush | _GEN_103 & cache_ptr == 3'h3 | _GEN_102 & mem_ptr == 3'h3)
        state_3 <= 4'h0;
      else if (io_hptw_resp_valid) begin
        if (_GEN_72)
          state_3 <= 4'h6;
        ...
        state_3 <= enq_state;
      if (flush | _GEN_103 & cache_ptr == 3'h4 | _GEN_102 & mem_ptr == 3'h4)
        state_4 <= 4'h0;
      else if (io_hptw_resp_valid) begin
        if (_GEN_76)
          state_4 <= 4'h6;
        ...
        state_4 <= enq_state;
      if (flush | _GEN_103 & cache_ptr == 3'h5 | _GEN_102 & mem_ptr == 3'h5)
        state_5 <= 4'h0;
      else if (io_hptw_resp_valid) begin
        if (_GEN_80)
          state_5 <= 4'h6;
        ...
        state_5 <= enq_state;
      mem_resp_hit_0 <=
        ~mem_resp_hit_0 & (_GEN_37 | (_GEN_14 ? _mem_resp_hit_T : mem_resp_hit_0));
      mem_resp_hit_1 <=
        ~mem_resp_hit_1 & (_GEN_38 | (_GEN_15 ? _mem_resp_hit_T : mem_resp_hit_1));
      mem_resp_hit_2 <=
        ~mem_resp_hit_2 & (_GEN_39 | (_GEN_16 ? _mem_resp_hit_T : mem_resp_hit_2));
      mem_resp_hit_3 <=
        ~mem_resp_hit_3 & (_GEN_40 | (_GEN_17 ? _mem_resp_hit_T : mem_resp_hit_3));
      mem_resp_hit_4 <=
        ~mem_resp_hit_4 & (_GEN_41 | (_GEN_18 ? _mem_resp_hit_T : mem_resp_hit_4));
      mem_resp_hit_5 <=
        ~mem_resp_hit_5 & (_GEN_42 | (_GEN_19 ? _mem_resp_hit_T : mem_resp_hit_5));
      need_addr_check_last_REG <= enq_state == 4'h3 & perfEvents_0_2 & ~flush;
    end
  ...
  assign io_out_bits_req_info_source = _GEN_81[mem_ptr];
  ...
  assign io_out_bits_first_s2xlate_fault = _GEN_83[mem_ptr];
  assign io_out_bits_af = _GEN_82[mem_ptr];
  assign io_mem_req_valid = io_mem_req_valid_0;
  assign io_mem_req_bits_addr =
    {(&_mem_arb_io_out_bits_req_info_s2xlate)
       ? _GEN_84[_mem_arb_io_out_bits_hptw_resp_entry_level]
  ...
  assign io_mem_refill_s2xlate = {1'h0, |_GEN_0[mem_refill_id]};
  assign io_mem_refill_source = _GEN_81[mem_refill_id];
