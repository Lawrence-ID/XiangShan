...
module Fence(
  ...
  output [38:0] io_out_bits_res_pc,
  ...
  always @(posedge clock) begin
    if (io_in_ready_0 & io_in_valid) begin
      ...
      uop_data_pc <= io_in_bits_data_pc;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_data_imm = {_RANDOM[5'h5][31:9], _RANDOM[5'h6], _RANDOM[5'h7][8:0]};
        uop_data_pc = {_RANDOM[5'h7][31:9], _RANDOM[5'h8][15:0]};
        io_fenceio_sfence_bits_addr_r =
          {_RANDOM[5'h1A][31:17], _RANDOM[5'h1B], _RANDOM[5'h1C][16:0]};
        io_fenceio_sfence_bits_id_r =
          {_RANDOM[5'h1C][31:17], _RANDOM[5'h1D], _RANDOM[5'h1E][16:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial
  ...
  assign io_out_bits_res_pc = uop_data_pc;
  ...
  assign io_fenceio_sfence_bits_addr = io_fenceio_sfence_bits_addr_r[40:0];
