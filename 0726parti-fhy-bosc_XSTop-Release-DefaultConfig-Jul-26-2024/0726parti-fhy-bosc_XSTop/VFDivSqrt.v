...
module VFDivSqrt(
  ...
  wire [7:0]   vlMaskRShift =
    8'hFF
    >> 4'(4'h8 - {1'h0, vlSetThisUop < _GEN_1 ? vlSetThisUop[2:0] : vlMaxThisUop[2:0]});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h1][16];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][17];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][19:18];
        outCtrl_r_vpu_vlmul = _RANDOM[5'h1][22:20];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][31];
        outCtrl_r_vpu_vstart = _RANDOM[5'h2][7:0];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][26:20];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h7][11];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h7][12];
        outData_r_src_4 = _RANDOM[5'h7][24:17];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:25],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:25],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][24:0]};
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][25];
        io_out_bits_ctrl_robIdx_r_value = {_RANDOM[5'h1B][31:26], _RANDOM[5'h1C][1:0]};
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1C][9:2];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1C][10];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1C][11];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h1C][16];
      `endif // RANDOMIZE_REG_INIT
    end // initial
