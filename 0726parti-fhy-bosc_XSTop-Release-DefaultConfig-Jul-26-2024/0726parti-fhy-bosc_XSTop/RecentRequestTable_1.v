...
module RecentRequestTable_1(
  ...
  output        io_w_ready,
  input         io_w_valid,
  input  [38:0] io_w_bits,
  input         io_r_req_valid,
  input  [38:0] io_r_req_bits_addr,
  ...
  reg  [6:0]  io_r_resp_bits_ptr_REG;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_r_resp_bits_ptr_REG = _RANDOM[/*Zero width*/ 1'b0][8:2];
        io_r_resp_bits_hit_REG = _RANDOM[/*Zero width*/ 1'b0][20:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        io_r_resp_valid_REG = 1'h0;
    end // initial
