...
module ActiveGenerationTable(
  ...
  always @(posedge clock) begin
    ...
    else if (~update | (&entries_0_access_cnt)) begin
    end
    else
    ...
    else if (~update_1 | (&entries_1_access_cnt)) begin
    end
    else
    ...
    else if (~update_2 | (&entries_2_access_cnt)) begin
    end
    else
    ...
    else if (~update_3 | (&entries_3_access_cnt)) begin
    end
    else
    ...
    else if (~update_4 | (&entries_4_access_cnt)) begin
    end
    else
    ...
    else if (~update_5 | (&entries_5_access_cnt)) begin
    end
    else
    ...
    else if (~update_6 | (&entries_6_access_cnt)) begin
    end
    else
    ...
    else if (~update_7 | (&entries_7_access_cnt)) begin
    end
    else
    ...
    else if (~update_8 | (&entries_8_access_cnt)) begin
    end
    else
    ...
    else if (~update_9 | (&entries_9_access_cnt)) begin
    end
    else
    ...
    else if (~update_10 | (&entries_10_access_cnt)) begin
    end
    else
    ...
    else if (~update_11 | (&entries_11_access_cnt)) begin
    end
    else
    ...
    else if (~update_12 | (&entries_12_access_cnt)) begin
    end
    else
    ...
    else if (~update_13 | (&entries_13_access_cnt)) begin
    end
    else
    ...
    else if (~update_14 | (&entries_14_access_cnt)) begin
    end
    else
    ...
    else if (~update_15 | (&entries_15_access_cnt)) begin
    end
    else
