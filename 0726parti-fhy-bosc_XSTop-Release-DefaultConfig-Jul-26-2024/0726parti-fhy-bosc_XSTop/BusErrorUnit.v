...
module BusErrorUnit(
  ...
  wire [7:0][39:0] _GEN_2 =
    {{40'h0},
     {40'h0},
     {{37'h0, local_interrupt_2, local_interrupt_1, local_interrupt_0}},
     {{37'h0, accrued_2, accrued_1, accrued_0}},
     {{37'h0, global_interrupt_2, global_interrupt_1, global_interrupt_0}},
     {{37'h0, enable_2, enable_1, enable_0}},
     {{4'h0, value_reg}},
     {{38'h0, cause_reg}}};
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      accrued_0 <=
        out_woready_19 & auto_in_a_bits_mask[0]
          ? auto_in_a_bits_data[0]
          : io_errors_icache_ecc_error_valid | accrued_0;
      accrued_1 <=
        out_woready_19 & auto_in_a_bits_mask[0]
          ? auto_in_a_bits_data[1]
          : io_errors_dcache_ecc_error_valid | accrued_1;
  ...
  always @(posedge clock) begin
    if (valids_1_0 | valids_1_1 | valids_1_2 | valids_1_3 | valids_1_4)
      value_reg <=
        {valids_1_4 ? auto_in_a_bits_data[35:32] : value_reg[35:32],
         ...
         valids_1_0 ? auto_in_a_bits_data[7:0] : value_reg[7:0]};
    else if (_GEN_0)
      value_reg <=
        _GEN ? io_errors_dcache_ecc_error_bits : io_errors_icache_ecc_error_bits;
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        value_reg = {_RANDOM[1'h0][31:2], _RANDOM[1'h1][5:0]};
        enable_0 = _RANDOM[1'h1][6];
        enable_1 = _RANDOM[1'h1][7];
        enable_2 = _RANDOM[1'h1][8];
        global_interrupt_0 = _RANDOM[1'h1][9];
        global_interrupt_1 = _RANDOM[1'h1][10];
        global_interrupt_2 = _RANDOM[1'h1][11];
        accrued_0 = _RANDOM[1'h1][12];
        accrued_1 = _RANDOM[1'h1][13];
        accrued_2 = _RANDOM[1'h1][14];
        local_interrupt_0 = _RANDOM[1'h1][15];
        local_interrupt_1 = _RANDOM[1'h1][16];
        local_interrupt_2 = _RANDOM[1'h1][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        cause_reg = 2'h0;
        enable_0 = 1'h1;
  ...
  assign auto_in_d_bits_opcode = {2'h0, in_bits_read};
  assign auto_in_d_bits_size = auto_in_a_bits_size;
  assign auto_in_d_bits_source = auto_in_a_bits_source;
  assign auto_in_d_bits_data =
    {24'h0,
     _GEN_1[auto_in_a_bits_address[5:3]] ? _GEN_2[auto_in_a_bits_address[5:3]] : 40'h0};
