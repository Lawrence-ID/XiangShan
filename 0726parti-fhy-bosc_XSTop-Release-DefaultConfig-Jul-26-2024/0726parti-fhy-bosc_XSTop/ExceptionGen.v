...
module ExceptionGen(
  ...
  always @(posedge clock) begin
    if (currentValid) begin
      ...
      if (_GEN) begin
        ...
        current_flushPipe <=
          _GEN_4
            ...
            : _GEN_3 & s1_out_bits_flushPipe | current_flushPipe;
        current_replayInst <=
          _GEN_4
            ? s1_out_bits_replayInst
            : _GEN_3 & s1_out_bits_replayInst | current_replayInst;
      ...
      current_exceptionVec_3 <=
        _GEN ? s1_out_bits_exceptionVec_3 : ~_GEN_0 & current_exceptionVec_3;
      current_exceptionVec_4 <=
      ...
      current_exceptionVec_14 <=
        _GEN ? s1_out_bits_exceptionVec_14 : ~_GEN_0 & current_exceptionVec_14;
      current_exceptionVec_15 <=
        _GEN ? s1_out_bits_exceptionVec_15 : ~_GEN_0 & current_exceptionVec_15;
      current_exceptionVec_16 <=
        _GEN ? s1_out_bits_exceptionVec_16 : ~_GEN_0 & current_exceptionVec_16;
      current_exceptionVec_17 <=
        _GEN ? s1_out_bits_exceptionVec_17 : ~_GEN_0 & current_exceptionVec_17;
      current_exceptionVec_18 <=
        _GEN ? s1_out_bits_exceptionVec_18 : ~_GEN_0 & current_exceptionVec_18;
      current_exceptionVec_19 <=
        _GEN ? s1_out_bits_exceptionVec_19 : ~_GEN_0 & current_exceptionVec_19;
      current_exceptionVec_21 <=
      ...
      current_replayInst <= _GEN ? s1_out_bits_replayInst : ~_GEN_0 & current_replayInst;
      current_trigger_backendHit_0 <=
        _GEN ? s1_out_bits_trigger_backendHit_0 : ~_GEN_0 & current_trigger_backendHit_0;
      current_trigger_backendHit_1 <=
        _GEN ? s1_out_bits_trigger_backendHit_1 : ~_GEN_0 & current_trigger_backendHit_1;
      current_trigger_backendHit_2 <=
        _GEN ? s1_out_bits_trigger_backendHit_2 : ~_GEN_0 & current_trigger_backendHit_2;
      current_trigger_backendHit_3 <=
        _GEN ? s1_out_bits_trigger_backendHit_3 : ~_GEN_0 & current_trigger_backendHit_3;
      current_trigger_backendCanFire_0 <=
        _GEN
          ? s1_out_bits_trigger_backendCanFire_0
          : ~_GEN_0 & current_trigger_backendCanFire_0;
      current_trigger_backendCanFire_1 <=
        _GEN
          ? s1_out_bits_trigger_backendCanFire_1
          : ~_GEN_0 & current_trigger_backendCanFire_1;
      current_trigger_backendCanFire_2 <=
        _GEN
          ? s1_out_bits_trigger_backendCanFire_2
          : ~_GEN_0 & current_trigger_backendCanFire_2;
      current_trigger_backendCanFire_3 <=
        _GEN
          ? s1_out_bits_trigger_backendCanFire_3
          : ~_GEN_0 & current_trigger_backendCanFire_3;
    end
    current_singleStep <=
      currentValid
        ? ~_GEN_5 & current_singleStep
        : ~_GEN & (_GEN_0 ? enq_s1_bits_singleStep : current_singleStep);
    current_crossPageIPFFix <=
      currentValid
        ? ~_GEN_5 & current_crossPageIPFFix
        : ~_GEN & (_GEN_0 ? enq_s1_bits_crossPageIPFFix : current_crossPageIPFFix);
    current_trigger_frontendHit_0 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendHit_0
        : ~_GEN
          & (_GEN_0 ? enq_s1_bits_trigger_frontendHit_0 : current_trigger_frontendHit_0);
    current_trigger_frontendHit_1 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendHit_1
        : ~_GEN
          & (_GEN_0 ? enq_s1_bits_trigger_frontendHit_1 : current_trigger_frontendHit_1);
    current_trigger_frontendHit_2 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendHit_2
        : ~_GEN
          & (_GEN_0 ? enq_s1_bits_trigger_frontendHit_2 : current_trigger_frontendHit_2);
    current_trigger_frontendHit_3 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendHit_3
        : ~_GEN
          & (_GEN_0 ? enq_s1_bits_trigger_frontendHit_3 : current_trigger_frontendHit_3);
    current_trigger_frontendCanFire_0 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendCanFire_0
        : ~_GEN
          & (_GEN_0
    ...
    current_trigger_frontendCanFire_1 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendCanFire_1
        : ~_GEN
          & (_GEN_0
    ...
    current_trigger_frontendCanFire_2 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendCanFire_2
        : ~_GEN
          & (_GEN_0
    ...
    current_trigger_frontendCanFire_3 <=
      currentValid
        ? _GEN_6 & current_trigger_frontendCanFire_3
        : ~_GEN
          & (_GEN_0
               ? enq_s1_bits_trigger_frontendCanFire_3
               : current_trigger_frontendCanFire_3);
    current_vstartEn <=
      currentValid ? ~_GEN_5 & current_vstartEn : ~_GEN_1 & current_vstartEn;
