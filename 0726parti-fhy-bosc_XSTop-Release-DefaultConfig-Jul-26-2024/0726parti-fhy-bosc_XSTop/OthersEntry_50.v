...
module OthersEntry_50(
        ...
        : ~common_srcCancelVec_0
          & ((|{io_commonIn_wakeUpFromWB_4_bits_pdest == entryReg_status_srcStatus_0_psrc
                ...
                io_commonIn_wakeUpFromWB_0_bits_pdest == entryReg_status_srcStatus_0_psrc
                  ...
                  & io_commonIn_wakeUpFromWB_0_valid}) | (|_GEN)
             | entryReg_status_srcStatus_0_srcState);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_0 = _RANDOM[5'h3][23];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_2 = _RANDOM[5'h3][25];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_4 = _RANDOM[5'h3][27];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_6 = _RANDOM[5'h3][29];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_21 = _RANDOM[5'h4][12];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_22 = _RANDOM[5'h4][13];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_23 = _RANDOM[5'h4][14];
        entryReg_status_issued = _RANDOM[5'h4][20];
        entryReg_status_issueTimer = _RANDOM[5'h4][23:22];
        entryReg_status_deqPortIdx = _RANDOM[5'h4][24];
        entryReg_imm = {_RANDOM[5'h4][31:25], _RANDOM[5'h5][24:0]};
        entryReg_payload_preDecodeInfo_valid = _RANDOM[5'h9][21];
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[5'h9][22];
        entryReg_payload_preDecodeInfo_brType = _RANDOM[5'h9][24:23];
        entryReg_payload_preDecodeInfo_isCall = _RANDOM[5'h9][25];
        entryReg_payload_preDecodeInfo_isRet = _RANDOM[5'h9][26];
        entryReg_payload_pred_taken = _RANDOM[5'h9][27];
        entryReg_payload_ftqPtr_flag = _RANDOM[5'h9][29];
        entryReg_payload_ftqPtr_value = {_RANDOM[5'h9][31:30], _RANDOM[5'hA][3:0]};
        entryReg_payload_ftqOffset = _RANDOM[5'hA][7:4];
        entryReg_payload_fuOpType = _RANDOM[5'hC][13:5];
        entryReg_payload_rfWen = _RANDOM[5'hC][14];
        entryReg_payload_fpWen = _RANDOM[5'hC][15];
        entryReg_payload_vecWen = _RANDOM[5'hC][16];
        entryReg_payload_v0Wen = _RANDOM[5'hC][17];
        entryReg_payload_vlWen = _RANDOM[5'hC][18];
        entryReg_payload_selImm = _RANDOM[5'hC][27:24];
        entryReg_payload_fpu_typeTagOut = _RANDOM[5'hD][30];
        entryReg_payload_fpu_wflags = _RANDOM[5'hE][0];
        entryReg_payload_fpu_typ = _RANDOM[5'hE][8:7];
        entryReg_payload_fpu_rm = _RANDOM[5'hE][14:12];
        entryReg_payload_pdest = {_RANDOM[5'h17][31:26], _RANDOM[5'h18][1:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validReg_last_REG = 1'h0;
    end // initial
  ...
  assign io_commonOut_srcWakeUpL1ExuOH_0_0 =
    (|_GEN_1) ? wakeupVec_0_0 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_0;
  assign io_commonOut_srcWakeUpL1ExuOH_0_2 =
    (|_GEN_1) ? wakeupVec_0_1 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_2;
  assign io_commonOut_srcWakeUpL1ExuOH_0_4 =
    (|_GEN_1) ? wakeupVec_0_2 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_4;
  assign io_commonOut_srcWakeUpL1ExuOH_0_6 =
    (|_GEN_1) ? wakeupVec_0_3 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_6;
  assign io_commonOut_srcWakeUpL1ExuOH_0_21 =
    (|_GEN_1) ? wakeupVec_0_4 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_21;
  assign io_commonOut_srcWakeUpL1ExuOH_0_22 =
    (|_GEN_1) ? wakeupVec_0_5 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_22;
  assign io_commonOut_srcWakeUpL1ExuOH_0_23 =
    (|_GEN_1) ? wakeupVec_0_6 : entryReg_status_srcStatus_0_srcWakeUpL1ExuOH_23;
  assign io_commonOut_srcWakeUpL1ExuOH_1_0 =
    (|_GEN_2) ? wakeupVec_1_0 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_0;
  assign io_commonOut_srcWakeUpL1ExuOH_1_2 =
    (|_GEN_2) ? wakeupVec_1_1 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_2;
  assign io_commonOut_srcWakeUpL1ExuOH_1_4 =
    (|_GEN_2) ? wakeupVec_1_2 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_4;
  assign io_commonOut_srcWakeUpL1ExuOH_1_6 =
    (|_GEN_2) ? wakeupVec_1_3 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_6;
  assign io_commonOut_srcWakeUpL1ExuOH_1_21 =
    (|_GEN_2) ? wakeupVec_1_4 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_21;
  assign io_commonOut_srcWakeUpL1ExuOH_1_22 =
    (|_GEN_2) ? wakeupVec_1_5 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_22;
  assign io_commonOut_srcWakeUpL1ExuOH_1_23 =
    (|_GEN_2) ? wakeupVec_1_6 : entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_23;
