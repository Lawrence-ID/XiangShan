...
module NewPipelineConnectPipe_45(
  input          clock,
  input          reset,
  input          io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpWen = _RANDOM[5'h17][3];
        data_vecWen = _RANDOM[5'h17][4];
        data_v0Wen = _RANDOM[5'h17][5];
        data_fpu_wflags = _RANDOM[5'h17][10];
        data_vpu_vma = _RANDOM[5'h17][26];
        data_vpu_vta = _RANDOM[5'h17][27];
        data_vpu_vsew = _RANDOM[5'h17][29:28];
        data_vpu_vlmul = {_RANDOM[5'h17][31:30], _RANDOM[5'h18][0]};
        data_vpu_vm = _RANDOM[5'h18][9];
        data_vpu_vstart = _RANDOM[5'h18][17:10];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h18][25];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h18][26];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h18][27];
        data_vpu_vuopIdx = {_RANDOM[5'h18][31:30], _RANDOM[5'h19][4:0]};
        data_vpu_lastUop = _RANDOM[5'h19][5];
        data_vpu_isNarrow = _RANDOM[5'h1D][21];
        data_vpu_isDstMask = _RANDOM[5'h1D][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
