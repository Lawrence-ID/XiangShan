...
module PrefetcherMonitor(
  ...
  wire        timely_reset = total_prefetch_cnt == 11'h3E8;
  ...
  wire        trigger_late_miss = timely_reset & late_miss_prefetch_cnt > 11'hC7;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      total_prefetch_cnt <=
        timely_reset
          ? 11'h0
          : 11'(total_prefetch_cnt + {10'h0, io_timely_total_prefetch});
      ...
      good_prefetch_cnt <=
        validity_reset
          ? 11'h0
          : 11'(good_prefetch_cnt + {10'h0, io_validity_good_prefetch});
      bad_prefetch_cnt <=
        validity_reset
          ? 11'h0
          : 11'(bad_prefetch_cnt + {10'h0, io_validity_bad_prefetch});
