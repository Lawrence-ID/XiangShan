...
module DCache(
  ...
  wire              _missQueue_io_release_block;
  ...
  wire              _mainPipe_io_evict_addr_valid;
  wire [35:0]       _mainPipe_io_evict_addr_bits;
  ...
  wire              _GEN_0 = _GEN | auto_client_out_d_bits_opcode == 3'h4;
  wire              missQueue_io_mem_grant_valid = _GEN_0 & auto_client_out_d_valid;
  ...
  wire              _GEN_1 = auto_client_out_d_bits_opcode == 3'h6;
  assign clientNodeOut_d_ready = _GEN_0 ? _missQueue_io_mem_grant_ready : _GEN_1;
  reg  [6:0]        state_vec_0;
  reg  [6:0]        state_vec_1;
  reg  [6:0]        state_vec_2;
  reg  [6:0]        state_vec_3;
  ...
  wire [127:0][6:0] _GEN_2 =
    {{state_vec_127},
     ...
     {state_vec_1},
     {state_vec_0}};
  wire [6:0]        _GEN_3 = _GEN_2[_mainPipe_io_replace_way_set_bits];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_perf_0_value_REG = {_RANDOM[7'h4E][31], _RANDOM[7'h4F][4:0]};
        io_perf_0_value_REG_1 = _RANDOM[7'h4F][10:5];
        io_perf_1_value_REG = _RANDOM[7'h4F][16:11];
        io_perf_1_value_REG_1 = _RANDOM[7'h4F][22:17];
        io_perf_2_value_REG = _RANDOM[7'h4F][28:23];
        io_perf_2_value_REG_1 = {_RANDOM[7'h4F][31:29], _RANDOM[7'h50][2:0]};
        io_perf_3_value_REG = _RANDOM[7'h50][8:3];
        io_perf_3_value_REG_1 = _RANDOM[7'h50][14:9];
        io_perf_4_value_REG = _RANDOM[7'h50][20:15];
        io_perf_4_value_REG_1 = _RANDOM[7'h50][26:21];
        io_perf_5_value_REG = {_RANDOM[7'h50][31:27], _RANDOM[7'h51][0]};
        io_perf_5_value_REG_1 = _RANDOM[7'h51][6:1];
        io_perf_6_value_REG = _RANDOM[7'h51][12:7];
        io_perf_6_value_REG_1 = _RANDOM[7'h51][18:13];
        io_perf_7_value_REG = _RANDOM[7'h51][24:19];
        io_perf_7_value_REG_1 = _RANDOM[7'h51][30:25];
        io_perf_8_value_REG = {_RANDOM[7'h51][31], _RANDOM[7'h52][4:0]};
        io_perf_8_value_REG_1 = _RANDOM[7'h52][10:5];
        io_perf_9_value_REG = _RANDOM[7'h52][16:11];
        io_perf_9_value_REG_1 = _RANDOM[7'h52][22:17];
        io_perf_10_value_REG = _RANDOM[7'h52][28:23];
        io_perf_10_value_REG_1 = {_RANDOM[7'h52][31:29], _RANDOM[7'h53][2:0]};
        io_perf_11_value_REG = _RANDOM[7'h53][8:3];
        io_perf_11_value_REG_1 = _RANDOM[7'h53][14:9];
        io_perf_12_value_REG = _RANDOM[7'h53][20:15];
        io_perf_12_value_REG_1 = _RANDOM[7'h53][26:21];
        io_perf_13_value_REG = {_RANDOM[7'h53][31:27], _RANDOM[7'h54][0]};
        io_perf_13_value_REG_1 = _RANDOM[7'h54][6:1];
        io_perf_14_value_REG = _RANDOM[7'h54][12:7];
        io_perf_14_value_REG_1 = _RANDOM[7'h54][18:13];
        io_perf_15_value_REG = _RANDOM[7'h54][24:19];
        io_perf_15_value_REG_1 = _RANDOM[7'h54][30:25];
        io_perf_16_value_REG = {_RANDOM[7'h54][31], _RANDOM[7'h55][4:0]};
        io_perf_16_value_REG_1 = _RANDOM[7'h55][10:5];
        io_perf_17_value_REG = _RANDOM[7'h55][16:11];
        io_perf_17_value_REG_1 = _RANDOM[7'h55][22:17];
        io_perf_18_value_REG = _RANDOM[7'h55][28:23];
        io_perf_18_value_REG_1 = {_RANDOM[7'h55][31:29], _RANDOM[7'h56][2:0]};
        io_perf_19_value_REG = _RANDOM[7'h56][8:3];
        io_perf_19_value_REG_1 = _RANDOM[7'h56][14:9];
        io_perf_20_value_REG = _RANDOM[7'h56][20:15];
        io_perf_20_value_REG_1 = _RANDOM[7'h56][26:21];
        io_perf_21_value_REG = {_RANDOM[7'h56][31:27], _RANDOM[7'h57][0]};
        io_perf_21_value_REG_1 = _RANDOM[7'h57][6:1];
        io_perf_22_value_REG = _RANDOM[7'h57][12:7];
        io_perf_22_value_REG_1 = _RANDOM[7'h57][18:13];
        io_perf_23_value_REG = _RANDOM[7'h57][24:19];
        io_perf_23_value_REG_1 = _RANDOM[7'h57][30:25];
        io_perf_24_value_REG = {_RANDOM[7'h57][31], _RANDOM[7'h58][4:0]};
        io_perf_24_value_REG_1 = _RANDOM[7'h58][10:5];
        io_perf_25_value_REG = _RANDOM[7'h58][16:11];
        io_perf_25_value_REG_1 = _RANDOM[7'h58][22:17];
        io_perf_26_value_REG = _RANDOM[7'h58][28:23];
        io_perf_26_value_REG_1 = {_RANDOM[7'h58][31:29], _RANDOM[7'h59][2:0]};
        io_perf_27_value_REG = _RANDOM[7'h59][8:3];
        io_perf_27_value_REG_1 = _RANDOM[7'h59][14:9];
        io_perf_28_value_REG = _RANDOM[7'h59][20:15];
        io_perf_28_value_REG_1 = _RANDOM[7'h59][26:21];
        io_perf_29_value_REG = {_RANDOM[7'h59][31:27], _RANDOM[7'h5A][0]};
        io_perf_29_value_REG_1 = _RANDOM[7'h5A][6:1];
        io_perf_30_value_REG = _RANDOM[7'h5A][12:7];
        io_perf_30_value_REG_1 = _RANDOM[7'h5A][18:13];
        io_perf_31_value_REG = _RANDOM[7'h5A][24:19];
        io_perf_31_value_REG_1 = _RANDOM[7'h5A][30:25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        missQueue_io_l2_pf_store_only_REG = 1'h0;
        io_error_valid_REG = 1'h0;
  ...
  MainPipe mainPipe (
    ...
    .io_replace_way_way
      ({_GEN_3[6],
        _GEN_3[6]
          ? {_GEN_3[5], _GEN_3[5] ? _GEN_3[4] : _GEN_3[3]}
          : {_GEN_3[2], _GEN_3[2] ? _GEN_3[1] : _GEN_3[0]}}),
    .io_evict_addr_valid                (_mainPipe_io_evict_addr_valid),
    .io_evict_addr_bits                 (_mainPipe_io_evict_addr_bits),
  ...
  MissQueue missQueue (
    ...
    .io_release_addr_valid                     (_mainPipe_io_evict_addr_valid),
    .io_release_addr_bits                      (_mainPipe_io_evict_addr_bits),
    .io_release_block                          (_missQueue_io_release_block),
  ...
  WritebackQueue wb (
    ...
    .io_mem_grant_valid          (~_GEN_0 & _GEN_1 & auto_client_out_d_valid),
    .io_mem_grant_bits_source    (auto_client_out_d_bits_source),
    ...
    .io_mshr_block               (_missQueue_io_release_block),
  ...
  assign io_lsu_tl_d_channel_valid = missQueue_io_mem_grant_valid;
