  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_common_fpu_wflags = _RANDOM[5'hA][26];
        data_common_fpu_rm = _RANDOM[5'hB][8:6];
        data_common_vpu_vsew = _RANDOM[5'hB][13:12];
        data_common_dataSources_0_value = _RANDOM[5'h11][14:11];
        data_common_dataSources_1_value = _RANDOM[5'h11][18:15];
        data_common_dataSources_2_value = _RANDOM[5'h11][22:19];
        data_common_l1ExuOH_0_8 = _RANDOM[5'h11][31];
        data_common_l1ExuOH_0_9 = _RANDOM[5'h12][0];
        data_common_l1ExuOH_0_10 = _RANDOM[5'h12][1];
        data_common_l1ExuOH_0_11 = _RANDOM[5'h12][2];
        data_common_l1ExuOH_1_8 = _RANDOM[5'h12][27];
        data_common_l1ExuOH_1_9 = _RANDOM[5'h12][28];
        data_common_l1ExuOH_1_10 = _RANDOM[5'h12][29];
        data_common_l1ExuOH_1_11 = _RANDOM[5'h12][30];
        data_common_l1ExuOH_2_8 = _RANDOM[5'h13][23];
        data_common_l1ExuOH_2_9 = _RANDOM[5'h13][24];
        data_common_l1ExuOH_2_10 = _RANDOM[5'h13][25];
        data_common_l1ExuOH_2_11 = _RANDOM[5'h13][26];
        data_common_loadDependency_0 = _RANDOM[5'h14][21:20];
        data_common_loadDependency_1 = _RANDOM[5'h14][23:22];
        data_common_loadDependency_2 = _RANDOM[5'h14][25:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
