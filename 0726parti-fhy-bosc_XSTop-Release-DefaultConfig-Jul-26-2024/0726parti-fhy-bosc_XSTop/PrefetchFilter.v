...
module PrefetchFilter(
  ...
  always @(posedge clock) begin
    ...
    else if (s2_tlb_fire_vec_r_r_0 & ~io_tlb_req_resp_bits_miss
    ...
    entries_0_region_bits <=
      alloc
        ? s1_gen_req_region_bits
        : {16{_update_T_30 & s1_update_vec[0]}} & s1_gen_req_region_bits
          | entries_0_region_bits;
    entries_0_filter_bits <=
      alloc
        ? 16'h0
        : {16{_pf_req_arb_io_in_0_ready & pf_req_arb_io_in_0_valid}} & 16'h1 << _pf_addr_T
          | entries_0_filter_bits;
    if (alloc_1) begin
    ...
    else if (s2_tlb_fire_vec_r_r_1 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_1_filter_bits <=
      alloc_1
        ? 16'h0
        : {16{_pf_req_arb_io_in_1_ready & pf_req_arb_io_in_1_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_2 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_2_filter_bits <=
      alloc_2
        ? 16'h0
        : {16{_pf_req_arb_io_in_2_ready & pf_req_arb_io_in_2_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_3 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_3_filter_bits <=
      alloc_3
        ? 16'h0
        : {16{_pf_req_arb_io_in_3_ready & pf_req_arb_io_in_3_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_4 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_4_filter_bits <=
      alloc_4
        ? 16'h0
        : {16{_pf_req_arb_io_in_4_ready & pf_req_arb_io_in_4_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_5 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_5_filter_bits <=
      alloc_5
        ? 16'h0
        : {16{_pf_req_arb_io_in_5_ready & pf_req_arb_io_in_5_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_6 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_6_filter_bits <=
      alloc_6
        ? 16'h0
        : {16{_pf_req_arb_io_in_6_ready & pf_req_arb_io_in_6_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_7 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_7_filter_bits <=
      alloc_7
        ? 16'h0
        : {16{_pf_req_arb_io_in_7_ready & pf_req_arb_io_in_7_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_8 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_8_filter_bits <=
      alloc_8
        ? 16'h0
        : {16{_pf_req_arb_io_in_8_ready & pf_req_arb_io_in_8_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_9 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_9_filter_bits <=
      alloc_9
        ? 16'h0
        : {16{_pf_req_arb_io_in_9_ready & pf_req_arb_io_in_9_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_10 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_10_filter_bits <=
      alloc_10
        ? 16'h0
        : {16{_pf_req_arb_io_in_10_ready & pf_req_arb_io_in_10_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_11 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_11_filter_bits <=
      alloc_11
        ? 16'h0
        : {16{_pf_req_arb_io_in_11_ready & pf_req_arb_io_in_11_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_12 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_12_filter_bits <=
      alloc_12
        ? 16'h0
        : {16{_pf_req_arb_io_in_12_ready & pf_req_arb_io_in_12_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_13 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_13_filter_bits <=
      alloc_13
        ? 16'h0
        : {16{_pf_req_arb_io_in_13_ready & pf_req_arb_io_in_13_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_14 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_14_filter_bits <=
      alloc_14
        ? 16'h0
        : {16{_pf_req_arb_io_in_14_ready & pf_req_arb_io_in_14_valid}} & 16'h1
    ...
    else if (s2_tlb_fire_vec_r_r_15 & ~io_tlb_req_resp_bits_miss
             & io_tlb_req_resp_valid) begin
    ...
    entries_15_filter_bits <=
      alloc_15
        ? 16'h0
        : {16{_pf_req_arb_io_in_15_ready & pf_req_arb_io_in_15_valid}} & 16'h1
         ...
         state_reg[14]
           ...
           : {state_reg[6],
              state_reg[6]
                ? {state_reg[5], state_reg[5] ? state_reg[4] : state_reg[3]}
                : {state_reg[2], state_reg[2] ? state_reg[1] : state_reg[0]}}};
  wire        s0_tlb_fire_vec_0 = _tlb_req_arb_io_in_0_ready & tlb_req_arb_io_in_0_valid;
  wire        s0_tlb_fire_vec_1 = _tlb_req_arb_io_in_1_ready & tlb_req_arb_io_in_1_valid;
  wire        s0_tlb_fire_vec_2 = _tlb_req_arb_io_in_2_ready & tlb_req_arb_io_in_2_valid;
  wire        s0_tlb_fire_vec_3 = _tlb_req_arb_io_in_3_ready & tlb_req_arb_io_in_3_valid;
  wire        s0_tlb_fire_vec_4 = _tlb_req_arb_io_in_4_ready & tlb_req_arb_io_in_4_valid;
  wire        s0_tlb_fire_vec_5 = _tlb_req_arb_io_in_5_ready & tlb_req_arb_io_in_5_valid;
  wire        s0_tlb_fire_vec_6 = _tlb_req_arb_io_in_6_ready & tlb_req_arb_io_in_6_valid;
  wire        s0_tlb_fire_vec_7 = _tlb_req_arb_io_in_7_ready & tlb_req_arb_io_in_7_valid;
  wire        s0_tlb_fire_vec_8 = _tlb_req_arb_io_in_8_ready & tlb_req_arb_io_in_8_valid;
  wire        s0_tlb_fire_vec_9 = _tlb_req_arb_io_in_9_ready & tlb_req_arb_io_in_9_valid;
