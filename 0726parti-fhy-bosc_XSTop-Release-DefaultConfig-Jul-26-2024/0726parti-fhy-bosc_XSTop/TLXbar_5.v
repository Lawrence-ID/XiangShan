...
module TLXbar_5(
  ...
  wire       requestAIO_0_0 =
    {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:12] ^ 18'h38010} == 19'h0;
  wire       requestAIO_0_1 =
    auto_in_0_a_bits_address[30:29] == 2'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:28] ^ 2'h2} == 3'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:27] ^ 3'h6} == 4'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:16] ^ 14'h3800} == 15'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:12] ^ 18'h38011} == 19'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:13] ^ 17'h1C009} == 18'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:14] ^ 16'hE005} == 17'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:15] ^ 15'h7003} == 16'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:17] ^ 13'h1C01} == 14'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:18] ^ 12'hE01} == 13'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:19] ^ 11'h701} == 12'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:20] ^ 10'h381} == 11'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:21] ^ 9'h1C1} == 10'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:22] ^ 8'hE1} == 9'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:23] ^ 7'h71} == 8'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:24] ^ 6'h39} == 7'h0
    | {auto_in_0_a_bits_address[30], auto_in_0_a_bits_address[29:25] ^ 5'h1D} == 6'h0
    | {auto_in_0_a_bits_address[30], ~(auto_in_0_a_bits_address[29:26])} == 5'h0
    | auto_in_0_a_bits_address[30];
  wire       requestAIO_1_0 =
    {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:12] ^ 18'h38010} == 19'h0;
  wire       requestAIO_1_1 =
    auto_in_1_a_bits_address[30:29] == 2'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:28] ^ 2'h2} == 3'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:27] ^ 3'h6} == 4'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:16] ^ 14'h3800} == 15'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:12] ^ 18'h38011} == 19'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:13] ^ 17'h1C009} == 18'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:14] ^ 16'hE005} == 17'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:15] ^ 15'h7003} == 16'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:17] ^ 13'h1C01} == 14'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:18] ^ 12'hE01} == 13'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:19] ^ 11'h701} == 12'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:20] ^ 10'h381} == 11'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:21] ^ 9'h1C1} == 10'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:22] ^ 8'hE1} == 9'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:23] ^ 7'h71} == 8'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:24] ^ 6'h39} == 7'h0
    | {auto_in_1_a_bits_address[30], auto_in_1_a_bits_address[29:25] ^ 5'h1D} == 6'h0
    | {auto_in_1_a_bits_address[30], ~(auto_in_1_a_bits_address[29:26])} == 5'h0
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft_2 <= ~latch_2 & 1'(beatsLeft_2 - (auto_in_0_d_ready & in_0_d_valid));
      ...
      beatsLeft_3 <= ~latch_3 & 1'(beatsLeft_3 - (auto_in_1_d_ready & in_1_d_valid));
  ...
  assign auto_in_1_d_bits_size =
    (muxState_3_0 ? auto_out_0_d_bits_size : 2'h0)
    | (muxState_3_1 ? auto_out_1_d_bits_size : 2'h0);
  ...
  assign auto_in_0_d_bits_opcode =
    (muxState_2_0 ? auto_out_0_d_bits_opcode : 3'h0)
    | (muxState_2_1 ? auto_out_1_d_bits_opcode : 3'h0);
  assign auto_in_0_d_bits_param =
    (muxState_2_0 ? auto_out_0_d_bits_param : 2'h0)
    | (muxState_2_1 ? auto_out_1_d_bits_param : 2'h0);
  assign auto_in_0_d_bits_size =
    (muxState_2_0 ? auto_out_0_d_bits_size : 2'h0)
    | (muxState_2_1 ? auto_out_1_d_bits_size : 2'h0);
  assign auto_in_0_d_bits_sink =
    muxState_2_0 & auto_out_0_d_bits_sink | muxState_2_1 & auto_out_1_d_bits_sink;
  assign auto_in_0_d_bits_denied =
    muxState_2_0 & auto_out_0_d_bits_denied | muxState_2_1 & auto_out_1_d_bits_denied;
  assign auto_in_0_d_bits_data =
    (muxState_2_0 ? auto_out_0_d_bits_data : 64'h0)
    | (muxState_2_1 ? auto_out_1_d_bits_data : 64'h0);
  ...
  assign auto_out_1_a_bits_address =
    (muxState_1_0 ? auto_in_0_a_bits_address : 31'h0)
    | (muxState_1_1 ? auto_in_1_a_bits_address : 31'h0);
