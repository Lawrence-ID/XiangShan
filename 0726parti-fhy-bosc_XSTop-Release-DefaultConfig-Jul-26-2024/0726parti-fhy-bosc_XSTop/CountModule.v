...
module CountModule(
  ...
  wire [7:0]  _GEN_1 = _GEN_0[37:30] | {io_src[15:12], io_src[19:16]} & 8'h33;
  wire [1:0]  _GEN_2 = _GEN_0[27:26] | io_src[21:20];
  wire [7:0]  _GEN_3 = _GEN_0[21:14] | {io_src[31:28], io_src[35:32]} & 8'h33;
  wire [1:0]  _GEN_4 = _GEN_0[11:10] | io_src[37:36];
  wire [7:0]  _GEN_5 = {_GEN_0[5:0], 2'h0} | {io_src[47:44], io_src[51:48]} & 8'h33;
  wire [50:0] _GEN_6 =
    {io_src[5:4],
     io_src[7:6],
     io_src[9:8],
  ...
  wire [63:0] countSrc =
    io_func[1]
      ? {io_src[0],
         ...
         _GEN_6[46:39] | _GEN_1 & 8'h55,
         _GEN_1[1],
         _GEN_6[37] | io_src[18],
         {io_src[19], 1'h0} | _GEN_2 & 2'h1,
         _GEN_6[34:31] | {io_src[23:22], io_src[25:24]} & 4'h5,
         _GEN_6[30:23] | _GEN_3 & 8'h55,
         _GEN_3[1],
         _GEN_6[21] | io_src[34],
         {io_src[35], 1'h0} | _GEN_4 & 2'h1,
