...
module NewPipelineConnectPipe_26(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_rf_0_0_addr = _RANDOM[3'h0][19:12];
        data_srcType_0 = _RANDOM[3'h0][26:23];
        data_common_fuType = {_RANDOM[3'h0][31], _RANDOM[3'h1], _RANDOM[3'h2][1:0]};
        data_common_fuOpType = _RANDOM[3'h2][10:2];
        data_common_robIdx_flag = _RANDOM[3'h5][11];
        data_common_robIdx_value = _RANDOM[3'h5][19:12];
        data_common_sqIdx_flag = _RANDOM[3'h5][25];
        data_common_sqIdx_value = _RANDOM[3'h5][31:26];
        data_common_dataSources_0_value = _RANDOM[3'h6][3:0];
        data_common_l1ExuOH_0_0 = _RANDOM[3'h6][4];
        data_common_l1ExuOH_0_2 = _RANDOM[3'h6][6];
        data_common_l1ExuOH_0_4 = _RANDOM[3'h6][8];
        data_common_l1ExuOH_0_6 = _RANDOM[3'h6][10];
        data_common_l1ExuOH_0_8 = _RANDOM[3'h6][12];
        data_common_l1ExuOH_0_9 = _RANDOM[3'h6][13];
        data_common_l1ExuOH_0_10 = _RANDOM[3'h6][14];
        data_common_l1ExuOH_0_11 = _RANDOM[3'h6][15];
        data_common_l1ExuOH_0_21 = _RANDOM[3'h6][25];
        data_common_l1ExuOH_0_22 = _RANDOM[3'h6][26];
        data_common_l1ExuOH_0_23 = _RANDOM[3'h6][27];
        data_common_loadDependency_0 = _RANDOM[3'h7][4:3];
        data_common_loadDependency_1 = _RANDOM[3'h7][6:5];
        data_common_loadDependency_2 = _RANDOM[3'h7][8:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
