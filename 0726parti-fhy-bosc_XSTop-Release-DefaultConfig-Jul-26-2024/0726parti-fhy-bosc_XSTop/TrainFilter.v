...
module TrainFilter(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:503];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [8:0] i = 9'h0; i < 9'h1F8; i += 9'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[9'h29][10];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[9'h29][18:11];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[9'h3D][31:2], _RANDOM[9'h3E][10:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[9'h4C][12];
        ld_in_reordered_res_0_1_1_bits_uop_pc =
          {_RANDOM[9'h4D][31:13], _RANDOM[9'h4E][21:0]};
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[9'h5E][22];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[9'h5E][30:23];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[9'h72][31:14], _RANDOM[9'h73][22:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[9'h81][24];
        ld_in_reordered_res_0_1_2_bits_uop_pc =
          {_RANDOM[9'h82][31:25], _RANDOM[9'h83], _RANDOM[9'h84][1:0]};
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[9'h94][2];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[9'h94][10:3];
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[9'hA7][31:26], _RANDOM[9'hA8], _RANDOM[9'hA9][2:0]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[9'hB7][4];
        ld_in_reordered_res_1_2_0_bits_uop_pc =
          {_RANDOM[9'hB8][31:5], _RANDOM[9'hB9][13:0]};
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[9'hC9][14];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[9'hC9][22:15];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[9'hDD][31:6], _RANDOM[9'hDE][14:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[9'hEC][16];
        ld_in_reordered_res_1_2_1_bits_uop_pc =
          {_RANDOM[9'hED][31:17], _RANDOM[9'hEE][25:0]};
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[9'hFE][26];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value =
          {_RANDOM[9'hFE][31:27], _RANDOM[9'hFF][2:0]};
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[9'h112][31:18], _RANDOM[9'h113][26:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[9'h121][28];
        ld_in_reordered_res_1_2_2_bits_uop_pc =
          {_RANDOM[9'h122][31:29], _RANDOM[9'h123], _RANDOM[9'h124][5:0]};
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[9'h147][31:30], _RANDOM[9'h148], _RANDOM[9'h149][6:0]};
        ld_in_reordered_0_valid = _RANDOM[9'h157][8];
        ld_in_reordered_0_bits_uop_pc = {_RANDOM[9'h158][31:9], _RANDOM[9'h159][17:0]};
        ld_in_reordered_0_bits_vaddr = {_RANDOM[9'h17D][31:10], _RANDOM[9'h17E][18:0]};
        ld_in_reordered_1_valid = _RANDOM[9'h18C][20];
        ld_in_reordered_1_bits_uop_pc = {_RANDOM[9'h18D][31:21], _RANDOM[9'h18E][29:0]};
        ld_in_reordered_1_bits_vaddr = {_RANDOM[9'h1B2][31:22], _RANDOM[9'h1B3][30:0]};
        ld_in_reordered_2_valid = _RANDOM[9'h1C2][0];
        ld_in_reordered_2_bits_uop_pc = {_RANDOM[9'h1C3][31:1], _RANDOM[9'h1C4][9:0]};
        ld_in_reordered_2_bits_vaddr = {_RANDOM[9'h1E8][31:2], _RANDOM[9'h1E9][10:0]};
        REG = _RANDOM[9'h1F7][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
