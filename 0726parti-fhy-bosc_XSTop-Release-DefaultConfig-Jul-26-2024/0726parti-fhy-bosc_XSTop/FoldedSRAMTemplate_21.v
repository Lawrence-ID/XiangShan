...
module FoldedSRAMTemplate_21(
  ...
  SRAMTemplate_60 array (
    ...
    .io_w_req_bits_flattened_bitmask
      ({io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[53],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[52],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[51],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[50],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[49],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[48],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[47],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[46],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[45],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[44],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[43],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[42],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[41],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[40],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[39],
        io_w_req_bits_setIdx[0] & io_w_req_bits_bitmask[38],
