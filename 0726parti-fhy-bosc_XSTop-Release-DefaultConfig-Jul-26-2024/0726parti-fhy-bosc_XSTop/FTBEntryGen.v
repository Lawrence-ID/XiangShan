...
module FTBEntryGen(
  ...
  wire [39:0] _GEN_0 = cfi_is_jalr ? io_target[40:1] : io_pd_jalTarget[40:1];
  ...
  wire        is_new_br =
    ...
    & {io_old_entry_tailSlot_valid & io_old_entry_tailSlot_offset == io_cfiIndex_bits
       ...
       io_old_entry_brSlots_0_valid
         & io_old_entry_brSlots_0_offset == io_cfiIndex_bits} == 2'h0;
  ...
  wire        old_entry_always_taken_always_taken_1 =
    ...
    & io_old_entry_tailSlot_sharing & io_cfiIndex_bits == io_old_entry_tailSlot_offset;
  ...
  assign io_new_entry_pftAddr =
    io_hit
      ? (pft_need_to_change
           ? 4'(io_start_addr[4:1] + new_pft_offset)
           : io_old_entry_pftAddr)
      : io_pd_jmpInfo_valid & ~last_jmp_rvi ? jmpPft[3:0] : io_start_addr[4:1];
  assign io_new_entry_carry =
    io_hit
      ? (pft_need_to_change ? _old_entry_modified_carry_T_1[4] : io_old_entry_carry)
  ...
  assign io_new_entry_always_taken_1 =
    ...
    & (is_new_br
         ...
         : jalr_target_modified
             ...
             : old_entry_always_taken_always_taken_1);
  ...
  assign io_mispred_mask_0 =
    io_new_entry_brSlots_0_valid_0 & _GEN_7[io_new_entry_brSlots_0_offset_0];
  assign io_mispred_mask_1 =
    _io_mispred_mask_1_T & _GEN_7[io_new_entry_tailSlot_offset_0];
  assign io_mispred_mask_2 =
    io_new_entry_tailSlot_valid_0 & ~io_new_entry_tailSlot_sharing_0
    & _GEN_7[io_pd_jmpOffset];
  assign io_is_old_entry =
    ...
    & ~(io_old_entry_always_taken_0 & ~old_entry_always_taken_always_taken_0
        | io_old_entry_always_taken_1 & ~old_entry_always_taken_always_taken_1);
endmodule
