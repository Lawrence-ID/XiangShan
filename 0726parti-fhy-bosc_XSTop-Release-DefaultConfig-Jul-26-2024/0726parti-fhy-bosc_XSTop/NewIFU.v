...
module NewIFU(
  ...
  wire              _f3_mmio_req_commit_T = mmio_state == 4'hA;
  wire              f3_mmio_req_commit = f3_req_is_mmio & _f3_mmio_req_commit_T;
  ...
  wire              _GEN_18 = _GEN_8 | _GEN_9 | _mmio_redirect_T;
  wire              _GEN_19 = _GEN_7 | _GEN_18;
  wire              _GEN_20 = _GEN_19 | ~_f3_mmio_req_commit_T;
  wire              _GEN_21 = _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3 | _GEN_5;
  wire              f3_hasLastHalf =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      f3_valid <=
        ...
        & (f2_fire & ~f2_flush | ~(f3_fire & ~f3_req_is_mmio | f3_mmio_req_commit)
           & f3_valid);
      mmio_is_RVC <=
        ~_GEN_10
        & (_GEN_4
             ...
             : _GEN_3
                 ? (io_uncacheInter_fromUncache_valid
                      ...
                      : mmio_is_RVC)
                 : (_GEN_5 | _GEN_6 | _GEN_19 | ~_f3_mmio_req_commit_T) & mmio_is_RVC);
      if (_GEN_10) begin
        mmio_resend_addr <= 36'h0;
        mmio_resend_gpaddr <= 41'h0;
        mmio_state <= 4'h0;
      ...
      mmio_resend_af <=
        ...
        & (_GEN_21
             ...
             : _GEN_6
                 ...
                 : _GEN_7
                     ? pmpExcpAF
                     : (_GEN_18 | ~_f3_mmio_req_commit_T) & mmio_resend_af);
      mmio_resend_pf <=
        ~_GEN_10
        & (_GEN_21
             ? mmio_resend_pf
