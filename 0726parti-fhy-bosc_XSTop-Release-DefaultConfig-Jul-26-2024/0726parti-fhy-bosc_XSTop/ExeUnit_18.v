...
module ExeUnit_18(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      uncer_en_reg <= _robIdx_T | ~_GEN & uncer_en_reg;
      uncer_en_reg_1 <= _robIdx_T | ~_GEN & uncer_en_reg_1;
      busy <=
  ...
  ClockGate ClockGate (
    .TE (1'h0),
    .E  (_robIdx_T | uncer_en_reg),
    .CK (clock),
    .Q  (_ClockGate_Q)
  );
  ClockGate ClockGate_1 (
    .TE (1'h0),
    .E  (_robIdx_T | uncer_en_reg_1),
    .CK (clock),
    .Q  (_ClockGate_1_Q)
  );
  Dispatcher_18 in1ToN (
