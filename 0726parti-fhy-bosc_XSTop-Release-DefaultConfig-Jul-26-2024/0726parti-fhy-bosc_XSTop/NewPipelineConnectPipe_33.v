...
module NewPipelineConnectPipe_33(
  ...
  output [38:0] io_out_bits_predictInfo_target,
  ...
  reg [38:0] data_predictInfo_target;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpWen = _RANDOM[4'h7][4];
        data_vecWen = _RANDOM[4'h7][5];
        data_v0Wen = _RANDOM[4'h7][6];
        data_vlWen = _RANDOM[4'h7][7];
        data_fpu_typeTagOut = _RANDOM[4'h7][10];
        data_fpu_wflags = _RANDOM[4'h7][12];
        data_fpu_typ = _RANDOM[4'h7][20:19];
        data_fpu_rm = _RANDOM[4'h7][26:24];
        data_pc = {_RANDOM[4'h7][31:27], _RANDOM[4'h8], _RANDOM[4'h9][1:0]};
        data_preDecode_valid = _RANDOM[4'h9][2];
        data_preDecode_isRVC = _RANDOM[4'h9][3];
        data_preDecode_brType = _RANDOM[4'h9][5:4];
        data_preDecode_isCall = _RANDOM[4'h9][6];
        data_preDecode_isRet = _RANDOM[4'h9][7];
        data_ftqIdx_flag = _RANDOM[4'h9][8];
        data_ftqIdx_value = _RANDOM[4'h9][14:9];
        data_ftqOffset = _RANDOM[4'h9][18:15];
        data_predictInfo_target = {_RANDOM[4'h9][31:19], _RANDOM[4'hA][25:0]};
        data_predictInfo_taken = _RANDOM[4'hA][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
