...
module VectorFloatDividerR64(
              ...
              : fsm_q == 6'h2
                  ...
                  : fsm_q == 6'h4
                      ...
                      : fsm_q == 6'h8
                          ...
                          : fsm_q == 6'h10 | ~(fsm_q != 6'h20 | io_finish_ready_i)
                              ? 6'h20
                              : 6'h1;
  ...
  wire         op_invalid_f16_2 =
    ...
    | (&(io_opa_i[46:42])) & ~(io_opa_i[41]) & (|(io_opa_i[41:32])) | (&(io_opb_i[46:42]))
    & ~(io_opb_i[41]) & (|(io_opb_i[41:32]));
  wire         op_invalid_f16_3 =
    opa_is_inf_f16_3 & opb_is_inf_f16_3 | opa_is_zero_f16_3 & opb_is_zero_f16_3
    | (&(io_opa_i[62:58])) & ~(io_opa_i[57]) & (|(io_opa_i[57:48])) | (&(io_opb_i[62:58]))
    & ~(io_opb_i[57]) & (|(io_opb_i[57:48]));
  wire         res_is_nan_f64_0 =
    opa_exp_is_max_f64_0 & opa_frac_f64_0[51] | opb_exp_is_max_f64_0 & opb_frac_f64_0[51]
    | op_invalid_f64_0;
  wire         res_is_nan_f32_1 =
    opa_exp_is_max_f32_1 & opa_frac_f32_1[22] | opb_exp_is_max_f32_1 & opb_frac_f32_1[22]
    | op_invalid_f32_1;
  wire         res_is_nan_f16_2 =
    (&(io_opa_i[46:42])) & io_opa_i[41] | (&(io_opb_i[46:42])) & io_opb_i[41]
    | op_invalid_f16_2;
  wire         res_is_nan_f16_3 =
    (&(io_opa_i[62:58])) & io_opa_i[57] | (&(io_opb_i[62:58])) & io_opb_i[57]
    | op_invalid_f16_3;
      ...
      out_exp_diff_q_f64_0 <=
        fsm_q[0]
          ? 13'(13'(13'({1'h0,
                    ...
                    - {2'h0,
                       opb_exp_f64_0[10:1],
                       opb_exp_f64_0[0] | opb_exp_is_zero_f64_0})
                + {7'h0,
                   {6{opb_exp_is_zero_f64_0}} & _U_Left_Shift_opb_f64_0_io_lzd_result})
          : 13'(out_exp_diff_q_f64_0 - {12'h0, iter_num_q[0]});
      out_exp_diff_q_f32_1 <=
        fsm_q[0]
          ? 10'(10'(10'({1'h0,
                    ...
                    - {2'h0,
                       opb_exp_f32_1[7:1],
                       opb_exp_f32_1[0] | opb_exp_is_zero_f32_1})
                + {5'h0,
                   {5{opb_exp_is_zero_f32_1}} & _U_Left_Shift_opb_f32_1_io_lzd_result})
          : 10'(out_exp_diff_q_f32_1 - {9'h0, iter_num_q[1]});
    ...
    if (start_handshaked | fsm_q[1] | fsm_q[2] | fsm_q[3])
      iter_num_q <=
        fsm_q[1]
          ...
          : fsm_q[2]
              ? (fp_format_onehot_q[0] ? 4'h1 : fp_format_onehot_q[1] ? 4'h3 : 4'h8)
              : 4'(iter_num_q - 4'h1);
    ...
    if (start_handshaked | fsm_q[1] | fsm_q[2] | fsm_q[4])
      frac_divisor_q_60bit <=
        start_handshaked & (&io_fp_format_i) | ~start_handshaked & fp_format_onehot_q[2]
          ...
          : start_handshaked & fp_format_is_fp32 | ~start_handshaked
            & fp_format_onehot_q[1]
