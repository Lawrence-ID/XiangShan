  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        probes_0_task_tag = _RANDOM[3'h0][27:9];
        probes_0_task_set = {_RANDOM[3'h0][31:28], _RANDOM[3'h1][4:0]};
        probes_0_task_opcode = _RANDOM[3'h1][13:11];
        probes_0_task_param = _RANDOM[3'h1][15:14];
        probes_0_task_alias = _RANDOM[3'h1][16];
        probes_1_valid = _RANDOM[3'h1][17];
        probes_1_rdy = _RANDOM[3'h1][18];
        probes_1_waitG = _RANDOM[3'h1][25:19];
        probes_1_task_tag = {_RANDOM[3'h1][31:26], _RANDOM[3'h2][12:0]};
        probes_1_task_set = _RANDOM[3'h2][21:13];
        probes_1_task_opcode = _RANDOM[3'h2][30:28];
        probes_1_task_param = {_RANDOM[3'h2][31], _RANDOM[3'h3][0]};
        probes_1_task_alias = _RANDOM[3'h3][1];
        probes_2_valid = _RANDOM[3'h3][2];
        probes_2_rdy = _RANDOM[3'h3][3];
        probes_2_waitG = _RANDOM[3'h3][10:4];
        probes_2_task_tag = _RANDOM[3'h3][29:11];
        probes_2_task_set = {_RANDOM[3'h3][31:30], _RANDOM[3'h4][6:0]};
        probes_2_task_opcode = _RANDOM[3'h4][15:13];
        probes_2_task_param = _RANDOM[3'h4][17:16];
        probes_2_task_alias = _RANDOM[3'h4][18];
        probes_3_valid = _RANDOM[3'h4][19];
        probes_3_rdy = _RANDOM[3'h4][20];
        probes_3_waitG = _RANDOM[3'h4][27:21];
        probes_3_task_tag = {_RANDOM[3'h4][31:28], _RANDOM[3'h5][14:0]};
        probes_3_task_set = _RANDOM[3'h5][23:15];
        probes_3_task_opcode = {_RANDOM[3'h5][31:30], _RANDOM[3'h6][0]};
        probes_3_task_param = _RANDOM[3'h6][2:1];
        probes_3_task_alias = _RANDOM[3'h6][3];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        probes_0_valid = 1'h0;
        probes_0_rdy = 1'h0;
