...
module Directory(
  ...
  reg              r_6;
  reg              r_7;
  wire             origin_bit_opt_io_w_req_valid = ~resetFinish | replacerWen;
  wire             origin_bit_opt_io_w_req_bits_data_7 = resetFinish & (|_hit_s3_T);
  wire [8:0]       origin_bit_opt_io_w_req_bits_setIdx =
    resetFinish ? req_s3_set : resetIdx;
  ...
  wire [3:0]       rrip_req_type =
    {_GEN_7[way_s3], req_s3_replacerInfo_channel[2], _rrip_req_type_T_10, req_s3_refill};
  reg  [9:0]       PSEL;
  ...
  wire [7:0][1:0]  _GEN_8 =
    {{repl_state_s3[15:14]},
     ...
     {repl_state_s3[3:2]},
     {repl_state_s3[1:0]}};
  wire [1:0]       _next_state_s3_increcement_T = 2'(2'h3 - _GEN_8[way_s3]);
  ...
  wire [1:0]       _next_state_s3_increcement_T_1 = 2'(2'h3 - _GEN_8[way_s3]);
  ...
  SRAMTemplate_141 replacer_sram_opt (
    ...
    .io_w_req_valid       (origin_bit_opt_io_w_req_valid),
    .io_w_req_bits_setIdx (origin_bit_opt_io_w_req_bits_setIdx),
  ...
  SRAMTemplate_142 origin_bit_opt (
    ...
    .io_w_req_valid        (origin_bit_opt_io_w_req_valid),
    .io_w_req_bits_setIdx  (origin_bit_opt_io_w_req_bits_setIdx),
    .io_w_req_bits_data_0  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_1  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_2  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_3  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_4  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_5  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_6  (origin_bit_opt_io_w_req_bits_data_7),
    .io_w_req_bits_data_7  (origin_bit_opt_io_w_req_bits_data_7),
