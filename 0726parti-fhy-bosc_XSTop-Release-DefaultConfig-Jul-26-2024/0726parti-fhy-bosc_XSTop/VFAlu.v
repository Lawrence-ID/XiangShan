...
module VFAlu(
  ...
  wire            _numOfUopVFREDOSUM_uvlMax_T_2 = ctrlVec_1_vpu_vsew == 2'h2;
  reg             outEew_r;
  ...
  wire            _numOfUopVFREDOSUM_uvlMax_T = ctrlVec_1_vpu_vsew == 2'h1;
  wire [5:0]      _cmpResultOldVdRshiftWidth_T_9 =
    _numOfUopVFREDOSUM_uvlMax_T ? {ctrlVec_1_vpu_vuopIdx[2:0], 3'h0} : 6'h0;
  wire [4:0]      _GEN_10 =
    _cmpResultOldVdRshiftWidth_T_9[4:0]
    | (_numOfUopVFREDOSUM_uvlMax_T_2 ? {ctrlVec_1_vpu_vuopIdx[2:0], 2'h0} : 5'h0);
  ...
  wire [111:0]    _outOldVdForREDO_T_6 =
    _numOfUopVFREDOSUM_uvlMax_T ? dataVec_1_src_2[127:16] : 112'h0;
  wire [95:0]     _GEN_13 =
    _outOldVdForREDO_T_6[95:0]
    | (_numOfUopVFREDOSUM_uvlMax_T_2 ? dataVec_1_src_2[127:32] : 96'h0);
            ...
            8'(_GEN_12 + 8'h1) >= dataVec_1_src_4
              | (_outSrcMaskRShift_T_2[1]
                   ? _fflagsRedMask_T_3 & resultDataUInt[16]
                     ...
                     | (&ctrlVec_1_vpu_vsew) & resultDataUInt[64]
