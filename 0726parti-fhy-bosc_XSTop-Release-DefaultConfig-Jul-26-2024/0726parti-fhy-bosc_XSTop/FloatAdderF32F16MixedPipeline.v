    ...
    if (io_fire) begin
      ...
      io_fp_c_r_1 <=
        (is_min
           ? (_GEN_0
                ? 32'h0
                : ~fp_b_is_greater & ~fp_b_is_equal | fp_b_to32[31] & fp_b_is_zero
                  & fp_a_is_zero
                    ? fp_b_16_or_32
                    : fp_a_16_or_32)
        ...
        | (is_flt ? {31'h0, ~_fflags_NV_stage0_T_7 & fp_b_is_greater} : 32'h0)
        | (is_fle
      ...
      io_fflags_r_1 <=
        {(is_min | is_max) & _fflags_NV_stage0_T_3 | is_feq & _fflags_NV_stage0_T_3
           | (is_flt | is_fle) & _fflags_NV_stage0_T_7,
         4'h0};
    end
  end // always @(posedge)
