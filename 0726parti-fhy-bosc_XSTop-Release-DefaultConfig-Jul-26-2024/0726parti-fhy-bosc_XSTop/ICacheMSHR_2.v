  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        blkPaddr = {_RANDOM[1'h0][31:4], _RANDOM[1'h1][1:0]};
        vSetIdx = _RANDOM[1'h1][9:2];
        waymask = _RANDOM[1'h1][11:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valid = 1'h0;
        flush = 1'h0;
