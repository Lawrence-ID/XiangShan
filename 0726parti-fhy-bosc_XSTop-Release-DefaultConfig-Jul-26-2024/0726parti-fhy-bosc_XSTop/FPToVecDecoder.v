...
module FPToVecDecoder(
  ...
  wire        isFP32Instr =
    ...
    | {io_instr[31:25], io_instr[6:0]} == 14'h653 | _GEN_1 == 19'h2C053 | _GEN_2 == 9'h43
    | _GEN_2 == 9'h47 | _GEN_2 == 9'h4F | _GEN_2 == 9'h4B | _GEN_3 == 22'h3800D3
    | _GEN_0 == 17'h4053 | _GEN_0 == 17'h4153
    | {io_instr[31:25], io_instr[14:12], io_instr[6:0]} == 17'h40D3;
  ...
  assign io_vpuCtrl_vlmul =
    {2'h3,
     ~(isFP32Instr | _GEN_1 == 19'h60053 | {io_instr[31:20], io_instr[6:0]} == 19'h600D3
       | {io_instr[31:20], io_instr[14:12], io_instr[6:0]} == 22'h380053)};
  ...
  assign io_vpuCtrl_isReverse =
    ...
    | _GEN_0 == 17'h14553 | _GEN_0 == 17'h144D3 | _GEN_0 == 17'h14453 | _GEN_0 == 17'h5053
    | _GEN_0 == 17'h50D3 | _GEN_0 == 17'h5453 | _GEN_0 == 17'h54D3 | _GEN == 14'h453
    | _GEN == 14'h4D3 | _GEN == 14'h653 | {io_instr[31:25], io_instr[6:0]} == 14'h6D3
    | _GEN_1 == 19'h2C053 | {io_instr[31:20], io_instr[6:0]} == 19'h2D053
    | _GEN_2 == 9'h43 | _GEN_2 == 9'h47 | _GEN_2 == 9'h4F | _GEN_2 == 9'h4B
    | _GEN_2 == 9'hC3 | _GEN_2 == 9'hC7 | _GEN_2 == 9'hCF | _GEN_2 == 9'hCB
    | _GEN_3 == 22'h3800D3
    | {io_instr[31:20], io_instr[14:12], io_instr[6:0]} == 22'h3880D3 | _GEN_0 == 17'h4053
    | _GEN_0 == 17'h4453 | _GEN_0 == 17'h4153 | _GEN_0 == 17'h4553 | _GEN_0 == 17'h40D3
    | {io_instr[31:25], io_instr[14:12], io_instr[6:0]} == 17'h44D3;
endmodule
