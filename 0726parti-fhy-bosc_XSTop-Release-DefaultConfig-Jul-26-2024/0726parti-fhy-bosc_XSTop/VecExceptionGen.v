...
module VecExceptionGen(
  ...
  wire        maskLogicalInst =
    _GEN_2 == 16'h6557 | _GEN_2 == 16'h7557 | _GEN_2 == 16'h6157 | _GEN_2 == 16'h6D57
    | _GEN_2 == 16'h6957 | _GEN_2 == 16'h7957 | _GEN_2 == 16'h7157 | _GEN_2 == 16'h7D57;
  ...
  wire        vmvSingleInst =
    ...
    | {io_inst[31:20], io_inst[14:12], io_inst[6:0]} == 22'h1082D7;
  wire        vmvWholeInst =
    _GEN_5 == 22'h2781D7 | _GEN_5 == 22'h2785D7 | _GEN_5 == 22'h278DD7
    | {io_inst[31:25], io_inst[19:12], io_inst[6:0]} == 22'h279DD7;
  ...
  wire        eewIllegal =
    io_inst[13:12] == 2'h1 & io_inst[6:0] == 7'h57
    & (~(_GEN_3 == 21'h92CD7 | _GEN_3 == 21'h928D7 | _GEN_3 == 21'h95CD7
         | _GEN_3 == 21'h958D7 | _GEN_3 == 21'h944D7 | _GEN_3 == 21'h940D7)
       & io_vtype_vsew == 2'h1 | _intExtEewIllegal_T) | intExt2 & _intExtEewIllegal_T
    | intExt4 & ~(io_vtype_vsew[1]) | intExt8 & io_vtype_vsew != 2'h3
    | (_wnEmulIllegal_T | redWideningInst) & (&io_vtype_vsew);
  ...
  wire        notAllowOverlapInst =
    ...
    | _GEN_3 == 21'hA0957 | {io_inst[31:26], io_inst[19:12], io_inst[6:0]} == 21'hA4157
    | _GEN_2 == 16'h3A57 | _GEN_2 == 16'h39D7 | _GEN_2 == 16'h3B57 | _GEN_2 == 16'h3AD7
    | _GEN_2 == 16'h3057 | _GEN_2 == 16'h3857 | _GEN_2 == 16'h3257
    | {io_inst[31:26], io_inst[14:12], io_inst[6:0]} == 16'h31D7
    | {io_inst[31:25], io_inst[14:12], io_inst[6:0]} == 17'hBD57;
  wire        vstartIllegal =
    (io_decodedInst_fuType[18] | io_decodedInst_fuType[19] | io_decodedInst_fuType[20]
     | io_decodedInst_fuType[21] | io_decodedInst_fuType[22] | io_decodedInst_fuType[23]
     | io_decodedInst_fuType[24] | io_decodedInst_fuType[25] | io_decodedInst_fuType[26]
