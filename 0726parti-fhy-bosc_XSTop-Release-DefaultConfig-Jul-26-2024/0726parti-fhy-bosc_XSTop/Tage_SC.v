...
module Tage_SC(
  ...
  wire         provided =
    _tables_1_io_resps_0_valid | _tables_0_io_resps_0_valid | _tables_2_io_resps_0_valid
    | _tables_3_io_resps_0_valid;
  wire         s1_altUsed_0 =
    ~provided
    | (_providerInfo_T
  ...
  wire         provided_1 =
    _tables_1_io_resps_1_valid | _tables_0_io_resps_1_valid | _tables_2_io_resps_1_valid
    | _tables_3_io_resps_1_valid;
  wire         s1_altUsed_1 =
    ~provided_1
    | (_providerInfo_T_5
  ...
  wire         tickToPosSat = _GEN_58 >= bankTickCtrDistanceToTops_0 & tickInc;
  wire         tickDec =
  ...
  wire         tickToNegSat = _GEN_59 >= bankTickCtrs_0 & tickDec;
  ...
  wire         tickToPosSat_1 = _GEN_68 >= bankTickCtrDistanceToTops_1 & tickInc_1;
  wire         tickDec_1 =
  ...
  wire         _GEN_70 =
    ...
    & updateAltDiffers;
  wire [3:0]   newCtr =
    (&updateUseAltCtr) & updateAltCorrect
      ? 4'hF
      : updateUseAltCtr == 4'h0 & ~updateAltCorrect
          ? 4'h0
          : updateAltCorrect ? 4'(updateUseAltCtr + 4'h1) : 4'(updateUseAltCtr - 4'h1);
  ...
  wire         _GEN_71 =
    ...
    & updateAltDiffers_1;
  wire [3:0]   newCtr_1 =
    (&updateUseAltCtr_1) & updateAltCorrect_1
      ? 4'hF
      : updateUseAltCtr_1 == 4'h0 & ~updateAltCorrect_1
          ? 4'h0
          : updateAltCorrect_1
              ? 4'(updateUseAltCtr_1 + 4'h1)
              : 4'(updateUseAltCtr_1 - 4'h1);
    ...
    if (reset) begin
      ...
      if (needToAllocate) begin
        if (&bankTickCtrs_0) begin
          ...
          bankTickCtrDistanceToTops_0 <=
            tickToPosSat ? 7'h0 : 7'(bankTickCtrDistanceToTops_0 - _GEN_58);
          bankTickCtrs_0 <= tickToPosSat ? 7'h7F : 7'(bankTickCtrs_0 + _GEN_58);
        end
        else if (tickDec) begin
          bankTickCtrDistanceToTops_0 <=
            tickToNegSat ? 7'h7F : 7'(bankTickCtrDistanceToTops_0 + _GEN_59);
          bankTickCtrs_0 <= tickToNegSat ? 7'h0 : 7'(bankTickCtrs_0 - _GEN_59);
        end
      end
      if (needToAllocate_1) begin
        if (&bankTickCtrs_1) begin
          ...
          bankTickCtrDistanceToTops_1 <=
            tickToPosSat_1 ? 7'h0 : 7'(bankTickCtrDistanceToTops_1 - _GEN_68);
          bankTickCtrs_1 <= tickToPosSat_1 ? 7'h7F : 7'(bankTickCtrs_1 + _GEN_68);
        end
        else if (tickDec_1) begin
          bankTickCtrDistanceToTops_1 <=
            tickToNegSat_1 ? 7'h7F : 7'(bankTickCtrDistanceToTops_1 + _GEN_69);
          bankTickCtrs_1 <= tickToNegSat_1 ? 7'h0 : 7'(bankTickCtrs_1 - _GEN_69);
        end
      end
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h0)
        useAltOnNaCtrs_0_0 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1)
        useAltOnNaCtrs_0_1 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2)
        useAltOnNaCtrs_0_2 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3)
        useAltOnNaCtrs_0_3 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4)
        useAltOnNaCtrs_0_4 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5)
        useAltOnNaCtrs_0_5 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6)
        useAltOnNaCtrs_0_6 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7)
        useAltOnNaCtrs_0_7 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h8)
        useAltOnNaCtrs_0_8 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h9)
        useAltOnNaCtrs_0_9 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hA)
        useAltOnNaCtrs_0_10 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hB)
        useAltOnNaCtrs_0_11 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hC)
        useAltOnNaCtrs_0_12 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hD)
        useAltOnNaCtrs_0_13 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hE)
        useAltOnNaCtrs_0_14 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'hF)
        useAltOnNaCtrs_0_15 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h10)
        useAltOnNaCtrs_0_16 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h11)
        useAltOnNaCtrs_0_17 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h12)
        useAltOnNaCtrs_0_18 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h13)
        useAltOnNaCtrs_0_19 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h14)
        useAltOnNaCtrs_0_20 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h15)
        useAltOnNaCtrs_0_21 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h16)
        useAltOnNaCtrs_0_22 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h17)
        useAltOnNaCtrs_0_23 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h18)
        useAltOnNaCtrs_0_24 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h19)
        useAltOnNaCtrs_0_25 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1A)
        useAltOnNaCtrs_0_26 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1B)
        useAltOnNaCtrs_0_27 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1C)
        useAltOnNaCtrs_0_28 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1D)
        useAltOnNaCtrs_0_29 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1E)
        useAltOnNaCtrs_0_30 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h1F)
        useAltOnNaCtrs_0_31 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h20)
        useAltOnNaCtrs_0_32 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h21)
        useAltOnNaCtrs_0_33 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h22)
        useAltOnNaCtrs_0_34 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h23)
        useAltOnNaCtrs_0_35 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h24)
        useAltOnNaCtrs_0_36 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h25)
        useAltOnNaCtrs_0_37 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h26)
        useAltOnNaCtrs_0_38 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h27)
        useAltOnNaCtrs_0_39 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h28)
        useAltOnNaCtrs_0_40 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h29)
        useAltOnNaCtrs_0_41 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2A)
        useAltOnNaCtrs_0_42 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2B)
        useAltOnNaCtrs_0_43 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2C)
        useAltOnNaCtrs_0_44 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2D)
        useAltOnNaCtrs_0_45 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2E)
        useAltOnNaCtrs_0_46 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h2F)
        useAltOnNaCtrs_0_47 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h30)
        useAltOnNaCtrs_0_48 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h31)
        useAltOnNaCtrs_0_49 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h32)
        useAltOnNaCtrs_0_50 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h33)
        useAltOnNaCtrs_0_51 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h34)
        useAltOnNaCtrs_0_52 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h35)
        useAltOnNaCtrs_0_53 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h36)
        useAltOnNaCtrs_0_54 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h37)
        useAltOnNaCtrs_0_55 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h38)
        useAltOnNaCtrs_0_56 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h39)
        useAltOnNaCtrs_0_57 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3A)
        useAltOnNaCtrs_0_58 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3B)
        useAltOnNaCtrs_0_59 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3C)
        useAltOnNaCtrs_0_60 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3D)
        useAltOnNaCtrs_0_61 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3E)
        useAltOnNaCtrs_0_62 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h3F)
        useAltOnNaCtrs_0_63 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h40)
        useAltOnNaCtrs_0_64 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h41)
        useAltOnNaCtrs_0_65 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h42)
        useAltOnNaCtrs_0_66 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h43)
        useAltOnNaCtrs_0_67 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h44)
        useAltOnNaCtrs_0_68 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h45)
        useAltOnNaCtrs_0_69 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h46)
        useAltOnNaCtrs_0_70 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h47)
        useAltOnNaCtrs_0_71 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h48)
        useAltOnNaCtrs_0_72 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h49)
        useAltOnNaCtrs_0_73 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4A)
        useAltOnNaCtrs_0_74 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4B)
        useAltOnNaCtrs_0_75 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4C)
        useAltOnNaCtrs_0_76 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4D)
        useAltOnNaCtrs_0_77 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4E)
        useAltOnNaCtrs_0_78 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h4F)
        useAltOnNaCtrs_0_79 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h50)
        useAltOnNaCtrs_0_80 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h51)
        useAltOnNaCtrs_0_81 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h52)
        useAltOnNaCtrs_0_82 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h53)
        useAltOnNaCtrs_0_83 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h54)
        useAltOnNaCtrs_0_84 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h55)
        useAltOnNaCtrs_0_85 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h56)
        useAltOnNaCtrs_0_86 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h57)
        useAltOnNaCtrs_0_87 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h58)
        useAltOnNaCtrs_0_88 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h59)
        useAltOnNaCtrs_0_89 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5A)
        useAltOnNaCtrs_0_90 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5B)
        useAltOnNaCtrs_0_91 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5C)
        useAltOnNaCtrs_0_92 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5D)
        useAltOnNaCtrs_0_93 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5E)
        useAltOnNaCtrs_0_94 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h5F)
        useAltOnNaCtrs_0_95 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h60)
        useAltOnNaCtrs_0_96 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h61)
        useAltOnNaCtrs_0_97 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h62)
        useAltOnNaCtrs_0_98 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h63)
        useAltOnNaCtrs_0_99 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h64)
        useAltOnNaCtrs_0_100 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h65)
        useAltOnNaCtrs_0_101 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h66)
        useAltOnNaCtrs_0_102 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h67)
        useAltOnNaCtrs_0_103 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h68)
        useAltOnNaCtrs_0_104 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h69)
        useAltOnNaCtrs_0_105 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6A)
        useAltOnNaCtrs_0_106 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6B)
        useAltOnNaCtrs_0_107 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6C)
        useAltOnNaCtrs_0_108 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6D)
        useAltOnNaCtrs_0_109 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6E)
        useAltOnNaCtrs_0_110 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h6F)
        useAltOnNaCtrs_0_111 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h70)
        useAltOnNaCtrs_0_112 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h71)
        useAltOnNaCtrs_0_113 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h72)
        useAltOnNaCtrs_0_114 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h73)
        useAltOnNaCtrs_0_115 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h74)
        useAltOnNaCtrs_0_116 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h75)
        useAltOnNaCtrs_0_117 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h76)
        useAltOnNaCtrs_0_118 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h77)
        useAltOnNaCtrs_0_119 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h78)
        useAltOnNaCtrs_0_120 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h79)
        useAltOnNaCtrs_0_121 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7A)
        useAltOnNaCtrs_0_122 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7B)
        useAltOnNaCtrs_0_123 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7C)
        useAltOnNaCtrs_0_124 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7D)
        useAltOnNaCtrs_0_125 <= newCtr;
      if (updateValids_0 & _GEN_70 & io_update_bits_pc[7:1] == 7'h7E)
        useAltOnNaCtrs_0_126 <= newCtr;
      if (updateValids_0 & _GEN_70 & (&(io_update_bits_pc[7:1])))
        useAltOnNaCtrs_0_127 <= newCtr;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h0)
        useAltOnNaCtrs_1_0 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1)
        useAltOnNaCtrs_1_1 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2)
        useAltOnNaCtrs_1_2 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3)
        useAltOnNaCtrs_1_3 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4)
        useAltOnNaCtrs_1_4 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5)
        useAltOnNaCtrs_1_5 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6)
        useAltOnNaCtrs_1_6 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7)
        useAltOnNaCtrs_1_7 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h8)
        useAltOnNaCtrs_1_8 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h9)
        useAltOnNaCtrs_1_9 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hA)
        useAltOnNaCtrs_1_10 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hB)
        useAltOnNaCtrs_1_11 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hC)
        useAltOnNaCtrs_1_12 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hD)
        useAltOnNaCtrs_1_13 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hE)
        useAltOnNaCtrs_1_14 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'hF)
        useAltOnNaCtrs_1_15 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h10)
        useAltOnNaCtrs_1_16 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h11)
        useAltOnNaCtrs_1_17 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h12)
        useAltOnNaCtrs_1_18 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h13)
        useAltOnNaCtrs_1_19 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h14)
        useAltOnNaCtrs_1_20 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h15)
        useAltOnNaCtrs_1_21 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h16)
        useAltOnNaCtrs_1_22 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h17)
        useAltOnNaCtrs_1_23 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h18)
        useAltOnNaCtrs_1_24 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h19)
        useAltOnNaCtrs_1_25 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1A)
        useAltOnNaCtrs_1_26 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1B)
        useAltOnNaCtrs_1_27 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1C)
        useAltOnNaCtrs_1_28 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1D)
        useAltOnNaCtrs_1_29 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1E)
        useAltOnNaCtrs_1_30 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h1F)
        useAltOnNaCtrs_1_31 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h20)
        useAltOnNaCtrs_1_32 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h21)
        useAltOnNaCtrs_1_33 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h22)
        useAltOnNaCtrs_1_34 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h23)
        useAltOnNaCtrs_1_35 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h24)
        useAltOnNaCtrs_1_36 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h25)
        useAltOnNaCtrs_1_37 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h26)
        useAltOnNaCtrs_1_38 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h27)
        useAltOnNaCtrs_1_39 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h28)
        useAltOnNaCtrs_1_40 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h29)
        useAltOnNaCtrs_1_41 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2A)
        useAltOnNaCtrs_1_42 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2B)
        useAltOnNaCtrs_1_43 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2C)
        useAltOnNaCtrs_1_44 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2D)
        useAltOnNaCtrs_1_45 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2E)
        useAltOnNaCtrs_1_46 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h2F)
        useAltOnNaCtrs_1_47 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h30)
        useAltOnNaCtrs_1_48 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h31)
        useAltOnNaCtrs_1_49 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h32)
        useAltOnNaCtrs_1_50 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h33)
        useAltOnNaCtrs_1_51 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h34)
        useAltOnNaCtrs_1_52 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h35)
        useAltOnNaCtrs_1_53 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h36)
        useAltOnNaCtrs_1_54 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h37)
        useAltOnNaCtrs_1_55 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h38)
        useAltOnNaCtrs_1_56 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h39)
        useAltOnNaCtrs_1_57 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3A)
        useAltOnNaCtrs_1_58 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3B)
        useAltOnNaCtrs_1_59 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3C)
        useAltOnNaCtrs_1_60 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3D)
        useAltOnNaCtrs_1_61 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3E)
        useAltOnNaCtrs_1_62 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h3F)
        useAltOnNaCtrs_1_63 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h40)
        useAltOnNaCtrs_1_64 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h41)
        useAltOnNaCtrs_1_65 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h42)
        useAltOnNaCtrs_1_66 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h43)
        useAltOnNaCtrs_1_67 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h44)
        useAltOnNaCtrs_1_68 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h45)
        useAltOnNaCtrs_1_69 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h46)
        useAltOnNaCtrs_1_70 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h47)
        useAltOnNaCtrs_1_71 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h48)
        useAltOnNaCtrs_1_72 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h49)
        useAltOnNaCtrs_1_73 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4A)
        useAltOnNaCtrs_1_74 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4B)
        useAltOnNaCtrs_1_75 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4C)
        useAltOnNaCtrs_1_76 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4D)
        useAltOnNaCtrs_1_77 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4E)
        useAltOnNaCtrs_1_78 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h4F)
        useAltOnNaCtrs_1_79 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h50)
        useAltOnNaCtrs_1_80 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h51)
        useAltOnNaCtrs_1_81 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h52)
        useAltOnNaCtrs_1_82 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h53)
        useAltOnNaCtrs_1_83 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h54)
        useAltOnNaCtrs_1_84 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h55)
        useAltOnNaCtrs_1_85 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h56)
        useAltOnNaCtrs_1_86 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h57)
        useAltOnNaCtrs_1_87 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h58)
        useAltOnNaCtrs_1_88 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h59)
        useAltOnNaCtrs_1_89 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5A)
        useAltOnNaCtrs_1_90 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5B)
        useAltOnNaCtrs_1_91 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5C)
        useAltOnNaCtrs_1_92 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5D)
        useAltOnNaCtrs_1_93 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5E)
        useAltOnNaCtrs_1_94 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h5F)
        useAltOnNaCtrs_1_95 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h60)
        useAltOnNaCtrs_1_96 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h61)
        useAltOnNaCtrs_1_97 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h62)
        useAltOnNaCtrs_1_98 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h63)
        useAltOnNaCtrs_1_99 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h64)
        useAltOnNaCtrs_1_100 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h65)
        useAltOnNaCtrs_1_101 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h66)
        useAltOnNaCtrs_1_102 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h67)
        useAltOnNaCtrs_1_103 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h68)
        useAltOnNaCtrs_1_104 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h69)
        useAltOnNaCtrs_1_105 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6A)
        useAltOnNaCtrs_1_106 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6B)
        useAltOnNaCtrs_1_107 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6C)
        useAltOnNaCtrs_1_108 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6D)
        useAltOnNaCtrs_1_109 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6E)
        useAltOnNaCtrs_1_110 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h6F)
        useAltOnNaCtrs_1_111 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h70)
        useAltOnNaCtrs_1_112 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h71)
        useAltOnNaCtrs_1_113 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h72)
        useAltOnNaCtrs_1_114 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h73)
        useAltOnNaCtrs_1_115 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h74)
        useAltOnNaCtrs_1_116 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h75)
        useAltOnNaCtrs_1_117 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h76)
        useAltOnNaCtrs_1_118 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h77)
        useAltOnNaCtrs_1_119 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h78)
        useAltOnNaCtrs_1_120 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h79)
        useAltOnNaCtrs_1_121 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7A)
        useAltOnNaCtrs_1_122 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7B)
        useAltOnNaCtrs_1_123 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7C)
        useAltOnNaCtrs_1_124 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7D)
        useAltOnNaCtrs_1_125 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & io_update_bits_pc[7:1] == 7'h7E)
        useAltOnNaCtrs_1_126 <= newCtr_1;
      if (updateValids_1 & _GEN_71 & (&(io_update_bits_pc[7:1])))
        useAltOnNaCtrs_1_127 <= newCtr_1;
      if (_GEN & io_update_bits_meta[48] != tagePred
        ...
        scThresholds_0_ctr <=
          (&newThres_newCtr) | _newThres_res_ctr_T_4 ? 5'h10 : newThres_newCtr;
      ...
      if (_GEN_1 & io_update_bits_meta[49] != tagePred_1
        ...
        scThresholds_1_ctr <=
          (&newThres_newCtr_1) | _newThres_res_ctr_T_11 ? 5'h10 : newThres_newCtr_1;
