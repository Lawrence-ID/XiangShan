...
module ClosePathF16Pipeline(
  ...
  wire [10:0] U_CS3_io_adder_op1 = {1'h1, io_fp_a[9:0]};
  wire [10:0] U_CS3_io_adder_op0 = {1'h1, io_fp_b[9:0]};
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      close_sign_result_r <=
        sel_CS0 & (_U_CS0_io_result[11] | _U_CS1_io_result[11]) & io_fp_a[15] | sel_CS0
        & ~(_U_CS0_io_result[11]) & ~(_U_CS1_io_result[11]) & RDN | sel_CS1
        & ~(io_fp_a[15]) | sel_CS2 & io_fp_a[15] | sel_CS3 & ~(io_fp_a[15]) | sel_CS4
        & (Efp_b_is_greater ^ io_fp_a[15]);
    end
  end // always @(posedge)
