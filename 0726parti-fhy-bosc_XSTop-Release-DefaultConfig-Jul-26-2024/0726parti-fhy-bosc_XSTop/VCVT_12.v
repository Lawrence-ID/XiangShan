...
module VCVT_12(
  ...
  wire         _eNum1H_T = isWidenCvt | isNarrowCvt;
  wire [2:0]   eNum1H_invInputs = ~{io_in_bits_ctrl_vpu_vsew, _eNum1H_T};
  wire [1:0]   _eNum1H_orMatrixOutputs_T =
    {&{_eNum1H_T, eNum1H_invInputs[1], io_in_bits_ctrl_vpu_vsew[1]},
     &{eNum1H_invInputs[0], io_in_bits_ctrl_vpu_vsew[0], io_in_bits_ctrl_vpu_vsew[1]}};
  wire [1:0]   _eNum1H_orMatrixOutputs_T_2 =
    {&{_eNum1H_T, io_in_bits_ctrl_vpu_vsew[0], eNum1H_invInputs[2]},
     &{eNum1H_invInputs[0], eNum1H_invInputs[1], io_in_bits_ctrl_vpu_vsew[1]}};
  wire [1:0]   _eNum1H_orMatrixOutputs_T_4 =
    {&{_eNum1H_T, eNum1H_invInputs[1], eNum1H_invInputs[2]},
     ...
     io_in_bits_ctrl_vpu_vlmul[2]
       ? {3'h0,
          {|_eNum1H_orMatrixOutputs_T_4,
           ...
           1'h0} >> 2'(~(io_in_bits_ctrl_vpu_vlmul[1:0]) + 2'h1)}
       : {3'h0,
          |_eNum1H_orMatrixOutputs_T_4,
          |_eNum1H_orMatrixOutputs_T_2,
          |_eNum1H_orMatrixOutputs_T,
          1'h0} << io_in_bits_ctrl_vpu_vlmul[1:0]};
  wire [10:0]  eStart =
