...
module PTW(
  ...
  wire             _gpaddr_T_28 = level == 2'h1;
  wire             _gpaddr_T_26 = level == 2'h0;
  wire             pageFault =
    ~(io_mem_resp_bits[0]) | ~(io_mem_resp_bits[1]) & io_mem_resp_bits[2]
    | (_find_pte_T | io_mem_resp_bits[2])
    & ~(level == 2'h2 | _gpaddr_T_28 & io_mem_resp_bits[18:10] == 9'h0 | _gpaddr_T_26
        & io_mem_resp_bits[27:10] == 18'h0);
  reg              accessFault;
  reg              hptw_pageFault;
  ...
  wire             ppn_af =
    s2xlate ? (|(io_mem_resp_bits[53:39])) : (|(io_mem_resp_bits[53:34]));
  wire             guest_fault = hptw_pageFault | hptw_accessFault;
  wire             find_pte = _find_pte_T | io_mem_resp_bits[2] | ppn_af | pageFault;
  reg  [1:0]       source;
  wire [32:0]      _GEN =
    af_level == 2'h0
      ? {satp_ppn[23:0], vpn[26:18]}
      : {l1Hit ? ppn[23:0] : io_mem_resp_bits[33:10], vpn[17:9]};
    ...
    stage1Hit
      ...
      : onlyS2xlate
          ...
          : s_last_hptw_req
              ? {5'h0, _GEN, 3'h0}
              : {_gpaddr_T_28
                   ? {io_mem_resp_bits[38:19], vpn[8:0]}
                   : _gpaddr_T_26
                       ? {io_mem_resp_bits[38:28], vpn[17:0]}
                       : io_mem_resp_bits[38:10],
                 12'h0};
  ...
  wire             _GEN_6 = guest_fault | accessFault;
  wire [23:0]      _GEN_7 = _GEN_6 ? 24'h0 : io_mem_resp_bits[33:10];
  wire             ptw_resp_perm_pm_d = ~_GEN_6 & io_mem_resp_bits[7];
  wire             ptw_resp_perm_pm_a = ~_GEN_6 & io_mem_resp_bits[6];
  wire             ptw_resp_perm_pm_g = ~_GEN_6 & io_mem_resp_bits[5];
  wire             ptw_resp_perm_pm_u = ~_GEN_6 & io_mem_resp_bits[4];
  wire             ptw_resp_perm_pm_x = ~_GEN_6 & io_mem_resp_bits[3];
  wire             ptw_resp_perm_pm_w = ~_GEN_6 & io_mem_resp_bits[2];
  wire             ptw_resp_perm_pm_r = ~_GEN_6 & io_mem_resp_bits[1];
  wire [25:0]      ptw_resp_1_ppn =
    {_GEN_6 ? 5'h0 : io_mem_resp_bits[38:34], _GEN_7[23:3]};
  wire             io_resp_valid_0 =
    stage1Hit
      ? ~idle & hptw_resp_stage2
      : ~idle & mem_addr_update & ~last_s2xlate
        & (w_mem_resp & find_pte | s_pmp_check & accessFault | onlyS2xlate | guest_fault);
  wire             io_llptw_valid_0 =
    ~s_llptw_req & _gpaddr_T_28 & ~find_pte & ~accessFault;
  ...
  wire             _GEN_8 = perfEvents_0_2 & io_req_bits_stage1Hit;
  wire             _GEN_9 = io_hptw_resp_valid & ~w_hptw_resp;
  wire             _GEN_10 = _GEN_9 & stage1Hit;
  wire             _GEN_11 = io_resp_ready & io_resp_valid_0;
  wire             _GEN_12 = perfEvents_0_2 & ~io_req_bits_stage1Hit;
  wire             perfEvents_4_2 = io_mem_req_ready & io_mem_req_valid_0;
  wire             _GEN_13 = _gpaddr_T_26 & ~onlyS2xlate & ~(find_pte | accessFault);
  wire             _GEN_14 = s2xlate & last_s2xlate;
  assign finish =
    mem_addr_update & ~_GEN_13 & (io_llptw_valid_0 | ~_GEN_14 & io_resp_valid_0);
  reg              perfEvents_5_2;
  ...
  always @(posedge clock) begin
    ...
    hptw_resp_stage2 <= _GEN_10 | ~_GEN_8 & hptw_resp_stage2;
  ...
  wire [1:0]       _GEN_16 = {1'h0, io_req_bits_l1Hit};
  wire             _GEN_17 = ~_GEN_12 & (_GEN_11 & stage1Hit | ~_GEN_8 & idle);
  wire             _GEN_18 =
    (|io_req_bits_req_info_s2xlate) & io_req_bits_req_info_s2xlate != 2'h1;
  wire             _GEN_19 = _GEN_12 ? _GEN_18 : ~_GEN_8 & last_s2xlate;
  wire             _GEN_20 = io_hptw_req_ready & io_hptw_req_valid_0;
  wire             _GEN_21 = _GEN_20 & ~s_hptw_req;
  wire             _GEN_22 = _GEN_9 & ~stage1Hit;
  wire             _GEN_23 = _GEN_20 & ~s_last_hptw_req;
  wire             _GEN_24 = io_hptw_resp_valid & ~w_last_hptw_resp;
  wire             _GEN_25 = _GEN_24 | _GEN_22;
  wire             _GEN_26 = sent_to_pmp & ~mem_addr_update;
  wire             _GEN_27 = accessFault & ~idle;
  wire             _GEN_28 = guest_fault & ~idle;
  wire             _GEN_29 = _GEN_28 | _GEN_27;
  wire             _GEN_30 = _GEN_28 | _GEN_27 | _GEN_24 | _GEN_22 & onlyS2xlate;
  wire             _GEN_31 = ~_GEN_30 & _GEN_19;
  wire             _GEN_32 = io_mem_resp_valid & ~w_mem_resp;
  wire             _GEN_33 = ~_GEN_32 & (_GEN_29 | s_llptw_req);
  wire             _GEN_34 = _GEN_32 | _GEN_30 | mem_addr_update;
  wire             _GEN_35 = mem_addr_update & _GEN_13;
  wire             _GEN_36 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_37 = accessFault | pageFault | ppn_af;
  wire             _GEN_38 = ~mem_addr_update | _GEN_13;
  wire             _GEN_39 = ~_GEN_14 & _GEN_11;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_32)
        ...
        af_level <= _GEN_16;
      s_pmp_check <=
        flush | _GEN_28 | _GEN_27 | _GEN_26
        | (~_GEN_22 | onlyS2xlate | io_hptw_resp_bits_h_resp_gpf
           | io_hptw_resp_bits_h_resp_gaf) & (~_GEN_12 | _GEN_18) & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_35 | s2xlate) & (perfEvents_4_2 | _GEN_29 | ~_GEN_26 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_13 | (io_llptw_valid_0 ? _GEN_36 | _GEN_33 : _GEN_39 | _GEN_33)
             : _GEN_33);
      w_mem_resp <= flush | _GEN_32 | ~perfEvents_4_2 & (_GEN_29 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_13 & s2xlate)
        & (_GEN_28 | _GEN_27 | _GEN_21
           | (_GEN_12 ? ~(_GEN_18 | _GEN_8) & s_hptw_req : ~_GEN_8 & s_hptw_req));
      w_hptw_resp <=
        flush | _GEN_28 | _GEN_27 | _GEN_22 | ~_GEN_21 & (_GEN_10 | w_hptw_resp);
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_13 | io_llptw_valid_0 | ~_GEN_14 | _GEN_37)
        & (_GEN_28 | _GEN_27 | _GEN_23 | s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_28 | _GEN_27 | _GEN_24 | ~_GEN_23 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_13
               & (io_llptw_valid_0
                    ? ~_GEN_36 & _GEN_34
                    : _GEN_14 ? _GEN_37 & _GEN_34 : ~_GEN_11 & _GEN_34)
             : _GEN_34);
      idle <=
        flush
        | (_GEN_38 ? _GEN_17 : io_llptw_valid_0 ? _GEN_36 | _GEN_17 : _GEN_39 | _GEN_17);
      hptw_pageFault <=
        _GEN_25 ? io_hptw_resp_bits_h_resp_gpf : ~_GEN_12 & hptw_pageFault;
      hptw_accessFault <=
        _GEN_25 ? io_hptw_resp_bits_h_resp_gaf : ~_GEN_12 & hptw_accessFault;
      last_s2xlate <=
        _GEN_38
          ? _GEN_31
          : io_llptw_valid_0
              ? ~(_GEN_36 | _GEN_30) & _GEN_19
              : _GEN_14 ? ~(_GEN_37 | _GEN_30) & _GEN_19 : _GEN_31;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s_pmp_check = _RANDOM[5'h2][1];
        s_mem_req = _RANDOM[5'h2][2];
        s_llptw_req = _RANDOM[5'h2][3];
        w_mem_resp = _RANDOM[5'h2][4];
        s_hptw_req = _RANDOM[5'h2][5];
        w_hptw_resp = _RANDOM[5'h2][6];
        s_last_hptw_req = _RANDOM[5'h2][7];
        w_last_hptw_resp = _RANDOM[5'h2][8];
        mem_addr_update = _RANDOM[5'h2][9];
        idle = _RANDOM[5'h2][10];
        accessFault = _RANDOM[5'h2][11];
        hptw_pageFault = _RANDOM[5'h2][12];
        hptw_accessFault = _RANDOM[5'h2][13];
        last_s2xlate = _RANDOM[5'h2][14];
        stage1Hit = _RANDOM[5'h2][15];
        stage1_entry_0_tag = {_RANDOM[5'h2][31:16], _RANDOM[5'h3][9:0]};
        stage1_entry_0_asid = _RANDOM[5'h3][25:10];
        stage1_entry_0_vmid = {_RANDOM[5'h3][31:26], _RANDOM[5'h4][7:0]};
        stage1_entry_0_perm_d = _RANDOM[5'h4][8];
        stage1_entry_0_perm_a = _RANDOM[5'h4][9];
        stage1_entry_0_perm_g = _RANDOM[5'h4][10];
        stage1_entry_0_perm_u = _RANDOM[5'h4][11];
        stage1_entry_0_perm_x = _RANDOM[5'h4][12];
        stage1_entry_0_perm_w = _RANDOM[5'h4][13];
        stage1_entry_0_perm_r = _RANDOM[5'h4][14];
        stage1_entry_0_level = _RANDOM[5'h4][16:15];
        stage1_entry_0_v = _RANDOM[5'h4][18];
        stage1_entry_0_ppn = {_RANDOM[5'h4][31:19], _RANDOM[5'h5][12:0]};
        stage1_entry_0_ppn_low = _RANDOM[5'h5][15:13];
        stage1_entry_0_pf = _RANDOM[5'h5][17];
        stage1_entry_1_tag = {_RANDOM[5'h5][31:18], _RANDOM[5'h6][11:0]};
        stage1_entry_1_asid = _RANDOM[5'h6][27:12];
        stage1_entry_1_vmid = {_RANDOM[5'h6][31:28], _RANDOM[5'h7][9:0]};
        stage1_entry_1_perm_d = _RANDOM[5'h7][10];
        stage1_entry_1_perm_a = _RANDOM[5'h7][11];
        stage1_entry_1_perm_g = _RANDOM[5'h7][12];
        stage1_entry_1_perm_u = _RANDOM[5'h7][13];
        stage1_entry_1_perm_x = _RANDOM[5'h7][14];
        stage1_entry_1_perm_w = _RANDOM[5'h7][15];
        stage1_entry_1_perm_r = _RANDOM[5'h7][16];
        stage1_entry_1_level = _RANDOM[5'h7][18:17];
        stage1_entry_1_v = _RANDOM[5'h7][20];
        stage1_entry_1_ppn = {_RANDOM[5'h7][31:21], _RANDOM[5'h8][14:0]};
        stage1_entry_1_ppn_low = _RANDOM[5'h8][17:15];
        stage1_entry_1_pf = _RANDOM[5'h8][19];
        stage1_entry_2_tag = {_RANDOM[5'h8][31:20], _RANDOM[5'h9][13:0]};
        stage1_entry_2_asid = _RANDOM[5'h9][29:14];
        stage1_entry_2_vmid = {_RANDOM[5'h9][31:30], _RANDOM[5'hA][11:0]};
        stage1_entry_2_perm_d = _RANDOM[5'hA][12];
        stage1_entry_2_perm_a = _RANDOM[5'hA][13];
        stage1_entry_2_perm_g = _RANDOM[5'hA][14];
        stage1_entry_2_perm_u = _RANDOM[5'hA][15];
        stage1_entry_2_perm_x = _RANDOM[5'hA][16];
        stage1_entry_2_perm_w = _RANDOM[5'hA][17];
        stage1_entry_2_perm_r = _RANDOM[5'hA][18];
        stage1_entry_2_level = _RANDOM[5'hA][20:19];
        stage1_entry_2_v = _RANDOM[5'hA][22];
        stage1_entry_2_ppn = {_RANDOM[5'hA][31:23], _RANDOM[5'hB][16:0]};
        stage1_entry_2_ppn_low = _RANDOM[5'hB][19:17];
        stage1_entry_2_pf = _RANDOM[5'hB][21];
        stage1_entry_3_tag = {_RANDOM[5'hB][31:22], _RANDOM[5'hC][15:0]};
        stage1_entry_3_asid = _RANDOM[5'hC][31:16];
        stage1_entry_3_vmid = _RANDOM[5'hD][13:0];
        stage1_entry_3_perm_d = _RANDOM[5'hD][14];
        stage1_entry_3_perm_a = _RANDOM[5'hD][15];
        stage1_entry_3_perm_g = _RANDOM[5'hD][16];
        stage1_entry_3_perm_u = _RANDOM[5'hD][17];
        stage1_entry_3_perm_x = _RANDOM[5'hD][18];
        stage1_entry_3_perm_w = _RANDOM[5'hD][19];
        stage1_entry_3_perm_r = _RANDOM[5'hD][20];
        stage1_entry_3_level = _RANDOM[5'hD][22:21];
        stage1_entry_3_v = _RANDOM[5'hD][24];
        stage1_entry_3_ppn = {_RANDOM[5'hD][31:25], _RANDOM[5'hE][18:0]};
        stage1_entry_3_ppn_low = _RANDOM[5'hE][21:19];
        stage1_entry_3_pf = _RANDOM[5'hE][23];
        stage1_entry_4_tag = {_RANDOM[5'hE][31:24], _RANDOM[5'hF][17:0]};
        stage1_entry_4_asid = {_RANDOM[5'hF][31:18], _RANDOM[5'h10][1:0]};
        stage1_entry_4_vmid = _RANDOM[5'h10][15:2];
        stage1_entry_4_perm_d = _RANDOM[5'h10][16];
        stage1_entry_4_perm_a = _RANDOM[5'h10][17];
        stage1_entry_4_perm_g = _RANDOM[5'h10][18];
        stage1_entry_4_perm_u = _RANDOM[5'h10][19];
        stage1_entry_4_perm_x = _RANDOM[5'h10][20];
        stage1_entry_4_perm_w = _RANDOM[5'h10][21];
        stage1_entry_4_perm_r = _RANDOM[5'h10][22];
        stage1_entry_4_level = _RANDOM[5'h10][24:23];
        stage1_entry_4_v = _RANDOM[5'h10][26];
        stage1_entry_4_ppn = {_RANDOM[5'h10][31:27], _RANDOM[5'h11][20:0]};
        stage1_entry_4_ppn_low = _RANDOM[5'h11][23:21];
        stage1_entry_4_pf = _RANDOM[5'h11][25];
        stage1_entry_5_tag = {_RANDOM[5'h11][31:26], _RANDOM[5'h12][19:0]};
        stage1_entry_5_asid = {_RANDOM[5'h12][31:20], _RANDOM[5'h13][3:0]};
        stage1_entry_5_vmid = _RANDOM[5'h13][17:4];
        stage1_entry_5_perm_d = _RANDOM[5'h13][18];
        stage1_entry_5_perm_a = _RANDOM[5'h13][19];
        stage1_entry_5_perm_g = _RANDOM[5'h13][20];
        stage1_entry_5_perm_u = _RANDOM[5'h13][21];
        stage1_entry_5_perm_x = _RANDOM[5'h13][22];
        stage1_entry_5_perm_w = _RANDOM[5'h13][23];
        stage1_entry_5_perm_r = _RANDOM[5'h13][24];
        stage1_entry_5_level = _RANDOM[5'h13][26:25];
        stage1_entry_5_v = _RANDOM[5'h13][28];
        stage1_entry_5_ppn = {_RANDOM[5'h13][31:29], _RANDOM[5'h14][22:0]};
        stage1_entry_5_ppn_low = _RANDOM[5'h14][25:23];
        stage1_entry_5_pf = _RANDOM[5'h14][27];
        stage1_entry_6_tag = {_RANDOM[5'h14][31:28], _RANDOM[5'h15][21:0]};
        stage1_entry_6_asid = {_RANDOM[5'h15][31:22], _RANDOM[5'h16][5:0]};
        stage1_entry_6_vmid = _RANDOM[5'h16][19:6];
        stage1_entry_6_perm_d = _RANDOM[5'h16][20];
        stage1_entry_6_perm_a = _RANDOM[5'h16][21];
        stage1_entry_6_perm_g = _RANDOM[5'h16][22];
        stage1_entry_6_perm_u = _RANDOM[5'h16][23];
        stage1_entry_6_perm_x = _RANDOM[5'h16][24];
        stage1_entry_6_perm_w = _RANDOM[5'h16][25];
        stage1_entry_6_perm_r = _RANDOM[5'h16][26];
        stage1_entry_6_level = _RANDOM[5'h16][28:27];
        stage1_entry_6_v = _RANDOM[5'h16][30];
        stage1_entry_6_ppn = {_RANDOM[5'h16][31], _RANDOM[5'h17][24:0]};
        stage1_entry_6_ppn_low = _RANDOM[5'h17][27:25];
        stage1_entry_6_pf = _RANDOM[5'h17][29];
        stage1_entry_7_tag = {_RANDOM[5'h17][31:30], _RANDOM[5'h18][23:0]};
        stage1_entry_7_asid = {_RANDOM[5'h18][31:24], _RANDOM[5'h19][7:0]};
        stage1_entry_7_vmid = _RANDOM[5'h19][21:8];
        stage1_entry_7_perm_d = _RANDOM[5'h19][22];
        stage1_entry_7_perm_a = _RANDOM[5'h19][23];
        stage1_entry_7_perm_g = _RANDOM[5'h19][24];
        stage1_entry_7_perm_u = _RANDOM[5'h19][25];
        stage1_entry_7_perm_x = _RANDOM[5'h19][26];
        stage1_entry_7_perm_w = _RANDOM[5'h19][27];
        stage1_entry_7_perm_r = _RANDOM[5'h19][28];
        stage1_entry_7_level = _RANDOM[5'h19][30:29];
        stage1_entry_7_v = _RANDOM[5'h1A][0];
        stage1_entry_7_ppn = _RANDOM[5'h1A][26:1];
        stage1_entry_7_ppn_low = _RANDOM[5'h1A][29:27];
        stage1_entry_7_pf = _RANDOM[5'h1A][31];
        stage1_pteidx_0 = _RANDOM[5'h1B][0];
        stage1_pteidx_1 = _RANDOM[5'h1B][1];
        stage1_pteidx_2 = _RANDOM[5'h1B][2];
        stage1_pteidx_3 = _RANDOM[5'h1B][3];
        stage1_pteidx_4 = _RANDOM[5'h1B][4];
        stage1_pteidx_5 = _RANDOM[5'h1B][5];
        stage1_pteidx_6 = _RANDOM[5'h1B][6];
        stage1_pteidx_7 = _RANDOM[5'h1B][7];
        stage1_not_super = _RANDOM[5'h1B][8];
        hptw_resp_stage2 = _RANDOM[5'h1B][9];
        source = _RANDOM[5'h1B][11:10];
        hptw_resp_entry_tag = {_RANDOM[5'h1B][31:12], _RANDOM[5'h1C][8:0]};
        hptw_resp_entry_vmid = {_RANDOM[5'h1C][31:25], _RANDOM[5'h1D][6:0]};
        hptw_resp_entry_ppn = _RANDOM[5'h1D][30:7];
        hptw_resp_entry_perm_d = _RANDOM[5'h1D][31];
        hptw_resp_entry_perm_a = _RANDOM[5'h1E][0];
        hptw_resp_entry_perm_g = _RANDOM[5'h1E][1];
        hptw_resp_entry_perm_u = _RANDOM[5'h1E][2];
        hptw_resp_entry_perm_x = _RANDOM[5'h1E][3];
        hptw_resp_entry_perm_w = _RANDOM[5'h1E][4];
        hptw_resp_entry_perm_r = _RANDOM[5'h1E][5];
        hptw_resp_entry_level = _RANDOM[5'h1E][7:6];
        hptw_resp_gpf = _RANDOM[5'h1E][10];
        hptw_resp_gaf = _RANDOM[5'h1E][11];
        perfEvents_5_2 = _RANDOM[5'h1F][13];
        ...
        io_perf_5_value_REG = _RANDOM[5'h1F][24];
        io_perf_5_value_REG_1 = _RANDOM[5'h1F][25];
        io_perf_6_value_REG = _RANDOM[5'h1F][26];
        io_perf_6_value_REG_1 = _RANDOM[5'h1F][27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h0;
        af_level = 2'h0;
  ...
  assign io_resp_bits_resp_entry_0_perm_d =
    stage1Hit ? stage1_entry_0_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_0_perm_a =
    stage1Hit ? stage1_entry_0_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_0_perm_g =
    stage1Hit ? stage1_entry_0_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_0_perm_u =
    stage1Hit ? stage1_entry_0_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_0_perm_x =
    stage1Hit ? stage1_entry_0_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_0_perm_w =
    stage1Hit ? stage1_entry_0_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_0_perm_r =
    stage1Hit ? stage1_entry_0_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_0_ppn_low =
    stage1Hit ? stage1_entry_0_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_0_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_1_perm_d =
    stage1Hit ? stage1_entry_1_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_1_perm_a =
    stage1Hit ? stage1_entry_1_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_1_perm_g =
    stage1Hit ? stage1_entry_1_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_1_perm_u =
    stage1Hit ? stage1_entry_1_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_1_perm_x =
    stage1Hit ? stage1_entry_1_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_1_perm_w =
    stage1Hit ? stage1_entry_1_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_1_perm_r =
    stage1Hit ? stage1_entry_1_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_1_ppn_low =
    stage1Hit ? stage1_entry_1_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_1_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_2_perm_d =
    stage1Hit ? stage1_entry_2_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_2_perm_a =
    stage1Hit ? stage1_entry_2_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_2_perm_g =
    stage1Hit ? stage1_entry_2_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_2_perm_u =
    stage1Hit ? stage1_entry_2_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_2_perm_x =
    stage1Hit ? stage1_entry_2_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_2_perm_w =
    stage1Hit ? stage1_entry_2_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_2_perm_r =
    stage1Hit ? stage1_entry_2_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_2_ppn_low =
    stage1Hit ? stage1_entry_2_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_2_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_3_perm_d =
    stage1Hit ? stage1_entry_3_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_3_perm_a =
    stage1Hit ? stage1_entry_3_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_3_perm_g =
    stage1Hit ? stage1_entry_3_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_3_perm_u =
    stage1Hit ? stage1_entry_3_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_3_perm_x =
    stage1Hit ? stage1_entry_3_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_3_perm_w =
    stage1Hit ? stage1_entry_3_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_3_perm_r =
    stage1Hit ? stage1_entry_3_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_3_ppn_low =
    stage1Hit ? stage1_entry_3_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_3_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_4_perm_d =
    stage1Hit ? stage1_entry_4_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_4_perm_a =
    stage1Hit ? stage1_entry_4_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_4_perm_g =
    stage1Hit ? stage1_entry_4_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_4_perm_u =
    stage1Hit ? stage1_entry_4_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_4_perm_x =
    stage1Hit ? stage1_entry_4_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_4_perm_w =
    stage1Hit ? stage1_entry_4_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_4_perm_r =
    stage1Hit ? stage1_entry_4_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_4_ppn_low =
    stage1Hit ? stage1_entry_4_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_4_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_5_perm_d =
    stage1Hit ? stage1_entry_5_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_5_perm_a =
    stage1Hit ? stage1_entry_5_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_5_perm_g =
    stage1Hit ? stage1_entry_5_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_5_perm_u =
    stage1Hit ? stage1_entry_5_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_5_perm_x =
    stage1Hit ? stage1_entry_5_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_5_perm_w =
    stage1Hit ? stage1_entry_5_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_5_perm_r =
    stage1Hit ? stage1_entry_5_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_5_ppn_low =
    stage1Hit ? stage1_entry_5_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_5_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_6_perm_d =
    stage1Hit ? stage1_entry_6_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_6_perm_a =
    stage1Hit ? stage1_entry_6_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_6_perm_g =
    stage1Hit ? stage1_entry_6_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_6_perm_u =
    stage1Hit ? stage1_entry_6_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_6_perm_x =
    stage1Hit ? stage1_entry_6_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_6_perm_w =
    stage1Hit ? stage1_entry_6_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_6_perm_r =
    stage1Hit ? stage1_entry_6_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_6_ppn_low =
    stage1Hit ? stage1_entry_6_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_6_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_resp_bits_resp_entry_7_perm_d =
    stage1Hit ? stage1_entry_7_perm_d : ptw_resp_perm_pm_d;
  assign io_resp_bits_resp_entry_7_perm_a =
    stage1Hit ? stage1_entry_7_perm_a : ptw_resp_perm_pm_a;
  assign io_resp_bits_resp_entry_7_perm_g =
    stage1Hit ? stage1_entry_7_perm_g : ptw_resp_perm_pm_g;
  assign io_resp_bits_resp_entry_7_perm_u =
    stage1Hit ? stage1_entry_7_perm_u : ptw_resp_perm_pm_u;
  assign io_resp_bits_resp_entry_7_perm_x =
    stage1Hit ? stage1_entry_7_perm_x : ptw_resp_perm_pm_x;
  assign io_resp_bits_resp_entry_7_perm_w =
    stage1Hit ? stage1_entry_7_perm_w : ptw_resp_perm_pm_w;
  assign io_resp_bits_resp_entry_7_perm_r =
    stage1Hit ? stage1_entry_7_perm_r : ptw_resp_perm_pm_r;
  ...
  assign io_resp_bits_resp_entry_7_ppn_low =
    stage1Hit ? stage1_entry_7_ppn_low : _GEN_7[2:0];
  assign io_resp_bits_resp_entry_7_af = ~stage1Hit & ptw_resp_1_af;
  ...
  assign io_refill_req_info_s2xlate = (|req_s2xlate) ? 2'h1 : req_s2xlate;
