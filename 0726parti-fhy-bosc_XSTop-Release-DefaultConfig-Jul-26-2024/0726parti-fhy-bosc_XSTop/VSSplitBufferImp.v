...
module VSSplitBufferImp(
  ...
  output [34:0]  io_vstd_bits_uop_fuType,
    ...
    {15'h0,
     {8'h0,
      {4'h0, {2'h0, {1'h0, _flowData_T_15} | {2{_flowData_T_16}}} | {4{_flowData_T_17}}}
        | {8{_flowData_T_18}}} | {16{_flowData_T_19}}} << _vaddr_T_2[3:0];
  ...
  wire [255:0] _usSplitData_tmpData_T_46 =
    (_vaddr_T_2[3:0] == 4'h0 ? {128'h0, uopq_data} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h1 ? {120'h0, uopq_data, 8'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h2 ? {112'h0, uopq_data, 16'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h3 ? {104'h0, uopq_data, 24'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h4 ? {96'h0, uopq_data, 32'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h5 ? {88'h0, uopq_data, 40'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h6 ? {80'h0, uopq_data, 48'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h7 ? {72'h0, uopq_data, 56'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h8 ? {64'h0, uopq_data, 64'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'h9 ? {56'h0, uopq_data, 72'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'hA ? {48'h0, uopq_data, 80'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'hB ? {40'h0, uopq_data, 88'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'hC ? {32'h0, uopq_data, 96'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'hD ? {24'h0, uopq_data, 104'h0} : 256'h0)
    | (_vaddr_T_2[3:0] == 4'hE ? {16'h0, uopq_data, 112'h0} : 256'h0)
    | ((&(_vaddr_T_2[3:0])) ? {8'h0, uopq_data, 120'h0} : 256'h0);
  wire [6:0]   _sqIdx_new_ptr_T_1 =
    7'({uopq_uop_sqIdx_flag, uopq_uop_sqIdx_value} + {2'h0, splitIdx});
  ...
  assign io_out_bits_vaddr =
    uopq_preIsSplit
      ? _vaddr_T_2
      : {2'h0,
         (_usSplitData_T_3 ? {_vaddr_T_2[38:4], 4'h0} : 39'h0)
           | (_usSplitData_T_4 ? 39'({_vaddr_T_2[38:4], 4'h0} + 39'h10) : 39'h0)};
  ...
  assign io_out_bits_uop_sqIdx_flag = _sqIdx_new_ptr_T_1[6];
  assign io_out_bits_uop_sqIdx_value = _sqIdx_new_ptr_T_1[5:0];
  ...
  assign io_vstd_valid = issueValid & ((|_GEN_0) | ~uopq_preIsSplit);
  assign io_vstd_bits_uop_fuType = uopq_uop_fuType;
  assign io_vstd_bits_uop_fuOpType = uopq_uop_fuOpType;
  assign io_vstd_bits_uop_sqIdx_flag = _sqIdx_new_ptr_T_1[6];
  assign io_vstd_bits_uop_sqIdx_value = _sqIdx_new_ptr_T_1[5:0];
  assign io_vstd_bits_data =
    uopq_preIsSplit
      ...
      : (_usSplitData_T_3 ? _usSplitData_tmpData_T_46[127:0] : 128'h0)
